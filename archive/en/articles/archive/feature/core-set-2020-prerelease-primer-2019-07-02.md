...
---
[Link to Wayback Machine](https://web.archive.org/web/20190713153619/https://magic.wizards.com/en/articles/archive/feature/core-set-2020-prerelease-primer-2019-07-02)
...
Old favorites. New pals. Lots of Chandra in your face everywhere. That can only mean one thing: it's time for *Core Set 2020*!


Whether you're new to slinging spells or a seasoned Planeswalker, this set is a great one to dive into. We always make sure that our core sets are the best time to start learning *Magic* and also have plenty of scintillating new cards for plenty of decks.


And, as always, there's one destination to see all this goodness before anybody else—the Prerelease!


Whether it's your first Prerelease or your hundredth, it's a great time to come check out the set. Plus, you get to play with the cards before anybody else!


So, what can you expect to have happen at a Prerelease? Read on!
...
No matter where in the world I am or what time of year it is, I always try to go check out a local Prerelease. And I'm not alone: tons of *Magic* players, from seasoned veterans to folks just starting out, do the same! Prereleases are among the most popular events we throw.
...
If you're a Sealed Deck veteran, you may want to skip ahead to the next section, where I talk about some of the differences you can expect at your local store for *Core Set 2020*. But if you're new to the wide world of Sealed Deck, or are maybe just looking for a few extra pointers, read on!
...
Be sure to pack all the supplies you will need for this journey. For example, you may still want to bring a Standard deck to play for fun between rounds, a trade binder, pen and paper to keep track of life, and even a water bottle.


A Prerelease event tends to take about 4–5 hours, so make sure to set aside enough time for the entire event. And you're going to need some fuel with all of that battling, so you may want to bring something like a protein bar, apple (so appropriate—they have cores!), or other snack.


Okay now, let's see. You have a store selected on your map, and you've filled your pack with everything you'll need. And, of course, you've taken a look at all the awesome cards in the [*Core Set 2020* Card Image Gallery](https://magic.wizards.com/en/articles/archive/card-image-gallery/core-set-2020). Perhaps, if you were curious what a tournament might be like, you might have checked out my article conveniently titled "[Your First Tournament](https://magic.wizards.com/en/articles/archive/beyond-basics/your-first-tournament-2017-02-23)."
...
![Prerelease box](https://media.wizards.com/2019/images/daily/YQPCq3JnW8.png)


Inside, you'll get six *Core Set 2020* boosters, plus a random stamped rare or mythic rare card as your Prerelease foil that could be any rare or mythic rare in the set!
...
![Everything inside](https://media.wizards.com/2019/images/daily/FXLChmcGoe.png)
...
Ideally, the colors you pick will have all four of these criteria, but if two or three of those are true, that's plenty good.
...
First, lay your creatures out in mana-cost order. This helps you see what creatures you're going to potentially be able to cast at each part of the game. (Don't lay your noncreatures out at this point unless they're cards you are planning to play as soon as you have that much mana—for example, you will generally cast a [Daybreak Chaplain](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Daybreak+Chaplain) on turn two, whereas [Disenchant](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Disenchant) isn't usually a turn-two play.)
...
That's far from set in stone, but it's a good place to start. Cull your creatures down to these numbers by choosing your favorites.
...
Not to mention, *Core Set 2020* has five different Planeswalker Decks to pick between—there's so much variety! Check them out!


![PW decks](https://media.wizards.com/2019/images/daily/dlzY8YKOqJ.png)
...
Want more of the core set? Well, good news! Something relatively new to Prerelease is the ability to actually pick up a booster box at the Prerelease!
...
There has never been a better time to enter *Magic*. With a brand-new core set around the corner [*Magic: The Gathering Arena*](https://magic.wizards.com/en/mtgarena) bringing people into the game, and tons of stores at which you can play, there are plenty of opportunities to play *Magic* everywhere!


If you're new, welcome on in. If you've been around for a while, welcome back. It's gonna be a good time!


So, gather up your friends, take another look through the [Card Image Gallery](https://magic.wizards.com/en/articles/archive/card-image-gallery/core-set-2020), make sure you're preregistered at your local store, and get ready to come out to the Prerelease and have fun!
...
Have an amazing time with the set, and I'll talk to you soon!
