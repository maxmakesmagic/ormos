...
### April 26-28: *Sixth Edition* is Released!

Ten years ago, when the core set reached *Classic Sixth Edition*, it marked an important point in **Magic** history. Finally, [Storm Cauldron](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Storm+Cauldron) was in the core set!

![Storm Cauldron](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Storm+Cauldron)  
...
As an aside, that "rat's maze" isn't just a metaphor. *Duelist #9* actually used a rat-maze metaphor to explain the timing rules:

![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/arcana300/mtgcom_arcana_130_pic1.jpg)  
There were more mazes than that, which you can see in [this Arcana](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/arcana/130). We strongly recommend it, because it's pretty funny.

The rules changes didn't go into effect for a month after *Classic Sixth Edition* came out, which gave people time to get used to the idea of the game changing. To help with the transition, Bill Rose explained the rules in a letter that's [still on the website](http://www.wizards.com/magic/advanced/6e/6e_letter.asp).
