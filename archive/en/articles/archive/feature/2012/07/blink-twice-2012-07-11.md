...
---
[Link to Wayback Machine](https://web.archive.org/web/20211025174257/https://magic.wizards.com/en/articles/archive/feature/blink-twice-2012-07-11)
...
[_metadata_:node]:- "665276"
[_metadata_:publish_date]:- "2012-07-11"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Blink Twice"
[_metadata_:wayback_capture_timestamp]:- "2021-10-25 17:42:57"
...
While the [flicker mechanic](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Flicker) goes back a long way, it really didn't take its place in the Constructed circle until [Momentary Blink](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Momentary+Blink) was printed and the mechanic came with card advantage attached. [Momentary Blink](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Momentary+Blink) was probably the most powerful flicker ever, but there have been plenty to see print since. In *Avacyn Restored*, both [Cloudshift](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cloudshift) and [Ghostly Flicker](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ghostly+Flicker) do a pretty good job of showcasing the mechanic in Limited, but [Restoration Angel](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Restoration+Angel) is the big champion here, already taking a firm hold of success in Standard. But that isn't the only place you can find a flicker...


[Venser, the Sojourner](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Venser%2C+the+Sojourner) has been a well-liked card ever since it was spoiled on this very site, but its success stories have been few and far between, as it has existed in a very powerful environment. Well, Llowle on **Magic Online** seems to think the strategy is still a viable one and showcased the Planeswalker in a pretty awesome list that made its way to the Top 8 of a recent Standard Premier event.


This list might not have as much of an emphasis on the blinking action as you would think, but Venser still plays a central role in the deck's game plan. With something as innocent as a [Stonehorn Dignitary](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stonehorn+Dignitary) out, the opponent might not ever get another attack step again! Resetting a [Batterskull](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Batterskull) token or gaining extra life off of a [Pristine Talisman](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pristine+Talisman) is also pretty nifty and turns the underplayed [Drogskol Reaver](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Drogskol+Reaver) into an actual card-advantage engine, even before it attacks!
