...
---
[Link to Wayback Machine](https://web.archive.org/web/20190609084726/https://magic.wizards.com/en/articles/archive/feature/modern-horizons-prerelease-primer-2019-06-06)
...
[_metadata_:node]:- "1422716"
[_metadata_:publish_date]:- "2019-06-06"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Modern Horizons Prerelease Primer"
[_metadata_:wayback_capture_timestamp]:- "2019-06-09 08:47:26"
...
Okay now, let's see. You have a store selected on your map, and you've filled your pack with everything you'll need. Of course, you've taken a look at all the awesome cards in the *Modern Horizons* [Card Image Gallery](https://magic.wizards.com/en/articles/archive/card-image-gallery/modern-horizons). Perhaps, if you were curious what a tournament might be like, you might have checked out my article conveniently titled "[Your First Tournament](http://magic.wizards.com/en/articles/archive/beyond-basics/your-first-tournament-2017-02-23)."
...
Normally, Prereleases are all a format called [Sealed Deck](https://magic.wizards.com/en/game-info/gameplay/formats/sealed-deck), where you're handed six booster packs, open them, and make a deck out of just those packs. This may be what you're used to.
...
![MH1 Packs](https://media.wizards.com/2019/images/daily/Jq82TYoPmH.png)
...
![Draft Order](https://media.wizards.com/2016/images/magic/draft/MTG_Draft_Order.jpg)
...
Interested in more of the finer details of Booster Draft? You can check out the page explaining it [here](https://magic.wizards.com/en/game-info/gameplay/formats/booster-draft).


There's also a great article from *Magic* Pro League player Reid Duke that runs through the basics of Booster Draft. If you're newer to Draft, definitely go check that out [here](https://magic.wizards.com/en/articles/archive/level-one/basics-booster-draft-2015-02-09)!
...
![Astral Drift](https://media.wizards.com/2019/images/daily/emBBZmqctl.png)


Unlike a randomized Prerelease promo, which you might be used to with other sets, this promo *cannot* go into your deck. So enjoy looking at it, take it in, hold it gingerly like you might hold a small child, but don't put it into your Limited deck. (Your cycling Commander deck, on the other hand . . . well, feel free to get that party started!)
...
Curious to learn more about how 2HG works and some of the intricacies of play? Be sure to check out the page all about it by clicking [here](http://magic.wizards.com/en/gameinfo/gameplay/formats/twoheadedgiant). And be sure to contact your local store if you are interested in 2HG to see what they might be running!
...
![MH1 Box](https://media.wizards.com/2019/images/daily/MNLPRA6jZ9.png)


And of course, you'll get your buy-a box [Flusterstorm](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Flusterstorm) promo, too:


![Flusterstorm](https://media.wizards.com/2019/mh1/en_7bVgoKkiI9.png)


Pick up your box and bring it home (or crack it all open there!) on the day of the Prerelease! Contact your [local store](https://locator.wizards.com/) for more details.
...
So if you're curious about how any of these work, check out the *Modern Horizons* [mechanics glossary](https://magic.wizards.com/en/articles/archive/feature/modern-horizons-mechanics-2019-05-31) and the [FAQ](https://magic.wizards.com/en/articles/archive/feature/modern-horizons-release-notes-2019-05-31)! Those should answer all the wonky-tonk questions these cards will no doubt cause.
...
So, gather up your friends, take another look through the [Card Image Gallery](https://magic.wizards.com/en/articles/archive/card-image-gallery/modern-horizons), make sure you're preregistered at your [local store](https://locator.wizards.com/), and get ready to come have a blast at the Prerelease!
...
Instagram: [GavinVerhey](http://www.instagram.com/GavinVerhey)  
