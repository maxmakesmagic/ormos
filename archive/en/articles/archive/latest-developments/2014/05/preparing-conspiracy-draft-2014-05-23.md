...
[_metadata_:description]:- "Ah, Conspiracy. It's a secret to everybody. Well, not anymore—I'm incredibly excited for you all to see the set. After months of teasing, hidden messages, and sly references, you will soon be able to see the the entire set at the Card Image Gallery. When creating the Conspiracy set, the goal was to take some big swings on making a unique draft environment. We wanted to create"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "165036"
[_metadata_:publish_date]:- "2014-05-23"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Preparing for Conspiracy Draft"
[_metadata_:wayback_capture_timestamp]:- "2022-01-21 06:01:54"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20220121060154id_/https://magic.wizards.com/en/articles/archive/latest-developments/preparing-conspiracy-draft-2014-05-23"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/latest-developments/preparing-conspiracy-draft-2014-05-23"
---
...
Ah, *Conspiracy*. It's a secret to everybody. Well, not anymore—I'm incredibly excited for you all to see the set. After months of teasing, hidden messages, and sly references, you will soon be able to see the the entire set at the [Card Image Gallery](http://archive.wizards.com/magic/tcg/article.aspx?x=mtg/tcg/conspiracy/cig).
...
![](https://media.wizards.com/images/magic/tcg/products/cns/asdfsc3wfas234/gwF4ut8xW2_EN.jpg)
...
![](https://media.wizards.com/images/magic/tcg/products/cns/asdfsc3wfas234/MhQnE7rpUi_EN.jpg)

This might seem pretty crazy to you, but I have a unique opinion on this card. [Lizard Warrior](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lizard+Warrior) isn't very good. I know, I know, he looks so powerful. But it turns out he's not the kind of powerhouse that you would normally think of in draft. He does have one big advantage, though: you can get a lot of him if you really want precisely because he IS a bad card. There is a good chance that nobody is going to fight you over them. But why would you want to get all of the [Lizard Warrior](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lizard+Warrior)s in the draft instead of other, more powerful cards? Well, you can make the [Lizard Warrior](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lizard+Warrior)s stronger.
...
![](https://media.wizards.com/images/magic/tcg/products/cns/asdfsc3wfas234/TlopZmEr9i_EN.jpg)

Of course, this isn't the only card to help out that strategy—you can also make your [Lizard Warrior](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lizard+Warrior)s have haste, cost ![1 Mana](https://web.archive.org/web/20170413165508im_/http://archive.wizards.com/images/Symbols/Symbol_1_mana.gif) less, or have other powerful abilities.
...
![](https://media.wizards.com/images/magic/tcg/products/cns/asdfsc3wfas234/ey1ssVoDtI_EN.jpg)

There is a lot you can do with this. On the most basic level, you can pick up a cheap cantrip like [Brainstorm](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Brainstorm) and turn it into a much more powerful card-drawing spell. Or you can double all of your removal. Even some of the weakest removal in the set gets pretty impressive when you can double up on it.


Because you are doubling the spell, it's also possible to name a spell you only have one of in your deck, but that will be much more impactful when it is doubled. You may not get the card advantage when choosing [Lava Axe](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lava+Axe), but you do have the pretty important trick of being able to take someone from 10 to 0 in no time.
...
![](https://media.wizards.com/images/magic/daily/ld/2014/odp1fmt6e5_ld_wk20_300_art.jpg)
[Howling Wolf](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Howling+Wolf) | Art by [Nils Hamm](http://gatherer.wizards.com/pages/search/default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22nils%20hamm%22%5D)
...
Going back to the set itself, "[as-fan](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/mm/251)" is the metric we use to look at what opening a booster pack will look like. It is looking at a set from the position of fanning a pack out. That metric is useful because we want to make sure the experience of opening a pack tells you a lot about what the set is about—in other words, you shouldn't have to see the entire set to "get it."
...
Divide that by 80 (the number of commons in the set), and you see that around 3 of each common are opened in the entire draft. Those still have to get to you, though, so don't surprised if you don't see the maximum number of [Kor Chant](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kor+Chant)s, [Compulsive Research](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Compulsive+Research)es, or [Twisted Abomination](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Twisted+Abomination)s possible. You are probably better off trying to get those [Lizard Warrior](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lizard+Warrior)s, [Enclave Elite](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Enclave+Elite)s, or [Infectious Horror](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infectious+Horror)s. If we had used normal large-set numbers, it would've been 2.38 of each card per draft. That may not seem like a huge increase, but it really is noticeable.
