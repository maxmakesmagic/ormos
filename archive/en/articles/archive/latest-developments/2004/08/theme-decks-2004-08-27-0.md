...
---
[Link to Wayback Machine](https://web.archive.org/web/20220807232905/https://magic.wizards.com/en/articles/archive/latest-developments/theme-decks-2004-08-27-0)

[_metadata_:author]:- "Aaron Forsythe"
[_metadata_:description]:- "Since there is no theme this week on the website, I figured I'd talk about something else with a theme: theme decks. You know, those decks that come out with every set and have funny little names like `Master Blaster` and `Wicked Big.` One question that shows up in my mailbox every now and then is, “Why are the theme decks so bad?!” What are you talking about? You don't think"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "612601"
[_metadata_:publish_date]:- "2004-08-27"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "The Theme? Decks"
[_metadata_:wayback_capture_timestamp]:- "2022-08-07 23:29:05"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20220807232905id_/https://magic.wizards.com/en/articles/archive/latest-developments/theme-decks-2004-08-27-0"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/latest-developments/theme-decks-2004-08-27-0"
---
...
Since there is no theme this week on the website, I figured I'd talk about something else with a theme: theme decks. You know, those decks that come out with every set and have funny little names like "Master Blaster" and "Wicked Big." One question that shows up in [my mailbox](javascript:makeWinXY('/company/emailtoauthor.asp?author=Aaron%20Forsythe&headline=The%20Theme?%20Decks',500,455);) every now and then is, “Why are the theme decks so bad?!”


What are you talking about?


You don't think turn-1 [Spark Elemental](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Spark+Elemental), turn-2 [Tangle Asp](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tangle+Asp) is very good? Do you even know how to *play* this game?
...
### Why are Some of the Cards Bad?


The idea of a deck that 'does something' is a big step.Picking out "bad cards"—or rather cards that are less effective than other alternatives—is a skill, and one that we want to encourage in players. If we had already done the weeding out for them, it would be difficult for players to learn on their own. There's already plenty of deck copying going on in the community; it can't hurt to encourage some experimentation on the lower end of the spectrum.


Plus, power level isn't always a concern for players that like theme decks. [Vanquish](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vanquish) might not be a powerful card in the grand scheme of things, but for some players it may be exactly what they're looking for. We tend to cram the theme decks full of all manner of cards, to allow players to audition them for themselves. How will you know you don't like [Viridian Lorebearer](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Viridian+Lorebearer)s until you've played with them a few times? If we decreed that they were bad and never put them in the theme deck, who would that benefit? (Heck, they aren't *that* bad, actually.) There are a few mana Myr in the "Special Forces" deck; are they something you'd want more of? Less of? With just a few there already, you can make those decisions yourself.
...
5) [Trounce-O-Matic](http://archive.wizards.com/magic/displaythemedeck.asp?set=odyssey&decknum=4&lang=en) (*Odyssey*)


This is the one theme deck that my wife could consistently beat me with. It has all the tools for some serious butt-whoopin': [Wild Mongrel](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wild+Mongrel)s, [Werebear](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Werebear)s, [Cephalid Looter](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cephalid+Looter)s, and [Overrun](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Overrun).


4) [Spectrum](http://archive.wizards.com/magic/displaythemedeck.asp?set=invasion&decknum=4&lang=en) (*Invasion*)


Spectrum is the deck I played in the [Wizards Online Invitational](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=sideboard/events/wi03) last year and, man, was it fun. It has lots of card advantage ([Exclude](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Exclude), [Probe](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Probe)), fat monsters ([Zanam Djinn](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Zanam+Djinn), [Sabertooth Nishoba](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sabertooth+Nishoba)), and the next best thing to [Armageddon](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Armageddon), [Global Ruin](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Global+Ruin). On top of that, it was five colors, something I can rarely pass up.


3) [Sunburst](http://archive.wizards.com/magic/displaythemedeck.asp?set=5dn&decknum=4&lang=en) (*Fifth Dawn*)
...
2) [Nuts & Bolts](http://archive.wizards.com/magic/displaythemedeck.asp?set=5dn&decknum=1&lang=en) (*Fifth Dawn*)


Lots of people in R&D make theme decks (we certainly aren't looking for credit). This was the first one I ever made, and I did it before I started in R&D (while I was still editing this website), so again, this one feels special to me. Plus it contains [Skullclamp](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Skullclamp) that is banned in Standard and Block, which is good for a laugh.


1) [The Sparkler](http://www.wizards.com/magic/expert/Stronghold/Stronghold_PCDs.asp#Sparks) (*Stronghold*)
