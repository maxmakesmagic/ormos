...
---
[Link to Wayback Machine](https://web.archive.org/web/20211025085139/https://magic.wizards.com/en/articles/archive/savor-flavor/magics-exclusive-creatures-2011-08-09)

[_metadata_:description]:- "Taxonomically—oh yeah, you can tell we are getting dangerous today, because we're kicking things off adverbially—taxonomically, Magic divides things up largely by creature type rather than by, say, genus and species. We're not concerned with modern scientific formulations of what it means to be a particular species rather than another one, like whether there are reproductively"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "192806"
[_metadata_:path_date]:- "2011-08-09"
[_metadata_:publish_date]:- "2011-08-10"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Magic's Exclusive Creatures"
[_metadata_:wayback_capture_timestamp]:- "2021-10-25 08:51:39"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20211025085139id_/https://magic.wizards.com/en/articles/archive/savor-flavor/magics-exclusive-creatures-2011-08-09"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/savor-flavor/magics-exclusive-creatures-2011-08-09"
---


Magic's Exclusive Creatures
===========================
...
Taxonomically—oh yeah, you can tell we are getting *dangerous* today, because we're kicking things off *adverbially—*taxonomically, **Magic** divides things up largely by creature type rather than by, say, genus and species. We're not concerned with modern scientific formulations of what it means to be a particular species rather than another one, like whether there are reproductively isolated, naturally interbreeding populations of baloths (but then, we get into some bizarre conversations in Ramp;D). This is fantasy. We don't want DNA testing or population—we just want to know, does it fly like a Drake and get hit by lightning spells like a Drake? Then it's a Drake.

![](https://media.wizards.com/images/magic/daily/stf/stf155_barbedLightning.jpg)  
...
![](https://media.wizards.com/images/magic/daily/stf/stf155_cross1.jpg)  
How do you get to become a **Magic** exclusive creature? **Magic** has a lot of one-off oddball creatures, with your [Graxiplon](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Graxiplon)s and your [Groodions](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Drooling+Groodion), but those haven't earned their way into the ranks in the way that I mean today. Slivers have proven that they're a unique mainstay of the **Magic** Multiverse, for example—[Brushwagg](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Brushwagg) hasn't. So let me start by laying down some ground rules about what I mean to be a unique creature in **Magic**'s stable. To qualify as an exclusive for the purposes of this article, you need three things:
...
In: [Slivers](http://gatherer.wizards.com/Pages/Search/Default.aspx?action=advancedamp;subtype=+%5B'Sliver'%5D)
![](https://media.wizards.com/images/magic/daily/stf/stf155_sliver.jpg)[Sinew Sliver](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sinew+Sliver) | Art by [Steven Belledin](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=+%5B%22Steven+Belledin%22%5D)
...
In: [Phelddagrif](http://gatherer.wizards.com/Pages/Search/Default.aspx?type=+%5Bphelddagrif%5D%7C%7Csubtype=+%5Bphelddagrif%5D)
![](https://media.wizards.com/images/magic/daily/stf/stf155_p.jpg)[Questing Phelddagrif](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Questing+Phelddagrif) | Art by [Matt Cavotta](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=+%5B%22Matt+Cavotta%22%5D)

Hey, what can I say? One was in *Alliances*, the other was in the totally unrelated *Planeshift*; they have a distinctive look; and they're certainly unique to **Magic**. Welcome aboard, **Magic**-exclusive [Phelddagrif](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phelddagrif)s!

In: [Viashino](http://gatherer.wizards.com/Pages/Search/Default.aspx?subtype=+%5Bviashino%5D), [Kor](http://gatherer.wizards.com/Pages/Search/Default.aspx?subtype=+%5Bkor%5D), [Kithkin](http://gatherer.wizards.com/Pages/Search/Default.aspx?subtype=+%5Bkithkin%5D)
![](https://media.wizards.com/images/magic/daily/stf/stf155_cross3.jpg)  
These three races have all the hallmarks of trademark **Magic** creatures. The lizardlike and belligerent viashino, the albino-looking and nomadic kor, and the squat and tightly-knit kithkin all have their own distinctive looks. Although other fantasy properties may have had races somewhat similar to these, they're distinct enough in their creative identity to call them **Magic**'s own. The viashino have been spotted on Ravnica, Alara, and all over Dominaria. The Kor have showed up on Rath in *Tempest* block and of course more recently on the plane of Zendikar. Kithkin squeak in, with [Amrou Kithkin](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Amrou+Kithkin) having showed up back in *Legends* before their heyday in the *Lorwyn / Shadowmoor* year. (Maybe [Amrou Scout](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Amrou+Scout) and [Amrou Seekers](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Amrou+Seekers) help round out their identity? Certainly [Goldmeadow Lookout](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Goldmeadow+Lookout) felt more like a *Lorwyn* preview than a true multi-block data point.) Inducted all.

Out but Hopeful: Leonin, Rhox, Loxodon
![](https://media.wizards.com/images/magic/daily/stf/stf155_cross4.jpg)  
Cat-folk, rhino-folk, and elephant-folk, those noble anthropomorphs that show up for duty on white and occasionally green cards, are currently, sadly, out (for the purposes of this rather picky article). I'm not against naming leonin, rhoxes, and loxodons as lovable mainstays of **Magic**—jnot as exclusives. The "anthropomorphic animal race" is just not as distinctive when compared to what else you can find out there. See also ratfolk (Nezumi), snakefolk (orochi), and even cephalopod-folk (cephalids); they may all have cultures built up around them, but I don't feel that we can call them truly *ours* at this point. But there's hope. I think about [**Damp;D**](http://archive.wizards.com/dnd)'s illithid—the fearsome Mind Flayers. They began as basically no more than octopus-headed humanoids—not exactly common fantasy fare but not unheard of in other properties. But over time the illithids have become hyper-villainous, magic-proficient, brain-sucking power-seekers—a totally unique **Damp;D** race. Perhaps one or more of these anthropomorphs will gain enough distinctive **Magic** flavor ([Ajani Goldmane](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ajani+Goldmane) is about to claw my face off about now) that I'll be confident in calling them **Magic** exclusives.

In: [Wurm](http://gatherer.wizards.com/Pages/Search/Default.aspx?type=+%5Bwurm%5D%7C%7Csubtype=+%5Bwurm%5D)
![](https://media.wizards.com/images/magic/daily/stf/stf155_wurm.jpg)[Bellowing Tanglewurm](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bellowing+Tanglewurm) | Art by [jD](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=+%5B%22jD%22%5D)
...
Sure, you may have to invest all your magical study in wrecking your own mind, learn the ways of [Golgari creatures](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Golgari+Grave-Troll) that can [devour your long-term memory](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stinkweed+Imp), search the Multiverse for [nightmarish horrors](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ichorid) that [don't frankly care](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bloodghast) whether they're living or dead, and devise [methods of paying](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cabal+Therapy) in some [darker quantities](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dread+Return) than mana—but you can do it. Summon your army without even a single mana bond, go ahead. It's not easy—and it takes a decade's worth of cards from a half-dozen far-flung planes to be able to pull it off—but sure, if you don't want to use mana, go ahead and sacrifice your sanity, knowledge, and lifeblood instead. There are forces in the Multiverse who'd be happy to take those as legal tender too.
