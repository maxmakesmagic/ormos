...
---
[Link to Wayback Machine](https://web.archive.org/web/20151216165153/http://magic.wizards.com/en/articles/archive/feature/why-leaks-hurt-2015-12-16)
...
Previewing a set is, as [Rosewater said in an article years ago](http://magic.wizards.com/en/articles/archive/making-magic/leak-was-2002-09-30), very much like a movie trailer. It's how we can best introduce you to what's going on, who the characters are, and what a new set is all about.


![](https://media.wizards.com/2015/images/daily/cardart_M14_Feldon-of-the-Third-Path.jpg)


[Feldon of the Third Path](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Feldon+of+the+Third+Path) | Art by [Chase Stone](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+%5B%22Chase+Stone%22%5D)
...
Our policy has and continues to be that we simply don't discuss leaks. Go [read the article](http://magic.wizards.com/en/articles/archive/feature/what-card-leak-2002-05-01) from then-*Magic* Marketing Director Kyle Murray to learn about the problem we were facing even back then, over thirteen years ago. Confirming or disproving a leak may solve the problem in the short term, but it creates a bigger problem in that it can force us to acknowledge each and every rumor. And then when we decide not to comment, it becomes an even bigger deal.
