...
---
[Link to Wayback Machine](https://web.archive.org/web/20170830233754/http://magic.wizards.com/en/articles/archive/serious-fun/riddle-sphinx-2008-09-09)

[_metadata_:author]:- "Kelly Digges"
[_metadata_:description]:- "So let's say you're opening a booster pack of Shards of Alara. Maybe it's at the Prerelease a few weeks from now, or a Launch Party the week after that, or sometime later when you get the chance."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "608121"
[_metadata_:publish_date]:- "2008-09-09"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "The Riddle of the Sphinx"
[_metadata_:wayback_capture_timestamp]:- "2017-08-30 23:37:54"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20170830233754id_/http://magic.wizards.com/en/articles/archive/serious-fun/riddle-sphinx-2008-09-09"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/serious-fun/riddle-sphinx-2008-09-09"
---
...
So let's say you're opening a booster pack of *Shards of Alara*. Maybe it's at the [Prerelease](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/events/prereleases) a few weeks from now, or a [Launch Party](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/events/releases) the week after that, or sometime later when you get the chance.

You're not playing Pack Wars this time, [like I did a few weeks ago](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/sf/1). No, this is one of your first packs of the new set, so you crack it open and savor every card. One by one, you read the commons, then the uncommons. (I can't tell you anything about those yet, but a few of my colleagues will be doing exactly that later this week.)

You've ripped open the booster packaging. You've looked through the commons. You've looked through the uncommons. You've breathed in that new-card smell. There's just one thing left. You flip, at last, to the rare slot at the back of the pack...

...and see this:

![Sphinx Sovereign](https://media.magic.wizards.com/image_legacy_migration/mtg/images/tcg/products/shardsofalara/1wrqd461e7_EN.jpg)
...
Sphinx Sovereign costs ![](https://web.archive.org/web/20160830042801im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless4.gif)![](https://web.archive.org/web/20161227125855im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/white.gif)![](https://web.archive.org/web/20161115194122im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/blue.gif)![](https://web.archive.org/web/20161115194122im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/blue.gif)![](https://web.archive.org/web/20161227195556im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/black.gif), a mana cost unique in **Magic's** 15-year history. The fact that it's three colors is far from unique, though certainly unusual. The thing that sets it apart from most other three-colored cards is the imbalance, the fact that you need more blue mana to play Sphinx Sovereign than you do white or black. What's up with that funky cost? 

![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/tcg/products/shardsofalara/ALA_boosters_350.jpg)The answer lies in the structure of *Shards of Alara* and the worlds in which it's set. The plane of Alara is—as you might already know—no longer one world, but five; long ago, the plane was refracted into five different planes called shards. Each shard has three colors of mana: one "center" color along with its two allies. The other two colors—the center color's enemies—are completely unknown.
...
I like Esper a lot. It's the blue side of my green-blue personality taken to its logical extreme. And if there's one thing the blue side of my personality likes, it's taking things to their logical extreme.
...
![Reaper King](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Reaper+King)You probably weren't expecting to see a frame like [Reaper King](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Reaper+King)'s again anytime soon. But here's Sphinx Sovereign, in all its multicolored, artifacty glory. The card frame contains elements of the colored card frame and the artifact card frame, to help you remember that the card is, well, both colored and an artifact.You'll see similar frames on all of the colored artifacts, all of which are from Esper. In fact, *every* Esper creature is an artifact creature, and giving bonuses to your artifacts is Esper's mechanical theme.
...
Colored artifacts really are their colors and really are artifacts. Sphinx Sovereign is white, blue, and black. It's an artifact and a creature. Protect it with [Darksteel Forge](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Darksteel+Forge) or [Slobad, Goblin Tinkerer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Slobad%2C+Goblin+Tinkerer). Enchant it with [Steel of the Godhead](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Steel+of+the+Godhead), [Helm of the Ghastlord](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Helm+of+the+Ghastlord), or [Edge of the Divinity](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Edge+of+the+Divinity) (or all three!).

[Transguild Courier](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Transguild+Courier), [Reaper King](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Reaper+King), and [Sarcomite Myr](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sarcomite+Myr), make room in the dugout. The rest of the team just entered the stadium.
...
**Mythic Rares**Starting with *Shards of Alara*, roughly one out of every eight rare slots in boosters and tournament packs will contain a mythic rare in place of a regular rare. There are 15 mythic rares in *Shards of Alara*; each one is about twice as rare as one of the set's rares.![Shards of Alara Mythic Rare Symbol](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/sf/sf3_ALAMythic.jpg)This might not be the first mythic rare you've seen, if you read [Doug Beyer's feature article](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/feature/3) or the Arcana about [the *Shards of Alara* Prerelease card](/en/node/604276), Ajani Vengeant.
...
|  |  |
| --- | --- |
| Umbral Mantle | Sinstriker's Will |

There are all kinds of ways to get sneaky if you want to attack and still gain life, or not attack but make others lose life.. If you want to attack with Sphinx Sovereign but still gain life, consider giving it vigilance with something like [Triclopean Sight](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Triclopean+Sight), or untapping it with a card like [Puppeteer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Puppeteer) or [Umbral Mantle](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Umbral+Mantle). If you don't want to attack any particular player but do want all your opponents to lose life, you could give Sphinx Sovereign a tap ability with cards such as [Sinstriker's Will](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sinstriker%27s+Will) or [Psionic Gift](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Psionic+Gift), or tap it to use an ability of another card, such as [Opposition](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Opposition) or [Lodestone Myr](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lodestone+Myr).



|  |  |
| --- | --- |
| Sword of the Paruns | Ocular Halo |

You could either tap or untap Sphinx Sovereign with [Sword of the Paruns](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sword+of+the+Paruns), and you could give it both vigilance and a tap ability with [Ocular Halo](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ocular+Halo), which is a thought that really amuses me. Attack with vigilance and gain 3, then draw a card? Attack with vigilance, tap to draw a card, and sock everybody for 3? Either way, it's no power play; just a neat little maneuver I want to try out.
