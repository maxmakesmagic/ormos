...
---
[Link to Wayback Machine](https://web.archive.org/web/20200921123320/https://magic.wizards.com/en/articles/archive/feature/worldwake-prerelease-primer-2010-01-25)

[_metadata_:author]:- "Tim Willoughby"
[_metadata_:description]:- "Welcome to the Worldwake Prerelease Primer. While Worldwake won't be on sale until February 5, the follow-up to Zendikar is first properly unveiled at tournaments around the globe this weekend. Here, everyone gets a chance to play with the new cards for the first time, in Sealed Deck and Draft play, as a first taste of the set before it goes on sale."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "684111"
[_metadata_:publish_date]:- "2010-01-25"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Worldwake Prerelease Primer"
[_metadata_:wayback_capture_timestamp]:- "2020-09-21 12:33:20"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20200921123320id_/https://magic.wizards.com/en/articles/archive/feature/worldwake-prerelease-primer-2010-01-25"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/feature/worldwake-prerelease-primer-2010-01-25"
---


*Worldwake* Prerelease Primer
=============================
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/features/feature75_wwkHeader.jpg)  
Welcome to the *Worldwake* Prerelease Primer. While *Worldwake* won't be on sale until February 5, the follow-up to *Zendikar* is first properly unveiled at tournaments around the globe this weekend. Here, everyone gets a chance to play with the new cards for the first time, in Sealed Deck and Draft play, as a first taste of the set before it goes on sale. In movie terms, think of it as the premiere and the premiere after-party all thrown into one.
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/features/feature75_redCarpet.jpg)  
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/features/feature75_nissaCAgainst3Others.jpg)  
Creatures are not all that big, but they are very aggressive. It somehow worked out that creatures on *Zendikar* averaged out at not being all that large. A 2/2 could be considered the norm, and abilities like landfall strongly promoted getting stuck in (attacking, that is). Often these 2/2 creatures were quite cheap to cast, so you could expect to see plenty of them. What this meant was that spells that could kill creatures with a toughness of 2 would be able to kill most creatures, and that well-costed creatures with a toughness greater than 2 ([Nissa's Chosen](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Nissa%27s+Chosen), I'm looking at you) were great blockers.


Most games came down to a race. Really expensive spells were a riskier proposition in *Zendikar* Sealed Deck, as those aggressive creatures could easily knock life totals low enough that more expensive spells would be too slow. Incidental life gain was quite good because of this racing. [Sunspring Expedition](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sunspring+Expedition) wasn't all that exciting, as it did nothing but gain life for you, but [Grazing Gladehart](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grazing+Gladehart), [Ondu Cleric](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ondu+Cleric), and [Vampire's Bite](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vampire%27s+Bite) were all just fine, as they didn't slow down your offence but definitely took the edge off that of your opponent.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/features/feature75_3Cards1.jpg)  
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/features/feature75_castingCostCardTops.jpg)  
You will notice that in the list of creatures I want to play at different costs, I haven't listed any creatures that cost one mana. This is basically down to the fact that one-mana creatures often get outclassed very quickly in Sealed Deck. It does not mean that I definitely won't be playing any; it is more that I have a very high standard that I require from a one-cost creature for it to make it into my deck. This standard normally begins and ends with "must be useful if I draw it on turn four." [Scute Mob](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Scute+Mob) in *Zendikar* was a fine draw in the late game, and [Kraken Hatchling](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kraken+Hatchling) was just as good at blocking if drawn on turn four or later.
...
|  |  |
| --- | --- |
| Scute Mob | Kraken Hatchling |

The biggest trap in *Zendikar* was, to my mind, [Scythe Tiger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Scythe+Tiger). On turn one, it would be the biggest creature around, but at a very steep cost. On turn two, it would probably trade with an opponent's two-cost creature, and leave you down a land. If you look back at my list of things I learned about the *Zendikar* format, you'll see that I really liked having lands.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/features/feature75_2Colours.jpg)  
...
|  |  |
| --- | --- |
| Day of Judgment | Predatory Urge |

If there is a way that I can kill multiple opposing creatures with one spell, I want to be doing it. [Marsh Casualties](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Marsh+Casualties) and [Day of Judgment](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Day+of+Judgment) were the all-stars at this in *Zendikar*, but cards like [Predatory Urge](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Predatory+Urge) also stood out, allowing for more gradual killing off of an opposing team. There is a very good chance that the Prerelease card, Comet Storm, will be in my pile of 40 cards to play if I am lucky enough to open one. (You can't play the Prerelease version in your deck!) It can kill multiple creatures, as well as killing players from out of nowhere.


![Comet Storm](https://media.magic.wizards.com/image_legacy_migration/mtg/images/tcg/products/worldwake/m52w9090oz_EN.jpg)  
...
"Combat tricks" is a rather broad term. The first thing I think of when it comes to combat tricks is [Giant Growth](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Giant+Growth) effects—spells that make creatures bigger. The best of these generally are efficiently costed Equipment. This functions like a spell, only it just keeps on plugging every single turn. If your creature dies, the Equipment carries on. [Giant Growth](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Giant+Growth) type effects do a lot of the things that I am looking to do in Sealed Deck. Much of the time I will use them like removal spells, to turn an unfavourable combat into a favourable one after blockers are declared. On occasion they might be used to finish a hapless opponent off too. My favourite thing about instants that boost a creature's power and toughness, though, is that they put the fear into opponents. Once an opponent has seen that you can make your creatures bigger, he or she has much trickier decisions to make, when you start attacking with your 2/2 into an opposing 3/3.
...
![Groundswell](https://media.magic.wizards.com/image_legacy_migration/mtg/images/tcg/products/worldwake/h0kujv4w61_EN.jpg)  
Groundswell is very similar in many ways to [Giant Growth](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Giant+Growth). Sometimes it will be a little smaller, but those times are made up for by the times that it is a shade bigger. I should point out at this moment that upon resolution of the spell, it checks if a land has entered the battlefield under your control, and sets itself to be either +2/+2 or +4/+4. If you play a land after resolving the spell, it won't change anything. Likewise, landfall spells are not like landfall permanents—there is no triggering going on with this spell, it will simply look at what has happened thus far in the turn and either give +2/+2 or +4/+4. Having had more than one land enter the battlefield doesn't make it scale up any further.
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/features/feature75_kjb75ecrsdfa.jpg)  
...
![Skitter of Lizards](https://media.magic.wizards.com/image_legacy_migration/mtg/images/tcg/products/worldwake/haecem0deu_EN.jpg)  
Allies get gradually better the more of them you have. A single [Kazuul Warlord](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kazuul+Warlord) is always good, as it can just beat on its own. A singleton [Ondu Cleric](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ondu+Cleric), though, is not ideal. If you have five or more solid Allies, then it is worth seriously looking at which others you can sneak in, because a strong Ally draw is just about one of the most powerful starts on *Zendikar*.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/features/feature75_pileOfAllies.jpg)  
