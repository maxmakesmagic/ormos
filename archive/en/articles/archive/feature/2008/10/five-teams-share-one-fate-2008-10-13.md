...
---
[Link to Wayback Machine](https://web.archive.org/web/20200921134246/https://magic.wizards.com/en/articles/archive/feature/five-teams-share-one-fate-2008-10-13)
...
After a set comes out, we typically give one of its designers a chance to tell the story of being on the design team. And typically, that one designer was present for enough of the design to give a good, all-around look at how that set came to be.
...
![Brian Tinsman](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/authorpics/authorpic_briantinsman.jpg)**Brian Tinsman**
...
One of the things I love about exalted is the surprising way it sometimes lets your weakest creatures rise up to become mighty threats. It's fun to imagine the surprise on a [Mosstodon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mosstodon)'s face when it's forced to trade with a harmless-looking [Elvish Visionary](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Elvish+Visionary). Then your next weakest creature steps up for its turn to be a hero.

![Kelly Digges](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/authorpics/authorpic_kellydigges.jpg)**Kelly Digges**

I wasn't on any of the *Shards of Alara* design teams, but I'm on the list of people who get "hole-filling" emails—a process Alexis Janson talked about in her article [*Shadowmoor* – The Hole Story](/en/articles/archive/shadowmoor-%E2%80%93-hole-story-2008-05-12). Whenever I have the time, I reply to the hole-filling emails that the various development teams send out.
...
>   
> *CB05\_ROC BLACK TINY CREATURE WITH BLUE ACTIVATION*
> 
> 
> Oozing Maggots  
>  B  
...
The card didn't stay that way for long, though. Maybe it was too annoying? I don't actually know what happened to it. The next time I looked in the file, I saw the card that would eventually become [Shore Snapper](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shore+Snapper):

![Shore Snapper](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Shore+Snapper)The funny thing is that from my vantage point outside the R&D Pit, I wasn't sure at first whether that was "my" creature or not. Had it gotten bigger and swapped one evasion ability for another? Or was it an entirely different card?

I eventually figured out that Oozing Maggots had been scrapped (though I never did figure out why). [Shore Snapper](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shore+Snapper) actually started life as a mono-blue creature with islandwalk, which was changed to a mono-black creature with activated islandwalk to fill that slot.

There was also...


> *CZ09\_ROC RED-GREEN COMMON INSTANT/SORCERY HOLE*

I can't show you my submission here (because it might, just maybe, be in an upcoming set). But the original was not designed with power level in mind at all, and it was, shall we say, busted. After entering the file, its mana cost rapidly moved from ![](https://web.archive.org/web/20161227130159im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/red.gif)![](https://web.archive.org/web/20220123123600im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/green.gif) to ![](https://web.archive.org/web/20211201201921im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless1.gif)![](https://web.archive.org/web/20161227130159im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/red.gif)![](https://web.archive.org/web/20220123123600im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/green.gif) to ![](https://web.archive.org/web/20161225105850im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless2.gif)![](https://web.archive.org/web/20161227130159im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/red.gif)![](https://web.archive.org/web/20220123123600im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/green.gif), finally ending up at ![](https://web.archive.org/web/20161227130050im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless3.gif)![](https://web.archive.org/web/20161227130159im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/red.gif)![](https://web.archive.org/web/20220123123600im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/green.gif) before being removed from the set entirely.

The card that ended up in this slot is [Branching Bolt](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Branching+Bolt), a great design that I'm more than happy to see in the set.

Next up, there was....


> *CZ06\_ROC WHITE-BLUE COMMON INSTANT/SORCERY HOLE*
...
> *UU02\_ROC UNCOMMON BLUE INSTANT*  
...
The name, of course, is a play on *Planar Chaos*'s [Rebuff the Wicked](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rebuff+the+Wicked), which always struck me as a cool spell that was just slightly too narrow to see any play. I set out to make a less narrow version, and I was pretty happy with the result, even if ![](https://web.archive.org/web/20161115194122im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/blue.gif) is probably not a fair cost for it.
...
You know the final card as [Hindering Light](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hindering+Light):

![Hindering Light](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Hindering+Light)The icing on the cake, as I mentioned in my Serious Fun article, is that I was on the creative text team for *Shards of Alara*, and I wrote the flavor text on [Hindering Light](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hindering+Light) (along with a number of other cards). Unfortunately, I can't claim credit for the name; I was hoping for the triple crown, but none of my names made it. And no matter how many times I asked, they wouldn't take my art submission, either. Ah, well.

Anyway, it's a humble utility common, but [Hindering Light](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hindering+Light) will always hold a special place in my heart.
...
We, the Bant team (Brian Tinsman (lead), Mark Rosewater, and myself), needed some oblique support cards that better capitalize on the game play of Exalted. I am pretty good at weaving a card to be subtly good in one mechanical deck (though subtle is sometimes a bad trait for a card, especially splashy rares). I noticed that exalted decks usually untap only one creature each turn. The team had a few designs that capitalized on this, and the two notables that made it to print are [Topan Ascetic](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Topan+Ascetic) (a smaller [Llanowar Behemoth](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Llanowar+Behemoth)) and another card that began as "White [Smoke](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Smoke)."

![Smoke](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Smoke)This ![](https://web.archive.org/web/20161225105850im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless2.gif)![](https://web.archive.org/web/20161227125855im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/white.gif) enchantment later became a ![](https://web.archive.org/web/20161227130050im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless3.gif)![](https://web.archive.org/web/20161227125855im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/white.gif)![](https://web.archive.org/web/20161227125855im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/white.gif) 3/3 Angel, who later gained clever vigilance, who later became a Bant triple color ![](https://web.archive.org/web/20211201201921im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless1.gif)![](https://web.archive.org/web/20220123123600im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/green.gif)![](https://web.archive.org/web/20161227125855im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/white.gif)![](https://web.archive.org/web/20161115194122im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/blue.gif) 3/4 to fill a gold rare slot and distance it from [Battlegrace Angel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Battlegrace+Angel), also at white rare.

![Battlegrace Angel](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Battlegrace+Angel)### Second Chance Ampule

[Lich's Mirror](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lich%27s+Mirror) began as a rare hole submission of mine called [Second Chance](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Second+Chance) Ampule:
...
This card was charmingly "weird" enough to the hole-filling team to make it into the file. The card created many stories and many more arguments. This card became melded with another card named "Not Dead Yet," creating the current [Lich's Mirror](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lich%27s+Mirror) and was elected to become the first colorless artifact mythic rare.

![Lich's Mirror](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Lich%27s+Mirror)Note that the printed template "shortcuts" a few corner cases for rebooting a dead player. A more "algorithmically correct" template would be closer to:
...
However, the printed template scored so fantastically in our polling (second to only [Flameblast Dragon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Flameblast+Dragon)), we feared that adding some avoidable text might somehow destroy its poetry and appeal. So the printed wording stayed the same, encouraging [Puca's Mischief](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Puca%27s+Mischief) shenanigans (you don't lose permanents you've stolen when the Mirror breaks, or alternatively you can donate your [Lich's Mirror](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lich%27s+Mirror) to an opponent and kill them over and over and over and over without breaking your Mirror).
...
![Hadouken!](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/features/8_hadouken.jpg)In Naya design, this card was upgraded to hit players, ending many a stalemate between [Spearbreaker Behemoth](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Spearbreaker+Behemoth)s and [Feral Hydra](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Feral+Hydra)s. This card was cycled across Naya into [Soul's Might](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Soul%27s+Might), [Soul's Fire](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Soul%27s+Fire), [Soul's Grace](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Soul%27s+Grace), and embraced by the creative team as a chance to show Ajani on cards other than [Ajani Vengeant](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ajani+Vengeant). Development and templating dropped the "tap your guy as an additional cost" to remove text and combo better with attacking (via exalted and unearth).



|  |  |
| --- | --- |
| Soul's Grace | Soul's Might |

![Soul's Fire](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Soul%27s+Fire)### What a Blowout

[Cruel Ultimatum](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cruel+Ultimatum) began life as something close to...
