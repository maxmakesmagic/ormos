...
---
[Link to Wayback Machine](https://web.archive.org/web/20200926163042/https://magic.wizards.com/en/articles/archive/feature/name-beast-2003-01-28)
...
>  Enchant Land   
> ![](https://web.archive.org/web/20210707095534im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless0.gif): Enchanted land becomes a 1/4 creature until end of turn. Play this ability only once per turn.  
...
The spell effects based on the number of a specific creature type in play, which we referred to as the “Titania” spells after the popular [Priest of Titania](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Priest+of+Titania), were originally in Moe and moved up to *Onslaught*. The original idea was to have the creatures with the tap effects (like [Sparksmith](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sparksmith)) in *Onslaught* and the spell effects (like [Unified Strike](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Unified+Strike)) in Moe, but we were able to shuffle it around fairly well.

![Graveborn Muse](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Graveborn+Muse)### The Rest

One of the keys of making the all creature set work was the “morph reveal” effects. We started out with all the basic spell effects you would normally see in a set, like [Terror](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Terror), [Disenchant](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Disenchant), and so on, and then we started to get a little wackier with effects like target redirection and +6/+6 and trample. We were also able to take a bunch of static effects that we normally would not put on creatures and create a group of creature enchantment cards, which is the Muse cycle. All and all, the set ended up with enough spell effects to create interesting play decisions, which I was afraid would be missing in this type of set. But the whole process to get to an all creature set was quite a revelation… 13:18 to be exact.
