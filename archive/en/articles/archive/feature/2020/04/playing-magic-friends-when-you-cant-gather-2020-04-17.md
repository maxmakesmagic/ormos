...
---
[Link to Wayback Machine](https://web.archive.org/web/20200503071147/https://magic.wizards.com/en/articles/archive/feature/playing-magic-friends-when-you-cant-gather-2020-04-17)
...
[_metadata_:title]:- "Playing Magic with Friends When You Can't Gather"
...
First and foremost, of course, we've got two great digital versions of the tabletop *Magic* game: *MTG* *Arena* and *Magic Online*.


![](https://media.wizards.com/2020/images/daily/IKO-GamePlay-Arena.gif)![](https://media.wizards.com/2020/images/daily/IKO-GamePlay-MTGO.jpg)


If you haven't fired either of those up in a while, now is a great time: a lot of improvements have been made and are forthcoming (did you hear about [*MTG Arena*'s 8-player drafts](https://magic.wizards.com/en/articles/archive/magic-digital/mtg-arena-state-game-april-2020-04-13#playerdraft)?!) that make playing online better than ever. To play multiplayer formats like Commander, many people I know are flocking to *Magic Online* to play on there with some form of voice chat running in the background with friends. Oh, and not to mention Cube Draft is available too!
...
If you're going to use your phone, there are all kinds of ways to set that up. For a fun one, [check out this guide from the game store Just Games](https://www.justgamesrochester.com/prepping-your-at-home-camera/), which tells you how to easily turn an extra bundle box into a holder for streaming *Magic* from your phone! Pretty cool stuff.


Additionally, if you're interested in the finer points of lighting and equipment, then I highly recommend [this article by The Spike Feeders over on TCGPlayer](https://infinite.tcgplayer.com/article/How-to-Play-Paper-Magic:-The-Gathering-Over-the-Internet/d69daf46-0ede-4279-9ac4-921400d255df/)—I'm no lighting guru, but their advice has been great for me.
...
* Communication is key. You don't have all the normal physical cues, so being a little more over-communicative is great. To take a note from Sheldon Menery's playbook, he suggests ending your turns with, "Pass to [name]," so everyone knows where the turn is going next *and* hearing their name cues them in to pay attention.
* Be understanding. I'm already extremely lenient with takebacks in Commander, but especially here because of a lack of information, I'd be extremely relaxed about it.
* Consider what cards in your deck permanently interact with your opponent's cards. Normally in *Magic*, if you take an opponent's card, that's easy. Here, it gets much harder. Auras you put on other players' creatures are a little bit harder to remember, [Mind Control](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mind+Control) effects are harder to play than normal, and cards which search your opponent's deck (like, say, [Praetor's Grasp](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Praetor%27s+Grasp)) are nightmares to resolve. You may want to swap a couple cards out just to streamline the process.
* Use a background that's very easy to see cards on. When choosing a playmat, pick something that will have good contrast, for example.
* I'd grab a pen and have some paper handy to write on so that if you need to make notes about things that are harder to track because they aren't as visible ("Okay, I have his [Teferi's Protection](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Teferi%27s+Protection) exiled with my [Spelljack](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Spelljack)" or "Erin's graveyard contains three cards she can cast from the graveyard"), you have easy access to doing so. You can also write notes on your cards that way if you need to remind the other players of something
* Have a clear way to display life total. No matter what your method, this is going to be one of the most common questions, so having something clearly visible is a great plan.

The Worldwide Webcam
====================


As this continues to pick up in popularity, a lot of people are writing about it, talking about it, and most of all: doing it! If you just want to watch some games and chat, I highly recommend [Sheldon Menery's article over on StarCityGames](https://articles.starcitygames.com/premium/beating-the-quarantine-where-you-can-watch-and-play-commander-online/) that lists a number of content creators as well as when and where they're streaming if you just want to watch some wild games of Commander and see what happens.
