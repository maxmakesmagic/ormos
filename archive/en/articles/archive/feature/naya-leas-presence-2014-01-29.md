...
---
[Link to Wayback Machine](https://web.archive.org/web/20220812121446/https://magic.wizards.com/en/articles/archive/feature/naya-leas-presence-2014-01-29)
...
![Nylea's Presence](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Nylea%27s+Presence) JonteB's deck is a little different than Brad's, as it has mana acceleration that doesn't play well with [Anger of the Gods](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Anger+of+the+Gods). Instead of sweeping the board, JonteB is trying to power out big threats—[Polukranos, World Eater](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Polukranos%252C%2BWorld%2BEater), [Stormbreath Dragon](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stormbreath+Dragon), and [Elspeth, Sun's Champion](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Elspeth%252C%2BSun%2527s%2BChampion)—quicker than normal. 

 At first glance, the decklist might appear to be “budget” due to the lack of [shocklands](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&format=+%5B%22Return+to+Ravnica+Block%22%5D&type=+%5B%22Land%22%5D&text=+%5Bpay%5D+%5B2%5D) but that’s because the deck is entirely *Theros* block! You'd mostly want shocklands like [Sacred Foundry](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sacred+Foundry) to give you more lands to enchant with [Chained to the Rocks](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Chained+to+the+Rocks), but [Nylea's Presence](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Nylea%27s+Presence) fixes that problem quite nicely. The deck could use a couple more Mountains, but the advantage of having a three-color mana base that isn't incredibly painful seems huge. 

When a Block deck finishes well in a Standard tournament, it’s time to take a second look. With the dominance of Mono-Black and Mono-Blue Devotion, is it time for a new Naya deck to shine
