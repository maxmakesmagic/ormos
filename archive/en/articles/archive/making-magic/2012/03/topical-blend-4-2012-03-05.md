...
---
[Link to Wayback Machine](https://web.archive.org/web/20151211103648/http://magic.wizards.com/en/articles/archive/making-magic/topical-blend-4-2012-03-05)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "It's Fate Week here at DailyMTG.com. What does that mean, exactly? Well, from time to time we get open-ended, purposely vague themes that we, the authors, can do with whatever we like. Well, if it was Fate Week, I decided I needed to leave my very topic to fate itself. On a related note, it dawned on me that I haven't done a Topical Blend column in a long time (the last one being back in 2007)."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "654726"
[_metadata_:publish_date]:- "2012-03-05"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Topical Blend #4"
[_metadata_:wayback_capture_timestamp]:- "2015-12-11 10:36:48"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20151211103648id_/http://magic.wizards.com/en/articles/archive/making-magic/topical-blend-4-2012-03-05"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/making-magic/topical-blend-4-2012-03-05"
---
...
It's Fate Week here at **DailyMTG.com**. What does that mean, exactly? Well, from time to time we get open-ended, purposely vague themes that we, the authors, can do with whatever we like. Well, if it was Fate Week, I decided I needed to leave my very topic to fate itself. On a related note, it dawned on me that I haven't done a Topical Blend column in a long time ([the last one being back in 2007](/en/articles/archive/making-magic/topical-blend-3-sessions-2007-08-27)).


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm185_wheel.jpg)  
...
Topical Blend #1 was called "[To Err Is Human](/en/articles/archive/making-magic/topical-blend-1-%E2%80%93-err-human-2005-03-07-0)" and had me mixing my Top Ten Design Mistakes with Girls. This led to my personal favorite column of all time.


Topical Blend #2 had no name and combined Pros and Cons of Adding a Sixth color with "Mark Rosewater Admits He's %#@$ Insane!" (The latter was a running joke on a **Magic** humor site where about once a week someone would start a thread with that topic.) My column was mocked up to look like that website's message boards, so when you started the article you went right to what looked like a message board talking about the article where I discussed making a sixth color. This shtick confused a *lot* of readers. It was a really cool article, but when we changed over to one of our new (now old) systems, we lost all the formatting and the article is now hard to read and has none of its original charm. You can go [see it here](/en/articles/archive/making-magic/topical-blend-2-2005-12-12) but it really is just a shell of its former self.


Topical Blend #3 was called "[Sessions](/en/articles/archive/making-magic/topical-blend-3-sessions-2007-08-27)" and combined The Top Ten Coolest Creatures Ever Designed with **Dungeons & Dragons**. I wrote this Topical Blend back in 2007. 


I figured it was time for Topical Blend #4, and since it was Fate Week, instead of letting the audience vote on which two topics to combine, I let Fate decide. Here's how it worked: I collected **Magic** and non-**Magic** topics from my tweeps on [Twitter](https://twitter.com/maro254). Then for the **Magic** topics I removed any topic that wasn't a design issue (the FFL is a great topic for an article, but for Zac, as he actually plays in the FFL) or was something I'd already written about. Once that was done, I randomly picked a topic from each one.
...
> ![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm185_twitter1.jpg)[tehCorinthian](http://www.twitter.com/tehCorinthian) @maro254 Best designed cards of each set. HOF/history of card design. Everyone loves lists!
> 
> 
> 
...
> ![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm185_twitter2.jpg)[seanFsmith](http://www.twitter.com/seanFsmith) @maro254 Magic. As in, prestidigitation, conjuring, voodoo.
> 
> 
> 
...
[Click here to find out](http://www.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/mm/185&page=2).
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm185_rabbit.jpg)  
...
**Magic** design follows the same path. A lot of what we do is archetypal in that **Magic** has set patterns it always follows. Yes, it's nice to see how the [Giant Growth](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Giant+Growth) and [Lightning Bolt](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Bolt) variants conform to the new environment, but they are never going to wow you. You expect them. The design team has to make sure there is something in each set that is going to catch you off guard. They have to show you something you've never seen before. Because just as in a magic show, this makes the player want to learn more. "Ooh, how will that play?"
...
![48580](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&multiverseid=48580)
  
Brand new is a valuable but small commodity. You have to spend it wisely. A set doesn't need a lot, but it needs a little. Once we knew we were going to be in metal world, it was clear we wanted a metallic angel. The image was commissioned before we even knew what she did mechanically. I wish I remember who came up with [Platinum Angel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Platinum+Angel), as I would love to give him or her credit for such an awesome idea. Once we heard it, we knew we had our card and when it was previewed, it was instantly popular with the players.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm185_angel.jpg)[Platinum Angel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Platinum+Angel) | Art by [Brom](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+%5B%22Brom%22%5D)


The thing I love about the card is that it manages to capture your attention instantly. You read it once and you already know you want to get the thing into play. It manages to create awe, which is something hard to do.


### Lesson #2—Have Fun


During the [first article of my *Roseanne* trilogy](/en/articles/archive/roseanne-any-other-name-part-1-2011-03-14), I talked about how one executed a pitch. The number-one quality of a pitch, I said, was enthusiasm. If you want others to be excited by your idea, you have to be excited. The same is true for a performance. If you want your audience to be excited, you have to lead by example.
...
![50321](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&multiverseid=50321)
  
This card was my design. It was created by combining two design loves: my love of copying things and my love of effects like [Sneak Attack](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sneak+Attack), where cards pop in, do their thing, and then leave. I've designed thousands of cards, but only a small few have the *joie de vivre* (a French expression meaning "joy of living" used to talk about something that just inspires joy and cheer) of [Kiki-Jiki](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kiki-Jiki).


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm185_kiki.jpg)[Kiki-Jiki, Mirror Breaker](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kiki-Jiki%2C+Mirror+Breaker) | Art by [Pete Venters](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+%5B%22Pete+Venters%22%5D)


Designers always look back at their successes to see what they can learn when they try and recreate the magic, but a card like [Kiki-Jiki, Mirror Breaker](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kiki-Jiki%2C+Mirror+Breaker) is just something that happens. All the pieces come together to make something larger than the sum of its parts. It just clicks. I don't know what I did, but I know I'm quite proud of it. It brings the fun and elevates the entire game around it.
...
Players love tokens. Players love counters. Players love getting more. [Doubling Season](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Doubling+Season) was me catering to this whim. (Okay, okay—*I* love doubling things.) I knew it was going to be popular. Even I had no idea *how* popular. I believe [Doubling Season](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Doubling+Season) is the single card I am most asked to reprint.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm185_season.jpg)[Doubling Season](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Doubling+Season) | Art by [Wayne Reynolds](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+%5B%22Wayne+Reynolds%22%5D)


This wasn't a case of me tracking down new design space. This was me taking known design space and just seeing how far I could push it. [Doubling Season](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Doubling+Season) is definitely one of those cards that made me rethink how I make cards. Its popularity and future design influence wins it this slot.
...
![106645](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&multiverseid=106645)
  
I know this is an odd pick, but it represents to me the shining jewel of *Time Spiral* block design—the timeshifted sheets. Part of **Magic** design is breaking boundaries and finding new places to take the game. The timeshifted sheets did exactly that but in a way I don't think we had ever thought about before. It added its own rarity. It reused cards. It created its own slot in the booster pack. It was one of those moments where design changed the rules for what was acceptable.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm185_wrath.jpg)[Akroma, Angel of Wrath](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Akroma%2C+Angel+of+Wrath) | Art by [Ron Spears](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+%5B%22Ron+Spears%22%5D)


The other thing it did was to allow us to reuse things we never thought possible to return. Akroma is a legendary character from a set "hundreds of years ago." If you had asked me when she was created ([I wrote a whole column about Akroma](/en/articles/archive/making-magic/angels-among-us-2006-06-12-0) if you want more detail about her design, including how I was against it) if she would ever return, I would have bet a large sum of money the answer was "No."


But seeing the response to the timeshifted sheet brought me back to my days where I'd make the milk return that had disappeared into the newspaper cone fifteen minutes earlier. I had created a shared moment with my audience members and it always resulted in smiles on their faces.
...
![140201](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&multiverseid=140201)
  
This card was designed by [Aaron Forsythe](http://www.wizards.com/magic/magazine/archive.aspx?author=aaron%20forsythe), the lead designer of *Lorwyn*. Part of its charm is obviously its mechanic, which is very innovative, but I believe what elevates this card from good to great is the fact that it's on a Treefolk. Obviously, the choice made a lot of sense, as the Treefolk were one of *Lorwyn*'s tribes and the Treefolk historically have high toughness. Just imagine, though, if this mechanic was on a giant. It would still be cool, but it wouldn't be quite as endearing. The walking tree just feels a little more playful and thus, I believe, helps the players emotionally connect stronger with it.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm185_doran.jpg)[Doran, the Siege Tower](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Doran%2C+the+Siege+Tower) | Art by [Mark Zug](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+%5B%22Mark+Zug%22%5D)


I think it's crucial for every set to have a few cards that just make the players smile the first time they see it. Just as in my magic shows, an audience that relates to the art emotionally makes a stronger and longer-lasting connection.
