...
---
[Link to Wayback Machine](https://web.archive.org/web/20201111221047/https://magic.wizards.com/en/articles/archive/feature/september-2011-update-bulletin-2011-09-22)
...
Like I do in each Update Bulletin, I must take some time to thank the players, judges, organizers, and rules gurus out there that take the time to nominate cards and rules for review. If you'd like to send me a message, you can do so in a few ways: through the forums (I'm WotC\_MattT), through Twitter (@[TabakRules](http://twitter.com/#!/tabakrules)), or by replying to this article.


As always, the changes I've described here are going through a complete editing and review process, so they may differ from what actually happens. The [Card Image Gallery](http://www.wizards.com/magic/tcg/article.aspx?x=mtg/tcg/innistrad/cig) is already up, and the set should be showing up in [Gatherer](http://gatherer.wizards.com/Pages/Default.aspx) on or around September 22, with the Comprehensive Rules following shortly thereafter. Let's get started!



> * Introduction
> * [Functional Oracle Changes](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/feature/161d&page=2)
> * [Nonfunctional Oracle Changes](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/feature/161d&page=3)
> * [Comprehensive Rulebook Changes](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/feature/161d&page=4)
> 
...
> [Crimson Kobolds](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Crimson+Kobolds)  
> [Crookshank Kobolds](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Crookshank+Kobolds)  
> [Dryad Arbor](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dryad+Arbor)  
> [Evermind](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Evermind)  
> [Hypergenesis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hypergenesis)  
> [Intervention Pact](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Intervention+Pact)  
> [Kobolds of Kher Keep](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kobolds+of+Kher+Keep)  
> [Living End](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Living+End)  
> [Pact of Negation](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pact+of+Negation)  
> [Pact of the Titan](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pact+of+the+Titan)  
> [Restore Balance](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Restore+Balance)  
> [Slaughter Pact](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Slaughter+Pact)  
> [Summoner's Pact](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Summoner%27s+Pact)  
> [Transguild Courier](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Transguild+Courier)  
...
Oh, as to why this is in the functional changes section? Well, there are a few small differences, but we've decided we're comfortable with them. One, they're all losing an ability, so some of those cards will have a newfound appreciation for [Muraganda Petroglyphs](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Muraganda+Petroglyphs). Two, cards like [Mind Bend](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mind+Bend) that change one color word into another won't affect the color of these cards. Three, [Evermind](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Evermind) no longer turns the spells it's spliced onto blue. Really, how weird was that? Four, [Dryad Arbor](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dryad+Arbor) behaves a little differently under a [Blood Moon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blood+Moon). Previously, it would become colorless. No, really. (In layer 4, it becomes a Mountain and thus loses all of its abilities, including the one that would make it green in layer 5.) Now, because color indicator is not an ability it can lose, it remains green. It ain't easy, but we think [Dryad Arbor](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dryad+Arbor) will be just fine.


**New Creature Type: Werewolf**  
*Innistrad* introduces the creature type Werewolf. These three existing cards seem like good candidates for that creature type. Rumors that we're visiting a plane of [werebears](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Werebear) and [less-than-clean wererats](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dirty+Wererat) in 2014 are unsubstantiated.
...
[Lesser Werewolf](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lesser+Werewolf)  
*New creature type:* Werewolf


[Treacherous Werewolf](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Treacherous+Werewolf)  
*New creature types:* Werewolf Minion


[**Phyrexian Devourer**](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phyrexian+Devourer)  
...
*New [Phyrexian Devourer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phyrexian+Devourer) wording*  
...
**[Thought Lash](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Thought+Lash) & [Heart of Bogardan](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Heart+of+Bogardan)**  
 These two enchantments have a consequence to not paying for their cumulative upkeeps beyond merely sacrificing them. Really, this consequence wants to be stapled onto the cumulative upkeep ability—a trigger within a trigger, if you will. [Thought Lash](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Thought+Lash) especially wants to refer to the player who didn't pay the cumulative upkeep, not just the player who happened to control the enchantment when the upkeep wasn't paid (sorry, [Zedruu the Greathearted](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Zedruu+the+Greathearted)).


*New [Heart of Bogardan](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Heart+of+Bogardan) wording*  
...
*New [Thought Lash](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Thought+Lash) wording*  
...
[**Elder Spawn**](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Elder+Spawn)  
 Spawn is a creature type generally used on creature tokens, but it is a valid creature type. [Elder Spawn](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Elder+Spawn) was actually printed with the creature type Spawn, so there's really no reason not to change it back.
...
> * [Introduction](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/feature/161d&page=1)
...
*New [Arena](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Arena) wording*  
...
*New [Contested Cliffs](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Contested+Cliffs) wording*  
...
*New [Magus of the Arena](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Magus+of+the+Arena) wording*  
 {o3}, {oT}: Tap target creature you control and target creature of an opponent's choice he or she controls. Those creatures fight each other. *(Each deals damage equal to its power to the other.)*


*New [Rivals' Duel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rivals%27+Duel) wording*  
...
*New [Triangle of War](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Triangle+of+War) wording*  
...
**[Hall of the Bandit Lord](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hall+of+the+Bandit+Lord) & Friends**  
...
*New [Hall of the Bandit Lord](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hall+of+the+Bandit+Lord) wording*  
...
*New [Impromptu Raid](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Impromptu+Raid) wording*  
...
*New [Puppeteer Clique](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Puppeteer+Clique) wording*  
 Flying  
...
*New [Treacherous Urge](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Treacherous+Urge) wording*  
...
[**Rally the Horde**](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rally+the+Horde)  
 The changes we made to this card in [the last update](http://www.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/feature/150b&page=2) were so amusing that I just wanted to see them again. Okay, not really. Cards that repeat a process shouldn't repeat it until a condition that may never occur. This card did, so we reworked it slightly.
...
[**Burning of Xinye**](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Burning+of+Xinye)  
...
*New [Burning of Xinye](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Burning+of+Xinye) wording*  
...
[**Lim-Dûl's Vault**](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lim-D%C3%BBl%27s+Vault)  
...
*New [Lim-Dûl's Vault](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lim-D%C3%BBl%27s+Vault) wording*  
...
*New [Rite of Replication](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rite+of+Replication) wording*  
...
[**Gathan Raiders**](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gathan+Raiders)  
 Durations like the one found on [Gathan Raiders](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gathan+Raiders) typically say "as long as" the stated condition is true. This one differed and said "if," so we're bringing it in line.


*New [Gathan Raiders](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gathan+Raiders) wording*  
...
**110.5g**  
 This rule stated that a token couldn't return to the battlefield after leaving it. It's being expanded to include any zone change for a token that has left the battlefield. This shuts off some shenanigans, probably involving token copies of [Panglacial Wurm](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Panglacial+Wurm).
...
**205.3d**  
 This new rule states that an object can only gain a subtype if it is the appropriate card type. For example, if [Phantasmal Image](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phantasmal+Image) copies an animated land, the copy effect will fail to make it an Illusion because it's not a creature.
...
**612.5**  
 Color indicator was added to the list of things copied in the [Volrath's Shapeshifter](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Volrath%27s+Shapeshifter) rule.
...
**706.8**  
 This new rule explains how to copy a double-faced permanent. You only get the characteristics of the visible face. Or, as we put it in development, "the [Clone](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Clone) sees what the [Clone](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Clone) sees." (I know, the [Clone](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Clone) sometimes sees things it doesn't see.)


**706.9d**  
 This rule explained that characteristic-defining abilities that define a characteristic that's specifically exempted from the copying process are not copied. This is now also applicable to color indicators as well. For example, a [Vesuvan Doppelganger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vesuvan+Doppelganger) copying a [Crimson Kobolds](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Crimson+Kobolds) will not have a red color indicator and will be blue.
...
**711**  
 This is the new section on double-faced cards. See the [double-faced card rules page](http://www.wizards.com/magic/tcg/article.aspx?x=mtg/tcg/innistrad/dfcrules) for most of the information contained within.
