...
---
[Link to Wayback Machine](https://web.archive.org/web/20210128124910/https://magic.wizards.com/en/articles/archive/feature/boys-winter-2006-08-02)
...
**Warning: this article contains baseball metaphors.** 


![Herald_of_Leshrac](https://media.magic.wizards.com/image_legacy_migration/magic/images/cardart/CSP/Herald_of_Leshrac.jpg)Just to refresh everyone on what “Home Run” means, here's a little primer: A baseball home run is when a batter smashes the ball out of the ballpark and rounds all four bases in a triumphant jog. A **Magic** home run is when a card is a smashing all-around package with a good name, illustration, flavor text, and all three compliment the card mechanic. We've hit on this twice before, in “[Going, Going, Gone!” Hey That's Aliteration!](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/mc8) and in [Snack Time With Vorthos](/en/articles/archive/snack-time-vorthos-2005-12-21). I guess that makes this article the Trifecta…or the Hat Trick. Yay sports! (After typing that last line I was really tempted to switch gears and make this an Ice Hockey thing. You know, for *Coldsnap*.)


Anyway, back to **Magic**. What we found - we being fellow Creative Teamer Brandon Bozzi and me - when combing through *Coldsnap* was that the cards that stood out with the best names and art were often lacking flavor text. Unfortunately, that takes these hitters right out of the lineup. Cards with names like [Sunscour](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sunscour), [Void Maw](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Void+Maw), and [Jokulmorder](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Jokulmorder) have none, and so they are benched for the game. Cards with sweet art like [Dark Depths](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dark+Depths), [Herald of Leshrac](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Herald+of+Leshrac), and [Mouth of Ronom](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mouth+of+Ronom) also ride the pine for that same reason. It's unfortunate, but the rules are the rules. So who's up first?


### [Phyrexian Ironfoot](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phyrexian+Ironfoot)


It's no mystery that I absolutely love this artwork. Stephan latched onto the one thing I was hoping would come through and really nailed it—that big rusty hunk is ornery! You can see in the tension of the “leash” that it is resisting the little Rimewind nitwit who is tugging at it with all his measly might. And it doesn't end there. Not only is the gesture of the piece spot-on, the execution is superb too. Did you hear that clunk? That, my friends, was solid contact.


![Phyrexian_Ironfoot](https://media.magic.wizards.com/image_legacy_migration/magic/images/cardart/CSP/Phyrexian_Ironfoot.jpg)The name [Phyrexian Ironfoot](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phyrexian+Ironfoot) is a nice one. It does the two things it needs to do to make this card hum. 1. It uses the “P” word—Phyrexian. In **Magic** land, that word carries a lot of weight. It encompasses thousands of pages worth of story all in nine ominous letters. 2. It captures the mule's nature of this creature. “Ironfoot” just *sounds* like something that doesn't want to follow you. And, to boot, it describes the material with which it was built. Reluctant as it is to move, this big palooka is rounding second base.
...
So there are two ways to interpret the old saying “hit one out of the park.” One is the common game interpretation; batter hits the ball over the wall and out of the playing field. Home Run. Then there's the literal sense; batter hits the ball like St. Cuthpert hitting a Beeble and it launches out of the playing field, over the gawking crowd, and out of the entire ballpark. This is the case with [Mishra's Bauble](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mishra%27s+Bauble). The crowd goes wild.


### [Deathmark](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Deathmark)


If I was a Hollywood screenwriter, I would have clinched this article with the big blast from [Mishra's Bauble](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mishra%27s+Bauble). But I am not—I'm a bard from the Utvara region, so I wrap thing up with [Deathmark](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Deathmark). 


It's not that [Deathmark](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Deathmark)'s art is so totally awesome that I use it as my clean-up hitter. The art is strong, with a memorable iconic design and an interesting gore/snowflake concept. I like it quite a bit.
...
Ah, you noticed that I skipped over the flavor text. Well, that's why I am wrapping up The Boys of Winter with [Deathmark](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Deathmark).


I like this piece quite a bit. It's darkly funny, but what I like about it the most is what it does not say. What it does not say is “who is that body?” Well, I can tell you who that body is. It's Taaveti of Kelsinko. If you read last week's feature article, “[The Italicized World of *Coldsnap*](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/feature/348),” then you know the scoop. If you did not, then I suggest you read it—it's loads of fun. Some folks wrongly assumed we were joking when we killed Taaveti right there in the feature article, and that the woodland ranger was still alive and tracking folks through the snows of Terisiare. Nope. He's now at the epicenter of the wondrous rubine spray described here:
...
No jokes—the dude is dead. Oh yeah, as far as Home Run flavor, [Deathmark](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Deathmark) just clears the fence down the right field line. Hey, is that blood on my thumb? (evil laughter echoing.)
