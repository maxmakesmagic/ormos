...
---
[Link to Wayback Machine](https://web.archive.org/web/20211204051051/https://magic.wizards.com/en/articles/archive/news/duel-wield-part-2-2013-11-21)

[_metadata_:description]:- "I outlined Magic Online's key-bound shortcuts earlier this week in Part 1 of this article. In Part 2, I will explore other handy tricks that can make the duel scene faster and easier to use. Duel Scene Shortcuts Have a pile of Plains you want to tap for mana? Or maybe you want to attack with an entire stack of tokens? In the Wide Beta Client, if you right click on a stack of"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "118621"
[_metadata_:path_date]:- "2013-11-21"
[_metadata_:publish_date]:- "2013-12-08"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Duel Wield, Part 2"
[_metadata_:wayback_capture_timestamp]:- "2021-12-04 05:10:51"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20211204051051id_/https://magic.wizards.com/en/articles/archive/news/duel-wield-part-2-2013-11-21"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/news/duel-wield-part-2-2013-11-21"
---
...
I outlined **Magic Online**'s key-bound shortcuts earlier this week in [Part 1 of this article](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/other/11182013/loucks). In Part 2, I will explore other handy tricks that can make the duel scene faster and easier to use.


Duel Scene Shortcuts
Have a pile of Plains you want to tap for mana? Or maybe you want to attack with an entire stack of tokens? In the Wide Beta Client, if you right click on a stack of active cards, you'll get an option to perform the same action with all of them. It's much faster than clicking on each one individually.


![](https://media.wizards.com/legacy/mtg/images/digital/magiconline/01_plains.png)
...
There are ways to speed up activated and triggered abilities. Take a look at the context menu for the triggered ability from Bident of Thassa:


![](https://media.wizards.com/legacy/mtg/images/digital/magiconline/01_bident_triggeryield.png)
There are four options here. Let's look at the first two: "Always yield to…" and "Yield to…until end of turn." These set up auto-yields for all triggers from that permanent for the rest of the game. This is a great way to make sure you never have to wait for that Essence Warden trigger again. However, this doesn't affect future copies of that same permanent. If your opponent bounces your Bident and you cast it again, **Magic Online**  treats it like a new permanent, and you'll have to set up the new yields again. This makes auto-yielding sometimes difficult to set up for permanents that are entering and leaving the battlefield a lot.


If you auto-yield to Bident of Thassa, it will still ask you if you want to use the ability, since it's a "may" ability. That's where the other two options come in, "Always yes…" and "Always no…." If you tell it to both auto-yield and always-yes to your Bident trigger, then you'll never have to click through it on your own again that game. Just like the auto-yield settings, the "Always yes…" settings are stuck to that permanent.
...
Duel Options
[Top](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/other/11212013/loucks#top)

Take a look at the bar of buttons on the lower right of the duel scene:


![](https://media.wizards.com/legacy/mtg/images/digital/magiconline/01_optionsbutton.png)
...
![](https://media.wizards.com/legacy/mtg/images/digital/magiconline/01_optionslist.png)
...
![](https://media.wizards.com/legacy/mtg/images/digital/magiconline/01_phaseladder.png)
...
**Magic Online zones**  
![](https://media.wizards.com/legacy/mtg/images/digital/magiconline/01_zones_open.png)
