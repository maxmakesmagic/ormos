...
---
[Link to Wayback Machine](https://web.archive.org/web/20170604035538/http://magic.wizards.com/en/articles/archive/savor-flavor/you-cant-handle-reaper-king-2008-04-16)

[_metadata_:author]:- "Doug Beyer"
[_metadata_:description]:- "Vindicating one of the most bizarre—and flavorful—cards in the set."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "354026"
[_metadata_:publish_date]:- "2008-04-16"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "You Can't Handle the Reaper King"
[_metadata_:wayback_capture_timestamp]:- "2017-06-04 03:55:38"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20170604035538id_/http://magic.wizards.com/en/articles/archive/savor-flavor/you-cant-handle-reaper-king-2008-04-16"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/savor-flavor/you-cant-handle-reaper-king-2008-04-16"
---
...
The Reaper King is not for you. You are not good enough for him. He is beyond your ken and outside of your narrow range. You can't wield his power because you don't *get* him. You can't even touch His Scarecrowness because you don't have the intestinal fortitude to withstand him. You'd better leave well enough alone. You'd better click away and hope you open something else at the [Prerelease](http://archive.wizards.com/Magic/TCG/Events.aspx?x=mtgcom/events/prereleases). Because you *just aren't worthy*.
...
### Scarecrows by Design


To understand the Reaper King, you first have to understand its minions, the scarecrows. Scarecrows in*Shadowmoor* are a race of artifact creatures, some of whom, despite being colorless themselves, have "color matters" abilities. To know why the scarecrows were in the set in the first place, we have to look back at the set's design.


![](https://media.wizards.com/legacy/magic/images/mtgcom/fcpics/taste/db32_t2oj5lta5.jpg)There were always going to be artifact creatures in*Shadowmoor*. One of the game play features of*Shadowmoor* Limited play (playing the set via Sealed Deck and Draft, instead of by constructing decks out of your whole collection) is the option of building mono-color, or at least mono-*basic land type*, decks. Due to the power of *Shadowmoor* hybrid, your deck powered only by Swamps can be full of black creatures, black-red creatures, and blue-black creatures. Your Swamps-only deck could easily be three colors—but even with hybrid giving you more cards to choose from for your deck, the set still needed more creatures that could support a mono-color strategy.


Now, it might seem strange that artifact creatures would show up in a "color matters" set. A card like Crowd of Cinders (from the [Card Preview Archive](http://archive.wizards.com/Magic/TCG/Article.aspx?x=magic/shadowmoor/spoiler)) doesn't get any bigger when you add an artifact creature to the table, and a colorless artifact creature doesn't help you conspire to Burn Trail ([previewed by Steve Sadin](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/ss1)) somebody for 6. But artifact creatures are the ultimate flexible-mana creatures. A hybrid black-blue creature can go in a lot of decks, but an artifact creature can go in any deck, no matter what its mana base might be. They were in the set from the handoff from design to development, to allow people to crack open enough creatures for their mono-colored decks and revel in their mono-ness, and development (including me, in my part time) left them in to do just that.


It's interesting to note that many of the Scarecrows ended up with "color matters" abilities, despite their colorlessness. There's a cycle of Scarecrows at common that have their abilities "turn on" when you control a creature of the appropriate color. And those abilities come up more than you might think, even in monocolored decks. You might think that your "mono-Swamp" deck might only be able to give Wingrattle Scarecrow (from the [Card Preview Archive](http://archive.wizards.com/Magic/TCG/Article.aspx?x=magic/shadowmoor/spoiler)) persist, and not flying also, but then you find that you've been running blue-black hybrid creatures. Voila, a *flying* persist Scarecrow.


### The Scarecrows Become Themselves


Let's back up a bit. Design and development had kept a rather high number of artifact creatures in the set. So we in the creative team (including me, in my main job) were all ready to concept up some artificial beings. This was pretty exciting; the idea of combining "creepy, eerie plane of eternal dusk" with "artifact creature" was making me all tingly inside. The idea of using the Scarecrow creature type was on the table pretty early, a fun revival of the old subtype only found on the card Scarecrow (and recently Oracle'd onto the *Portal Three Kingdoms* card Straw Soldiers). But we had thoughts of having a few Scarecrows, a few Golems, some Constructs, and whatever, all creepified. It was art director Jeremy Jarvis who suggested that all the artifact creatures could be Scarecrows, by some broad definition of "scarecrow." Our concept illustrator Richard Whitters was game, and ran with the idea, coming up with some sketches. (Richard, by the way, really likes it when I hover over him while he's drawing and say "Whatcha doin'? Are you drawin'? Wanna draw me? Draw me as a GIANT! Draw me as a giant, eating a KITHKIN! Do it! C'mon, Richard!" Yeah, he digs that. Especially when you clap and make him wear a little organ-monkey fez.) Here are some of Richard's sketches, which you may have seen in [Jarvis's article](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/feature/452) last week.


![](http://archive.wizards.com/magic/images/mtgcom/fcpics/taste/db32_ScarecrowConcepts.jpg)


We loved these designs. Their backstory came quickly after.


### The Nature of Scarecrows


![](https://media.wizards.com/legacy/magic/images/mtgcom/fcpics/taste/db32_xj3tcgyiv.jpg)The story behind scarecrows is already creepy. They're false men, constructed of gourds, bits of straw, and castaway clothing, impaled on a post to give one's garden the vague impression of a humanoid presence. For *Shadowmoor*, though, their creepiness had to be cranked up even further. The tale goes like this.
...
![Reaper King](https://media.wizards.com/legacy/magic/images/mtgcom/fcpics/taste/db32_wc5m7tlo7.jpg)
