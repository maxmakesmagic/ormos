...
---
[Link to Wayback Machine](https://web.archive.org/web/20220628002803/https://magic.wizards.com/en/articles/archive/latest-developments/brief-history-tap-lands-2010-02-05)

[_metadata_:author]:- "Tom LaPille"
[_metadata_:description]:- "Latest Developments is taking this week off due to circumstances beyond human control. Below is Tom's article from last week for those who might have missed it. That it was a preview article last week doesn't make it any less interesting as a look at the Worldwake rare dual lands and how they fit into the history of `enters the battlefield tapped` dual lands in general."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "647211"
[_metadata_:publish_date]:- "2010-02-05"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "A Brief History of Tap Lands"
[_metadata_:wayback_capture_timestamp]:- "2022-06-28 00:28:03"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20220628002803id_/https://magic.wizards.com/en/articles/archive/latest-developments/brief-history-tap-lands-2010-02-05"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/latest-developments/brief-history-tap-lands-2010-02-05"
---


A Brief History of Tap Lands
============================
...
![Kelly Digges](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/authorpics/authorpic_kellydigges.jpg)*Latest Developments is taking this week off due to circumstances beyond human control. Below is Tom's article from last week for those who might have missed it. That it was a preview article last week doesn't make it any less interesting as a look at the* Worldwake *rare dual lands and how they fit into the history of "enters the battlefield tapped" dual lands in general. Definitely good reading (or rereading) as you prepare for Friday Night **Magic** and the impact of* Worldwake *on tournament Constructed formats!*


*Brian David-Marshall's The Week That Was is up as usual, and* [*Brian's take on* Zendikar / Worldwake *Limited*](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/twtw/76) *is great reading if you're headed out to* Worldwake *Launch Parties this weekend.*
...
In the fall of 1997, *Tempest* contained two cycles of dual lands. One was a cycle of allied-color lands:


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/ld/ld75_5Cards1.jpg)... and the other was of enemy-color lands:


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/ld/ld75_5Cards2.jpg)In return for producing two colors of mana, these lands had what by modern standards can only be described as enormous drawbacks. It's not very fun to have your land turn off for a turn when you are so presumptuous as to ask it to make colored mana, and the hilarious double dose of drawback on the second set of lands feel almost insulting. To my modern developer eyes, the message of these cards is that, if you decide that you want to play a multicolored deck, I guess that's okay, but you deserve to be punished for such impetuosity by a terrible mana base.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/ld/ld75_punishment.jpg)This is not the message that we want modern dual lands to send. We believe that **Magic** is more fun when players have choices in deck building, and opening up the ability to play multicolored decks greatly increases the amount of things that a deck builder can do. Many players rejected the drawbacks of the *Tempest* dual lands as being too onerous, which left them the choice of playing a multicolor deck with bad mana or playing a monocolored deck. Competitive Constructed players are often willing to deal with drawbacks on cards in exchange for power, but in this case the drawbacks were too great. None of these lands saw Standard play; even in *Tempest* Block Constructed, green-blue and blue-red decks largely chose to play basic lands and [Reflecting Pool](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Reflecting+Pool)s rather than go for the double-drawback lands.
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/ld/ld75_5Cards3.jpg)Players reacted very positively to these lands. They were accessible, they were simple, and they had no recurring drawback. While it was obvious for many players that *Tempest*'s dual lands did not belong in their allied-color decks, it was just as obvious that these *Invasion* lands did belong. Even more exciting, these lands were strong enough for competitive Constructed. Aggressive decks that depended on the ability to cast spells on the first three turns often eschewed them for *Ice Age* pain lands like [Karplusan Forest](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Karplusan+Forest) and [Brushland](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Brushland), but slower decks were more than happy to wait a turn for a painless source of multiple colors of mana. *Invasion* tap lands and *Ice Age* pain lands happily coexisted in decks like this one, which Carlos Romao used to win the [2002 World Championships](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=sideboard/events/worlds02).
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/ld/ld75_5Cards4.jpg)What does the snow supertype do for you? Plenty of cards in *Coldsnap* have activated abilities that require snow mana to activate, like [Boreal Centaur](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Boreal+Centaur) or [Adarkar Windform](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Adarkar+Windform). However, competitive Constructed players are quite picky about the cards they play, and only a few snow-incentive cards found their way into top-level Standard decks. The best of those cards were [Skred](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Skred), [Into the North](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Into+the+North), [Mouth of Ronom](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mouth+of+Ronom), and [Scrying Sheets](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Scrying+Sheets). These combined to make snow lands more than worth playing in red-green decks like this one, which Jacob Van Lunen played to 4-1 record in the Standard portion of the [2007 World Championships](/en/events/coverage/historic-wins-peleg-swiss-worlds).
...
It is not true that these snowy tap lands are strictly better than [Coastal Tower](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Coastal+Tower) and its ilk. I am sure that at some point in **Magic** play, a [Highland Weald](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Highland+Weald) was trapped underneath [Freyalise's Radiance](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Freyalise%27s+Radiance), an [Arctic Flats](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Arctic+Flats) found itself at the epicenter of an [Icequake](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Icequake), or a [Zombie Musher](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Zombie+Musher) walks past blockers thanks to the defending player's [Frost Marsh](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Frost+Marsh). However, none of the *Coldsnap* cards that key off of an opponent's snow permanents saw much play in competitive Constructed, so that rarely came up. In most decks, these lands were just as good as the *Invasion* ones, and in snow decks they were significantly better.


In *Shards of Alara*, we printed another cycle of tap lands.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/ld/ld75_5Cards5.jpg)These cards, unlike the *Coldsnap* lands, are strictly better than [Coastal Tower](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Coastal+Tower) and friends. They make a third color of mana, with no downside. This is quite a big upgrade from the *Invasion* lands, and as you have no doubt experienced, these cards have been played in tons of competitive Standard decks since *Shards of Alara* was released. It's rare to see a deck that uses a shard's colors without using its corresponding tap land. A few times, we've even seen a deck that plays two enemy colors use the appropriate three-color tap land as a source of only those two colors of mana, without any way to take advantage of the middle color. Here's one example, which Luis Scott-Vargas took to the Finals of [Pro Tour–Kyoto](/en/events/coverage/nassif-greater-power).
...
In *Zendikar*, we printed another set of tap lands that is always better than [Coastal Tower](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Coastal+Tower) and friends.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/ld/ld75_5Cards6.jpg)Rather than give you a third color of mana, these lands give you 1 life when they enter the battlefield. To many players, these lands didn't read as being very strong when compared to the *Shards of Alara* "tri-lands." To me, though, these lands have served as a lesson about how small a bonus needs to be tacked onto a two-color land before it becomes a strong tournament card. If you're playing two allied colors and can afford to wait a turn for a land to come online, the free life that the Refuges offer is not something you should turn down. The *Shards of Alara* lands are more powerful than the Refuges in decks that use all three colors of a shard. However, Refuges have shown up in other decks, like this red-white-blue deck with which Luis Scott-Vargas won the recent [StarCityGames Standard Open in Los Angeles](http://www.starcitygames.com/php/news/article/18542.html).
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/ld/ld75_wwkBanner.jpg)*Zendikar* is a block about lands. As I told you [during *Zendikar* previews](/en/articles/archive/latest-developments/land-your-land-2009-09-18), we thought it was important to make high-profile, powerful lands that had big effects on game play. This spawned our inclusion of both the long-awaited "enemy fetch lands" and the cycle of rare mono-colored lands that includes [Oran-Rief, the Vastwood](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Oran-Rief%2C+the+Vastwood), [Crypt of Agadeem](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Crypt+of+Agadeem), and its friends.
...
![Urza's Factory](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Urza%27s+Factory)

 

This was one of the most powerful lands in *Time Spiral* Block Constructed. Blue decks in that format played cards like [Teferi, Mage of Zhalfir](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Teferi%2C+Mage+of+Zhalfir) and [Triskelavus](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Triskelavus) that could put games away, but their most common method of victory was sitting behind counterspells, [Mystical Teachings](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mystical+Teachings), and removal spells while [Urza's Factory](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Urza%27s+Factory) slowly churned out tokens. This was very, very powerful, but I'm not sure that anyone got excited when they read this card, nor would most people single out [Urza's Factory](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Urza%27s+Factory) as a card that sticks out in their head when they think about *Time Spiral*.
...
Four of these lands have already been shown in the Visual Spoiler on the [*Worldwake* product page](http://archive.wizards.com/Magic/TCG/Products.aspx?x=mtg/tcg/products/worldwake).


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/ld/ld75_2Cards1.jpg)  
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/ld/ld75_2Cards2.jpg)There is, of course, a fifth one, and it is my preview card today. Here it is:


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/ld/ld75_fedmjdxjas.jpg)There is one final point that I wish to address. All of the lands I discussed before the *Worldwake* section in this article are uncommon, and the *Worldwake* lands are rare. This is a matter of limited balance. We could not make *Worldwake*'s animating dual land cycle as powerful as we wanted to at uncommon. There would have been too many lands floating around in drafts that popped out of the land row and beat the crap out of you. Rather than compromise and make uncommon cards that didn't do what we needed them to do, we chose to put them at rare where they had space to breathe. However, *Worldwake* lead developer Mike Turian made sure that there was still a taste of "lands attack" at uncommon, in addition to the common "Zendikon" cycle the design team included, to make sure that the presence of the theme was felt in Limited. Here is that card.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/ld/ld75_1Card2.jpg)We were generous with *Worldwake*'s cycle of animating dual lands. We understand that [Coastal Tower](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Coastal+Tower) is a very playable Constructed card, and that Celestial Colonnade is a big step up from it. However, every set needs flagship cards that convey the theme of the set, and *Worldwake* is a set about lands coming alive. I expect that it won't be too long before these lands will be coming alive and attacking you. I suggest you be ready for them.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/ld/ld75_sdv7b6it7ybotff.jpg)This coming weekend is the [*Worldwake* Prerelease](http://archive.wizards.com/Magic/TCG/Events.aspx?x=mtgcom/events/prerelease-facts), your first chance to get your hands on all the new cards. Below this is the Prerelease locator, which you can use to find a Prerelease near you. Many of us from Wizards of the Coast are traveling to large regional prereleases across the country. Perhaps we'll see you at one of them!
...
|  |  |  |
| --- | --- | --- |
| **Have you participated in a Grand Prix event in the last three months?** |  |  |
| No | 7873 | 93.9% |
| Yes | 507 | 6.1% |
| **Total** | **8380** | **100.0%** |
...
|  |  |  |
| --- | --- | --- |
| **Have you participated in a Pro Tour Qualifier event in the last three months?** |  |  |
| No | 6823 | 81.7% |
| Yes | 1527 | 18.3% |
| **Total** | **8350** | **100.0%** |
...
|  |  |  |
| --- | --- | --- |
| **Have you participated in a Friday Night Magic event in the last three months?** |  |  |
| Yes | 4585 | 53.5% |
| No | 3990 | 46.5% |
| **Total** | **8575** | **100.0%** |
