...
---
[Link to Wayback Machine](https://web.archive.org/web/20211025190823/https://magic.wizards.com/en/articles/archive/latest-developments/what-it-good-2011-01-28)

[_metadata_:author]:- "Tom LaPille"
[_metadata_:description]:- "Tomorrow is the Mirrodin Beseiged Prerelease. When you get there, you'll be dropped into the middle of a war between the people who call Mirrodin home and the Phyrexians who want to take it over. In Scars of Mirrodin, the Mirran natives had not yet come to understand what they faced. They know now, and they've mobilized. The resources that they developed to fight the"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "687011"
[_metadata_:publish_date]:- "2011-01-28"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "What is it Good For?"
[_metadata_:wayback_capture_timestamp]:- "2021-10-25 19:08:23"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20211025190823id_/https://magic.wizards.com/en/articles/archive/latest-developments/what-it-good-2011-01-28"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/latest-developments/what-it-good-2011-01-28"
---
...
Note that battle cry exists in white, red, and artifacts. It is not a coincidence that there are plenty of cards in both of those colors that create tokens. Those of you who are enterprising may reach back a block and combine red battle cry cards with red Eldrazi Spawn token makers. Between [Signal Pest](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Signal+Pest), [Accorder Paladin](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Accorder+Paladin), [Goblin Wardriver](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Goblin+Wardriver), and some token generation, you can put a lot of power onto the board surprisingly quickly. If your opponents aren't ready for that, they may just die.


I'll end the discussion with a few comments on [Contested War Zone](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Contested+War+Zone).
...
[Contested War Zone](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Contested+War+Zone) reads pretty bad. We wouldn't have made it the way we did if it weren't for someone. If you're planning on attacking with a lot of creatures, consider finding out if that person is you.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/ld/ld127_3Cards1.jpg)Now let's fast-forward to these cards being previewed. The first thing everyone seemed to notice was that they were all Knights to go with [Knight Exemplar](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Knight+Exemplar). A few days later, Director of **Magic** R&D Aaron Forsythe built a Knight deck with all those cards, demanded to play me, and crushed me twice in ten minutes when I played one of my less competitive Standard decks. I'd say you all had a reasonable idea. It will be fun to see how good an idea it is in the coming months.
...
There are some really nice new toys for infect decks in *Mirrodin Besieged*, including [Phyrexian Vatmother](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phyrexian+Vatmother) and [Phyrexian Crusader](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phyrexian+Crusader). Unlike *Scars of Mirrodin*'s black infect creatures, the aforementioned have some built-in resilience. [Phyrexian Vatmother](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phyrexian+Vatmother)'s 5 toughness is a lot. [Phyrexian Crusader](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phyrexian+Crusader)'s first strike and infect make it hard to kill in combat, and it has protection from two colors that are very well known for their spot removal. You might, of course, want to cast [Phyrexian Vatmother](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phyrexian+Vatmother) earlier than turn four. For that purpose, I suggest that you try [Plague Myr](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Plague+Myr).


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/ld/ld127_3Cards2.jpg)Another significant addition to infect is [Inkmoth Nexus](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Inkmoth+Nexus). [Inkmoth Nexus](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Inkmoth+Nexus) looks a lot like [Blinkmoth Nexus](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blinkmoth+Nexus), and this is no accident. However, that resemblance isn't why we made the card. Infect is one of this block's mechanics. It doesn't make much sense for us to do a mechanic through a whole block, but not have that mechanic affect Constructed. Historically, one of the best ways to power up aggressive decks is to give them awesome lands that double as creatures. [Mishra's Factory](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mishra%27s+Factory) began a long-standing tradition that passes through [Treetop Village](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Treetop+Village), [Ghitu Encampment](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ghitu+Encampment), and [Faerie Conclave](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Faerie+Conclave) all the way to [Raging Ravine](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Raging+Ravine) and its associates. *Mirrodin Besieged* lead developer Erik Lauer decided that infect needed a creature land. Giving it more than 1 power would have been kind of silly, so we tried [Inkmoth Nexus](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Inkmoth+Nexus) as printed to go for the nostalgia hit. The card worked out just about how we wanted it to in the Future Future League. Time will tell us how it goes in the real world.
...
| **Which faction will you choose when, or if, you go to a *Mirrodin Besieged* prerelease?** |
| --- |
| Mirran | 3638 | 43.8% |
| Phyrexian | 4663 | 56.2% |
| **Total** | **8301** | **100.0%** |
