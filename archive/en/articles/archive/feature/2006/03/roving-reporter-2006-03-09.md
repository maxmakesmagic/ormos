...
---
[Link to Wayback Machine](https://web.archive.org/web/20220124100820/https://magic.wizards.com/en/articles/archive/feature/roving-reporter-2006-03-09)
...
There was so much going on over the week that caught my interest, between the [Standard Pro Tour in Hawaii](/en/events/coverage/living-heezy-street) and all the *Guildpact* release action, that for this week I decided to put on my virtual reporter's hat and see what people have to say about a variety of topics. First, let's check in with rabble-rouser Ken Krouner, who's taken a break from release events to learn a few things about *Ravnica/Ravnica/Guildpact* draft.
...
> 
> 
> “Green has the best mana fixers. It has arguably the best commons in both sets ([Civic Wayfinder](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Civic+Wayfinder) and [Wildsize](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wildsize)). Those three colors have access to tools that can deal with any threat. However, the most important part about drafting in this sort of environment is that just because you are drafting the same colors as your neighbor doesn't mean your deck will be hopeless. At [Grand Prix Richmond](/en/events/coverage/draft-master-destroys-richmond) I found myself sharing at least 2 colors with 2 players on either side of me and I still managed to 2-1 the table with some artful drafting.
> 
> 
...
> * ![Izzet Boilerworks](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Izzet+Boilerworks)**Those double lands aren't coming back around**. “So don't bank on it. The secret is out on these little gems, so don't be shy about taking them where they should be taken. If one of these is your third pick, you should be happy.”
> * **Fliers are at a premium**. “You may have pooh-poohed that [Screeching Griffin](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Screeching+Griffin) in the past, but these days fliers are great no matter the size. Blue, which is normally rich with fliers has only really [Snapping Drake](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Snapping+Drake) to fill that role, and while he may be the most powerful of the commons, you should try to get your hands on all you can. This holds true for any type of evasion.”
> * **Don't let yourself fall into color combinations that don't feature exactly 1 guild from *Guildpact***. “You want to have a guild in the last pack so you aren't robbed of gold cards. While the single-colored cards are closer in power to the gold cards, you are still cutting yourself off from an entire class of powerful commons, not to mention the enhance cards (like [Ogre Savant](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ogre+Savant)), which are so much more powerful in *Guildpact*.”
...
Apparently the murmurs started mid-way through Day 1 of Pro Tour Honolulu. Called “The Shoal Deck”or “the [Tallowisp](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tallowisp) Deck”, and eventually known as Ghost Dad, the ***Magic** Online* concoction surprised opponents every step of the way. I've had some [personal experience succeeding](/en/articles/archive/three-rs%E2%80%94rachelr-ravnica-and-rainbow-stairwell-2005-11-03) with cards others dismiss as draft fodder, so it made me smile to read about [Thief of Hope](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Thief+of+Hope), [Enfeeblement](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Enfeeblement), [Pillory of the Sleepless](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pillory+of+the+Sleepless), and [Strands of Undeath](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Strands+of+Undeath) adding some color to the offbeat [Tallowisp](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tallowisp) deck that made some noise during Kamigawa Block. Of course, no one's doubted the power of [Ghost Council of Orzhova](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ghost+Council+of+Orzhova), but one bit of text gives it a little extra juice with [Tallowisp](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tallowisp), that all important “Spirit” creature type.

![](https://media.magic.wizards.com/image_legacy_migration/sideboard/images/pthon06/fm15_goodman.jpg)*Goodman, entertaining the crowd with deck and wit at PT-Honolulu*[Ted Knutson gave some background](/en/articles/archive/event-coverage/metagame-breakdown-i-will-beat-you-until-you-are-black-white-red) on the deck after it had [generated some buzz](/en/articles/archive/event-coverage/flores-file-our-most-diverse-day-one-wrap-2006-03-04) (including on Randy Buehler's pod casts), and mentioned it as the brainchild of ***Magic** Online* clan **Cymbrogi**. Online clans are one feature on ***Magic** Online* I don't get to touch on much, so I thought this would be the perfect opportunity to learn about how this MTGO clan helped put together one of the more successful rogue archetypes to percolate to the top of the standings. The deck posted a solid 56.72% win percentage (thanks Star City for the complete breakdown and analysis of the field), and earned Benjamin Goodman 22nd place and $2,200. 
...
I'm not sure that we could have designed a card that was a more perfect fit for the concept than [Pillory of the Sleepless](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pillory+of+the+Sleepless), in that it pitches to both shoals and is pretty powerful on its own-- especially in a world where you would often rather neutralize a Dragon than put it in the graveyard.
...
> 
> 
> * **[Savage Twister](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Savage+Twister)** - An uncommon with such a good ability will see play very often; we may even see an increased amount of Beast and dragon decks only because of this card. Play it in a FFA, and you can get free space for you biggies, without any annoying chump blockers.
> * ![Storm Herd](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Storm+Herd)**[Storm Herd](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Storm+Herd)** - A rare which will be cheap really fast, probably sell for 0.5 tix within a month, but still useable in the slow Multiplayer environment. Both 2HG and FFA will get use of this. The life gaining deck in FFAs will get a more effective finish. Even the cleric decks might play this to get use of their massive amount of life from [Daru Spiritualist](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Daru+Spiritualist)
> * **Haunt cards** - Is there any better defense than something that makes your opponent get really sad each time he/she attacks you? If you pull out a haunt card, just something as simple as [Cry of Contrition](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cry+of+Contrition) and let it haunt your own creatures, the player attacking you will know "If I attack him I will discard a card!” This kind of defense is what will make you invisible in tough games.
> * **[Djinn Illuminatus](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Djinn+Illuminatus)** - A card that can make you powerful enough to control the game. If you make sure to have enough DD on hand and lands in play, you could end the game with a simple shock. Of course, if you play this card while having 0 cards on hand you will get crushed before you can say Lhurgoyf.
> * **[Ink-Treader Nephilim](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ink-Treader+Nephilim)** - This card is really powerful. Just make sure to use it for whatever combo you want to use it for ([Lightning Helix](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Helix)), and then kill it, or else your opponents will do the combo instead.
> * **[Leyline of the Void](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Leyline+of+the+Void)** - Bye, Bye Kokusho. No enchantment removal in the B or RB decks will make this card into a favorite to use, just to keep all the annoying Kokusho decks at distance. Expect to see at least one of these in most FFA games, even if nobody is playing Black.
> * **[Quicken](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Quicken)** - Play a creature with high power. While it is on the stack, play [Quicken](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Quicken) and [Decree of Annihilation](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Decree+of+Annihilation). Win the game. This card has great potential; especially in FFA games where you get some time in the start to collect enough mana to pull these wicked things off.
> 
> “Well, those are the ones which I think stand out most from the crowd, when it comes to FFA. And remember to leave your [Spelltithe Enforcer](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Spelltithe+Enforcer) at home when you play FFAs. If you'd like any other opinions about FFA cards or any other thing which involves FFA, send me a mail.”
> 
> 
...
> 
> 
> “I think [Poisonbelly Ogre](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Poisonbelly+Ogre) could become part of some weird combo deck, with [Forbidden Orchard](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Forbidden+Orchard) and stuff. [Skeletal Vampire](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Skeletal+Vampire) seems quite nice if you have a billion turns and mana... Ooh, especially with [Seedborn Muse](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Seedborn+Muse)! [Cryptwailing](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cryptwailing) might be incredible in some decks, we'll see. [Sky Swallower](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sky+Swallower) seems combolicious, but it's only an 8/8 so I don't think it'll be too broken except with [Sway of the Stars](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sway+of+the+Stars). [Vedalken Plotter](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vedalken+Plotter) demolishes Tron, which is nice, but it costs too much for the ability I think [Mimeofacture](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mimeofacture) would be insane if it was an instant, but it isn't – hel-lo, [Quicken](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Quicken)! [Petrified Wood-Kin](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Petrified+Wood-Kin) seems combolicious with things like Second Rites, but the high mana cost might hurt it. [Earth Surge](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Earth+Surge) will have decks built around it-- bad decks. [Ghostway](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ghostway) is really nice because it gives you a huge edge over the people whose stuff was just destroyed. It helps medium aggro decks run [Wrath of God](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wrath+of+God) too, which is nice.
> 
> 
> “[Spelltithe Enforcer](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Spelltithe+Enforcer) is decent, but it will lead to everyone beating on you so I don't think it'll see much play. [Storm Herd](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Storm+Herd) might see play, but the ten mana is likely too much really.
> 
> 
> “[Goblin Flectomancer](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Goblin+Flectomancer) is a really nice card for making people decide not to hit you with things, as is [Hissing Miasma](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hissing+Miasma). Niv-Mizzet will see play with [Curiosity](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Curiosity) and everyone will groan. [Burning-Tree Shaman](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Burning-Tree+Shaman) eats some combo decks for lunch, and he's a 3/4 for three to boot, so I think he'll see play. [Invoke the Firemind](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Invoke+the+Firemind) is also good in infinite mana decks because it helps you dig if you aren't infinite yet, and also gives you the win sometimes. [Cerebral Vortex](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cerebral+Vortex) will be in those annoying Owl/Mine/[Underworld Dreams](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Underworld+Dreams)/etc decks that Only Hell (the online clan) members always play.
> 
> 
...
> 
> 
> “[Savage Twister](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Savage+Twister) is a Wrath for Green/Red, so it will see play in those decks, maybe. [Debtor's Knell](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Debtor%27s+Knell) is obviously insane. Teysa is making Johnnies drool.
> 
> 
> “[Gruul War Plow](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gruul+War+Plow) is the first card that allows any deck to give all its creatures trample, and it will see play for that reason; the second ability is just gravy. [Mizzium Transreliquat](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mizzium+Transreliquat) is very nice because somebody always has a good artifact out. It also destroys legendary artifacts at instant speed. *(Bye bye Legacy Weapon! --B)*
> 
> 
> “Of course the dual lands are all great and will see play. There will also probably be [Izzet Guildmage](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Izzet+Guildmage) combo decks, and then someone will play [Shock](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shock) and the Guildmage player will be sad.”
> 
> 
> 

There you have it, some *Guildpact* cards to be on the lookout for around the ***Magic** Online* multiplayer tables! Personally, I'm looking forward to using [Skarrg, the Rage Pits](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Skarrg%2C+the+Rage+Pits) to get involved in the creature combat of other players if the need arises. I will also personally guarantee anyone attacking with [Dune-Brood Nephilim](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dune-Brood+Nephilim) will get my assistance breaking through to generate ultra-cool Sand tokens! 
