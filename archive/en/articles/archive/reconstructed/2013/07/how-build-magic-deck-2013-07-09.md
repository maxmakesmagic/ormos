...
---
[Link to Wayback Machine](https://web.archive.org/web/20160130222335/http://magic.wizards.com/en/articles/archive/reconstructed/how-build-magic-deck-2013-07-09)

[_metadata_:author]:- "Gavin Verhey"
[_metadata_:description]:- "`How do I build a deck?`   Out of all the many questions I'm asked, this is one of the most popular. And for good reason: deck building can be a daunting process! How are you supposed to choose what goes into your deck out of all the cards you own? It can be baffling.There are a lot of articles focused on the minutiae of deck building, but sometimes the basics can be the hardest part."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "689851"
[_metadata_:publish_date]:- "2013-07-09"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "How to Build a Magic Deck"
[_metadata_:wayback_capture_timestamp]:- "2016-01-30 22:23:35"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20160130222335id_/http://magic.wizards.com/en/articles/archive/reconstructed/how-build-magic-deck-2013-07-09"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/reconstructed/how-build-magic-deck-2013-07-09"
---
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/rc/rc255_mindrot.jpg)  
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/rc/rc255_horriblealbumcover.jpg)Music is pretty awesome, so you pick up the album. (Digitally, of course.) After all, if you like music, won't the greatest hits of all music ever be just up your alley?
...
>   
>  "This is a deck that plans to take full advantage of [Fauna Shaman](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fauna+Shaman), using a lot of creatures and graveyard effects."  
>   
>  "This is a deck that is built around the combo of [Pestermite](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pestermite) and [Kiki-Jiki, Mirror Breaker](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kiki-Jiki%2C+Mirror+Breaker), looking to assemble those two cards to win the game."  
>   
>  "This is a blue-black control deck that is built to specifically beat Goblins and [Pestermite](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pestermite)/[Kiki-Jiki](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kiki-Jiki%2C+Mirror+Breaker) Combo decks."  
> 
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/rc/rc255_walrus.jpg)  
...
[![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/rc/rc255_badcurve_small.jpg)  
...
| Lightning Bolt | Giant Growth |
 ...
 This is also where the lower part of your mana curve—the spell part—comes into play. Are most of your removal spells expensive to cast? Perhaps you should play a few [Pillar of Flame](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pillar+of+Flame)s or [Doom Blade](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Doom+Blade)s then to help give you some removal spells in the early game. Using your mana efficiently and timely is a key to victory, and cheap spells let you do that turn after turn. 
...
Still have that mana curve laid out? Good. Are there any spots in the early game (other than, potentially, one-drops) that are thin? This is where I would go back to my collection or original list of cards and see what I have that would fit that mana cost well.
 ...
 It's tempting to be a little remiss if you end up playing a perceived weaker three-drop instead of a more powerful, more-expensive-to-cast card, but being able to make meaningful plays each turn of the game is important. Your three-drop [Borderland Ranger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Borderland+Ranger) may be a weaker card than your four-drop [Master Biomancer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Master+Biomancer), but I'd much rather have four [Borderland Ranger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Borderland+Ranger)s if I have no other three-drops and twelve four-drops. 



|  |  |
| --- | --- |
| Borderland Ranger | Master Biomancer |

 Finally, I'd take a look to see if there's anything synergistic you can add. Is there a card that works really well with another card that could fit in this deck? For example, if you notice that your deck is mostly flying creatures, perhaps [Favorable Winds](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Favorable+Winds) is a card you would want to play. 

 Curious about how many of each card to play? That can be a pretty tricky part of deck building as well. If you'd like to know more about how many copies of a given card you should play, I wrote about it pretty extensively in [my first article on DailyMTG](/en/articles/archive/zero-sixty-2012-03-27). Look for the header "Crunching Numbers" and you'll be right there.
...
### Deckspertise
 ...
 Curious about sideboarding? That's a whole another banana stand. I wrote [an entire article about the intricacies of sideboarding](/en/articles/archive/reconstructed/zero-sixtyzero-fifteen-2012-11-20)  that you can take a look at to help build up your sideboard. Between this article and that one, you should have all the basic tools you need to construct a tournament-level deck. 
