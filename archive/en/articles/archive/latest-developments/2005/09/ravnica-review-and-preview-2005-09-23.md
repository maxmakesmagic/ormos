...
---
[Link to Wayback Machine](https://web.archive.org/web/20150113224018/http://magic.wizards.com/en/articles/archive/latest-developments/ravnica-review-and-preview-2005-09-23)

[_metadata_:author]:- "Aaron Forsythe"
[_metadata_:description]:- "The Prerelease draws near! Are you prepared? Have you been paying attention? One reader sent me a letter last week asking a question that has probably been on the lips of quite a few people over the last month:"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "289431"
[_metadata_:publish_date]:- "2005-09-23"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Ravnica: Review and Preview"
[_metadata_:wayback_capture_timestamp]:- "2015-01-13 22:40:18"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20150113224018id_/http://magic.wizards.com/en/articles/archive/latest-developments/ravnica-review-and-preview-2005-09-23"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/latest-developments/ravnica-review-and-preview-2005-09-23"
---


Ravnica: Review and Preview
===========================
...
[The Prerelease](http://archive.wizards.com/Magic/TCG/Events.aspx?x=events/magic/prereleases) draws near! Are you prepared? Have you been paying attention?
...
Each card that is associated with a guild has its guild's symbol in the background of its text box (that looks really spiffy in foil). To be part of a guild, a card must have mana symbols of both of its guild's colors on it somewhere, or have the guild's keyword, or both. For example, the following cards would all be considered part of the Dimir (blue-black) guild: a card that cost 2UB to play, a card that cost (U/B)(U/B) to play, a black card with a U activation, a land that could produce U or B, an artifact that cost UB to activate, or any blue or black card with the transmute ability.


Again, the guild symbol doesn't actually mean anything during the game; it just looks cool and brings the world to life.


There are four guilds present in *Ravnica*—the Boros (RW), Dimir (UB), Golgari (BG), and Selesnya (GW). You can check out the story behind these guilds on the flavor page [here](http://archive.wizards.com/Magic/TCG/Article.aspx?x=magic/ravnica/home). The other six guilds won't show up until the next two sets, so you should get comfortable with these four for the time being.
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Rally the Righteous)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rally the Righteous)
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Perplex)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Perplex)
...
* The converted mana cost of Perplex is 3. That means if you transmute Perplex, you can get any card with a converted mana cost of 3, including cards that cost 2B, 1UU, 1WR, 2(G/W), XGGG, or 3.
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Grave-Shell Scarab)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grave-Shell Scarab)
...
**Convoke (green and white)**. Convoke is a mechanic that lets you essentially use creatures as lands to cast certain spells. Each of your creatures that you tap as you play a spell with convoke reduces the cost of that spell.
...
* While playing a spell with convoke, if you control a creature that taps to produce mana, such as [Birds of Paradise](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Birds+of+Paradise), you can either tap it for mana or tap it to reduce the cost of the spell, but not both.
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Selesnya Guildmage)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Selesnya Guildmage)
...
* If a cards costs (G/W)(G/W), you can play it for GG, GW, or WW.
* Hybrid cards are always considered to be both of their colors, regardless of what colors of mana were spent to play them. So you could play [Slay](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Slay) on a Selesnya Guildmage that was played for WW.
...
* There is no such thing as a (G/W) mana. (G/W) merely represents a cost that can be paid for using green mana or white mana.
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Galvanic Arc)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Galvanic Arc)
Just because the guilds are the focus of the new set doesn't mean every card is tied directly into the multicolored theme. We have already see interesting mono-colored cards previewed, including [Telling Time](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/mf59), [Carven Caryatid](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/aa192), and [Galvanic Arc](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/sw84), and today I get to show off what may be one of the most splashy mono-colored cards in the set.
...
“Imagine a demon being hunted by knights,” he explained to the group one day. The idea was simple—an undercosted creature whose balancing drawback was that he gave creatures *to your opponent*. The idea had been touched upon before in *Magic*, from the obscure [Varchild's War-Riders](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Varchild%27s+War-Riders) to the core set staple [Hunted Wumpus](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hunted+Wumpus). But never in a way that was so clean. I really liked how Richard's card was like a little story in and of itself. “Will the knights ever catch the demon? If so, who will emerge victorious?”
...
![](https://media.wizards.com/legacy/magic/images/mtgcom/fcpics/latest/af85_z2qeg8xjm0iba2di.jpg)
...
| Dimir (blue-black) | 8580 | 41.0% |
| Golgari (black-green) | 5480 | 26.2% |
| Boros (red-white) | 4058 | 19.4% |
| Selesnya (green-white) | 2831 | 13.5% |
| **Total** | **20949** | **100.0%** |
