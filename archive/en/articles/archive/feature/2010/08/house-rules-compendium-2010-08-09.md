...
---
[Link to Wayback Machine](https://web.archive.org/web/20161109024343/http://magic.wizards.com/en/articles/archive/feature/house-rules-compendium-2010-08-09)
...
[_metadata_:title]:- "House Rules Compendium"
...
*There's never been "one true way" to play **Magic**. From the very beginning, there have been numerous house rules, homebrew formats, and unique play variants that filter through the community until no one is quite sure of their origin.*
...
*In addition to some interesting slices of **Magic** history, "House Rules" was host to a number of formats that didn't catch on to the same degree, but that have plenty to offer in terms of fun. In the spirit of the recent spate of interesting variants such as [*Archenemy*](http://www.wizards.com/magic/tcg/productarticle.aspx?x=mtg/tcg/archenemy/productinfo), [Tweet MTG](http://www.wizards.com/magic/tcg/events.aspx?x=mtg/daily/events/tweetmtg2010), and [**Magic** Community Labs](http://community.wizards.com/magicthegathering/wiki/magic_community_labs)' [Uktabi Kong](http://www.wizards.com/magic/magazine/article.aspx?x=mtg/daily/arcana/508), I offer the following compendium of long-forgotten **Magic** variants for your perusal and enjoyment.*
...
Assassins encourages you to concentrate on your mark by incentives, not by restrictions. Players are free to attack whomever they want, target anyone they want, and so on, though you may still want to play with range. However, victory is not determined solely by who the last player is, but also by who manages to take out the most marks over the course of the game. The normal method of defeating someone is to reduce that player's life points below 1. For example, if Player A is at 8 life and Player B hits her with a [Fireball](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fireball) for 9 damage, Player A is eliminated at the end of a phase and Player B receives credit for the mark.

![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature103_disIl.jpg)  
Note that if you force your mark to lose by means other than damage, such as [Disenchant](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Disenchant)ing their [Illusions of Grandeur](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Illusions+of+Grandeur) or forcing them to draw more cards than they can, you receive credit just as if you had defeated her normally. Also, if multiple players deals the final blow simultaneously (for instance, if two players cast [Lightning Bolt](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Bolt)s at another player with two life), credit goes first to the active player or to the next closest player in order of play.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature103_10Cover.jpg)Members of the club I founded here in Israel—the Dominia Republic **Magic: The Gathering** Club—play a multiplayer **Magic** variant we call "Zero Sum." Each player starts with 20 life, split evenly 10/10 between the player's "right" and "left" sides. Any damage done by a player to the immediate left or right pushes the life points to the opposite side. For example, a [Lightning Bolt](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Bolt) from the player on your immediate left would make your life 7/13. Only when a player's life points are less than -10 on either side does that player lose the game. The player who dealt the crushing damage, however, receives a bonus of 10 life to be distributed between his or her right and left sides.

Damage not done from a player's immediate left or right simply strikes the player head-on, splitting the damage between the left and right sides and pushing equal numbers of life points to the opposite side, thereby having no net effect. Thus, [Earthquake](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Earthquake) only damages the players to the immediate left and right of the casting player and annoys everyone else, who loses creatures.

Life-bonus cards like [Healing Salve](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Healing+Salve) don't add points to a player's life total, but instead become part of a "life-point shield" that absorbs X damage, where X is the amount of life granted by the healing spell. The shield absorbs damage coming from any direction, including head-on. Also, cards like [Creature Bond](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Creature+Bond) can be played on any player's creature, but the creature's controller only suffers damage if a player to her left or right enchanted the creature.



|  |  |
| --- | --- |
| Healing Salve | Creature Bond |
...
As Anna and I settled into our seats at the Rose [Arena](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Arena), I took an inventory of our supplies. "Let's see—we've got our Portland neck scarves, our pocket binoculars, the life stones. Sweetheart, where's the cards?"
...
I could feel the kid waiting impatiently for me to decide. Then an idea hit me like a [Lightning Bolt](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Bolt). "Uh, give me a pretzel and eight booster packs. Mix in a few *Ice Age*."

I carried my purchases back to my seat, where Anna was watching the duel on her left. From what I could see, the woman's opponent was going to have some trouble against her [Stasis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stasis). I slid down next to Anna and handed her the boosters. She looked at me incredulously. "What am I supposed to do with these? We don't have any land."
...
"For [Fireball](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fireball)s?" I said hopefully. My vision of free [Polar Kraken](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Polar+Kraken)s began to fade. The woman next to Anna played a [Boomerang](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Boomerang) on her [Stasis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stasis) and joined the conversation. "I agree with her. It would *completely* change the game dynamics."
...
The [Stasis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stasis) woman played her [Stasis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stasis) again. "Without any actual land cards or tokens, what do you do with all those spells that affect lands, like [Wild Growth](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wild+Growth)?"

"Okay," I said, "we need land so we can use our [Flashfires](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Flashfires). Let's say that you can play any card as a basic land. Once you've played it, it stays a land. If you play your [Pestilence](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pestilence) as a swamp and then draw a [Circle of Protection: Black](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Circle%2Bof%2BProtection%253A%2BBlack), too bad—it's a swamp forevermore." I paused. "Unless it goes into the graveyard and comes back into your hand somehow. Since cards have no memory, you could play it as a [Pestilence](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pestilence) this time. Are you game?"
...
I considered my [Goblin Ski Patrol](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Goblin+Ski+Patrol) and asked Anna, "What about snow-covered lands?"

"How about we say that all *Ice Age* cards played as land are snow covered?"

I agreed, and the game commenced.

That first game was instructive. I drew a [Diabolic Machine](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Diabolic+Machine) but was shy one mana, so I grimaced, played a [Lightning Bolt](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Bolt) as a land, cast the [Diabolic Machine](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Diabolic+Machine), and was safe for a while.



|  |  |
| --- | --- |
| Diabolic Machine | Tor Giant |

The fellow at my elbow sympathized with me. "Gee, it's a shame you couldn't use that bolt on her [Tor Giant](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tor+Giant), but I guess it was worth it."
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature103_30Cover.jpg)*Friendly play is the root of **Magic**'s success. Keeping friendly play interesting, however, requires lots of friends or some new ways to play. So the next time someone in the group complains about "the same old game" or groans "not that deck again," offer to change the rules.*
