...
---
[Link to Wayback Machine](https://web.archive.org/web/20150308041814/http://magic.wizards.com/en/articles/archive/savor-flavor/bolass-secret-minions-2009-01-27)

[_metadata_:description]:- "As Nicol Bolas knows, the road to power is paved with the backs of willing minions. Total dominion over the Multiverse isn't going to arrive gift-wrapped on anyone's doorstep—even on the broad and inviting doorstep of an ancient, super-intelligent dragon like him. Power takes people. Any good diabolical plan requires servants just as any good machine needs its tiny, tireless, interlocking cogs."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "187091"
[_metadata_:publish_date]:- "2009-01-27"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Bolas's Secret Minions"
[_metadata_:wayback_capture_timestamp]:- "2015-03-08 04:18:14"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20150308041814id_/http://magic.wizards.com/en/articles/archive/savor-flavor/bolass-secret-minions-2009-01-27"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/savor-flavor/bolass-secret-minions-2009-01-27"
---


Bolas's Secret Minions
======================
...
![](https://media.wizards.com/legacy//mtg/images/daily/stf/stf23_nicolbolas.jpg)As Nicol Bolas knows, the road to power is paved with the backs of willing minions. Total dominion over the Multiverse isn't going to arrive gift-wrapped on anyone's doorstep—even on the broad and inviting doorstep of an ancient, super-intelligent dragon like him. Power takes *people*. Any good diabolical plan requires servants just as any good machine needs its tiny, tireless, interlocking cogs.


But it's tough to find good help these days.


![](https://media.wizards.com/legacy//mtg/images/daily/stf/stf23_minions.jpg)The sad truth is, minions are liable to flake out on you at a moment's notice. It takes most humanoids an average of merely *two* community-sundering betrayals before they're putting in their two weeks' notice. Research shows that their minds are simply too shallow to comprehend the majesty of the schemes of today's villain, and that their capacity for rote obedience is compromised by their kind's chronic affliction of volition.
...
![](https://media.wizards.com/legacy//mtg/images/daily/stf/stf23_rakkamar.jpg)* These Minions in Action

Gwafa Hazid's utility as a card is his flavorful "bribing" ability. He's not above getting in there and scrapping for two sometimes, but his true value is in his persuasive "[Pacifism](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pacifism)" effect. Put him on the board and get him going, and Gwafa can singlehandedly keep an entire army of bad monsters at bay.
...
Another strategy would be to punish the opponent for all the bribes (i.e. cards) he or she is getting out of the deal. Call in an anonymous tip at the right time, and cards like [Ebony Owl Netsuke](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ebony+Owl+Netsuke), [Sudden Impact](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sudden+Impact), or [Skullcage](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Skullcage) can be there to dole out the punishment. Use [Fate Transfer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fate+Transfer) or [Leech Bonder](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Leech+Bonder) to shift bribery counters around from creature to creature, keeping your foe's forces helpless as you see fit with no additional bribes.
...
|  |  |
| --- | --- |
| Gwafa Hazid, Profiteer | Rakka Mar |

Rakka Mar's strength lies in brute creature creation. Rakka can provide a barrage of virtual burn spells as part of a repeatedly-throw-fire-at-your-face strategy, or build up an army of fiery 3/1 rage-beasts over time. Note that her Elemental tokens aren't [Spark Elemental](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Spark+Elemental)s—they don't go "poof" at the end of the turn, so you can accumulate them one by one to march into your opponent's forces in a huge attack.


Or you can use Rakka's Elementals for more devious purposes. Whack something for 3 with [Pandemonium](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pandemonium) for each Rakka Mar activation. Sacrifice them to [Greater Good](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Greater+Good) for cards, [Thermopod](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Thermopod) for mana, [Gutless Ghoul](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gutless+Ghoul) for life, [Sadistic Hypnotist](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sadistic+Hypnotist) for discard, a [Doom Cannon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Doom+Cannon) set to Elementals for blastin' fun, and so on.
...
Speaking of Elementals, you can use the tribally relevant subtype of Rakka's minions to fuel many a *Lorwyn* block combo. Feed them to [Seething Pathblazer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Seething+Pathblazer) or [Hearthcage Giant](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hearthcage+Giant). Pump them with [Incandescent Soulstoke](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Incandescent+Soulstoke) or champion them with [Nova Chaser](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Nova+Chaser). To give your Elementals a slippery edge, add the antics of [Caterwauling Boggart](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Caterwauling+Boggart) to make that big alpha strike hit hard.
...
Besides being Elementals, they're also red, which makes [Bloodmark Mentor](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bloodmark+Mentor), [Rise of the Hobgoblins](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rise+of+the+Hobgoblins), [Crackleburr](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Crackleburr), and any of the red Lieges particularly happy, and allows for a very [Stone Rain](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stone+Rain)-riffic [Din of the Fireherd](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Din+of+the+Fireherd). Or use your fiery army to count toward a big [Horde of Boggarts](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Horde+of+Boggarts) or [Ulasht, the Hate Seed](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ulasht%2C+the+Hate+Seed), or to conspire up a [Burn Trail](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Burn+Trail) or [Giantbaiting](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Giantbaiting).


*Conflux* has almost arrived, and Nicol Bolas isn't the only one ready to deploy his faithful servants as the shards smash together. Get to the [Prerelease](/magic/tcg/events.aspx?x=mtgcom/events/prereleases)—your minions are waiting!


* Agents of Artifice Is In Stores Now!

You can pick up your copy of Ari Marmell's [*Agents of Artifice*](/magic/magazine/article.aspx?x=mtg/daily/arcana/96) now! It's the first in our line of planeswalker-centric novels, and kicks off the action with [Jace Beleren](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Jace+Beleren), [Liliana Vess](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Liliana+Vess), and the Esper mage Tezzeret (whose backstory you're seeing right now as a web comic[mtg/multiverse/webcomics/main]). I'm eager to hear what you think of the book—once you read it, click the email link at the bottom of this article and let me know.


![](https://media.wizards.com/legacy//mtg/images/daily/stf/stf23_agentscta.jpg)* Letter of the Week
...
Certainly there are mechanical and **Magic**-tradition reasons why [Executioner's Capsule](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Executioner%27s+Capsule) specifies nonblack—the card was likely designed as a "[Terror](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Terror) spellbomb" counterpart to its Esper brethren, a "[Disenchant](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Disenchant) spellbomb" and an "[Inspiration](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Inspiration) spellbomb." Specifying "nonblack" is a customary rider for black creature-kill effects in the tradition of the original [Terror](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Terror) and [Dark Banishing](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dark+Banishing), and that's likely the main reason it showed up there.
...
But this is a flavor column. *Why* would Esper have one type of spell-capsule that contained magic capable of killing *any* Esper creature, and another that could only kill *some* of them? Is the executioner's death-spell a relic of ancient times, both its power and its restrictions passed down through generations of necro-mages from a time before Alara was broken into five planes? Is some issue involved in the cost-benefit of artifact construction, such that creating a limited-target spell-capsule that can be activated for ![](https://web.archive.org/web/20211201201921im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless1.gif)![](https://web.archive.org/web/20161227195556im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/black.gif) is easier than creating an unlimited-target spell-capsule that can be activated for ![](https://web.archive.org/web/20161225105850im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless2.gif)![](https://web.archive.org/web/20161227125855im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/white.gif)? Is the nonblack restriction somehow part of the way the black capsule's magic kills, flooding its victim with a sudden influx of terrifying imagery that just doesn't do the trick on the devious minds of black-aligned creatures? Was the [Executioner's Capsule](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Executioner%27s+Capsule) designed before the Ethersworn had radically transformed Esper into a world populated almost exclusively with artifact creatures, and was therefore previously more useful as an anti-flesh measure?


Your idea got me thinking the most, John—that maybe there's some deal that Esper's executioners have with the plane's black-aligned creatures, such that they never make a capsule that can off one of their own. Or given that it's black we're talking about, it could have been an Esperite looking out for Number One: Perhaps the first creator of an [Executioner's Capsule](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Executioner%27s+Capsule), likely a black-aligned artificer himself, wanted to make sure his capsule creation could *never be used against him*. In hacker terms, it's like a back door—a feature designed specifically with its creator in mind. I guess the inventor of the [Dispeller's Capsule](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dispeller%27s+Capsule) had no such concern.
