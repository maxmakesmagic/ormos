...
---
[Link to Wayback Machine](https://web.archive.org/web/20210417232034/https://magic.wizards.com/en/articles/archive/born-gods-update-bulletin-2014-01-28-0)
...
[_metadata_:node]:- "683286"
[_metadata_:publish_date]:- "2014-01-28"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Born of the Gods Update Bulletin"
[_metadata_:wayback_capture_timestamp]:- "2021-04-17 23:20:34"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20210417232034id_/https://magic.wizards.com/en/articles/archive/born-gods-update-bulletin-2014-01-28-0"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/born-gods-update-bulletin-2014-01-28-0"
---
...
### [Blind Fury](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blind+Fury) (functional)


Before *Mirage* was released on **Magic Online**, [Blind Fury](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blind+Fury) was given a restriction to when you could cast it, specifically before the combat damage step. This was to prevent you from putting combat damage on the stack and then casting [Blind Fury](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blind+Fury) in response, before combat damage resolved. If you did this, the fact that creatures lost trample wouldn't matter as combat damage had already been potentially assigned to players from blocked creatures with trample. You would still get the bonus of all combat damage assigned to creatures being doubled. Basically, the rules structure of pre-*M10* allowed you to evade the clearly intended drawback of [Blind Fury](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blind+Fury), something the rules structure when *Mirage* was first printed didn't allow.


However, now that combat damage no longer uses the stack, this timing restriction is unnecessary. If you cast [Blind Fury](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blind+Fury) before the combat damage step, the spell will work as intended. If you cast it during or after the combat damage step, basically nothing will happen (except possibly if there are multiple combats, but even then you get what you expect). So, we're removing the timing restriction.


As a side note, a few other cards, such as [Blood Frenzy](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blood+Frenzy), were given similar restrictions so you couldn't evade their intended drawbacks, but because of the nature of their effects, removing those restrictions would essentially create different cards. This is something we're not interested in, so those cards are being left alone.
...
 
### [Bloodletter Quill](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bloodletter+Quill) (nonfunctional)
...
![2 Mana](https://media.magic.wizards.com/image_legacy_migration/images/Symbols/Symbol_2_mana.gif),
![Tap](https://media.magic.wizards.com/image_legacy_migration/images/Symbols/tap.gif), Put a blood counter on Bloodletter Quill: Draw a card, then lose 1 life for each blood counter on Bloodletter Quill.  
![Blue Mana](https://media.magic.wizards.com/image_legacy_migration/images/Symbols/blue_mana.gif)![Black Mana](https://media.magic.wizards.com/image_legacy_migration/images/Symbols/black_mana.gif): Remove a blood counter from Bloodletter Quill.
...
![2 Mana](https://media.magic.wizards.com/image_legacy_migration/images/Symbols/Symbol_2_mana.gif),
![Tap](https://media.magic.wizards.com/image_legacy_migration/images/Symbols/tap.gif), Put a blood counter on Bloodletter Quill: Draw a card, then you lose 1 life for each blood counter on Bloodletter Quill.  
![Blue Mana](https://media.magic.wizards.com/image_legacy_migration/images/Symbols/blue_mana.gif)![Black Mana](https://media.magic.wizards.com/image_legacy_migration/images/Symbols/black_mana.gif): Remove a blood counter from Bloodletter Quill.
...
 
### [Burning of Xinye](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Burning+of+Xinye) (functional, but a reversal)
...
 
### [Opal Palace](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Opal+Palace) (nonfunctional)
...
![Tap](https://media.magic.wizards.com/image_legacy_migration/images/Symbols/tap.gif): Add
![1 Mana](https://media.magic.wizards.com/image_legacy_migration/images/Symbols/Symbol_1_mana.gif) to your mana pool.  
![1 Mana](https://media.magic.wizards.com/image_legacy_migration/images/Symbols/Symbol_1_mana.gif),
![Tap](https://media.magic.wizards.com/image_legacy_migration/images/Symbols/tap.gif): Add to your mana pool one mana of any color in your commander's color identity. If you spend this mana to cast your commander, it enters the battlefield with a number of +1/+1 counters on it equal to the number of times it's been cast from the command zone this game.
...
![1 Mana](https://media.magic.wizards.com/image_legacy_migration/images/Symbols/Symbol_1_mana.gif) to your mana pool.  
![1 Mana](https://media.magic.wizards.com/image_legacy_migration/images/Symbols/Symbol_1_mana.gif),
![Tap](https://media.magic.wizards.com/image_legacy_migration/images/Symbols/tap.gif): Add to your mana pool one mana of any color in your commander's color identity. If you spend this mana to cast your commander, it enters the battlefield with a number of additional +1/+1 counters on it equal to the number of times it's been cast from the command zone this game.
...
 
### [Psychic Battle](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Psychic+Battle) (functional)


The last line of [Psychic Battle](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Psychic+Battle)'s old wording was added quickly after the card was released to prevent immediately drawing the game every time. Given that you choose new targets when you change them, [Psychic Battle](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Psychic+Battle)'s ability would just trigger itself, over and over and over again. Although the added line took care of the problem for one [Psychic Battle](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Psychic+Battle), two or more [Psychic Battle](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Psychic+Battle)s would still draw the game by causing each other to trigger *ad infinitum*. This was a templating oversight at the time, which we can now button up.
...
Whenever a player chooses one or more targets, each player reveals the top card of his or her library. The player who reveals the card with the highest converted mana cost may change the target or targets. If two or more cards are tied for highest cost, the target or targets remain unchanged. Changing targets this way doesn't trigger abilities of permanents named [Psychic Battle](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Psychic+Battle).
...
This rule explains exactly what we mean we refer to a counter being "placed" on an object. Essentially, we need to clarify that when a permanent enters the battlefield with some number of counters, those counters are being placed on that permanent and will be subject to cards like [Doubling Season](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Doubling+Season). This rule got a second look in light of the tribute ability, but no functional changes were made.
...
This rule talks about self-replacement effects, which are effects of a resolving spell or ability that modify other parts of that spell or ability. [Memory Lapse](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Memory+Lapse) is the classic example. It says to counter the spell, which normally means put it into its owner's graveyard, but it has a self-replacement effect that modifies that, so the spell goes to the top of its owner's library instead. Normally, self-replacements are part of the ability whose effect is being replaced, but we do make exceptions if ability words are involved. For example, [Caravan Vigil](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Caravan+Vigil)'s self-replacement effect is expressed as a separate ability because of morbid, even though it modifies the first ability. We added a sentence to this rule to explain that this construction is fine.
...
![](https://media.wizards.com/images/magic/daily/arcana/519_plotsscheme.jpg)
**702.103**
...
Thanks to [Strionic Resonator](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Strionic+Resonator), you can now copy triggered abilities. After pouting in protest for several updates, this rule on copying spells and abilities finally acknowledges this fact.
...
We updated this rule to state that if you cast a commander owned by someone else from the command zone (as can happen with [Daxos of Meletis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Daxos+of+Meletis)), the "commander tax" applies.
