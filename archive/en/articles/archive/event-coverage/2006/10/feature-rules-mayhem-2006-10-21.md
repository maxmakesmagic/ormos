...
---
[Link to Wayback Machine](https://web.archive.org/web/20171029024305/https://magic.wizards.com/en/articles/archive/event-coverage/feature-rules-mayhem-2006-10-21)

[_metadata_:author]:- "Scott Johns"
[_metadata_:description]:- "When you've got as many mechanics running around as Time Spiral does, there are bound to be some whacky rules interactions, and bringing back effects from the far past only exaggerates things. We here at the Pro Tour aren't only here to entertain, we're here to educate. So follow through on these examples and you'll definitely learn a trick or two for your next game."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "541246"
[_metadata_:publish_date]:- "2006-10-21"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Feature: Rules Mayhem!"
[_metadata_:wayback_capture_timestamp]:- "2017-10-29 02:43:05"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20171029024305id_/https://magic.wizards.com/en/articles/archive/event-coverage/feature-rules-mayhem-2006-10-21"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/event-coverage/feature-rules-mayhem-2006-10-21"
---
...
|  |  |  |
| --- | --- | --- |
| Smallpox | Nightshade Assassin | Cyclopean Giant |
|  |  | **X 3** |
...
Thanks to the way madness works, when you cast [Smallpox](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Smallpox) you'll be able to remove the [Nightshade Assassin](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Nightshade+Assassin) from the game with madness, then wait until the [Smallpox](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Smallpox) is done resolving (the next time the triggered ability can go on the stack) before bringing the assassin into play. 


Madness can get confusing, so let's take it step by step. You tap all four [Swamp](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Swamp)s and cast [Smallpox](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Smallpox). Time to start resolving the spell. Each of you loses 1 life. Each of you discards a card, which is when you discard your Assassin to madness, removing it from the game for now. Next you each sacrifices a creature. You don't have a creature in play (yet), so you're fine. Your opponent loses an Elephant. Then you each sacrifice a land. Now that [Smallpox](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Smallpox) is done, your assassin gets to come into play, offing the remaining elephant token in the process by revealing the remaining three black cards in your hand. Your opponent just lost two creatures *and* a card, and all you lost was the [Smallpox](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Smallpox) - and you got a 2/1 first striker into play in the process! 


(That one was courtesy of Ted Knutson, who came across it as a possible interaction with one of Anton Jonsson's decks yesterday.)  


Fun, right? Another crazy thing comes up courtesy of just plain old first strike. Say you've got this guy in play:

![Fungus Sliver](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Fungus+Sliver)Now, for fun, let's say he's got first strike somehow. (Perhaps you've got [Valor](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Valor) in your graveyard with a [Plains](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Plains) in play.) You have the following two cards in hand, with just enough mana to cast them.



|  |  |
| --- | --- |
| Bewilder | Might of Old Krosa |

Your opponent sends over a 1/1 Goblin token with no abilities or anything else. Did you know there's a way to kill off the 1/1 and grow your [Fungus Sliver](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fungus+Sliver) in the process? When you think you've got it figured out (or when you give up), click here  for the answer. 

Here's the play: Block the token with the [Fungus Sliver](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fungus+Sliver), then before first strike damage cast [Bewilder](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bewilder) on your Sliver, making it -1/2 (0/2 for all purposes except changing its power). At this point, first strike damage would be assigned, but since you have no power, you can't assign it. (This is where things get whacky.) Now, there's a rule that says that if a first striker can't assign damage during first strike damage, it gets to assign damage normally instead. So, once first strike damage is out of the way, just cast [Might of Old Krosa](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Might+of+Old+Krosa), making your sliver a 1/2. Now you go to normal damage assignment and get to put a point of *non-first strike* damage on the Goblin, enough to kill it while 
...
|  |  |
| --- | --- |
| Crookclaw Transmuter | Basalt Gargoyle |
