...
---
[Link to Wayback Machine](https://web.archive.org/web/20220629225855/https://magic.wizards.com/en/articles/archive/latest-developments/branding-play-2012-04-05)

[_metadata_:author]:- "Zac Hill"
[_metadata_:description]:- "Hope you've been enjoying Helvault Week!There are unfortunately only so many things I can say about a three-mana artifact that kills stuff every turn. I mean, it has pretty sweet-looking art, and there are some really scary creepers lurking in there, but that's hardly an article...What I instead want to talk to y'all about is this Helvault:More specifically, I want to talk"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "194436"
[_metadata_:path_date]:- "2012-04-05"
[_metadata_:publish_date]:- "2012-04-06"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Branding Play"
[_metadata_:wayback_capture_timestamp]:- "2022-06-29 22:58:55"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20220629225855id_/https://magic.wizards.com/en/articles/archive/latest-developments/branding-play-2012-04-05"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/latest-developments/branding-play-2012-04-05"
---
...
Hope you've been enjoying [Helvault](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Helvault) Week!

  
There are unfortunately only so many things I can say about [a three-mana artifact that kills stuff every turn](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Helvault). I mean, it has pretty sweet-looking art, and there are some *really* scary creepers lurking in there, but that's hardly an article...

What I instead want to talk to y'all about is *this* [Helvault](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Helvault):

![](https://media.wizards.com/images/magic/daily/ld/ld189_newhel.jpg)  
More specifically, I want to talk about the circumstances that led to this [Helvault](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Helvault)'s creation—and why, in general, we're starting to do Prereleases a little bit differently from how we've done them for the last ≈15 years.
...
![](https://media.wizards.com/images/magic/daily/ld/ld189_tal.jpg)[Talisman of Indulgence](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Talisman+of+Indulgence) | Art by [Mike Dringenberg](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=+%5B%22Mike+Dringenberg%22%5D)
...
![](https://media.wizards.com/images/magic/daily/ld/ld189_ad.jpg)[Ad Nauseam](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ad+Nauseam) | Art by [Jeremy Jarvis](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=+%5B%22Jeremy+Jarvis%22%5D)

I've attended every Prerelease since *Urza's Destiny* in some capacity or another. I can probably tell you a story about every single one. Since I've been in Ramp;D, I have flown out to Prerelease events around the US to meet players and talk to tournament organizers. So I'll start out by saying I definitely appreciate the value of the way we have always done our Prereleases.
...
![](https://media.wizards.com/images/magic/daily/ld/ld189_mik.jpg)[Mikaeus, the Lunarch](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mikaeus%2C+the+Lunarch) | Art by [Steven Belledin](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=+%5B%22Steven+Belledin%22%5D)
...
![](https://media.wizards.com/images/magic/daily/ld/ld189_phy.jpg)[Phyrexian Obliterator](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phyrexian+Obliterator) | Art by [Todd Lockwood](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=+%5B%22Todd+Lockwood%22%5D)
...
Breaking open the [Helvault](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Helvault), of course!

I can't provide very many details of how the event is going to work, and I haven't even been told what the contents of these [Helvault](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Helvault)s actually are. I can explain, however, the structure of the setup:

Each [Helvault](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Helvault), true to form, is going to come equipped with a series of "seals" that bind its treasures inside. Completing different challenges will allow players to work together to open each of these seals. Eventually, if enough of these challenges are completed, players will be able to disrupt the magic that sanctifies the 'Vault and unleash whatever lurks within.
...
And who knows? Maybe you'll walk away with some remnant of the [Helvault](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Helvault) itself, some small token that helps enliven those memories for a long time...
