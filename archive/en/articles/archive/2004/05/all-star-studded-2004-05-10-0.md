...
---
[Link to Wayback Machine](https://web.archive.org/web/20210502165019/https://magic.wizards.com/en/articles/archive/all-star-studded-2004-05-10-0)
...
[_metadata_:wayback_capture_timestamp]:- "2021-05-02 16:50:19"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20210502165019id_/https://magic.wizards.com/en/articles/archive/all-star-studded-2004-05-10-0"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/all-star-studded-2004-05-10-0"
---
...
The Magic Invitational is going on right now! You can watch the action live in [Magic Online](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=magic/magiconline/downloadlinks), or read our coverage [as it happens](/en/events/coverage/live-coverage-2004-magic-invitational).
...
1. It's the all-star game – Of all the high profile **Magic** tournaments run, the Invitational is by far the smallest. Only sixteen players are invited. And not just any players, only the cream of the crop. How do you score an invitation? Either by winning a key event (such as the World Championships), having a strong Pro Tour season (marked by either a high rating or the number of pro points earned) or being voted in on a player ballot by the **Magic** public.
2. The tournament isn't about money – There's no purse on the Invitational (although an invite does come with free airfare and hotel). Rather the players are competing for something far cooler – the chance to become part of Magic. The winner gets to design his very own **Magic** card that will have him pictured in the illustration.
3. It's a round-robin tournament – No Swiss rounds in this tournament. The Invitational is a fifteen round tournament in which every player plays every other player once. This means that whoever your favorites are they are destined to meet. The top two players after the fifteen rounds play off in the finals. (More on this in a second.)
4. The tournament has five formats – To spice things up, the Invitational changes formats every three rounds. That's five formats (three constructed and two limited). I'll explain the formats for this year's event later in the article.
5. It has an odd finals – Here's how the finals work. The top two players after the fifteen round robin rounds play a best two out of three match finals (using the three constructed formats). Each match is best 2 out of 3 games. It could be over in four games. It could be over in nine.
6. It's all played on ***Magic** Online* – The Invitational is the highest profile tournament played on ***Magic** Online*. Every match is recorded and can be watched by all of you at your leisure (more on this later as well). In addition, people online will have the chance to talk with players in between games. If this sounds interesting, please join us this Tuesday, Wednesday or Thursday (the finals are played Saturday night).
...
To see the formats, [click here](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/feature/211b).
...
To see the formats, [click here](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/feature/211c).
...
![Avalanche Riders](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Avalanche+Riders)Development tweaked the card by adding the ability echo and changing it from a 2/1 to a 2/2. The art is an interesting story. At the time I came up with the prize of making a card, it never dawned on me to do anything with the art. But as fate would have it, I was in charge with writing the art descriptions for *Urza's Legacy* (the only set other than *Unglued* that I did that for). I knew the creature in the art was a humanoid, so I figured why not make it Darwin. I sent the artist (Ed Beard, Jr.) his picture and a tradition was started.
...
To see the formats, [click here](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/feature/211d).
...
![Rootwater Thief](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Rootwater+Thief)**Long's Merfolk**  
...
To see the formats, [click here](http://www.wizards.com/sideboard/article.asp?x=sb19991201b).
...
Once again I made up some cards for the Duplicate Limited format. [Click here to see the cards](http://www.wizards.com/sideboard/article.asp?x=INVITATIONAL9900/duplicatecards). I would go into greater detail, but you see, I actually wrote a tournament report (not something I do very often) for this event. You want to know what happened? [Click here](http://www.wizards.com/sideboard/article.asp?x=sb20000317a). 

Upon winning the event, Pikula turned in the following card:

![Meddling Mage](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Meddling+Mage)The Meddler  
![](https://web.archive.org/web/20211201201921im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless1.gif)![](https://web.archive.org/web/20161115194122im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/blue.gif)![](https://web.archive.org/web/20161115194122im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/blue.gif)  
...
To see the formats, [click here](http://www.wizards.com/sideboard/article.asp?x=sb20000908a). 
...
This event came down to Jon Finkel versus Ben Rubin. Rubin put up a noble fight but was slaughtered in the finals by Finkel. This is the second Invitational where I wrote a tournament report (a rather lengthy one). If you'd like to know what went on “Down Under”, check it out ([Part 1](http://www.wizards.com/sideboard/article.asp?x=sb20010820c), [Part 2](http://www.wizards.com/sideboard/article.asp?x=sb20010821a)).
...
In addition, once again, here is the [on-line coverage of the event](http://archive.wizards.com/sideboard/event.asp?event=MI00).
...
To see the formats, [click here](http://www.wizards.com/sideboard/article.asp?x=sb20010824a). 

The sixth Invitational hit our fifth continent. This Invitational is the furthest trip I've ever taken. Including my layovers, the trip took about thirty-five hours. But it was well worth it. This Invitational is memorable for many things. One such thing is the fact that I got to pet a cheetah. In fact, you know that picture of me you see every time you read my column. That is actually from a picture of me petting a cheetah (along with editor-in-chief Scott Johns, no less). 
...
|  |  |
| --- | --- |
| voidmage prodigy | Voidmage Prodigy |

And here is the [on-line coverage of the event](/en/articles/archive/event-coverage/2001-magic-invitational-2015-09-02).
...
To see the formats, [click here](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=sideboard/feature/20020910a).
...
![Solemn Simulacrum](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Solemn+Simulacrum)**Forestfolk**  
...
Here's a link to [this year's formats](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/feature/mi04) as well as a link to this year's [Auction of the People decks](/en/articles/archive/auction-people-decks-2004-05-04).

In addition, here is a link to [this year's competitors](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=sideboard/news/20030919b). Note that current World Champion Daniel Zink had to bow out for school responsibilities and is being replaced by Canadian Gary Wise.
...
If you're interested in watching this week's event (and remember you can only watch finished games and not games in progress), [here's what you need to do](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=magic/magiconline/inv02replay).
