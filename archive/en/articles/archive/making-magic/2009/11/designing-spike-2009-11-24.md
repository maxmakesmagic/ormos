...
---
[Link to Wayback Machine](https://web.archive.org/web/20211021115625/https://magic.wizards.com/en/articles/archive/making-magic/designing-spike-2009-11-24)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "Welcome to Spike Week, part three of three of our series of player psychographic theme weeks. (Timmy Week was back in March and Johnny Week was in August – you can see `Designing for Timmy` here and `Designing for Johnny` here.) If you're unfamiliar with our player psychographics, I suggest reading my most recent article on them, `Timmy, Johnny and Spike Revisited`."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "189086"
[_metadata_:path_date]:- "2009-11-24"
[_metadata_:publish_date]:- "2009-11-30"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Designing for Spike"
[_metadata_:wayback_capture_timestamp]:- "2021-10-21 11:56:25"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20211021115625id_/https://magic.wizards.com/en/articles/archive/making-magic/designing-spike-2009-11-24"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/making-magic/designing-spike-2009-11-24"
---
...
Welcome to Spike Week, part three of three of our series of player psychographic theme weeks. (Timmy Week was back in March and Johnny Week was in August – you can see "Designing for Timmy" [here](/magic/Magazine/Article.aspx?x=mtg/daily/mm/29) and "Designing for Johnny" [here](/magic/Magazine/Article.aspx?x=mtg/daily/mm/50).) If you're unfamiliar with our player psychographics, I suggest reading my most recent article on them, "[Timmy, Johnny and Spike Revisited](/magic/magazine/article.aspx?x=mtgcom/daily/mr220)". If you're wondering where Melvin and Vorthos are, they're not player psychographics (which I explain in my column on them, "[Melvin and Vorthos](/magic/magazine/article.aspx?x=mtgcom/daily/mr278)"), but I'm sure they're eventually get their own theme weeks as theme weeks are hungry monsters and Kelly (Digges, our editor) is always looking for things to feed them. Now that I have all of the required reading out of the way, let's get to what you all came here for. In this column I am going to explain how we design for the Spike psychographic.

Punching the Spike
Before I can explain how we design for Spike, let me give you a quick refresher in who Spike is. Spike is one of the three player psychographics that **Magic** Ramp;D uses to design and develop cards. This, of course, leads to the question what is a player psychographic? A psychographic is a psychological profile that isolates different personality traits and behaviors to help the people using the profile (in this case Ramp;D) better understand what motivates a particular type of player to act a certain way. Learning what different players want out of **Magic** is important for a number of reasons. First, knowledge of which groups exist helps us understand what elements have to be included in each set. Second, knowing what players want helps us design those things into the cards.
...
So how exactly does Ramp;D make these types of cards? Several ways. The first is inter-set synergy. Some cards are good not because they are good in a vacuum but because they are good in a particular environment. This is especial true for Limited environments where design has very strict control of what resources exist and in what number. A poster child for this type of card is [Rats of Rath](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rats+of+Rath) from *Tempest* block.

**[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=RATS+OF+RATH)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=RATS+OF+RATH)**

Yes, a two-mana 2/1 that allows you to destroy your own cards. At first blush, this card looks sub-optimal. But as you begin to understand the *Tempest* Limited environment, you learn two things. One, there is a very strong aggro strategy that involves black, so having a two-mana 2-power guy is a little better than normal. More importantly though, the seemingly useless ability is far from useless. Why? Because of a little mechanic called buyback. The aggro strategy of *Tempest* Limited is balanced by a control strategy that takes advantage of cards like [Capsize](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Capsize). Once a player had enough mana, buyback spells became very powerful, and there were very few answers. But if [Capsize](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Capsize) is countered because its target goes away (what we called "fizzle" back in the day), the spell will not return to its owner's hand. This makes the Rats' ability very important because it can fizzle buyback spells.

Another means Ramp;D can use to hide a card's strength is to introduce a new ability. Players tend to gauge the power level of a card by comparing it to known cards. When a card does something that isn't easily comparable, it makes such judgments much harder to make. A classic example of this would be the card [Tarmogoyf](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tarmogoyf) from *Future Sight*.
...
The card, at first blush, looks like a goofy [Lhurgoyf](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lhurgoyf) tweak. (To be fair, it *is* a goofy [Lhurgoyf](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lhurgoyf) tweak.) Sure, it can grow quickly if the right number of different card types are in all graveyards, but how hard is that to accomplish? That uncertainty hid the value of the card for a month or two when the set was released. By the way, I should point out that while Ramp;D knew this card was good it ended up proving to be even better than Ramp;D initially thought. 

Note that these cards don't always have to appear bad at first. Some of the best examples are cards where the Spikes get to argue about how good something is. A poster child for this type of card just showed up in *Zendikar*: a little snake known as [Lotus Cobra](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lotus+Cobra).
...
What's even better than a good card to Spike? A card that's good in their hands but not one in the hands of a lesser player. As Spike is always trying to prove himself, he really enjoys cards whose power level require skill on his part. While the last category was one where development has a lot more control (design isn't the one who chooses which cards to push), this category is very much in design's court. The classic example of this type of card is *Invasion*'s [Fact or Fiction](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fact+or+Fiction).

[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Fact+or+Fiction)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=FACT+OR+FICTION)Splitting five cards correctly is very challenging. It depends not just on the value of the five cards in a vacuum but what they mean to the current game state. In addition, understanding what the opponent values, correctly or not, allows for splits that will push the opponent to make a certain choice most often to the advantage of the splitter. Doing this correctly requires a lot of skill. So much so that [Fact or Fiction](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fact+or+Fiction) has proven to be a favorite among Spikes.

The biggest reason is that it is allows Spike to prove himself not just in the choice to put it into his deck but in the actual play of the game itself. Each time he plays the card he gets to prove his ability to use the card correctly. So much so that [Fact or Fiction](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fact+or+Fiction) splits themselves become fodder for Spike metagame discussions.
...
![](https://media.wizards.com/legacy//mtg/images/daily/mm/mm67_charms.jpg)  
...
![](https://media.wizards.com/legacy//mtg/images/daily/mm/mm67_mechanics.jpg)  
...
![](https://media.wizards.com/legacy//mtg/images/daily/mm/mm67_mechanics2.jpg)  
...
Next we have cards that allow you choices when playing the card that affect what the card is. Although an old example, my go-to for this is [Primal Clay](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Primal+Clay). I could just as easily use any card with imprint or one that forces you to choose a color when played.

![](https://media.wizards.com/legacy//mtg/images/daily/mm/mm67_cards.jpg)  
