...
---
[Link to Wayback Machine](https://web.archive.org/web/20190925223738/https://magic.wizards.com/en/articles/archive/feature/throne-eldraine-prerelease-primer-2019-09-24)
...
Okay now, let's see. You have a store selected on your map, and you've filled your adventurer's backpack with everything you'll need. And, of course, you've taken a look at all the awesome cards in the [*Throne of Eldraine Card* Image Gallery](https://magic.wizards.com/en/articles/archive/card-image-gallery/throne-eldraine). Perhaps, if you were curious what a tournament might be like, you might have checked out my article conveniently titled "[Your First Tournament](https://magic.wizards.com/en/articles/archive/beyond-basics/your-first-tournament-2017-02-23)."
...
![ELD Prerelease Box](https://media.wizards.com/2019/images/daily/en_eld-prerelease-box.png)
...
![ELD Inside Box](https://media.wizards.com/2019/images/daily/en_eld-inside-box1.png)
...
First, lay your creatures out in mana-cost order. This helps you see what creatures you're going to potentially be able to cast at each part of the game. (Don't lay your noncreatures out at this point unless they're cards you are planning to play as soon as you have that much mana—for example, you will generally cast a [Youthful Knight](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Youthful+Knight) on turn two, whereas Trapped in the Tower isn't usually a turn-two play.)
...
![Flaxen Intruder](https://media.wizards.com/2019/eld/en_iBpzIhSq5P.png)![Embereth Shieldbreaker](https://media.wizards.com/2019/eld/en_eRI78mGSMw.png)
...
![Flaxen Intruder Alt](https://media.wizards.com/2019/eld/en_oSL3ssptHT.png)


Additionally, the planeswalkers in the set can also be opened in special borderless versions:


![Garruk, Cursed Huntsman](https://media.wizards.com/2019/eld/en_rteroLztQE.png)![Garruk, Cursed Huntsman Alt](https://media.wizards.com/2019/eld/en_FqHA3ZW64F.png)


Absolutely stunning. And just wait until you can hold them in your hands!


If you want more details on where and how you can find these beautiful cards, please take a look at [Mark Rosewater's article introducing everything](https://magic.wizards.com/en/articles/archive/making-magic/project-booster-fun-2019-07-20).
...
*Throne of Eldraine* has a few new mechanics to cover. I've mentioned some of them above already, but for a more in-depth look, check out the [mechanics article](https://magic.wizards.com/en/articles/archive/feature/throne-eldraine-mechanics-2019-09-04) (or the [release notes](https://magic.wizards.com/en/articles/archive/feature/throne-eldraine-release-notes-2019-09-20)) which will hopefully answer all the questions you have.
...
So, get the details from your local store, prepare yourself by looking through the [Card Image Gallery](https://magic.wizards.com/en/articles/archive/card-image-gallery/throne-eldraine), and get ready to have fun!
