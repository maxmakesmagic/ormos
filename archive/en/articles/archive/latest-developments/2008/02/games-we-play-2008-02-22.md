...
---
[Link to Wayback Machine](https://web.archive.org/web/20220120211302/https://magic.wizards.com/en/articles/archive/latest-developments/games-we-play-2008-02-22)

[_metadata_:author]:- "Mike Turian"
[_metadata_:description]:- "Oh hello! I'm Mike Turian, lead developer of Morningtide. Devin Low continues his trip in Malaysia for one more week, so I have once again been called into action! Bam! In today's article I will be talking about some of the games I have played and relating them back to Morningtide cards. My favorite articles written on this site are by Mark Rosewater. My favorite articles of"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "623376"
[_metadata_:publish_date]:- "2008-02-22"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "The Games We Play"
[_metadata_:wayback_capture_timestamp]:- "2022-01-20 21:13:02"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20220120211302id_/https://magic.wizards.com/en/articles/archive/latest-developments/games-we-play-2008-02-22"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/latest-developments/games-we-play-2008-02-22"
---
...
![NHL '93](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/fcpics/latest/dl25_nhl93.jpg)When I was in high school the Sega Genesis came out. My cousin, Nate Heiss, had owned a Nintendo for years that I loved to play. He wouldn't let go of the controller though so unless we were playing a two-player game I usually was doing more watching than playing.
...
Yes, it turned out that it wasn't quite perfect. We changed the Archdruid from a 3-mana 2/3 to a 5 mana 3/3. We changed his static ability of controlling all lands to a tap ability. [Gilt-Leaf Archdruid](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gilt-Leaf+Archdruid) has been awesome. Druids are the masters of all land.
...
Every time I show Thebes to a new person they love everything about it, except one thing. The game includes this super cool looking "Time Wheel". Each player gets their very own wheel. You can check out a picture of the wheel by [clicking here](http://www.boardgamegeek.com/image/278241).
...
![Stonehewer Giant](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Stonehewer+Giant)
Without a lot of love, patience and care [Stonehewer Giant](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stonehewer+Giant) would have fallen into the category of looks great, but is a disappointment. Originally, [Stonehewer Giant](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stonehewer+Giant) looked something like this:
...
[Stonehewer Giant](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stonehewer+Giant) has a lot of small pieces that are different from his final version. I'll talk about them in the order they were changed. From beginning to end we strived for a card that both looked great and played great.
...
[Stonehewer Giant](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stonehewer+Giant) finally became a warrior with the next change. In *Morningtide* white Giants were considered to be Soldiers. Devin Low built a deck to test [Stonehewer Giant](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stonehewer+Giant). It was red-white with a heavy Warrior theme. The [Stonehewer Giant](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stonehewer+Giant) could fetch one of the best *Morningtide* equipments, [Obsidian Battle-Axe](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Obsidian+Battle-Axe). The problem was that besides his excellent fetching ability the [Stonehewer Giant](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stonehewer+Giant) was an outcast in the deck.


Being a soldier meant that all of the cool warrior effects that the Giants naturally played best with weren't working. We talked with Brady and made [Stonehewer Giant](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stonehewer+Giant) a warrior. The best part is that now [Stonehewer Giant](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stonehewer+Giant) is an awesome combo with the Battle-Axe. [Stonehewer Giant](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stonehewer+Giant) can not only fetch the Battle-Axe but if the Axe is already in play, it snaps on and then [Stonehewer Giant](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stonehewer+Giant) can fetch a second equipment.


During that change we removed the "Equip a soldier" clause and replaced it with the simpler "Equip a creature". *Morningtide* already had a lot of tribal helpers. The [Stonehewer Giant](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stonehewer+Giant)'s job was to help keep equipment awesome. 
...
![Forgeblind Punisher](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/fcpics/latest/dl25_ForgeblindPunisher.jpg)When the serious strategic game-player kicks in I know that I am probably paying too much for his power. I see that another color pays the same amount of mana for a creature with 4 power and much more toughness and part of me wonders which is a better deal.


Another part of me wants to smash with a hammer. I am eager to listen.


![Indomitable Ancients](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Indomitable+Ancients)
...
In that moment [Indomitable Ancients](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Indomitable+Ancients) came to life. We decided that [Indomitable Ancients](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Indomitable+Ancients) looked better as a 4-mana 2/10 after a few tries with [Doran, the Siege Tower](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Doran%2C+the+Siege+Tower). 


I know a lot of people out there are gnashing their teeth right now. To them [Indomitable Ancients](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Indomitable+Ancients) are, as Ken Nagle said, "a rare [Kami of Old Stone](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kami+of+Old+Stone)". To them I say, at least he was good in Limited.


The thing is there are a lot of new players playing **Magic**. These are players who don't understand how the timing of the [Reveillark](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Reveillark)-[Body Double](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Body+Double) combo works or how combat damage goes on the stack. 


Before *Morningtide* was released we sent the rares around the company for different people to rate. During the ratings an amazing thing happened, while [Indomitable Ancients](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Indomitable+Ancients) got a lot of terrible ratings, it also got a lot of fantastic ratings. For every person who disliked "a rare Kami of the Old Stone" there were also the people who rated him really awesome.


Remember back when [Craw Wurm](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Craw+Wurm) was the most badass creature you had ever seen and then I hope you can appreciate what [Indomitable Ancients](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Indomitable+Ancients) means to people.


### Pokémon – Mewtwo Mewtwo!


Last week I asked people to post in the forums any topics they wanted me to talk about. Sanagi posted the cool combo of penny tokens with [Tempest Efreet](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tempest+Efreet) and [Dance of Many](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dance+of+Many). 


A number of posters talked about a Pokémon combo similar to the all [Countryside Crusher](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Countryside+Crusher) and [Mountain](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mountain) deck.
...
1. *Future Sight* (Yes, I'm responsible for [Tarmogoyf](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tarmogoyf). Lead developer)
...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| **1/1 Counters** | **4.37** |  | **Reinforce** | **3.63** |
| 1 | 662 |  | 1 | 1142 |
| 2 | 562 |  | 2 | 964 |
| 3 | 954 |  | 3 | 1052 |
| 4 | 1122 |  | 4 | 1086 |
...
| 7 | 1127 |  | 7 | 586 |
|  |
| **Race matters** | **4.43** |  | **Changeling** | **4.82** |
| 1 | 555 |  | 1 | 469 |
| 2 | 525 |  | 2 | 449 |
| 3 | 878 |  | 3 | 740 |
| 4 | 1246 |  | 4 | 907 |
...
| 7 | 1174 |  | 7 | 1225 |
|  |
| **Tribal cards** | **4.74** |  | **Kinship** | **3.94** |
| 1 | 642 |  | 1 | 795 |
| 2 | 368 |  | 2 | 826 |
| 3 | 664 |  | 3 | 1064 |
| 4 | 980 |  | 4 | 1277 |
