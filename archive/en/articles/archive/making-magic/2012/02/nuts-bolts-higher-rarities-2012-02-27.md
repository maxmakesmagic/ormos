...
---
[Link to Wayback Machine](https://web.archive.org/web/20150402070158/http://magic.wizards.com/en/articles/archive/making-magic/nuts-bolts-higher-rarities-2012-02-27)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "Three years ago, I wrote a little column called `Nuts & Bolts,` where I intended to show off smaller technical issues the designers have to deal with every day. I started with card codes to explain how designers label and keep track of a file."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "352861"
[_metadata_:publish_date]:- "2012-02-27"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Nuts & Bolts: Higher Rarities"
[_metadata_:wayback_capture_timestamp]:- "2015-04-02 07:01:58"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20150402070158id_/http://magic.wizards.com/en/articles/archive/making-magic/nuts-bolts-higher-rarities-2012-02-27"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/making-magic/nuts-bolts-higher-rarities-2012-02-27"
---


Nuts & Bolts: Higher Rarities
=============================
...
Three years ago, I wrote a little column called "[Nuts & Bolts](http://www.wizards.com/Magic/magazine/Article.aspx?x=mtg/daily/mm/21)," where I intended to show off smaller technical issues the designers have to deal with every day. I started with card codes to explain how designers label and keep track of a file. Certain readers were very fascinated by the idea of a card file, so the following year I wrote an article explaining [the concept of the design skeleton](http://www.wizards.com/magic/magazine/Article.aspx?x=mtg/daily/mm/78), a tool used by designers to create the initial file.


![](https://media.wizards.com/images/magic/daily/mm/mm184_hacker.jpg)
Magical Hacker | Art by [Doug Chaffee](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+[%22Doug+Chaffee%22])


It was clear that this subset of readers was very interested in how to make their own design skeletons, so the next year I wrote a column about [filling in the design skeleton](http://www.wizards.com/magic/magazine/article.aspx?x=mtg/daily/mm/132). While the "Nuts & Bolts" columns have drifted slightly from my original intent, it's clear that having a series of "how we make card files" columns has enough support that I've chosen to write a new one every year. That means today's column continues with everything I talked about in the first three. If you haven't read them, I strongly urge you to, because this column will assume you have. Okay, let's continue making a card file.


### Previously, in Nuts & Bolts


[Last year](http://www.wizards.com/magic/magazine/article.aspx?x=mtg/daily/mm/132), I talked about filling in the design skeleton at common. (And once again, if you haven't read the previous "Nuts & Bolts" columns, I strongly urge you to do so.) This year I'm going to add in a few more issues for common and then I'll talk about filling in the higher rarities.


![](https://media.wizards.com/images/magic/daily/mm/mm184_con.jpg)
Aesthetic Consultation | Art by [Dave Martin](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+[%22Dave+Martin%22])
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Artful+Dodge)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Artful+Dodge) [![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Black+Cat)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Black+Cat)
...
![](https://media.wizards.com/images/magic/daily/mm/mm184_mystic.jpg)
Mystic Retrieval | Art by [Scott Chou](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+[%22Scott+Chou%22])
...
![](https://media.wizards.com/images/magic/daily/mm/mm184_wish.jpg)
Make a Wish | Art by [Howard Lyon](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+[%22Howard+Lyon%22])
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Boneyard+Wurm)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Boneyard+Wurm) [![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Curiosity)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Curiosity)
...
You will want to put the uncommon design skeleton together the same way as the common one. (See [the original design skeleton article](http://www.wizards.com/magic/magazine/article.aspx?x=mtg/daily/mm/78) for how to do this.) The biggest difference will be that you are not starting with a blank slate. Remember that the first category items will help you inform decisions about what uncommon needs to have. As I explained last year, start with what is mandatory and work your way out from there.


![](https://media.wizards.com/images/magic/daily/mm/mm184_brim.jpg)
Brimstone Volley | Art by [Eytan Zana](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+[%22Eytan+Zana%22])
...
> * **Helping Players Win—**One of the things you learn in all-common playtests is that **Magic** needs the ability for large turnovers to happen. Yes, the game can look like it's going your way, but to keep up the suspense there always has to be the chance for the opponent to come back. (This is also known as a "[catch-up feature](http://www.wizards.com/magic/magazine/article.aspx?x=mtg/daily/mm/174).") This can come in the form of board sweepers that clear the battlefield. It can be large creatures that can turn the tide of battle. It can be sweeping effects that help you gain control of the game. The biggest of these come in rare and mythic rare, but you need to have a few in uncommon to make sure that every deck has some chance to turn the game around.
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Alpha+Brawl)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Alpha+Brawl) [![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Creepy+Doll)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Creepy+Doll)
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Evil+Twin)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Evil+Twin) [![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Deadly+Allure)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Deadly+Allure)
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Olivia+Voldaren)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Olivia+Voldaren) [![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Grimoire+of+the+Dead)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grimoire+of+the+Dead)
