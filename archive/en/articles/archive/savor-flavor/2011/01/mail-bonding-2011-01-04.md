...
---
[Link to Wayback Machine](https://web.archive.org/web/20170519040943/http://magic.wizards.com/en/articles/archive/savor-flavor/mail-bonding-2011-01-04)

[_metadata_:description]:- "Shudder off those icicles. Dump that wrapping paper in the mana-powered incinerator. Scour your mind of resolutions. Time's been wasting. We're already five days into 2011—well over one percent of our world's current helio-orbital journey—and we haven't peeped a word about Magic flavor yet."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "191466"
[_metadata_:path_date]:- "2011-01-04"
[_metadata_:publish_date]:- "2011-01-05"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Mail Bonding"
[_metadata_:wayback_capture_timestamp]:- "2017-05-19 04:09:43"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20170519040943id_/http://magic.wizards.com/en/articles/archive/savor-flavor/mail-bonding-2011-01-04"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/savor-flavor/mail-bonding-2011-01-04"
---
...
Shudder off those icicles. Dump that wrapping paper in the mana-powered incinerator. Scour your mind of resolutions. Time's been wasting. We're already five days into 2011—well over one percent of our world's current helio-orbital journey—and we haven't peeped a word about **Magic** flavor yet.
...
> 
> Take [Day of Judgment](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Day+of+Judgment) for example. The original card from *Zendikar* offered a cool little quotation from [Sorin Markov](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sorin+Markov), bringing the turmoil of Zendikar into the game. What story did the reprint in *Magic 2011* offer? Nothing really. Just the original art, the card's function, and a lot of blank space. Would it have been that hard to think of some flavor text to place in all that blank space? [Lightning Bolt](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Bolt) has the same problem. Although both the M10 and M11 versions both do 3 damage to a creature or player, the short little story about the sparkmage on the M10 editions adds so much more to the card.
> 
...
A few cards in **Magic**'s first sets (starting with what we now call Limited Edition Alpha) had no flavor text, even though there was room for it. [Wrath of God](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wrath+of+God). [Lightning Bolt](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Bolt). [Disenchant](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Disenchant). Certain iconic cards had such dramatic, punchy lines of rules text that they were left that way. Flavor text was actually seen as detracting from the overall aesthetics of these dramatic staples. 
...
The pattern stuck. Because of the popularity of the tradition, it was carried through to the modern day. Like real-world quotes (which I talked about [here](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/stf/97)), we still do the no-flavor-text schtick in Core Sets today. The effect can help newer players identify the most basic or famously dramatic effects in the game. And, most of all, some players appreciate the silent power of these italic-less cards. They enjoy the tradition of the centered, flavorless, speaks-for-itself rules text dating back to Alpha, and they enjoy the nod to the classic power of the cards selected for the treatment.

If you regard flavor text as holy, then yeah, you are not going to dig this tradition. But tastes differ, and we try to reward **Magic** fandom in all the different ways it exists. The *Zendikar* vs. ***Magic** 2010*[Day of Judgment](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Day+of+Judgment)s and M10 vs. M11 [Lightning Bolt](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Bolt)s may represent the best of both worlds. In recognition of the differences in tastes, the cards were printed both ways, and you can use whichever appeals to you. When we can do that, we will.

Mountain Man
Mike's query is about that [Mountain](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mountain)-matters planeswalker, [Koth of the Hammer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Koth+of+the+Hammer).

![](https://media.wizards.com/images/magic/daily/stf/stf124_koth.jpg)  
...
![](https://media.wizards.com/images/magic/daily/stf/stf124_axe.jpg)  

> However, although the darksteel itself is completely indestructible, the enchantment which turns the darkiron into darksteel (that is, which makes it indestructible) is not - it can be dispelled (although not by the normal spells which dispel an enchantment). This dispelling is what happens during the sacrifice of a darksteel permanent. The reason that the summoning mage can do this is because he enchanted the item in the first place, and thus he knows how to undo the enchantment. (In the game, one could—if one were sufficiently motivated—sacrifice an enchanted artifact to [Ferrovore](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ferrovore), just as one could so sacrifice a [Darksteel Myr](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Darksteel+Myr).) This flavor-use of enchantment (a behind-the-scenes ensorcelling of an object in order to produce a magic item from a mundane one) is not without precedent. It is fundamentally the same as making an ordinary collar into a [Basilisk Collar](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Basilisk+Collar), an ordinary hammer into a [Behemoth Sledge](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Behemoth+Sledge), or an ordinary sword into a [Deathrender](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Deathrender).
> 
