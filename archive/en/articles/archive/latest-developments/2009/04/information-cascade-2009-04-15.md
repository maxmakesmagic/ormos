...
---
[Link to Wayback Machine](https://web.archive.org/web/20211201013406/https://magic.wizards.com/en/articles/archive/latest-developments/information-cascade-2009-04-15)

[_metadata_:author]:- "Tom LaPille"
[_metadata_:description]:- "Today I have the privilege of introducing Alara Reborn's new mechanic. It's called cascade, and it's spectacularly fun. You may have already seen it on Bituminous Blast from the Visual Spoiler.As with all Magic cards, the shining façade of the final product belies the massive amount of effort that went into producing it."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "187581"
[_metadata_:path_date]:- "2009-04-15"
[_metadata_:publish_date]:- "2009-04-17"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Information Cascade"
[_metadata_:wayback_capture_timestamp]:- "2021-12-01 01:34:06"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20211201013406id_/https://magic.wizards.com/en/articles/archive/latest-developments/information-cascade-2009-04-15"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/latest-developments/information-cascade-2009-04-15"
---
...
Today I have the privilege of introducing *Alara Reborn*'s new mechanic. It's called cascade, and it's spectacularly fun. You may have already seen it on Bituminous Blast from the [Visual Spoiler](/magic/tcg/article.aspx?x=mtg/tcg/alarareborn/spoiler).

![](https://media.wizards.com/legacy//mtg/images/tcg/products/alarareborn/sgr1qw8vrg_en.jpg)  
...
![Matt Place](https://media.wizards.com/legacy//magic/images/mtgcom/authorpics/authorpic_mattplace.jpg)**Matt Place** (lead) – Matt is a former Pro Tour winner and full-time **Magic** developer. Matt also led the development of two other multicolor-themed sets, *Dissension* and *Eventide*, and that made him uniquely qualified to solve the problems that an exclusively multicolored set posed. I learned a lot from watching him work within the restrictions that were placed on him to create a fun set.

![Dave Guskin](https://media.wizards.com/legacy//magic/images/mtgcom/authorpics/authorpic_daveguskin.jpg)**Dave Guskin** – Dave is a full-time web developer at Wizards. He is the driving force behind the [new version](/Magic/Magazine/Article.aspx?x=mtg/daily/arcana/169) of the [Gatherer](http://gatherer.wizards.com) card database and he was also instrumental in the creation of the [Totally Normal Draft Viewer](/Magic/Magazine/Article.aspx?x=mtg/daily/activity/158). Dave spends part of his time in **Magic** Ramp;D helping us with Limited playtests and playing Constructed in the FFL, and he occasionally he serves on set development teams. 
...
![Mike Turian](https://media.wizards.com/legacy//magic/images/mtgcom/authorpics/authorpic_miketurian.jpg)**Mike Turian** – Mike is both a member of the **Magic** Pro Tour Hall of Fame and an experienced **Magic** developer. His lead developer credits include *Future Sight*, *Morningtide*, and *Conflux*, and that experience meant that Mike had no trouble seamlessly jumping onto the *Alara Reborn* team.
...
[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=%5Bcard%5D)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=%5Bcard%5D)This mechanic created tension for the player by showing what was behind door number two and asked if the player wanted that instead of what they had cast. When you cast a spin spell, you might end up playing it, but you might also take the buyout option. 
...
[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=%5Bcard%5D)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=%5Bcard%5D)The "play from your hand" clause solves the problem of spinning into another spin card. However, many people argued that this was not a problem at all. In fact, spinning into another spin card sounded like an incredibly fun thing to do. Many ways to enable this were discussed, but the simplest was to allow the mechanic to only see cards that cost less than the cost of the spell. This had various benefits. One was that it allowed for the dream of enormous spell chains. The second is that it made the template much shorter when written rigorously. It allowed us to delete "from your hand," and it also allowed us to simply say "less" rather than "less than or equal to." Finally, it made the mechanic work cleanly without requiring us to attach a number to it. This was the next version.
...
![](http://wizards.com//mtg/images/tcg/products/alarareborn/t2dzux4tuj_EN.jpg)  
...
![](https://media.wizards.com/legacy//mtg/images/daily/ld/ld34_4dlk0b3226.jpg)  
...
|  |
| --- |
| **Do you follow @[dailymtg](http://twitter.com/dailymtg) on Twitter?** |
...
Twitter is a social networking site that lets people share what they are up to in real time. Through the @[dailymtg](http://twitter.com/dailymtg) Twitter feed, Kelly Digges and Monty Ashley post fun tidbits about day-to-day life inside **Magic** Ramp;D. Sometimes we use it for other things. For example, people who follow the @dailymtg twitter feed received a special bonus preview card last Friday.

![](https://media.wizards.com/legacy//mtg/images/tcg/products/alarareborn/jmuy79o67k_en.jpg)  
...
![](https://media.wizards.com/legacy//mtg/images/tcg/products/alarareborn/fu3s4fawaj_en.jpg)  
We know that not everyone saw those on Twitter, and some may not have seen them at all before now. You can make sure you don't miss any cards by checking the [Visual Spoiler](/magic/tcg/article.aspx?x=mtg/tcg/alarareborn/spoiler). Every card we preview anywhere—such as the preview card in today's [The Week That Was](/Magic/Magazine/Article.aspx?x=mtg/daily/boab/34)—will find its way there!
...
|  |
| --- |
| **What is your favorite preview card so far?**TerminateUnscythe, Killer of KingsSpellbound DragonNemesis of ReasonJund HackbladeKnight of New AlaraSoulquakeThought HemorrhageSages of the AnimaAven MimeomancerBituminous BlastMarisis's TwinclawsPale RecluseEthercaste KnightSphinx of the Steel WindBlitz HellionDefiler of SoulsJenara, Asura of WarLavalancheDragon BroodmotherTime SeiveThraximundarThe five BorderpostsMaelstrom PulseQasali Pridemage |
