...
---
[Link to Wayback Machine](https://web.archive.org/web/20220702170407/https://magic.wizards.com/en/articles/archive/lenticular-design-2014-03-31)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "Over the last few years, I've used a term called `lenticular design.` Each time I've used it, I promised that one day I would write an article all about it, explaining what exactly it is and how design uses it to make Magic a better game. Well, today is that day. If you like articles that dig deep into the nitty-gritty of design, you're in luck, because today I'm going to"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "157806"
[_metadata_:publish_date]:- "2014-03-31"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Lenticular Design"
[_metadata_:wayback_capture_timestamp]:- "2022-07-02 17:04:07"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20220702170407id_/https://magic.wizards.com/en/articles/archive/lenticular-design-2014-03-31"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/lenticular-design-2014-03-31"
---
...
![](https://media.wizards.com/images/magic/daily/mm/2014/mm_wk13_293_cardart_thranlens.jpg)
[Thran Lens](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Thran+Lens) | Art by [L.A. Williams](http://gatherer.wizards.com/pages/search/default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22l.%20a.%20williams%22%5D)


We spent a lot of time solving this problem and the answer to it is what we now call New World Order. [You can read here for the full rundown](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/mm/172), but the short version is we decided to cap the level of complexity at common because beginning players on average buy fewer boosters and thus a great percentage of cards that are relevant to them are common. By making the threshold for complexity at common lower, we were simplifying the game for beginners, and thus lowering the barrier to entry, while still keeping the more advanced cards in the game.
...
![](https://media.wizards.com/legacy/mtg/images/daily/mm/mm188_lenticularkitty.gif)
 


The example I first used when [I introduced the concept of lenticular cards](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/mm/188) to all of you was [Black Cat](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Black+Cat). To a beginner, [Black Cat](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Black+Cat) is a two-mana 1/1 creature that has a nice surprise when it dies (the opponent discards a card). To the experienced player, though, the card is all about the death trigger. The threat of the death trigger influences how the card is played, something the beginner is oblivious to as he or she doesn't yet think about causality of play decisions. (I'll get to this in a minute.)
...
First, a card can use vocabulary that's not understood. A good example here is [Grip of Chaos](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grip+of+Chaos) from *Scourge*:
...
Second, it can have text that is hard to process. [Dead Ringers](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dead+Ringers) from *Apocalypse* is a perfect example:
...
What does [Dead Ringers](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dead+Ringers) do, exactly? If you have two creatures in play, one white-blue and one blue-red, and I cast [Dead Ringers](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dead+Ringers), will it destroy them both? The easiest way to identify this type of complexity is to see how many times a player has to read something to understand it. If the answer is more than once, the card has some comprehension complexity issues.
...
Fourth, the text can be perfectly clear but because the card seems to be doing something you would never want to do, some players will be confused. The classic example of this is the card [One with Nothing](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=One+with+Nothing) from *Saviors of Kamigawa*:
...
First is the subset of cards that affect other permanents on the battlefield. A classic example of this type of board complexity card that many players don't think of as being complex is [Prodigal Pyromancer](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Prodigal+Pyromancer) (and his predecessor, [Prodigal Sorcerer](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Prodigal+Sorcerer))



![Prodigal Pyromancer](http://gatherer.wizards.com/Handlers/Image.ashx?size=small&type=card&name=Prodigal%20Pyromancer&options=)

 


The reason [Prodigal Pyromancer](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Prodigal+Pyromancer) creates board complexity is because in combat he has the potential to change the math of any fight. Because players don't know where he'll be used, they have to take in account each and every case he *may* be used, which makes the math significantly harder. For advanced players, who have learned how to shorthand the combat, adding in the additional factor is much easier and, thus, to many, doesn't seem like a big deal. (It happens to be a big enough deal that we no longer do the card at common. There's more reasons than just that one, but that reason alone is probably enough for the shift.)


Second is the subset of cards that are affected by other permanents on the battlefield. An example of this type of card is [Wayfaring Temple](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wayfaring+Temple) from *Return to Ravnica*.



![Wayfaring Temple](http://gatherer.wizards.com/Handlers/Image.ashx?size=small&type=card&name=Wayfaring%20Temple&options=)

 


This type of card can be hard to track because it requires you to always be aware of other cards on the battlefield. For instance, attacking with [Wayfaring Temple](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wayfaring+Temple) can get complicated when you attack with other creatures and have to factor in the [Wayfaring Temple](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wayfaring+Temple)'s power and toughness after combat has happened.
...
![](https://media.wizards.com/images/magic/daily/mm/2014/mm_wk13_293_cardart_distortinglens.jpg)
[Distorting Lens](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Distorting+Lens) | Art by [Glen Angus](http://gatherer.wizards.com/pages/search/default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22glen%20angus%22%5D)
...
**Comprehension Complexity → Board Complexity → Strategic Complexity**
 
...
What they don't do is make decisions with the creature using the knowledge of the death trigger to determine how to use it. Let's take the following card, [Festering Goblin](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Festering+Goblin), originally from *Onslaught*:
...
An experienced player will make attacking and blocking decisions based on the death trigger. For instance, he or she might use a [Festering Goblin](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Festering+Goblin) to block a 2-toughness creature because the experienced player knows the combat damage from the [Festering Goblin](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Festering+Goblin) plus the -1/-1 effect will kill it. The beginning player, though, doesn't tend to think of the death trigger as a result of blocking, so the idea that you could combine the creature damage with the death trigger effect never occurs to him or her.
...
Both of these cards are 2/2 white creatures from *Tenth Edition* with "enter the battlefield" triggers that sometimes saw play in Limited. One is a good lenticular card while the other is not. [Venerable Monk](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Venerable+Monk) gives you life. The beginning player tends to over-value life, so he or she is quite happy to play it. While the more-experienced player will play [Venerable Monk](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Venerable+Monk) early (or late, if it's relevant to the board), he or she will sometimes choose to keep it in hand if drawn later in the game.
...
![Rescue from the Underworld](http://gatherer.wizards.com/Handlers/Image.ashx?size=small&type=card&name=Rescue%20from%20the%20Underworld&options=)

 


For example, to a beginner, [Rescue from the Underworld](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rescue+from+the+Underworld) from *Theros* has a specific purpose. It very flavorfully reanimates a creature, but to a more-experienced player, it does more than that. For instance, it indirectly flickers a creature. There are many ways in *Theros* Limited to make good use of that ability. It is by hiding extra functionality in a flavorful card that the designer can work in lenticular cards into the design.
...
![](https://media.wizards.com/images/magic/daily/mm/2014/mm_wk13_293_cardart_urzascontactlenses.jpg)
[Urza's Contact Lenses](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Urza%27s+Contact+Lenses) | Art by [David A. Cherry](http://gatherer.wizards.com/pages/search/default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22david%20a.%20cherry%22%5D)
...
As always, I am curious for any feedback for today's article. You can email me, respond in the thread or contact me through any of my social media ([Twitter](https://twitter.com/maro254), [Tumblr](http://markrosewater.tumblr.com/), [Google+](https://plus.google.com/107824009487778543249/posts), and [Instagram](http://instagram.com/mtgmaro#)).
