...
---
[Link to Wayback Machine](https://web.archive.org/web/20160503152823/http://magic.wizards.com/en/articles/archive/feature/prerelease-primer-2003-01-24-0)
...
* Try to play two colors if you can. It is perfectly reasonable to "splash" a third color as long as the mana requirements are not too intense. Splashing black for a [Cruel Revival](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cruel+Revival) is fine. Splashing white for an [Akroma, Angel of Wrath](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Akroma%2C+Angel+of+Wrath) is not.
...
* Make sure you play with some removal (read: black or red cards!). There are a number of creatures like [Sparksmith](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sparksmith), [Wellwisher](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wellwisher), and [Keeper of the Nine Gales](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Keeper+of+the+Nine+Gales) that will dominate the game if you cannot kill them.
