...
Welcome to *Planechase 2012* Preview Week. This week we'll be talking about the new *Planechase* set. Our [feature today](http://www.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/feature/196) by [Mark Gottlieb](http://www.wizards.com/Magic/Magazine/Archive.aspx?author=Mark%20Gottlieb) is going to be talking about how the set got put together, so I thought I'd take a different tack with my column today. I'm going to explore why **Magic** as a game needs so many different worlds. Don't worry, I'm still going to introduce the design team and get in a few preview cards before I'm through.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm196_nj.jpg)*Atlantic City Boardwalk, 1923*
...
I talked about [the design of *Planechase*](http://www.wizards.com/magic/magazine/article.aspx?x=mtg/daily/mm/54) when the first set came out, but let me retrace that story a little as it applies to what I'm talking about. The initial idea behind *Planechase* was recreating something we called Enchant World tournaments, where in the middle of game play the environment of the whole tournament would change by adding enchantment-like effects to all the matches.


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm196_8bmrpbwx63.jpg)Vela the Night-Clad | Art by [Allen Williams](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+%5B%22Allen+Williams%22%5D)
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm196_li5o5wt52i.jpg)Time Distortion | Art by [RK Post](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+%5B%22RK+Post%22%5D)
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm196_6rbnebzwqf.jpg)Krond the Dawn-Clad | Art by [Zoltan Boros](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+%5B%22Zoltan+Boros%22%5D)
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm196_globus.jpg)The current roster of **Magic** designers includes Ken Nagle, Ethan Fleischer, and Shawn Main—all three from one of the two *Great Designer Searches*. But that's not the only *Great Designer Search* alum leading designs. Alexis Janson led the design for next year's *Sinker*set (the codename for the last *Return to Ravnica* set). Finally, *Planechase 2012* is [Mark Globus](http://www.wizards.com/Magic/Magazine/Archive.aspx?author=Mark%20Globus)'s second design lead (his first was ***Magic** 2012*).
...
![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/authorpics/authorpic_kellydigges.jpg)For a long time, [Kelly](http://www.wizards.com/magic/magazine/archive.aspx?author=kelly%20digges) was the editor-in-chief on **DailyMTG.com**. I interacted with him frequently, but it was always about my column or strategies about what to preview or which theme week to run next. In Hollywood, there's a running joke that what every person in the town really wants to do is direct. Well, what Kelly really wanted to do was make **Magic** cards.
...
![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/authorpics/authorpic_daveguskin.jpg)Continuing our theme of people finding their way to R&D from other sections of the company, we come to [Dave Guskin](http://www.wizards.com/Magic/Magazine/Archive.aspx?author=Dave%20Guskin). Dave started out as a programmer for online media. Dave, for example, had his hands on many of the elements of **DailyMTG.com**.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm196_miller.jpg)Here's a little secret we don't talk about much. Wizards of the Coast produces games other than **Magic**. (Sh, don't tell anyone.) While most people have heard of our other "little game," **Dungeons & Dragons**, fewer have heard of a game we made called **Duel Masters**. You see, many years ago, we wanted to get our hands on the next popular trading card game for kids to come out of Japan, so we made our own (I was on the design team, along with Mike Elliott, Charlie Catino, Tyler Bielman, and Andrew Finch).


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm196_kai.jpg)**Duel Masters** has recently gone through a transition, creating an American version of the game called [**Kaijudo**](http://www.kaijudo.com/). I bring this up because [Ryan](http://www.wizards.com/Magic/Magazine/Archive.aspx?author=Ryan%20Miller)'s day job is being the head designer for **Duel Masters** and **Kaijudo**. (And yes, that's the equivalent of what I do for **Magic**.)
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/tcg/products/pc2/6v9xkf46zk_lg.jpg)  
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/tcg/products/pc2/a83np4oye1_en.jpg)For starters, yes, *Planechase 2012* has some new cards with old mechanics—devour, in this case. (Go read [Mark Gottlieb's feature article](http://www.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/feature/196) for more about what's in *Planechase 2012*.) Next, let me explain what many of you are asking right now: "How exactly does this card work?"


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm196_ahv4hmx17y.jpg)Thromok the Insatiable | Art by [Terese Nielsen](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+%5B%22Terese+Nielsen%22%5D)
