...
---
[Link to Wayback Machine](https://web.archive.org/web/20170415043953/http://magic.wizards.com/en/articles/archive/feature/2015-world-magic-cup-preview-2015-12-07)
...
[_metadata_:node]:- "937776"
[_metadata_:publish_date]:- "2015-12-07"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "2015 World Magic Cup Preview"
[_metadata_:wayback_capture_timestamp]:- "2017-04-15 04:39:53"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20170415043953id_/http://magic.wizards.com/en/articles/archive/feature/2015-world-magic-cup-preview-2015-12-07"
...
<https://www.youtube.com/embed/kfym0LH1R7c>
...
[Friday Morning](#FridayMorning) | [Friday Afternoon](#FridayAfternoon) | [Saturday Morning](#SaturdayMorning) | [Saturday Afternoon](#SaturdayAfternoon) | [Sunday](#Sunday)


[Nonstandard Standard](#NonstandardStandard) | [All About Limited](#AllAboutLimited) | [The Contenders](#TheContenders)
...
**Top 8 elimination matches, featuring Unified Standard**
...
| Day 1 Video Coverage | Friday, December 11 | 1 a.m. PT | 4 a.m. ET | 9 a.m. UTC | [Magic Twitch channel](http://www.twitch.tv/magic) |
| Day 2 Video Coverage | Saturday, December 12 | 1 a.m. PT | 4 a.m. ET | 9 a.m. UTC | [Magic Twitch channel](http://www.twitch.tv/magic) |
| Day3 Video Coverage | Sunday, December 13 | 12 a.m. PT | 3 a.m. ET | 8 a.m. UTC | [Magic Twitch channel](http://www.twitch.tv/magic) |
...
* [Gideon, Ally of Zendikar](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gideon%2C+Ally+of+Zendikar)
* [Jace, Vryn's Prodigy](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Jace%2C+Vryn%27s+Prodigy)
* [Shambling Vent](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shambling+Vent)
* [Den Protector](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Den+Protector)
* [Bloodstained Mire](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bloodstained+Mire)
* [Flooded Strand](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Flooded+Strand)
* [Polluted Delta](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Polluted+Delta)
* [Windswept Heath](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Windswept+Heath)
* [Wooded Foothills](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wooded+Foothills)
...
Let's assume for a moment that you solve this problem. You've successfully worked out where Jace and Gideon want to end up, and you've found the optimal configuration for your fetch lands. If you're smart, you've probably already read [Frank Karsten's primer](http://www.channelfireball.com/articles/unified-standard-primer-for-the-world-magic-cup/) about this very subject, and you're comfortable that the three decks you've arrived at are, in fact, the "best" that are available in Unified Standard. Now it's time for part two of this particular puzzle.
...
Puzzle number two is all about Limited. In a sense, it's a mirror of Unified Standard. There, the problem comes with restrictions—all the cards are known, but you get access to less of them than you would at a regular tournament. After all, your PPTQ carload of grinders could *all* play Atarka Red, or [Rally the Ancestors](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rally+the+Ancestors), if you wanted to. In *Battle for Zendikar* Team Limited, the problem is reversed. This time, you've got way *more* choices than usual. In a typical Sealed Deck tournament, you have six boosters to work with to create a single 40-card deck. At first glance, having to make three decks from twelve boosters sounds like a downgrade, but the reality is that having control over where your cards get assigned means that twelve boosters is *vastly* more powerful than two sets of six boosters. It's so much more powerful, in fact, that we can ask the teams to build three decks and expect all of them to be more powerful than a typical single-player Sealed deck. *How much* more powerful is the key question on Friday and Saturday morning at the WMC.


As is so often true with Limited play, *synergy* is a massive deal. For a super-quick, super-dirty definition, synergy is how well cards work together, rather than in isolation. [Serene Steward](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Serene+Steward) lets you spend mana to put a +1+1 counter on a creature. [Stone Haven Medic](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stone+Haven+Medic) lets you tap to gain life. [Serene Steward](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Serene+Steward) is a better card with [Stone Haven Medic](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stone+Haven+Medic) in play, and [Stone Haven Medic](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stone+Haven+Medic) is a better card with [Serene Steward](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Serene+Steward) in play. That's synergy right there.
...
**Allies**—An ability that is all about synergy, anyone who has played any amount of *BFZ* Draft knows how powerful some of the Ally triggers can be, whether that's double strike from [Resolute Blademaster](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Resolute+Blademaster), +2+2 from [Tajuru Warcaller](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tajuru+Warcaller), or menace from [Firemantle Mage](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Firemantle+Mage). In Team Sealed, there can often be a critical mass of Allies. And if you have a large group of cheap Allies, they can actually function as an aggro deck, not just a collection of suboptimal Ally triggers.


![](https://media.wizards.com/2015/images/daily/cardart_BFZ_Tajaru-Warcaller.jpg)


[Tajuru Warcaller](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tajuru+Warcaller) | Art by [Anastasia Ovchinnikova](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22Anastasia+Ovchinnikova%22%5D)


**Eldrazi**—[Bane of Bala Ged](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bane+of+Bala+Ged) and [Ruin Processor](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ruin+Processor), both seven mana. [Breaker of Armies](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Breaker+of+Armies) and [Eldrazi Devastator](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Eldrazi+Devastator), eight mana. [Void Winnower](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Void+Winnower), nine mana. [Desolation Twin](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Desolation+Twin) and [Ulamog, the Ceaseless Hunger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ulamog%2C+the+Ceaseless+Hunger), both ten mana. That's a lot of mana for a lot of Eldrazi beef, and the more they cost, the less likely you are to have played against them in Limited games. In Team Sealed, however, two things are working in the Eldrazi's favor. First of all, green is widely regarded as the weakest color. An Ally deck will likely want two or three green cards ([Tajuru Warcaller](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tajuru+Warcaller), [Tajuru Stalwart](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tajuru+Stalwart), possibly [Tajuru Beastmaster](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tajuru+Beastmaster)), but that's about it. That means that *every* piece of mana acceleration you have across twelve boosters can cram into a single deck. That's [Lifespring Druid](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lifespring+Druid), [Beastcaller Savant](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Beastcaller+Savant), [Kozilek's Channeler](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kozilek%27s+Channeler), and every Eldrazi Scion maker out there.


The second thing going for the Eldrazi is the A-plus-B conundrum. In order for this plan to work, you need a critical mass of acceleration *and* a critical mass of Eldrazi. Usually, at least one of these is missing from a typical Sealed pool. Here in Team Sealed, somebody gets *all* of the Eldrazi, and if a turn-five [Ruin Processor](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ruin+Processor) isn't enough to win the game, there's a good chance that a turn-six [Eldrazi Devastator](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Eldrazi+Devastator) or turn-seven [Void Winnower](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Void+Winnower) will.
...
A team featuring both McLaren and Hayne finished almost dead last in [Nice 2014](http://magic.wizards.com/en/events/coverage/2014WMC). Only one Day Two appearance at WMC—surely it can't go wrong that badly again?


**Croatia**—Stjepan Sučić (captain), Vjeran Horvat, Matija Vlahović, Filip Mrso


They finished a superb fifth place at [WMC Indianapolis 2012](http://magic.wizards.com/en/events/coverage/chinese-taipei-claims-first-world-magic-cup), but were very disappointing last year. Vjeran Horvat and Filip Mrso return from the Nice squad, and Stjepan Sučić has one of the best win rates on the European GP scene. Day Two is a minimum goal.
...
Hungary has a fabulous history of success with three Day Twos, and they were only a topdecked [Rakdos's Return](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rakdos%27s+Return) away from being 2013 Champions. Tamás Nagy and Gábor Kocsis have seven WMC starts between them, and they will expect at least another Day Two.
