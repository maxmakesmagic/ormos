...
---
[Link to Wayback Machine](https://web.archive.org/web/20211026131008/https://magic.wizards.com/en/articles/archive/making-magic/level-headed-2010-05-06)
...
[_metadata_:node]:- "190031"
[_metadata_:path_date]:- "2010-05-06"
[_metadata_:publish_date]:- "2010-05-10"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Level Headed"
[_metadata_:wayback_capture_timestamp]:- "2021-10-26 13:10:08"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20211026131008id_/https://magic.wizards.com/en/articles/archive/making-magic/level-headed-2010-05-06"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/making-magic/level-headed-2010-05-06"
---
...
![](https://web.archive.org/web/20130605230208im_/http://wizards.com/mtg/images/daily/mm/mm90_leveledBottoms.jpg)  
...
Level 0 vs. Level 1
![](https://media.wizards.com/legacy//mtg/images/daily/mm/mm90_dice.jpg)Everyone was on board with creatures "leveling up"—that is, the idea that these creatures would have a level and be able to advance up to higher levels, improving along the way. The idea of leveling is a pretty core gaming concept (I believe introduced by **Dungeons amp; Dragons**, but I could be wrong). As we were trying to tap into resonant areas of an adventure world, leveling seemed ideal. 
...
The level 1 camp argued that we were trying to be resonant and connect with what people already know and to do that we needed to start at level 1. Why? Because just about any game you could name (especially **Dungeons amp; Dragons**, which was the key inspiration for the mechanic) that used leveling started at level 1. Players would just assume creatures started at level 1 and making it level 0 would be counter-intuitive.
...
The real issue was: Which version did the most players correctly interpret when they saw it? Let's take [Knight of Cliffhaven](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Knight+of+Cliffhaven) again as an example.

[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Knight+of+Cliffhaven)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Knight+of+Cliffhaven)  
...
I'm starting to get to the nitty-gritty, but I want to point out that Ramp;D (and graphic design) have to worry about the nitty-gritty. The question here was whether or not the "+" was needed on the number in the third stage. If [Kargan Dragonlord](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kargan+Dragonlord) became an 8/8 flying, trampling, fire-breather at level 8, was it clear that it would always be that, even if it gained levels? The answer was "No, it wasn't clear." **Magic** players have learned to be precise, so if the card said "level 8" it would be taken to mean "exactly at level 8." The "+" was added.

![](https://web.archive.org/web/20130605212917im_/http://wizards.com/mtg/images/daily/mm/mm90_muchoLeveled.jpg)  
Type Lines vs. No Type Lines
...
On the Level
My hope with today's column is that it can give you an insight into all the little details that Ramp;D has to worry about and how each one leads to its own issues. I'm very happy with where the levelers ended up but it was definitely a rocky road to get to the solution.

Join me next week when I finish Part 2 of my look at [Dieter Rams's 10 Principles for Good Design](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/mm/89).
