...
---
[Link to Wayback Machine](https://web.archive.org/web/20160727133732/http://magic.wizards.com/en/articles/archive/making-magic/changing-planes-2012-05-18)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "Welcome to Planechase 2012 Preview Week. This week we'll be talking about the new Planechase set. Our feature today by Mark Gottlieb is going to be talking about how the set got put together, so I thought I'd take a different tack with my column today. I'm going to explore why Magic as a game needs so many different worlds."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "194761"
[_metadata_:path_date]:- "2012-05-18"
[_metadata_:publish_date]:- "2012-05-21"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Changing Planes"
[_metadata_:wayback_capture_timestamp]:- "2016-07-27 13:37:32"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20160727133732id_/http://magic.wizards.com/en/articles/archive/making-magic/changing-planes-2012-05-18"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/making-magic/changing-planes-2012-05-18"
---
...
Welcome to *Planechase 2012* Preview Week. This week we'll be talking about the new *Planechase* set. Our [feature today](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/feature/196) by [Mark Gottlieb](http://archive.wizards.com/Magic/Magazine/Archive.aspx?author=Mark%20Gottlieb) is going to be talking about how the set got put together, so I thought I'd take a different tack with my column today. I'm going to explore why **Magic** as a game needs so many different worlds. Don't worry, I'm still going to introduce the design team and get in a few preview cards before I'm through.
...
![](https://media.wizards.com/images/magic/daily/mm/mm196_mae.jpg)[The Maelstrom](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=The+Maelstrom) | Art by [James Paick](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=+%5B%22James+Paick%22%5D)
...
![](https://media.wizards.com/images/magic/daily/mm/mm196_nj.jpg)*Monopoly* invested in Atlantic City as its setting. While the game has branched out to allow other interests to be the creative center, the core game has never budged. If you want to play traditional *Monopoly*, you're going to be playing in Atlantic City.
...
![](https://media.wizards.com/images/magic/daily/mm/mm196_pan.jpg)[Panopticon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Panopticon) | Art by [John Avon](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=+%5B%22John+Avon%22%5D)
...
![](https://media.wizards.com/images/magic/daily/mm/mm196_min.jpg)[Minamo](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Minamo) | Art by [Charles Urbach](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=+%5B%22Charles+Urbach%22%5D)
...
Enchanting Worlds
I talked about [the design of *Planechase*](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/mm/54) when the first set came out, but let me retrace that story a little as it applies to what I'm talking about. The initial idea behind *Planechase* was recreating something we called Enchant World tournaments, where in the middle of game play the environment of the whole tournament would change by adding enchantment-like effects to all the matches.

![](https://media.wizards.com/images/magic/daily/mm/mm196_8bmrpbwx63.jpg)Vela the Night-Clad | Art by [Allen Williams](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=+%5B%22Allen+Williams%22%5D)
...
![](https://media.wizards.com/images/magic/daily/mm/mm196_li5o5wt52i.jpg)Time Distortion | Art by [RK Post](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=+%5B%22RK+Post%22%5D)
...
![](https://media.wizards.com/images/magic/daily/mm/mm196_6rbnebzwqf.jpg)Krond the Dawn-Clad | Art by [Zoltan Boros](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=+%5B%22Zoltan+Boros%22%5D)
...
![](https://media.wizards.com/images/magic/daily/mm/mm196_globus.jpg)The current roster of **Magic** designers includes Ken Nagle, Ethan Fleischer, and Shawn Main—all three from one of the two *Great Designer Searches*. But that's not the only *Great Designer Search* alum leading designs. Alexis Janson led the design for next year's *Sinker*set (the codename for the last *Return to Ravnica* set). Finally, *Planechase 2012* is [Mark Globus](http://archive.wizards.com/Magic/Magazine/Archive.aspx?author=Mark%20Globus)'s second design lead (his first was ***Magic** 2012*).

By day, Mark is the Senior Producer for **Magic** Ramp;D, which means he oversees all the structure (basically schedules, processes, and personnel) that allows Ramp;D to make **Magic**. Most of my meetings with Mark involve talking about deadlines and resources, but Mark moonlights as a pretty awesome **Magic** designer. I've always enjoyed having him on my design teams, and it's been fun to watch him start to run his own.
...
![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/authorpics/authorpic_KellyDigges.jpg)For a long time, [Kelly](http://archive.wizards.com/magic/magazine/archive.aspx?author=kelly%20digges) was the editor-in-chief on **DailyMTG.com**. I interacted with him frequently, but it was always about my column or strategies about what to preview or which theme week to run next. In Hollywood, there's a running joke that what every person in the town really wants to do is direct. Well, what Kelly really wanted to do was make **Magic** cards.

He used his skill set to create a very unique position in Ramp;D—one that is half editor and half developer. If you keep your eye out for Kelly's name, you'll see it popping up on a lot of supplemental products (*Duel Decks* and such). But part of being in Ramp;D is also participating in design and development teams.
...
![](https://web.archive.org/web/20150914171930im_/http://archive.wizards.com/magic/images/mtgcom/authorpics/authorpic_daveguskin.jpg)Continuing our theme of people finding their way to Ramp;D from other sections of the company, we come to [Dave Guskin](http://archive.wizards.com/Magic/Magazine/Archive.aspx?author=Dave%20Guskin). Dave started out as a programmer for online media. Dave, for example, had his hands on many of the elements of **DailyMTG.com**.

Nowadays, Dave is a member of the **Magic** Ramp;D digital team that's responsible for overseeing the many **Magic** products made for the digital medium. Dave is kept very busy but always finds time for a design or development team or two.
...
![](https://media.wizards.com/images/magic/tcg/products/pc2/6v9xkf46zk_lg.jpg)  
![](https://media.wizards.com/images/magic/daily/mm/mm196_z2bpcuph6s.jpg)Selesnya Loft Garden | Art by [Martina Pilcerova](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=+%5B%22Martina+Pilcerova%22%5D)

Many of you might recognize this mechanic. It's a card I claimed was quite fun ([here](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/mm/81) and [here](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/mm/82)) and also picked as the best design of *Ravnica* block ([here](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/mm/185)). Yes, this plane is [Doubling Season](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Doubling+Season), set, of course, on the very plane the card came from in the first place. What can you do with a [Doubling Season](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Doubling+Season) plane? As [Doubling Season](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Doubling+Season) proved, a *lot* of things.

Here's an idea of what you might be able to do with it in *Planechase 2012*:

![](https://media.wizards.com/images/magic/tcg/products/pc2/a83np4oye1_en.jpg)  
For starters, yes, *Planechase 2012* has some new cards with old mechanics—devour, in this case. (Go read [Mark Gottlieb's feature article](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/feature/196) for more about what's in *Planechase 2012*.) Next, let me explain what many of you are asking right now: "How exactly does this card work?"

![](https://media.wizards.com/images/magic/daily/mm/mm196_ahv4hmx17y.jpg)Thromok the Insatiable | Art by [Terese Nielsen](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=+%5B%22Terese+Nielsen%22%5D)
