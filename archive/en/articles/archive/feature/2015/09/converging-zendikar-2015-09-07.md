...
---
[Link to Wayback Machine](https://web.archive.org/web/20150909214149/http://magic.wizards.com/en/articles/archive/feature/converging-zendikar-2015-09-07)
...
[_metadata_:node]:- "659021"
[_metadata_:publish_date]:- "2015-09-07"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Converging on Zendikar"
[_metadata_:wayback_capture_timestamp]:- "2015-09-09 21:41:49"
...
While a set's design team is responsible for most aspects of the set's structure, themes, and mechanics, occasionally new elements get added later on in the development process. I was on both the design and development teams for *Battle for Zendikar*, so I have a unique perspective on how the set's structure evolved over time. Today, I bring you the story of how the converge mechanic was added to *Battle for Zendika*r, along with an exciting new preview card.
...
![](https://media.wizards.com/2015/images/daily/FEAT20150907_Card-Color-Costs.png)


*[Sunhome Guildmage](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sunhome+Guildmage) **must** be cast with white **and** red mana, [White Knight](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=White+Knight) **must** be cast with white mana, [Boros Guildmage](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Boros+Guildmage) can be cast with **either** white **or** red mana, [Bronze Sable](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bronze+Sable) can be cast with any color of mana.*
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Demonic+Tutor)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Demonic+Tutor) [![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Green+Sun%27s+Zenith)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Green+Sun%27s+Zenith) [![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Collected+Company)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Collected+Company)
...
But wait! Didn't I say Bring to Light lets you cheat past a card's mana cost? Is that really fair to say, when it asks you to be able to produce WUBRG? Well, if you're building a five-color deck to take advantage of other converge cards as well, WUBRG may be easier to produce than say, 1WWW for [Archangel of Tithes](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Archangel+of+Tithes), or even 3WW for [End Hostilities](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=End+Hostilities). Plus, unlike [Green Sun's Zenith](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Green+Sun%27s+Zenith), which always costs you one more mana than the creature itself, Bring to Light offers to find you a five-cost creature and cast it for that same five mana. It can even find instants and sorceries! Oh, and did I mention that [Green Sun's Zenith](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Green+Sun%27s+Zenith) is powerful enough to be banned in Modern?
