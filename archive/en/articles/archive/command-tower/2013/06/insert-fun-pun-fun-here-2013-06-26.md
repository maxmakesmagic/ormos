...
---
[Link to Wayback Machine](https://web.archive.org/web/20211016091426/https://magic.wizards.com/en/articles/archive/command-tower/insert-fun-pun-fun-here-2013-06-26)

[_metadata_:description]:- "Commander is about experiences. While crafting a communal Melek, Izzet Paragon deck is great, and working to tweak it together is solid, the goal of building decks is to create something fun. Firing up to build a new deck comes with plenty of ways to start . But there's more ways to have fun than shortcut to games as quickly as possible. Commander is a communal experience,"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "199341"
[_metadata_:path_date]:- "2013-06-26"
[_metadata_:publish_date]:- "2013-06-27"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Insert Fun Pun Fun Here"
[_metadata_:wayback_capture_timestamp]:- "2021-10-16 09:14:26"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20211016091426id_/https://magic.wizards.com/en/articles/archive/command-tower/insert-fun-pun-fun-here-2013-06-26"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/command-tower/insert-fun-pun-fun-here-2013-06-26"
---


Insert Fun Pun Fun Here
=======================
...
Commander is about experiences. While [crafting a communal](http://archive.wizards.com/Magic/magazine/Article.aspx?x=mtg/daily/ct/249) [Melek, Izzet Paragon](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Melek%2C+Izzet+Paragon) deck is great, and [working to tweak it together](http://archive.wizards.com/Magic/magazine/Article.aspx?x=mtg/daily/ct/251)  is solid, the goal of building decks is to create something fun. Firing up to build a new deck comes with [plenty of ways to start](http://archive.wizards.com/Magic/magazine/Article.aspx?x=mtg/daily/ct/252) . But there's more ways to have fun than shortcut to games as quickly as possible. 
...
![](https://media.wizards.com/images/magic/daily/ct/ct253_thoughtflare.jpg)[Thoughtflare](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Thoughtflare) | Art by [David Rapoza](http://gatherer.wizards.com/Pages/Search/Default.aspx?action=advancedamp;artist=%5B%22David%20Rapoza%22%5D)
...
>  The most fun I have when building a Commander deck is perusing available cards, especially ones about which I didn't know. There are moments when you're scouring your collection with a pile of potential cards off to the side, and you stumble across a card that fits like an absolute glove into what you want to do. Then there are moments when you're running searches on the [Gatherer](http://gatherer.wizards.com/Pages/Default.aspx), and a light bulb appears over your head as you find an obscure card from an obscure set that fills in the last missing piece in your deck.   
> It's moments like those that I love when I'm building a Commander deck. 
> 
> 

 I agree with Oren. I built [a box of nearly every card I would ever want to use in Commander](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/sf/168), and when I have multiple decks all of the cards across decks are still unique. Every time I see new-to-me cards that I find awesome, I add them to the box. 
...
>  My favorite part of building a deck is often putting in cards that are versatile and have unique reactions when paired with other cards. [Mimic Vat](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mimic+Vat) is one of those cards where anything with an ETB effect on it can be bonkers, so including ETB creatures that also neatly work with [Birthing Pod](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Birthing+Pod) just as well. If I can pod into a [Grave Titan](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grave+Titan), then Pod him and imprint him on the [Mimic Vat](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mimic+Vat), I am in heaven. It's these subtle connections that make deck building great. 
> 
> 
...
![](https://media.wizards.com/images/magic/daily/ct/ct253_unfriend.jpg)A deck that you *and your friends* enjoy is the bees knees of Commander. Since it's a social format, ensuring that all sides of the battlefield are having fun is a consideration that's hard to define but easy to understand in action. Players like Jeffery do more than understand there's a balance to be struck, but instead actively seek it out so more games end on a fun note.
...
> 
 ...
 Cards like [Mind's Eye](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mind%27s+Eye) and [Sol Ring](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sol+Ring) are common characters to find in Commander decks, but Dominic points out the obvious: Not every card belongs in every deck. That intrinsic balance, tweaking a few cards to subtly reshape how things will play out, can be rewarding. 
...
>  The best part about building a new Commander deck, like building any **Magic** deck, is exploring a personalized angle to how the deck will play. For example, I just built a five-color "control" deck with [Child of Alara](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Child+of+Alara) as the commander. For me, the best part was adding an indestructible theme (which I haven't seen elsewhere). 
> 
> 
...
Novelty through cards is a well-trod idea covered above. But a novel experience, where things seen independently elsewhere are combined in an unexpected way is a powerful approach to hundred-card decks. Finding a new theme to underpin a deck can be just as exciting as a new card or interaction you've never seen. It's certainly a pleasant feeling when you realize you're heading into unknown territory all your own.
 ...
 But what was, [again](http://archive.wizards.com/magic/magazine/Article.aspx?x=mtg/daily/ct/252), among the most common responses? I'll let Jake's words explain: 
...
> 
 ...
 Of course, the format's namesake is something that's incredibly fun to ponder over! While some colors and combinations have more choices, and some available choices aren't the most exciting or reasonable to work with, even [the most challenging and unintuitive commanders find interesting homes](http://www.gatheringmagic.com/jules-robins-commander-edh-brewing-03112013-prodigious-projects/). Each commander has the potential to excite someone, and as we continue to add more, the potential for pleasure continues to rise. 

Commander's called that for good reasons.

Elemental Questions
 We're in for a little schedule change with Command Tower next week. I'm going to move out [last week's prompt](http://archive.wizards.com/magic/magazine/Article.aspx?x=mtg/daily/ct/252) responses one week since next week is time for **Magic** 2014 previews! What this does give us is a narrow opportunity to run a prompt that won't have responses provided right away. 

This time you'll be asking the questions.

 Commander, as a format, is managed by the Commander Rules Committee. One of the features promised in [my first Command Tower article](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/ct/241)  was interviews with members of the Rules Committee. That time is soon coming. 
...
![](https://media.wizards.com/images/magic/daily/footers/slice1.jpg)![](https://media.wizards.com/images/magic/daily/footers/boros_02.jpg)![Adam Styborski](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/authorpics/authorpic_adamstyborski.jpg) **Adam Styborski**[@the\_stybs](https://twitter.com/the_stybs)[Email Adam](/company/emailtoauthor.asp?author=Adam%20Styborskiamp;amp;headline=%5BINSERT%20HEADLINE%5D "Click to send email to the author.") | [Author Archive](/Magic/Magazine/Archive.aspx?author=Adam%20Styborski)[Serious Fun Archive](/Magic/Magazine/Archive.aspx?tag=Serious%20Funamp;description=Serious%20Fun) |  
