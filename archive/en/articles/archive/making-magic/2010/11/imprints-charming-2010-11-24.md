...
---
[Link to Wayback Machine](https://web.archive.org/web/20220630160248/https://magic.wizards.com/en/articles/archive/making-magic/imprints-charming-2010-11-24)
...
[_metadata_:node]:- "191236"
[_metadata_:path_date]:- "2010-11-24"
[_metadata_:publish_date]:- "2010-11-29"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Imprints Charming"
[_metadata_:wayback_capture_timestamp]:- "2022-06-30 16:02:48"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20220630160248id_/https://magic.wizards.com/en/articles/archive/making-magic/imprints-charming-2010-11-24"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/making-magic/imprints-charming-2010-11-24"
---
...
> 
> **The card has a built-in effect that Ramp;D does not typically put at common.** My example for this guideline would be Jonathon Loucks' living reflection mechanic. It makes use of copy effects. Can you think of the last time you saw a copy effect at common? If we're unwilling to put a single one-of card at common, we're not willing to put an entire mechanic that uses it at common. (Note I *am* a fan of this mechanic, it just doesn't have any place at common—well, at least if it's planning to copy things.)
> 
> **The mechanic messes around with an aspect of the rules that has a page or more of notes in the comp rules.** My example for this guideline is Jonathon Loucks' living reflection mechanic again. If you've never read the comp rules write-up on copy effect, click [here](http://archive.wizards.com/magic/comprules/MagicCompRules_20101001.txt) and search for "706. Copying Objects". As you can see, it's over a page.
> 
...
We wanted to keep the mechanic feeling special, so we made the choice to not put it at common because we wanted the feeling that this mechanic, well, wasn't common. We wanted to create some "splash" (Ramp;D slang for having an appeal above and beyond the card text). 
...
[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Soul+Foundry)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Soul+Foundry)  
