...
---
[Link to Wayback Machine](https://web.archive.org/web/20220118022705/https://magic.wizards.com/en/articles/archive/feature/akroma-vanguard-not-just-beatdown-anymore-2006-06-15)
...
Akroma Vanguard: Not Just for Beatdown Anymore?
===============================================
...
Let me start this by saying thank goodness that the awesome Akroma won the You Decide! Legends contest and got her own theme week. That made it easy for me to do a ***Magic** Online*-oriented Akroma piece, since Akroma happens to be a [Vanguard](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=magic/magiconline/vanguard) avatar, and a mighty fine one indeed! What if the awesome Top 4 competitor [Reya Dawnbringer](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Reya+Dawnbringer) had won? I suppose I could have stretched things by doing an Angel Tribal Wars deck or something... Akroma (and those of you who voted) saved us all from that fate.
...
I decided to think about creatures that are interesting, fun and just *barely* on the wrong side of being playable or competitive. Tacking on two extra abilities, most of which are really good, good push them into the realm of ridiculous. At least, that was my hope. Outside of ridiculous creatures like Meloku and Keiga, blue creatures tend to fit the bill, and I toyed around with Moonfolk and Wizards ([Daring Apprentice](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Daring+Apprentice) with haste!). [Shape Stealer](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shape+Stealer) seemed cool, and the already decent Ninjas could get flat out nuts with flying and haste. [Clone](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Clone) could improve upon the best creature your opponent had, and I also kept wanting to dip into Simic's Graft territory, since gaining +1/+1 counters along with other special abilities is bound to be fun. Sadly, this path was violating my basic premise of staying away from “already really good” creatures, since the Simic dudes are mostly an efficient lot.

### Can't Keep a Mediocre Man Down

![Might of the Nephilim](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Might+of+the+Nephilim)Looking over the *Dissension* spoiler for new cards to play with, I made note of a good number of cards that screamed “Nephilim!!” One even used flattery in its title, “[Might of the Nephilim](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Might+of+the+Nephilim)” to get attention. Two mana, +8/+8 at instant speed—how can you resist? Top off with a [Psychotic Fury](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Psychotic+Fury) for double strike, that's some serious damage!Wait a minute; didn't I just go down the [Nephilim road in my Emperor games](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/bs59) not too long ago? Actually, the focus of the deck wasn't so much all the Nephilim as it was [Ink-Treader Nephilim](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ink-Treader+Nephilim) (alongside Niv-Mizzet and other fun goodies). I also ran the [Nephilim recently in a Prismatic deck](/en/articles/archive/nephilim-are-prismatastic-2006-04-27). However, the more I thought about it, the more I thought a Standard Nephilim deck, running a full boat of the weird and wacky creatures, fit my criteria perfectly. The Nephilim can do some wacky and powerful things, but there's no denying that they need some help to be considered competitive-level good. Enter Akroma to staple two more abilities to their text. The life boost would also allow me a little time to get them into play. Perfect!

### Five Color Green

Of course, now I had the practical concern of how to build a five-color deck that could consistently cast any of the Nephilim I happened to have in my hand on turn 3 or 4. *Dissension*'s [Pillar of the Paruns](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pillar+of+the+Paruns) was a godsend of course. Green has tons of mana fixing, so I debated the usual suspects: [Sakura-Tribe Elder](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sakura-Tribe+Elder), [Farseek](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Farseek), [Birds of Paradise](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Birds+of+Paradise), and [Kodama's Reach](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kodama%27s+Reach). *Dissension* also had [Utopia Sprawl](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Utopia+Sprawl), which was certainly intriguing. 

After much soul searching, I decided I would run all four green/x dual lands from *Ravnica* block since they were Forests and could be enchanted with [Utopia Sprawl](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Utopia+Sprawl), and they would allow me to cast [Farseek](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Farseek) on turn 2. Running 4 Pillars gave me 20 lands, and I ended up deciding to try four [Tendo Ice Bridge](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tendo+Ice+Bridge)s on top of that.

I shuffled up and ran a few test games. Two things quickly became apparent: The green/x duals, [Utopia Sprawl](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Utopia+Sprawl), and [Farseek](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Farseek) combination was fantastic, but the Ice Bridges were horrid. Twenty four of my spells had no colorless component to their mana cost, so once I used the Ice Bridge token for colored mana, they were often useless. This coupled with the Pillars occasionally being not so helpful took me back to the drawing board. Ultimately, I decided to swap them out for one each of non-Forest basic lands.

Running a few more test games, the mana worked out great! I was consistently playing a Nephilim on turn 3, and the abilities tacked on were proving to be quite helpful. The one glitch was my Nephilim gaining protection from red when I was holding a [Psychotic Fury](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Psychotic+Fury). I hated to ditch them, but the deck was marginal enough already that I didn't want to draw blanks. I ended up swapping them out for [Crime // Punishment](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Crime+%2F%2F+Punishment), which seemed like a great option for utility. 

![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/fcpics/aether/bs65_akroma1.jpg)Did some more playtesting and had some great results in the casual room, especially if my opponent happened to be playing red or black creatures. In this one game against drunken\_wookie (great screen name, by the way), he worked hard to keep me from drawing cards from Glint-Eye, and ended up killing it with [Putrefy](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Putrefy), but then I drop Yore-Tiller next turn, he gets haste and attacks, putting Glinty back into play attacking. Whoo-hoo!!

![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/fcpics/aether/bs65_akroma2.jpg)After playing more games in the casual room, I start to feel more and more confident in the deck. It just keeps winning! I decide to check to see if there are any 2x Standard Vanguard tournaments coming up, and sure enough one starts in 5 minutes! I suddenly realize I have no sideboard, so I scramble to put one together and sign up in time to jump in. This is what I played:
...
#### Akroma Nephilim, by Bennie Smith
...
Most of you familiar with the more competitive Vanguard decks can guess how I fared with this deck: I got annihilated! I get schooled by a Loxodon Hierarch/Zubera deck (with [Shirei, Shizo's Caretaker](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shirei%2C+Shizo%27s+Caretaker)), I get crushed by a Nekrataal/[Glimpse of Nature](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Glimpse+of+Nature) deck in two quick games, and then lose a hard-fought battle against Rumbling Slum Zoo beatdown.

I think it's pretty clear that Akroma Nephilim is a fun casual deck that needs to stay out of the PEs! If you're looking for a more “standard” competitive Akroma deck, check out the one that [won the 4x back in February here by Patariba](/en/articles/archive/bat-flapping-tribal-beat-2006-02-16).

One last [Vanguard](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=magic/magiconline/vanguard) note: if you're a fan of Momir **Magic** (I talked about it [here](/en/articles/archive/kiki-ing-ffa-2006-06-01)), you'll not want to miss Brian David-Marshall's column tomorrow!

### Adepts: Making the Game Fun (part 2)

Last week, we [kicked off a big interview with Kevin Boris](/en/articles/archive/adepts-making-game-fun-2006-06-08) regarding the Adept team. This week, we wrap up his interview, and present some Q&A with two well-known Adepts.
...
![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/fcpics/aether/bs65_bribery.jpg)***ITA**: Are you able to replay games and see what happened and what was typed?*  
...
To finish up our overview on Adepts and the things they do, Kevin rustled up two team members to give us their “Adept-eye” view of doing the job, Adept\_Sentinel and Adept\_Gnome. 

![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/fcpics/aether/bs65_adept.jpg)***ITA**: Give us your vitals: name, age, where you live, what you do for a living, astrological sign, screenname and password, etc. (heh, just kidding on that last part)*
  
**Adept\_Sentinel**: My name is... wait! I am not allowed to say, unfortunately. My personal information is kept secret to thwart possible disgruntled players from taking revenge or friends requesting special treatment should they violate the Code of Conduct.   
**Adept\_Gnome**: It's true: We're limited in what we can say about ourselves. I'm 29 years old, and my background is in computer programming.
...
**AG**: In August 2002, I was a know-it-all and wanted to show off my knowledge.   
 Nowadays I think I know “just enough”. Adept work has since fostered a love in people and Psychology. I am a strong believer in [Responsibility Assumption](http://en.wikipedia.org/wiki/Responsibility_assumption), which means that I over-explain everything - even answers like this!
...
**AG**: Adepts work from home - expect pink bunny slippers and a caffeinated drink on a guy or gal that handles 3 rooms at a time. We maintain a few reports as well. Over time, folks will come in for every server state, card combo, or player complaint, so it helps to research answers ahead of time! We have a program that stores our best-typed answers (they're called macros), so you needn't feel bad about asking us to repeat ourselves.  
 As for the paparazzi …. Ehhhh, haven't seen any. What could they tell us that [www.wizards.com](http://www.wizards.com) journalists don't?
...
**AG**: When I play, it's usually in Leagues around Release Events. I am a “[Timmy-Johnny-Vorthos](/en/articles/archive/making-magic/timmy-johnny-and-spike-revisited-2006-03-20-0)”.
...
**AG**: Yes. I learned of the Sixth Edition changes from player's questions. Actually, I'm still learning things that way. Did you know you could kill a creature with [Cytoshape](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cytoshape)?
...
**AS**: Certainly, friendliness and knowledge of the program are preferred. If you enjoy playing **Magic** and consider helping people to be worthwhile, then by all means submit an application (when they are being accepted; [you can go here](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=magic/magiconline/moderation)).  
...
**AS**: There is no such thing as an Invisible Adept. waves hand  
**AG**: Come now, Bennie … this is **Magic**, not Solitaire. Ah-h! Put the [White Knight](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=White+Knight) on the [Sliver Queen](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sliver+Queen). There. Perfect.
...
Programmer extraordinaire [Rachel Reynolds](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/jm68#rachel) is back with some more behind the scenes stories of the trials and tribulations of a ***Magic** Online* programmer. 
...
![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/fcpics/aether/bs65_guildmage.jpg)
> 
...
> Pure/Copper Tablet  
>  Hit/Conservator  
>  Rise/Clockwork Beast  
>  Trial/Chaos Orb  
>  Supply/Celestial Prism  
>  Bound/Black Vise  
>  Odds/Black Lotus  
>  Crime/Basalt Monolith  
...
> 
> ![Experiment Kraj](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Experiment+Kraj)“[Experiment Kraj](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Experiment+Kraj) was the card in *Dissension* I figured was the hardest to program, and I saved it for last. Initially, I got it to gain all the abilities, but it never lost them if the creature it gained them from left play or lost its counter. I then tried resetting the abilities each time the legal actions for the card were calculated, and in doing so I erased the ability to put [Experiment Kraj](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Experiment+Kraj) into play, so you could never cast it at all. I then put in code to make sure it kept its initial abilities, and could play [Experiment Kraj](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Experiment+Kraj) again, but it still wasn't losing the abilities from creatures that left play. It turned out that it was considering the cards to still have their counter after they left play and I had to make sure I was only looking for cards in the correct zone (when a card moves to a new zone, it is put into a zone called “limbo” that isn't displayed, and a new copy is created in the zone the card is moved to, I had to make sure that [Experiment Kraj](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Experiment+Kraj) wasn't gaining abilities from cards that were in limbo).
>  

  

> 
> “When I initially programmed [Infernal Tutor](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infernal+Tutor), it had a check for what to do if you had no cards in hand and another check for what to do if you had cards in hand. However, the check for no cards in hand was first. So if you had no cards in hand, it would let you search your library for a card and put it into your hand. Then it would check and see that you had cards in hand, and it would let you do the other part too…”
> 
> 
> 
