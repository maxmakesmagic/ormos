...
---
[Link to Wayback Machine](https://web.archive.org/web/20161013152846/http://magic.wizards.com/en/articles/archive/latest-developments/kill-planeswalker-2009-01-08)

[_metadata_:author]:- "Tom LaPille"
[_metadata_:description]:- "*/ As you may recall, Latest Developments was in flux for the latter part of last year, with a rotating crew of authors from the development team. I'd like to take this opportunity to thank Ken Nagle, Bill Stark, Mike Turian, Matt Place, Erik Lauer, and Tom LaPille for sharing their different views and stories about Magic development. Now, it's my pleasure to announce that Tom has stepped up to write the column on a weekly basis."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "186981"
[_metadata_:path_date]:- "2009-01-08"
[_metadata_:publish_date]:- "2009-01-09"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "To Kill a Planeswalker"
[_metadata_:wayback_capture_timestamp]:- "2016-10-13 15:28:46"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20161013152846id_/http://magic.wizards.com/en/articles/archive/latest-developments/kill-planeswalker-2009-01-08"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/latest-developments/kill-planeswalker-2009-01-08"
---
...
Previous Latest Developments columnists have often shown you examples of how we develop individual cards. For example, my predecessor Devin Low wrote [an entire column](/magic/magazine/article.aspx?x=mtg/daily/ld/18) about the journey of just one card from design to print. However, we develop in broader strokes too. We often think about entire mechanics, sets, and blocks. We also think about what's best for the game as a whole. For example, we recently spent time thinking about whether printing a card with the line "Destroy target planeswalker" on a card would make **Magic** more or less fun.

Allow me to elaborate. Many games of **Magic** are essentially fights between armies of creatures and spells that support them. However, variety is hugely important to how fun a game is over the long term, and one of the reasons **Magic** is awesome is that it can produce strange situations that challenge players of any experience level. In fact, we deliberately make cards that produce those situations to keep players interested. For example, we might make [a card that lets you use your cards' "comes into play" abilities over and over](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=a+card+that+lets+you+use+your+cards%27+%22comes+into+play%22+abilities+over+and+over), or [a card that turns direct damage effects into card drawing](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=a+card+that+turns+direct+damage+effects+into+card+drawing).
...
|  |  |
 ...
 Here in **Magic** Ramp;D, we try to make sure that there are adequate answers to anything powerful you might encounter so that you don't get stuck without a way to deal with a power card or combination. On a very basic level, we make lots of cards that target card types. Are you losing to your friend's enchantment deck? There are 18 cards in Standard that can destroy enchantments, including more than one that takes care of every enchantment in play. Artifacts got you down? There are a total of 18 cards in Standard that destroy artifacts. We also make cards that interact with specific zones. A new player might experience some bewilderment when they encounter their first opponent who is abusing the graveyard with reanimation spells or dredge cards, but a little searching will turn up [Relic of Progenitus](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Relic+of+Progenitus), [Beckon Apparition](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Beckon+Apparition), [Faerie Macabre](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Faerie+Macabre), [Heap Doll](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Heap+Doll), and various other cards they can use to interact with their opponents' graveyards. Finally, we print cards that attack more abstract strategies. Is your opponent trying to kill you by playing a lot spells in one turn? [Rule of Law](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rule+of+Law) will stop them in their tracks. 

 We really like to print answer cards like [Naturalize](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Naturalize), [Relic of Progenitus](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Relic+of+Progenitus), and [Rule of Law](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rule+of+Law). They aren't subtle, but when you really need an answer to something and you're desperate, it's much better if we can give you an obvious answer so the search isn't difficult and you find what you need. Sometimes, however, we do print more subtle answers. [Stifle](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stifle) was placed in *Scourge* as an answer to storm. Unfortunately, making the connection that [Stifle](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stifle) is good against storm cards requires some sophisticated rules knowledge. Specifically, one needs to know that storm creates a triggered ability, or be able to figure that out from the storm reminder text. Happily, players identified [Stifle](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stifle) as a storm answer and adopted it en masse, and the card is now a staple in both Extended and Legacy. 
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Elspeth%2C+Knight-Errant)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Elspeth%2C+Knight-Errant) The game-play benefits to printing "destroy target planeswalker" are obvious. It isn't any fun when you encounter something really powerful that you don't know what to do with, and printing a card that just up and kills planeswalkers is a great way to give people an answer to them. Why, then, do we not just print that? 
 ...
 It is not surprising that the various denizens of the Magic Ramp;D "Pit" turned one developer's joke about printing "destroy target planeswalker" into a large and very serious discussion. I can't share the results of that discussion, but happily that is because it isn't over. In fact, we'd love to hear what you think! 



|  |
| --- |
| **Should we be willing to print "destroy target planeswalker" despite the flavor issues?**Yes. Having explicit answers to planeswalkers is important.No. The costs to flavor outweigh the game-play benefits.I don't care. |
