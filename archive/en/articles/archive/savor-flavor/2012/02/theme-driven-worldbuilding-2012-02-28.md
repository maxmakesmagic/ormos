...
---
[Link to Wayback Machine](https://web.archive.org/web/20210304035130/https://magic.wizards.com/en/articles/archive/savor-flavor/theme-driven-worldbuilding-2012-02-28)

[_metadata_:description]:- "I got this email from reader Josie that really got my gears turning. Those gears that began turning happened to be attached to huge, heavy floodgates I generally use to keep myself from blabbing forever about worldbuilding and everything we do to create settings for Magic. So if today's article contains too much hyperspecific sausage-factory detail for you, blame Josie and her"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "194106"
[_metadata_:path_date]:- "2012-02-28"
[_metadata_:publish_date]:- "2012-02-29"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Theme-Driven Worldbuilding"
[_metadata_:wayback_capture_timestamp]:- "2021-03-04 03:51:30"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20210304035130id_/https://magic.wizards.com/en/articles/archive/savor-flavor/theme-driven-worldbuilding-2012-02-28"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/savor-flavor/theme-driven-worldbuilding-2012-02-28"
---


Theme-Driven Worldbuilding
==========================
...
How far in the future do you develop Magic worlds?
Pretty far. Years. Typically, by the time you're opening a booster pack of an October set, **Magic**'s creative team (of which I am one of the writers) is already largely done fleshing out the *next* setting after the one that's out. That's just the time frame that makes all the schedules work. The worldbuilding has to get done in time for the world guide (also known as the style guide) to be completed, the world guide has to get done in time for the artists to use it as a reference for their art assignments that will illustrate the cards, the art has to get done in time to get laid out on the cards, the cards have to get done in time for them to be printed and distributed, and the printing and distribution have to get done in time for you to bust packs of that set at the Prerelease. If we didn't work on the worldbuilding that far out, the pipeline would break down and we couldn't make all the moving parts of this crazy machine come together on time.

![](https://media.wizards.com/legacy/mtg/images/daily/stf/stf184_sight.jpg)[Future Sight](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Future+Sight) | Art by [Matt Covatta](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=+%5B%22Matt+Covatta%22%5D)

Meanwhile, during that same time frame, we've *also* already begun making preparations and early explorations for the next setting after *that*. Straddling settings like this can be a challenge; it is an exercise in permanent secrecy and routine mental compartmentalization. While Ramp;D members are discussing *Innistrad* and *Dark Ascension* on this website, our brains are already plump with information about the freaking cool settings for the next couple of years. It's a *Twilight-Zone*-worthy scenario: we have all the advantages of time travelers from the future, *except* that we can't actually discuss anything we know—which is basically all of the advantages of being time travelers from the future—and everything we can talk about publicly, the cards and worlds that are out now, is all work that occurred two years in our past. Suffice it to say: Cool stuff! Is coming! And we'll talk about it later!

Beyond the two next settings that are constantly under way, we usually have a few fragile inklings about what might be coming along even further out than that, based on what flavor or mechanical themes are in plan for the future. Beyond a couple of years out, though, things are very tentative and are subject to change. We know those far-future plans could be radically altered or completely scrapped at any time, but it's still useful to let those ideas percolate for when the time comes. Having an idea of what might be coming down the road later can help you make aesthetic decisions about what you're working on presently, to help make sure that settings feel sufficiently different from each other. For example, we gave vampires on Mirrodin a very particular visual shtick ([syringe fingers](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/stf/134)) because we knew we would want to distinguish them from, more importantly, the look of vampires of Innistrad ([Sorin-inspired dark scleras](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/stf/167)).
