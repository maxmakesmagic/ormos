...
---
[Link to Wayback Machine](https://web.archive.org/web/20200902204918/https://magic.wizards.com/en/articles/archive/feature/core-set-2021-prerelease-primer-2020-06-22)
...
[_metadata_:node]:- "1503831"
[_metadata_:publish_date]:- "2020-06-22"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Core Set 2021 Prerelease Primer"
[_metadata_:wayback_capture_timestamp]:- "2020-09-02 20:49:18"
...
Core Set 2021 Prerelease Primer
===============================
...
*Core Set 2021* is knocking on the door, and it's one of the most stuffed-with-goodness core sets of all time. Whether you're kicking off your *Magic* journey, coming back to the game, or currently a stalwart player, you'll find plenty of cards worth playing.


With powerful reprints like [Ugin, the Spirit Dragon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ugin%2C+the+Spirit+Dragon) to new takes on old friends like Barrin, Tolarian Archmage, or even just adorable pets like Pack Leader (hello, Dogs!), *Core Set 2021* is a head-turner.


So, what's the best way to check it out?


The Prerelease of course!
...
If you'd prefer watching to reading, you can find me walking through a lot of this in video form here:


<https://www.youtube.com/embed/r_xjcTq7UMc>


Or, if you're a reader, keep on scrolling


Let's run through it today!
...
If you're a Sealed Deck veteran, you may want to skip ahead to the next section, where I talk about what you can expect for *Core Set 2021*. But if you're new to the world of Sealed Deck, or are maybe just looking for a few extra pointers, read on!
...
And if you're not able to get to a local store for any reason, you can still play on *Magic: The Gathering Arena*! (And if you're still learning, even better, as *MTG Arena* is excellent for new players!) They have Sealed events starting June 25, and the play experience is still the same, great *Magic*. It's a great time to try out *MTG Arena* if you haven't already.


Okay now, let's see. You have a store selected, and you've taken a look at all the awesome cards in the [*Core Set 2021* Card Image Gallery](https://magic.wizards.com/en/articles/archive/card-image-gallery/core-set-2021).
...
![Box](https://media.wizards.com/2020/images/daily/en_NmGfB5n0SV.png)


Inside, you'll get six *Core Set 2021* boosters . . . plus, a random stamped rare or mythic rare card as your Prerelease foil that could be any rare or mythic rare in the set!
...
![Everything you get inside](https://media.wizards.com/2020/images/daily/en_ggQHD09DAX.png)


Excellent! Plenty of great stuff here.
...
The first thing you're going to want to do is figure out a method to pick which colors you'll be playing. I recommend playing two colors. You can sometimes "splash" for a third color, but generally you'll want to pick two to be your core.
...
First, lay your creatures out in mana-cost order. This helps you see what creatures you're going to potentially be able to cast at each part of the game. (Don't lay your noncreatures out at this point unless they're cards you are planning to play as soon as you have that much mana—for example, you will generally cast a [Quirion Dryad](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Quirion+Dryad) on turn two, whereas [Heroic Intervention](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Heroic+Intervention) isn't usually a turn-two play.)
...
Now that you have your *core* (pun intended) creature base figured out, it's time to add in spells! Pick your favorites among your colors to bring your deck to 22 or 23 cards, and then you're good to go from the spell side.
...
Starting with *Throne of Eldraine*, we debuted our new "booster fun" initiative, putting alternate, tricked-out versions of specific cards into packs. And with *Core Set 2021*, we're bringing that up a notch and putting it all around the set!


You can find that in a few different ways. First of all, the set's main planeswalkers and their associated cards at lower rarities have alternate versions with a special frame for that character.


![Chandra's Magmutt](https://media.wizards.com/2020/m21/en_ZT0LFFLbWx.png)![Chandra, Heart of Fire](https://media.wizards.com/2020/m21/en_RPUqy8rUIB.png)![Liliana's Standard Bearer](https://media.wizards.com/2020/m21/en_7ghGMAGEo5.png)


Each planeswalker's card lineage has its own frame and look!


Additionally, six cards have been handpicked as gorgeous borderless cards, with alternate art to boot!


![Cultivate](https://media.wizards.com/2020/m21/en_8dJp7PhyVB.png)![Solemn Simulacrum](https://media.wizards.com/2020/m21/en_j9dcJBIauw.png)


What's more, the planeswalkers in the set can also be opened in a special borderless version:


![Ugin, the Spirit Dragon](https://media.wizards.com/2020/m21/en_v8HvBdTA1S.png)![Teferi, Master of Time](https://media.wizards.com/2020/m21/en_2llKjkHiQl.png)


They're really spectacular. Either way, you can find these in booster packs. Plus, the extended-art cards continue in the Collector Boosters! They'll look like this:


![Subira, Tulzidi Caravanner](https://media.wizards.com/2020/m21/en_S5NXXEQsmg.png)![Pack Leader](https://media.wizards.com/2020/m21/en_G4pSp3R1bE.png)


If you're curious on anything else about these cards and the variations, check out Mike Turian's article [here](https://magic.wizards.com/en/articles/archive/card-preview/collecting-core-set-2021-2020-06-05).
...
Depending on the setup you and your friends have, there are many ways to do this. Check out my article on playing [*Magic* over Webcam](https://magic.wizards.com/en/articles/archive/feature/playing-Magic-friends-when-you-cant-gather-2020-04-17) for all kinds of tips on setting it up—and with places like Discord, Google Hangouts, and Spelltable.com, it's easier than ever to get a webcam game going.
...
And as a fun extra bonus, in addition to the Buy-a-Box card, if you buy a box, you'll also receive two *Jumpstart* boosters as well! (While supplies last.)


![Rin and Seri, Inseparable](https://media.wizards.com/2020/m21/en_5DpJceE68L.png)


![JMP Boosters](https://media.wizards.com/2020/images/daily/jk6hi4xCIb.png)


This will give you a fun little taste of *Jumpstart*. (For more information on what that is, click [here](https://magic.wizards.com/en/products/jumpstart?source=MX_Nav2020)!)


Leave You Wanting *Core*
========================


This is a wild core set—and I can't wait for you to give it a try, in whatever way you can. (And is safe!) Whether you're playing in a store or just busting packs at home, you'll definitely get excited while opening this set.


If you have any questions at all, feel free to hit me up on Twitter, Tumblr, Instagram, Tiktok, or even by sending an email to [BeyondBasics*Magic*@gmail.com](mailto:BeyondBasicsMagic@gmail.com). I'd be happy to hear from you!


I hope you've enjoyed *Core Set 2021* previews, and whenever you play with the set, have fun!


—Gavin  

Email: [BeyondBasics*Magic*@gmail.com](mailto:BeyondBasicsMagic@gmail.com)  
