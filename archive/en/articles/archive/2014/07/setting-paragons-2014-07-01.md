...
---
[Link to Wayback Machine](https://web.archive.org/web/20141021031200/http://magic.wizards.com/en/articles/archive/setting-paragons-2014-07-01)

[_metadata_:description]:- "Taking a look at a powerful five-card uncommon cycle with a high setup cost. "
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "230266"
[_metadata_:publish_date]:- "2014-07-01"
[_metadata_:source]:- "div-main"
[_metadata_:title]:- "Setting Up the Paragons"
[_metadata_:wayback_capture_timestamp]:- "2014-10-21 03:12:00"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20141021031200id_/http://magic.wizards.com/en/articles/archive/setting-paragons-2014-07-01"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/setting-paragons-2014-07-01"
---
...
Last week's previews garnered many responses on Twitter and via email. People seem excited by the power level of [the cycle of cards we looked at](http://magic.wizards.com/en/articles/archive/magic-2015-week-one-previews-2014-06-25). As well they should be. If you manage to put yourself in the right color pair, those five uncommons pack a big punch.


This week, we are looking at five more uncommons from [*Magic 2015*](/content/magic-2015-core-set-card-set-archive-products-game-info). This cycle—called Paragons—are also quite powerful, but in a different way from the cards we saw last week. How about we take a gander at them all at once, and then discuss afterward?



![](https://media.wizards.com/images/magic/daily/li/2014/oks6753dfs_5_EN.jpg)

Looking at the Paragons, you can see they all share four main traits.


First, they are all 2/2 for four mana. Unfortunately, this does not pass [the Vanilla Test](http://archive.wizards.com/Magic/magazine/article.aspx?x=mtg/daily/eventcoverage/ptrtr12/video15), and is indeed quite far away from doing so. A 2/3 for four mana doesn't even pass, and a 3/3 for four is merely acceptable. Using the Vanilla Test, we have determined that each of these Paragons have some making up to do if we are going to be excited to run them in our 40-card Limited decks.
...
Third, they are all have a static "anthem" effect. (Continuing from last week: anthem effects are called that because of [Glorious Anthem](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Glorious+Anthem). They were also once called "Crusade" effects, from, well, [Crusade](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Crusade)). Two things to note about this particular pump effect:
...
![](https://media.wizards.com/images/magic/daily/li/2014/oks6753dfs_art.jpg)


Paragon of Gathering Mists | Art by [Michael C. Hayes](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+%5b%22Michael%20C.%20Hayes%22%5d)
...
One way to think of it: it's like you are netting one extra mana per creature getting pumped. Generally speaking, it costs a bit more than one mana to get a creature +1/+1. (For an example, compare something like [Grizzly Bears](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grizzly+Bears) and [Nessian Courser](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Nessian+Courser)). If you cast a Paragon and it pumps up three creatures, it's something like getting an additional three mana of value.
...
Be careful. The scenario I just described is one that you want to be aware of while playing, but not one that you want to discourage you from playing such powerful spells. In the risk-versus-reward equation, the Paragons come out on the plus side. They are not without [setup cost](http://archive.wizards.com/Magic/magazine/Article.aspx?x=mtg/daily/li/291), but they do deliver the goods when properly built around.
...
![](https://media.wizards.com/images/magic/tcg/products/m15/sf0JdVsk2/EN_pje55u4cmg.png)
...
![](https://media.wizards.com/images/magic/tcg/products/m15/sf0JdVsk2/EN_ljyxoxtqal.png)
...
Enter Paragon of Open Graves. The activated ability is all the way up to ![](https://web.archive.org/web/20161225105850im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless2.gif)![](https://web.archive.org/web/20161227195556im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/black.gif), and it would matter quite a lot if it could target itself with this ability. Since it costs triple the mana of the other four, we would expect a much better ability. And it does have a better ability than the others, depending on the board state.
...
![](https://media.wizards.com/images/magic/tcg/products/m15/sf0JdVsk2/EN_3nbwlbnp3i.png)
...
![](https://media.wizards.com/images/magic/tcg/products/m15/sf0JdVsk2/EN_rvf8st984o.png)
...
![](https://media.wizards.com/images/magic/daily/li/2014/oks6753dfs_art2.jpg)


Paragon of Eternal Wilds | Art by [Winona Nelson](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+[Winona]+[Nelson])


It's a Setup


I mentioned [setup cost](http://archive.wizards.com/Magic/magazine/Article.aspx?x=mtg/daily/li/291) earlier, and I want to put some perspective around it before I sign off for the day.
