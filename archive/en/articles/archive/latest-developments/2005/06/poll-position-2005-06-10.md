...
---
[Link to Wayback Machine](https://web.archive.org/web/20180323014222/https://magic.wizards.com/en/articles/archive/latest-developments/poll-position-2005-06-10)

[_metadata_:author]:- "Aaron Forsythe"
[_metadata_:description]:- "At the end of each of my columns is a poll. Sometimes these are there just as “talking points.” Other times I include them to help settle an argument here in R&D about what our players like or don't like. Once in a while, the poll is there as a data-gathering device to help us make decisions about what direction some part of the game should go."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "289371"
[_metadata_:publish_date]:- "2005-06-10"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Poll Position"
[_metadata_:wayback_capture_timestamp]:- "2018-03-23 01:42:22"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20180323014222id_/https://magic.wizards.com/en/articles/archive/latest-developments/poll-position-2005-06-10"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/latest-developments/poll-position-2005-06-10"
---
...
> 
> *“Say you activate [Genju of the Spires](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Genju+of+the+Spires), making a Mountain into a 6/1. You then copy that Mountain with Kiki-Jiki's ability. Is the token a 6/1 creature with haste? No.*
> 
> 
...
Looks like most of you are pretty rules-savvy. For those of you that still don't get it, check out section 503 in the *Magic* Comprehensive Rules, specifically Rule 503.2. If you still don't get it, time to write to [Carter](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/authorarchive).
...
![](https://media.wizards.com/legacy/sideboard/images/mi05/sohchamp.jpg)  
...
![](https://media.wizards.com/legacy/global/images/mtgcom_daily_af70_pic1_en.jpg)This particular poll was to settle an argument. At least one other member of R&D was arguing with me that the old Legends Elder Dragons (the ones reprinted in *Chronicles*) were considered cooler by players than the *Invasion* ones. My point was that a large percentage of current players cut their teeth during *Invasion*, and therefore would have great memories of Rith and the gang but no real experience with [Nicol Bolas](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Nicol+Bolas) and his pals. And even if they did, can an 8-mana Dragon with an upkeep cost be cooler than the very playable 6-mana ones from *Invasion*?


The secondary market prices are close—one site has Rith for $6.00 and *Chronicles* [Nicol Bolas](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Nicol+Bolas) for $5.00—so we decided to put it to a vote. We tossed in the other two cycles just to mix it up a bit.
...
![](https://media.wizards.com/legacy/magic/starter/portal/images/portal_ii_mockup.gif)The jury is still out on this decision, but I still think it is a good one. What good are *Magic* cards that can't be played in any format?


One big downside to this decision was that [Imperial Seal](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Imperial+Seal)'s secondary market value went through the roof into the multiple hundreds of dollars range overnight. As one dealer at Pro Tour—Atlanta put it, “It is now a piece of Power.” I only hope now that the card is as good as advertised!
...
Why black came in second here I don't know—I believe it actually turned out to be dead last heading into the release of *Saviors*. Perhaps the allure of [Cranial Extraction](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cranial+Extraction) and [Kokusho, the Evening Star](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kokusho%2C+the+Evening+Star) had visions of Swamps dancing in players' heads.


Red is the real #2 color, with blue coming in third and white in fourth. Hopefully the printing of *Saviors* as well as a few late metagame shifts (black Rats deck, anyone?) will shake the order up in time for [US Regionals](http://archive.wizards.com/Magic/TCG/Events.aspx?x=events/regionals/us) (which is, by the way, the weekend of my birthday—June 25).
...
![Underground Sea](http://gatherer.wizards.com/Handlers/Image.ashx?size=small&type=card&name=Underground%20Sea&options=)
...
I played tons of Arena leagues back in the day, racking up quite a collection of oversized cards. I only went to Friday Night *Magic* once, where I won a very exciting foil [Mind Warp](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mind+Warp). :/
...
There are a lot of good sites out there—personally I'm in the “5-8” camp. Most of you know which are the good ones, so I won't play favorites. I would like to point out a couple little-known gems, however. [UGMadness](http://ww2.wizards.com/Site/LeavingWizards.aspx?url=http://ugm.mana-burn.com&origin=) and [Manascrewed](http://ww2.wizards.com/Site/LeavingWizards.aspx?url=http://www.manascrewed.com&origin=) are indy webcomics about *Magic*. The humor is sometimes a little risqué, and they both take their fair share of shots at R&D and Wizards in general, but I enjoy them. Check them out at your own risk.
...
The results of this poll form a pretty predictable curve with the peak at about $10—the amount most players consider reasonable for a top-end single. The number that leaps out at me is the 500+ of you that have dropped a G on one card. I hope that card was [Black Lotus](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Black+Lotus) every time.


My personal high was $90 for an Unlimited [Ancestral Recall](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ancestral+Recall), a card I will unfortunately be discussing again when we get to the “stolen cards” poll.
...
At a store tournament several years ago, I had a plastic box stolen right out of my backpack. In that box was a Vintage control deck and an Extended “Fruity Pebbles” deck, and this was back when dual lands were legal in Extended. I lost a lot of those things that day, along with a couple [Mana Drain](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mana+Drain)s, a [Black Lotus](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Black+Lotus), three Moxes, a [Library of Alexandria](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Library+of+Alexandria), and the Power Blue. That basically marked the end of my very short Vintage career—in fact, the only card I've bothered to replace of those was the Ancestral, which I used in my 5-Color decks.


I was nailed by another thief at Worlds 2001 where my Extended Secret Force deck was taken. Goodbye [Verdant Force](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Verdant+Force)s, [Masticore](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Masticore)s, and [Gaea's Cradle](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gaea%27s+Cradle)s. I still don't have any [Masticore](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Masticore)s left, and I love that guy. I hope whoever has them is enjoying them. No, really.
