...
[_metadata_:description]:- "Melissa discusses the design niche that hate cards fill before revealing one of the more sadistic examples in recent memory."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "1201141"
[_metadata_:publish_date]:- "2017-09-08"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Why We Make Hate Cards"
[_metadata_:wayback_capture_timestamp]:- "2021-05-02 23:13:12"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20210502231312id_/https://magic.wizards.com/en/articles/archive/card-preview/20170908"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/card-preview/20170908"
---
...
Hello! Today I'll be showing you a type of [hate card](http://magic.wizards.com/en/articles/archive/play-design/m-files-hour-devastation-part-1-2017-07-14#hate-card) that we sometimes refer to as a "hate bear." But before I actually show you the card, let's talk about what a hate card is and why we make them.
...
For example, let's take a look at two cards, [Pyroclasm](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pyroclasm) and [Tivadar's Crusade](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tivadar%27s+Crusade). Both of these cards are pretty good against Goblins, but I wouldn't call [Pyroclasm](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pyroclasm) a hate card. [Pyroclasm](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pyroclasm) is a strong card against small creatures. It's great against decks like Mono-Black Zombies, Elves, Merfolk, or just any aggro strategy, including Goblins. [Pyroclasm](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pyroclasm) isn't very effective against [Goblin Goon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Goblin+Goon) or a pair of [Goblin Chieftain](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Goblin+Chieftain)s, but it's still strong against a wide range of decks.


[Tivadar's Crusade](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tivadar%27s+Crusade) is really strong against Goblins. It kills every Goblin on the battlefield regardless of how big they are. However, [Tivadar's Crusade](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tivadar%27s+Crusade) is *only* good against Goblins, and awful against everything else. If you really want to beat your friend who plays Goblins in Vintage, Legacy, and Commander, you're going to want to pack [Tivadar's Crusade](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tivadar%27s+Crusade) in your deck. Just don't expect for [Tivadar's Crusade](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tivadar%27s+Crusade) to do anything against any other creatures. [Tivadar's Crusade](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tivadar%27s+Crusade) is a hate card because it's specifically targeting Goblins and is weak against decks that aren't Goblins.


When we are designing cards to meet [Future Future League](http://magic.wizards.com/en/articles/archive/play-design/designing-hour-devastation-cards-meet-ffl-goals-2017-07-07) needs, sometimes we design hate cards to target a specific deck. It's possible that a strategy is stronger or more dominant than we thought it would be. In these cases, we will add a card to the environment to "hate out" that specific card or deck, especially when that card or deck is something we can't change.


Another type of hate card is a step down from a targeted hate card like [Tivadar's Crusade](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tivadar%27s+Crusade) and also the type of card that we make way more of. These types of cards are what I like to call "safeguards." They don't target a specific deck or card but instead act as a safety valve against a range of strategies in case one or more of those strategies get out of hand. For example, [Solemnity](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Solemnity) from *Hour of Devastation* was a safeguard against energy and against +1/+1 counters. We weren't sure how strong those strategies would be in the real world, but we wanted to have an option for players in case they wanted something specifically targeted for those decks.


Now that I've explained the types of hate cards, what is a "hate bear"? A hate bear is a hate card that is attached to a creature. Many hate bears are attached to 2/2 creatures for two mana, which are the stats of [Grizzly Bears](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grizzly+Bears), and that's where the name originated from. However, the creature does not have to be a two-mana 2/2 to be a hate bear. In R&D, we usually refer to any creature that has an ability attached to it for the purpose of hating something out as a hate bear, regardless of stats.


Today's preview card is a hate bear that is an example of both a targeted hate card and a safeguard.
