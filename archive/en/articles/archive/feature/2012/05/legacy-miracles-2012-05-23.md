...
---
[Link to Wayback Machine](https://web.archive.org/web/20211018183607/https://magic.wizards.com/en/articles/archive/feature/legacy-miracles-2012-05-23)
...
[_metadata_:node]:- "672451"
[_metadata_:publish_date]:- "2012-05-23"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Legacy Miracles"
[_metadata_:wayback_capture_timestamp]:- "2021-10-18 18:36:07"
...
This deck sets up in a very traditional manner that stalwart Legacy players will find familiar. [Force of Will](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Force+of+Will); [Counterspell](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Counterspell); [Swords to Plowshares](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Swords+to+Plowshares); [Sensei's Divining Top](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sensei%27s+Divining+Top); [Brainstorm](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Brainstorm); and [Jace, the Mind Sculptor](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Jace%2C+the+Mind+Sculptor) make up the core, supplemented by a couple situational counterspells and the versatile [Snapcaster Mage](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Snapcaster+Mage). The deck will deplete your resources via attrition, get up on cards, and then eventually finish you off with [Vendilion Clique](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vendilion+Clique)...

Or an [Entreat the Angels](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Entreat+the+Angels)! By using miracles alongside [Brainstorm](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Brainstorm), [Ponder](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ponder), [Jace](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Jace%2C+the+Mind+Sculptor), and [Sensei's Divining Top](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sensei%27s+Divining+Top), it is incredibly easy for this deck to set up the miracle ability on [Entreat the Angels](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Entreat+the+Angels) or [Terminus](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Terminus). It's even fairly easy to miracle on the opponent's turn thanks to [Sensei's Divining Top](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sensei%27s+Divining+Top)!

With a [Counterbalance](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Counterbalance) sideboard to fight storm and cheap beatdown decks, this deck tries to keep all of its bases covered. If you're looking for an update of a classic Legacy deck, this might be just what you're looking for!
