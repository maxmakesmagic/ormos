...
---
[Link to Wayback Machine](https://web.archive.org/web/20211023081018/https://magic.wizards.com/en/articles/archive/latest-developments/looking-limited-pointing-2010-02-11)

[_metadata_:author]:- "Erik Lauer"
[_metadata_:description]:- "Hello! I've gotten lots of requests from readers to write an article about Limited pointing, something that this column hasn't talked about in quite a while. Rather than try to do it myself, I asked Erik Lauer, the man who manages the metrics we use while working on Magic sets, to write an article for you. He's our go-to guy when we have questions about how to use math to make"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "189526"
[_metadata_:path_date]:- "2010-02-11"
[_metadata_:publish_date]:- "2010-02-12"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Looking at Limited Pointing"
[_metadata_:wayback_capture_timestamp]:- "2021-10-23 08:10:18"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20211023081018id_/https://magic.wizards.com/en/articles/archive/latest-developments/looking-limited-pointing-2010-02-11"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/latest-developments/looking-limited-pointing-2010-02-11"
---
...
![Tom LaPille](https://media.wizards.com/legacy//magic/images/mtgcom/authorpics/authorpic_tomlapille.jpg)*Hello! I've gotten lots of requests from readers to write an article about Limited pointing, something that this column hasn't [talked about](/Magic/magazine/Article.aspx?x=mtgcom/daily/af93) in quite a while. Rather than try to do it myself, I asked Erik Lauer, the man who manages the metrics we use while working on **Magic** sets, to write an article for you. He's our go-to guy when we have questions about how to use math to make **Magic** development better, and I leave you in his capable hands. I'll be back next week with a follow-up article that gives my take on the exercises he proposes below.*

*See you next Friday!*

*Tom LaPille*

Developers here in Ramp;D play a lot **Magic**, and form opinions on all the cards in the card set. We need to condense all their opinions into something manageable so the lead developer of a set can have some understanding of what each developer thinks of each card. One way we do that is to numerically rate each card. We call this "pointing." For Limited environments such as Sealed and Draft, we rate on a scale from 0.0 to 5.0. Stronger cards get a higher rating than weaker cards.
...
![](https://media.wizards.com/legacy//mtg/images/daily/ld/ld77_pointing.jpg)  
...
- [Greypelt Hunter](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Greypelt+Hunter)
- [Harrow](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Harrow)
- [Hearstabber Mosquito](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hearstabber+Mosquito)
...
![](https://web.archive.org/web/20130607114251im_/http://wizards.com/mtg/images/daily/ld/ld77_cardTops.jpg)  
Once we have values for all the cards, can we add them up to figure out which color is the strongest? Not quite. First off, cards have different rarities, so they are opened at different rates. But there is another problem, which is a bit harder to fix. [Admonition Angel](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Admonition+Angel) is a 4.0 because we defined it that way, and [Searing Blaze](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Searing+Blaze) is a 2.5 by definition as well. That does not mean that a [Searing Blaze](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Searing+Blaze) + a [Battle Hurda](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Battle+Hurda) is a good as an [Admonition Angel](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Admonition+Angel). While the values of the cards are in order from strongest to weakest, that is all we have so far. They aren't in a form where we can add them up the way developers like.

![](https://web.archive.org/web/20130607100423im_/http://wizards.com/mtg/images/daily/ld/ld77_notEqual.jpg)  
How can we fix this? We need to again go back to our idea of "which is stronger" for a pile of cards to add to a Sealed pool, but this time you get to add more than one card. How many [Searing Blaze](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Searing+Blaze)s is an [Admonition Angel](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Admonition+Angel) worth? If you could take two [Searing Blaze](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Searing+Blaze)s to add to your sealed pool, would you do that, or would you take the Angel? 

![](https://web.archive.org/web/20130607021655im_/http://wizards.com/mtg/images/daily/ld/ld77_equalQuestionMark.jpg)  
Is a [Goliath Sphinx](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Goliath+Sphinx) worth 2 [Searing Blaze](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Searing+Blaze)s? If I could have 28 [Lightning Bolt](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Bolt)s, I wouldn't want 28 [Admonition Angel](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Admonition+Angel)s. At that point the 40-card decks are too small, so we would need to talk about 100-card Limited decks. However developers have a lot less experience with 100-card Limited decks than 40-card decks, so we try to keep the questions in line with the expertise. We ask how many of the weaker card you would need to be about equal with one copy of the stronger card. 



|  |
| --- |
| **How many Searing Blazes would be just as good as one Admonition Angel?**12345678910 or moreThere is no amount. |
...
|  |
| --- |
| **How many Searing Blazes would be just as good as one Wolfbriar Elementa?**12345678910 or moreThere is no amount. |
...
|  |
| --- |
| **How many Searing Blazes would be just as good as one Goliath Sphinx?**12345678910 or moreThere is no amount. |
...
|  |
| --- |
| **How many Wind Zendikons would be just as good as one Searing Blaze?**12345678910 or moreThere is no amount. |
...
|  |
| --- |
| **How many Battle Hurdas would be just as good as one Searing Blaze?**12345678910 or moreThere is no amount. |
