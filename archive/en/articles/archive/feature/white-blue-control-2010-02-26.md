...
---
[Link to Wayback Machine](https://web.archive.org/web/20220816003831/https://magic.wizards.com/en/articles/archive/feature/white-blue-control-2010-02-26)
...
#### Patrick Chapin's White-Blue Control
...
Rumors of blue's death have been greatly exaggerated. While other players bemoaned the state of the color, Patrick Chapin, Gabriel Nassif, and their testing partners took advantage of some new *Worldwake* goodies to breathe new life into a classic control archetype. [Treasure Hunt](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Treasure+Hunt), [Celestial Colonnade](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Celestial+Colonnade), and [Everflowing Chalice](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Everflowing+Chalice) team up with existing control options like [Cancel](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cancel), [Day of Judgment](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Day+of+Judgment), [Negate](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Negate), and [Oblivion Ring](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Oblivion+Ring), in a weird—no doubt carefully calculated—mix of numbers. You can read more in the [official event coverage](/en/events/coverage/g%C3%B6rtzen-goes-all-way-san-diego).
