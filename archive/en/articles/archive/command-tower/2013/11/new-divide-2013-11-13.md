...
---
[Link to Wayback Machine](https://web.archive.org/web/20211024171310/https://magic.wizards.com/en/articles/archive/command-tower/new-divide-2013-11-13)

[_metadata_:description]:- "All good things come to an end.Final Judgment | Art by Kev WalkerYou spent weeks, months, or years tweaking and adjusting a Commander deck. You found new cards that work best in your deck and nowhere else. You traded for premium and special-art versions of cards just so your favorite plays looked as good as possible. That was then. Today, the prized treasure that was your"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "202061"
[_metadata_:path_date]:- "2013-11-13"
[_metadata_:publish_date]:- "2013-11-14"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "The New Divide"
[_metadata_:wayback_capture_timestamp]:- "2021-10-24 17:13:10"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20211024171310id_/https://magic.wizards.com/en/articles/archive/command-tower/new-divide-2013-11-13"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/command-tower/new-divide-2013-11-13"
---
...
> 
>  After winning three games with my [Ghost Council of Orzhova](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ghost+Council+of+Orzhova) deck, it was apparent that the aversion to counterspells ran too high to build a deck containing twenty sweeper spells, [Swallowing Plague](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Swallowing+Plague), and the [Syphon](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;name=+%5BSyphon%5Damp;text=+%5Bgain%5Damp;type=+!%5B%22Creature%22%5D) cards. I dismantled the deck and build a black deck and a white deck and everyone was much happier. 
> 
> —REV. GARY
> 
> 
...
> 
>  A recent example of this happening was a [Sygg, River Cutthroat](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sygg%2C+River+Cutthroat) deck I had built. It was packed with all sorts of thievery mechanics with counterspells and removal for support. It would practically ensure that no one would keep their best thing, and I would mesh together a board state from my opponents. While it was interesting and never the same experience, I found my friends scowling at all of their cards being taken from them all the time. 
> 
...
![](https://media.wizards.com/images/magic/daily/ct/ct273_thereisnocowlevel.jpg)  
...
![](https://media.wizards.com/images/magic/daily/sf/sf155_rhys.jpg)[Rhys the Redeemed](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rhys+the+Redeemed) | Art by [Steve Prescott](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=%5B%22Steve+Prescott%22%5D)

  
 It happened to me with a [Rhys the Redeemed](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rhys+the+Redeemed) deck. Casting a commander on the first turn of every game, efficiently building up mana with ramp spells and artifacts, leveraging protective enchantments to mitigate opponent interference, and the ability to exponentially grow tokens turn after turn led to very stale games: either I quickly stomped to victory or stumbled and, in that moment of weakness, was crushed unceremoniously with the full power of every opponent. 
...
>  Deconstructing a Commander deck is practically always an arduous, time-consuming process wrapped in a neat bundle of heartache. As you go through your deck, wrenching each card from its comfortable sleeve and ejecting it into the cold, pitiless binder, box, or haphazard pile, you reminisce. "[Storm Herd](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Storm+Herd) for 97... that was a great day, too bad about the overloaded [Cyclonic Rift](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cyclonic+Rift) two turns later," "I populated this [Worldspine Wurm](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Worldspine+Wurm)'s tokens six times against John and Frank," "[Mycoloth](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mycoloth)... you made all my friends hate me. I'll miss you." 
> 
...
>  My [Razia, Boros Archangel](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Razia%2C+Boros+Archangel) deck just wasn't performing the way that I wanted her to. Win or lose, a deck needs to consistently "do its thing." 
> 
>  For exactly the opposite reason, I took apart [Darigaaz, the Igniter](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Darigaaz%2C+the+Igniter). It won by ramping into a big [Diabolic Revelation](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Diabolic+Revelation)s and assembling the following: [Sporemound](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sporemound); [Life and Limb](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Life+and+Limb); [Prismatic Omen](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Prismatic+Omen); and [Valakut, the Molten Pinnacle](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Valakut%2C+the+Molten+Pinnacle). 
> 
...
> 
>  The main impetus for this frenzy of deconstruction was the same, though—I wanted to build [Oros, the Avenger](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Oros%2C+the+Avenger). A few years ago, my friends bought me a Russian pack of *Planar Chaos* and the legendary Dragon was my rare. I had always wanted to put the deck together, so my two "least performing" decks in those colors got the axe. 
> 
...
> 
>  Of course I have a pet deck that never goes into consideration for breaking down. My "pet" Commander deck is [Scion of the Ur-Dragon](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Scion+of+the+Ur-Dragon). Part Dragon tribal, Part gold tribal, and mostly legendary tribal. I built it around the concept of gold cards and domain, so I make use of a gold spells over a monocolor spells where ever I can. To that end, I focus on flavor and flexibility over function and redundancy. I run the majority of gold charm cycles, with only a Izzet and Orzhov guild charms not making the cut. 
> 
>  Using Scion as a tool-box approach for commander combat is very fun. His fluid nature makes him a difficult commander to deal with. If he goes unblocked he's likely to become a legendary dragon like Teneb or Crosis, or even [Hellkite Tyrant](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hellkite+Tyrant) if the opportunity for artifact theft is there. If they try to kill him with a spell, [Quicksilver Dragon](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Quicksilver+Dragon) and [Keiga, the Tide Star](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Keiga%2C+the+Tide+Star) turn it to my advantage. 
> 
> 
> 
> |  |  |
...
> 
>   
>  With all the Dragons in my graveyard, reanimation effects are a must. [Bladewing the Risen](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bladewing+the+Risen), [Living Death](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Living+Death), and [Victimize](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Victimize) are all-stars in this deck, especially alongside [Warstorm Surge](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Warstorm+Surge) and [Scourge of Valkas](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Scourge+of+Valkas) for some back-breaking damage. Kaalia of the Vast, [Call to the Kindred](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Call+to+the+Kindred), and [Riptide Shapeshifter](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Riptide+Shapeshifter) provide ways to cheat out Dragons on the cheap. The [Shapeshifter](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shapeshifter) provides double duty alongside [Captain Sisay](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Captain+Sisay) with getting Scion out of the library if he's ever tucked in, in addition to the alternative commander [Karona, False God](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Karona%2C+False+God). 
> 
>  The mana base is perhaps the most difficult part to manage; to prevent a heavy green leaning, I use artifacts to provide much of the mana fixing and ramping. However, this difficulty provided me the opportunity to run the [Guildgates](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;name=+%5Bguildgate%5D) and [Maze's End](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Maze%27s+End) as a surprise victory condition. 
> 
> 
> 
> |  |  |
...
> 
 ...
 Avoiding the need to pillage older decks for cards for newer decks was one of the factors that went into the  [creation of my Commander Box](https://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/sf/168). While I appreciate that all of the [newest preconstructed Commander decks"](http://archive.wizards.com/magic/tcg/productarticle.aspx?x=mtg/tcg/commander13/productinfo) each include copies of [Temple of the False God](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Temple+of+the+False+God) and [Sol Ring](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sol+Ring), I'm willing to ask myself a harder question: Does *this new deck* want a card more than some other deck? Our answers will differ and lead to different decisions. Taking apart an older deck can lead to great things. Brett summarized all out reasons well: 
...
>  In answer to your question, I'm afraid I am very bad at taking apart existing Commander decks. This led over time to my 26 current Commander decks before I read [your article about a Commander Box](https://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/sf/168).
> 
