...
---
[Link to Wayback Machine](https://web.archive.org/web/20220120001357/https://magic.wizards.com/en/articles/archive/feature/blue-red-green-control-2010-11-04)
...
The Standard format is under way with the brand new *Scars of Mirrodin*! Dan Jordan won the StarCityGames.com Standard Open in Charlotte, North Carolina playing Blue-Red-Green Control. The deck is the latest iteration of Turbo Land from the previous Standard format. Using mana acceleration and card draw Dan sets up a powerful end game that uses [Jace, the Mind Sculptor](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Jace%2C+the+Mind+Sculptor), [Volition Reins](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Volition+Reins), and [Frost Titan](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Frost+Titan) to seal up the victory.
