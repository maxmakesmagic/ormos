...
---
[Link to Wayback Machine](https://web.archive.org/web/20220626210608/https://magic.wizards.com/en/articles/archive/latest-developments/journey-mailbag-2014-04-25)

[_metadata_:author]:- "Sam Stoddard"
[_metadata_:description]:- "As you all get ready for the Journey into Nyx Prerelease, I wanted to take a week and answer a few questions that my twitter followers had about Journey into Nyx, and Magic Development as a whole:  As a whole, we are slowly moving away from having too many one-mana accelerators at a time in Standard. Part of balancing the game and the colors is deciding on how their curve is"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "163391"
[_metadata_:publish_date]:- "2014-04-25"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Journey into the Mailbag"
[_metadata_:wayback_capture_timestamp]:- "2022-06-26 21:06:08"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20220626210608id_/https://magic.wizards.com/en/articles/archive/latest-developments/journey-mailbag-2014-04-25"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/latest-developments/journey-mailbag-2014-04-25"
---
...
As you all get ready for the *Journey into Nyx* Prerelease, I wanted to take a week and answer a few questions that my twitter followers had about *Journey into Nyx*, and **Magic** Development as a whole:
...
It's not great, and was actually a large point of contention internally. The thing is, we like to have a few vanilla creatures per set (at least one per color), which means that preventing ourselves from ever doing that is going to cause problems. If we had to make every white two-drop in the block something worse than [Traveling Philosopher](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Traveling+Philosopher)s, we are tying our hands in terms of what the vanillas can end up being in the first set.





Ultimately, as the block progresses, we make the cards we need to make for both Limited and Constructed. We felt that [Lagonna-Band Trailblazer](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lagonna-Band+Trailblazer) was the right card for its slot, and a 0/3 with heroic wasn't.
...
We don't have specific metrics, although we do a lot to attempt to power-balance Limited so the most powerful cards appear at higher rarities, to create more variance. Cards like [Shivan Dragon](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shivan+Dragon) and [Enlarge](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Enlarge) are classic examples of bombs that do healthy things to Limited games and make them about other things than just a series of two-for-one trades to determine the victor.
