...
---
[Link to Wayback Machine](https://web.archive.org/web/20170115022611/http://magic.wizards.com/en/articles/archive/latest-developments/ah-yes-very-standard-2012-08-10)

[_metadata_:author]:- "Zac Hill"
[_metadata_:description]:- "Veteran readers of mine will appreciate that I am something of a living archive when it comes to the most essential elements of the Magic cultural lexicon. I was around for `mise,` `tings,` `gas,` `DI,` `inf,` and innumerable other sayings and phrases that make absolutely no sense whatsoever."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "645331"
[_metadata_:publish_date]:- "2012-08-10"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Ah Yes. Very Standard."
[_metadata_:wayback_capture_timestamp]:- "2017-01-15 02:26:11"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20170115022611id_/http://magic.wizards.com/en/articles/archive/latest-developments/ah-yes-very-standard-2012-08-10"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/latest-developments/ah-yes-very-standard-2012-08-10"
---
...
Veteran readers of mine will appreciate that I am something of a living archive when it comes to the most essential elements of the **Magic** cultural lexicon. I was around for "mise," "tings," "gas," "DI," "inf," and innumerable other sayings and phrases that make absolutely no sense whatsoever.

![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/ld/ld207_zac_speak_2.jpg)  
So when I was told it was Standard Week, my instincts naturally veered to the only *possible* valid response to, for example, an opponent peeling back-to-back Bonfires of the Damned for exactly enough to wipe your board, then peeling back-to-back Temporal Masteries in order to ultimate Tamiyo with a [Dissipate](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dissipate) in hand the turn before you topdeck what would be a lethal [Pillar of Flame](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pillar+of+Flame):
...
One can make the argument that that was never really the case, of course. Creatures used to be kind of embarrassingly bad, whereas spells like [Lightning Bolt](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Bolt), [Swords to Plowshares](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Swords+to+Plowshares), and [Control Magic](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Control+Magic) were with the game from the very beginning. Red aggro certainly picked up steam with *Tempest* block—no one is going to deny this—but generally speaking I think I'd like to sit in the chair that has access to the [Force Spike](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Force+Spike)s, [Counterspell](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Counterspell)s, and [Dismiss](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dismiss)es and not the one getting excited about [Elite Vanguards with severe drawbacks](http://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=4825). Meanwhile, control decks—theoretically advantaged against combo, according to this model—were somehow supposed to defeat upwards of five mana on the first turn and a bevy of draw-seven effects. The first environment I took very seriously was *Tempest*/*Urza's* Standard, where most of the cards I played in most of my decks are now restricted in the Vintage format, and yet these (combo) decks were supposed to be at a *disadvantage* to a third of the metagame? Finally, the model ignored what was perhaps the most powerful archetype: the archetype that simply cast overpowered spells over and over again until the opponent lost (e.g., [Necro](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Necro) → [Firestorm](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Firestorm); [Recurring Nightmare](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Recurring+Nightmare) → [Survival](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Survival); [Grim Monolith](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grim+Monolith) → anything).

![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/ld/ld207_spells_2.jpg)  
So in retrospect I'm not sure that such a model *ever* held water, even though it seemed to make sense at the time.

In any case, a bunch of Very Bad Things like Black Summer (all [Necro](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Necro) all the time) and Combo Winter (all [Academy](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Academy) all the time) led R&D to reconsider whether it was really a good idea for creature-based decks to occupy only a third of the environment at a given point. It isn't fun, of course, to just sit and summon a bunch of dumb animals and blindly throw them at the opponent over and over again until the game ends. The trouble is that *that's exactly the kind of interaction* having such a paucity of creature-based strategies in an environment encourages. When blocking isn't a "thing," each one of your creatures is just a down-payment investment that depreciates your opponent's life total by a rate equal to its power every turn, and deck design is about nothing but figuring out what the most efficient way to do that is without losing all your guys to removal. From the other side, you can actually just do the math to figure out what the average rate of damage your opponent can produce is, and either (a) determine whether there's enough removal-with-value in the environment to just kill all your opponent's creatures with advantage before you die, or (b) "goldfish" faster than your opponent's "fundamental turn," which boils down to winning your game of *Solitaire* before he or she does.
...
Aggro → Midrange → Ramp/Combo → Control/[Disrupt](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Disrupt)ive Aggro

What do each of these terms mean to us internally?

Aggro is your traditional "kill your opponent as quick as possible using efficient creatures" kind of deck. It usually features potent attacking-based one-drops (e.g., [Champion of the Parish](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Champion+of+the+Parish) and [Diregraf Ghoul](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Diregraf+Ghoul)) and a mana curve heavily weighted to the first several turns. Frequently, it will supplement its primary strategy with "range," or ways to end the game after its initial assault has been blunted.



|  |  |
| --- | --- |
| Champion of the Parish | Diregraf Ghoul |
...
Unlike the "Aggro/Control/Combo" model, the sequence of the decks listed above isn't simply a declaration of what beats what—though it is partially that. Rather, each bucket represents a shift in how the deck intends to interact with the deck in the previous bucket, largely by focusing on a different zone. The Midrange deck exploits the aggro deck's lower mana curve—and the limitation of being developmentally constrained by mana—to produce superior threats on the battlefield. The Ramp and Combo decks exploit the midrange deck's lack of pressure to spend time setting up what amount to trump cards. The Control/[Disrupt](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Disrupt)ive aggro decks exploit the Ramp/Combo decks' focus on one particular threat by targeting that threat and leaving those decks unable to function. Finally, the Aggro deck exploits the Control deck's ponderous mana-costs and the [Disrupt](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Disrupt)ive Aggro deck's lower density of battlefield advantage to deploy its strategy before it's capable of being successfully disrupted.
...
At the end of the day, no heuristic is going to accurately model a system as complex as a **Magic** metagame. Moreover, sometimes you print a card like [Stoneforge Mystic](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stoneforge+Mystic) or [Snapcaster Mage](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Snapcaster+Mage) that throws these categories out the window and starts to heavily reward the strategy of "casting better cards than your opponent." In general, though, this model gives us a ton of insight about how to best deploy various levels of power in the Standard environment, ensuring that we're juicing up the kinds of decks we need to bring balance to a metagame, and not just handing out all the gas to what's already good.
