...
---
[Link to Wayback Machine](https://web.archive.org/web/20170614174822/http://magic.wizards.com/en/articles/archive/feature/any-time-day-good-time-pie-2007-02-08)
...
[_metadata_:node]:- "626936"
[_metadata_:publish_date]:- "2007-02-08"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Any Time of Day Is a Good Time for Pie"
[_metadata_:wayback_capture_timestamp]:- "2017-06-14 17:48:22"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20170614174822id_/http://magic.wizards.com/en/articles/archive/feature/any-time-day-good-time-pie-2007-02-08"
...
![](https://media.magic.wizards.com/image_legacy_migration/magic/images/dropcap_A.jpg)*ny time of day is a good time for pie.* That is wisdom, folks. Some of you may recognize this as one of the many pearls of wisdom delivered in the movie Pulp Fiction. It is being delivered again today – as there has never been a better time for pie than in the wake of *Planar Chaos*.  The whole concept of the color pie is a part of **Magic** flavor as much as it is a part of Magic mechanics. “Color,” at its very root, is a character trait for every **Magic** card, whether it’s a “character” or not. While most color pie talk centers around which mechanics are allotted to which colors, there is definitely a link between what those mechanics are and how they are represented creatively in each of the five colors. For example, direct damage is represented differently across the five colors – lightning or fire in Red, combat tactics in White, natural defenses in Green, psionic attack in Blue, and vampiric consumption in Black. 

![](https://media.magic.wizards.com/image_legacy_migration/magic/images/ttm-feb8.jpg) One of the most interesting stages of **Magic** Creative is the concepting of cards. This is when we take the bare mechanics of a card and attach to it meaning, flavor, and world relevance. It is taking a Blue spell that deals 4 damage to a target and 2 to you and making it a mentally taxing psionic attack – Psionic Blast. Some of the most challenging cards to concept are the ones that have the same abilities as pre-existing cards, but are in a different color. Char may not have been all that difficult to nail, but it is an interesting counterpart to its Blue cousin – being a *physically* taxing *fire* attack. You can read more about card concepts in my article, “[Card Concept – Who is This Unsung Hero?](/en/articles/archive/card-concept-who-unsung-hero-2006-03-08)” 
...
| 
**Mana Tithe**
 Mana Tithe is one of the poster children for Planar Chaos’s color-shift theme. It’s the white counterspell that I spoke of earlier. Countering spells has just never been a mono-white thing. But now that it is, we needed to find the “white” in this almost exclusively blue ability. In the end, we settled on law and order as the link between countering spells and white’s own character. In essence, this spell is not countering magic out of trickery, but rather denying the actions of those seeking to not play by the rules. | Mana_Tithe |
...
**Merfolk Thaumaturgist**
 ...
 This scaled and tailed version of the *Weatherlight* card [Dwarven Thaumaturgist](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dwarven+Thaumaturgist), was not so difficult to flavor. The card just screamed out to be a Merfolk, the staple blue weenie race in *Weatherlight*. The name, in addition to the card concept, was a slam dunk. So why do I cite it here? I just happen to think the flavor text is a wonderful way to make note of the card’s former redness and to place it specifically in the *Weatherlight* time period – by quoting a Red *Weatherlight* character. Tahngarth curses the “fishtails” on the cards [Tolarian Serpent](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tolarian+Serpent), [Phantom Warrior](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phantom+Warrior), and [Vodalian Illusionist](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vodalian+Illusionist) as well. This is exactly how *Planar Chaos* timeshifted cards should be flavored – with nostalgic ties not only to the card from which they were color-shifted, but also to the card set to which their flavor is tied. 
...
| 
**Pyrohemia**
 (I can’t help but say this word to the tune of the Art of Noise song, Paranoimia.) Aside from this card’s musical connection to the past, it also bears one really strong Magical connection. [Pyrohemia](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pyrohemia) is a color-shifted version of the Alpha card Pestilence. The goal was to create a card that did not just damage all creatures (red does that all the time), but to do it in the same way that Pestilence did it. That would be the nostalgic bond. The answer was to concept it as a contagion, like Pestilence, but one that communicates a disease that seems red. How about blood catching fire while still in the veins? Sounds pretty horrific (and darn cool) to me!  | pyrohemia |
...
**Groundbreaker**
 ...
 On a similar note, in my play group, Wild Growth is always announced in triplicate, to the tune of Duran Duran’s “Wild Boys.” “Wild Growth, Wild Growth, Wild Growth...!” 


**Damnation** and **Brute Force**
...
**Blood Knight**
 ...
 OK, as a red version of [Black Knight](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Black+Knight), this guy is no great flavor achievement, but [Blood Knight](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blood+Knight) does sound really cool. I am happy that we did not have to go with the obvious (and obviously lame) “Red Knight.” Really, mentioning it here is just an excuse for me to show you the full frame art (of which I am very proud.)  | blood_knight |

**Hedge Troll**


![hedge_troll](https://media.magic.wizards.com/image_legacy_migration/magic/images/cardart/PLC/hedge_troll.jpg)[Hedge Troll](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hedge+Troll) is a real crowd pleaser. The phonetic nod to [Sedge Troll](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sedge+Troll) is enough to float the entire boat, but the coolness goes deeper than that. The flavor text is a deft rework of the original, with the added bonus of making sense of the color change both mechanically and creatively. Here’s the [Sedge Troll](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sedge+Troll) flavor text, followed by [Hedge Troll](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hedge+Troll)’s. 
...
*His abode was clean and bare, not a morsel in sight. I asked him what he ate, fearing the answer. He smiled and said his faith alone sustained him.*
 ...
 So [Sedge Troll](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sedge+Troll) was a dastardly creature, feeding his regenerative powers by eating the poor folks he had stuck in his stew. Black and green have always had regenerating creatures, but what to do with a green guy who regenerates with a white ability? “Seek the answer within, my son.” So says the troll of the hedge. Fasting and faith, friends, are what power the [Hedge Troll](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hedge+Troll). I am still impressed by this piece – pulling it all together and doing so in a smooth, nostalgic fashion. 
