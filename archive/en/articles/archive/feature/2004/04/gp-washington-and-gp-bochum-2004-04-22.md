...
---
[Link to Wayback Machine](https://web.archive.org/web/20220525165925/https://magic.wizards.com/en/articles/archive/feature/gp-washington-and-gp-bochum-2004-04-22)
...
[_metadata_:node]:- "614091"
[_metadata_:publish_date]:- "2004-04-22"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "GP Washington and GP Bochum"
[_metadata_:wayback_capture_timestamp]:- "2022-05-25 16:59:25"
...
![](https://media.magic.wizards.com/image_legacy_migration/sideboard/images/gpdc04/me.jpg)*“Thaaaat's Me” (Bill Stead, Chris Fennell, and Charles Gindy)*Close to 600 gamers returned to the region where the Team Pro Tour began all these years ago. Three-person teams had to build two sealed deck sets over the course of eight rounds, then the top 20 teams would draft three times on day two, finally cutting to the top 4.
...
![](https://media.magic.wizards.com/image_legacy_migration/sideboard/images/gpboc04/fin.jpg)*Stijn Cornelissen, Jesse Cornelissen, and Tom van de Logt*Last but not least are the champions – team Shietkoe from The Netherlands. Spearheaded by former World Champion Tom van de Logt, it also features Jesse and Stijn Cornelissen. Their team name means “Shooting Cow” in Dutch, which is a reference to [Anaba Shaman](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Anaba+Shaman). (The Cornelissen brothers always use a Minotaur related name for their teams.) Their brother Kamiel has been the most successful **Magic** player of the three so far, but this weekend it was their time to shine as the team took their strategy of drafting Green in the A seat, White-Red in B, and Affinity in C all the way to the finals.
...
![](https://media.magic.wizards.com/image_legacy_migration/global/images/mtgcom_daily_mr108_pic3_en.jpg)*Mark Rosewater, GenCon ’98*Last week’s question:
...
In the first game he led off with [Leonin Boa](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Leonin+Boa) and followed it up with a turn two [Lightning Greaves](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Greaves). I played out some creatures and kept attacking as Nicholas would do nothing but play land after land. He had six lands in play and still not a single creature! I attacked, bringing him down to five life, and used one of the two [Consume Spirit](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Consume+Spirit)s I was holding to burn him down to three – ready to either attack for the win or burn him to death if I drew another land on the next turn. 

On turn seven Neary tapped out and cast… [Platinum Angel](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Platinum+Angel)! He then equipped it with [Lightning Greaves](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Greaves) and proceeded to bash me for many turns. My mono-black deck had only one answer to an untargetable Angel – [Barter In Blood](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Barter+In+Blood) – and I failed to draw it in time.
