...
---
[Link to Wayback Machine](https://web.archive.org/web/20210429041024/https://magic.wizards.com/en/articles/archive/making-magic/magic-lessons-2009-06-19)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "Little known fact: mana burn was almost removed from the game during the Sixth Edition rules change. How did it survive? Well, there was a mix of opinions about what to do with it, but one Ramp;D person fought passionately to save it. His passion was enough to tip the scales and keep it in the game. How did mana burn end up being removed ten years later? An Ramp;D member"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "188026"
[_metadata_:path_date]:- "2009-06-19"
[_metadata_:publish_date]:- "2009-06-22"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Magic Lessons"
[_metadata_:wayback_capture_timestamp]:- "2021-04-29 04:10:24"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20210429041024id_/https://magic.wizards.com/en/articles/archive/making-magic/magic-lessons-2009-06-19"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/making-magic/magic-lessons-2009-06-19"
---
...
Little known fact: mana burn was almost removed from the game during the *Sixth Edition* rules change. How did it survive? Well, there was a mix of opinions about what to do with it, but one Ramp;D person fought passionately to save it. His passion was enough to tip the scales and keep it in the game. 

How did mana burn [end up being removed](http://archive.wizards.com/magic/Magazine/Article.aspx?x=mtg/daily/feature/42a) ten years later? An Ramp;D member fought passionately for its removal, building support and consensus among Ramp;D. There were those who wished to save it, but this passionate Ramp;D member managed to convince the majority that for the health of the game it was time for mana burn to go.

![](https://media.wizards.com/legacy//mtg/images/daily/mm/mm44_mark.jpg)  
That passionate Ramp;D member, in both cases, was me. How did I go from mana burn's savior to the ringleader of its removal? What changed during those ten years? I matured as an Ramp;D member and as a designer (one might even say as a person). That maturity came from ten years of experiences that helped me learn many things about **Magic** and its design. These lessons made me look at mana burn and the game of **Magic** in a very different light. For my column today I am going to share these lessons with all of you. Remember, these aren't lessons about life (I did those already—[here](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/mr216) and [here](http://archive.wizards.com/magic/magazine/Article.aspx?x=mtgcom/daily/mr218)), but specifically about the game of **Magic**. (Then again, I believe everything is holistically connected, so maybe these are just more lessons on life.)

Lesson #1: Change is Inevitable
![](https://media.wizards.com/legacy//mtg/images/daily/mm/mm44_ohio.jpg)  
...
![](https://media.wizards.com/legacy//mtg/images/daily/mm/mm44_change.jpg)  
...
![](https://media.wizards.com/legacy//mtg/images/daily/mm/mm44_fear.jpg)  
...
Is it power creep? Will the constant quest of Ramp;D to provide the bigger, badder, more powerful thing cause the game to collapse in on itself? No, Development's gotten pretty good at understanding what we can and can't do. I don't see the game spinning out of control as long as we have developers of our current quality.
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Shivan_Dragon)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shivan_Dragon)How does Ramp;D fight this? How do we keep the line within the appropriate range? The answer is twofold. First, we make the best use of intuition that we can. Second, we remove things. The first part of this answer works as such: How do you make it easier to teach new players? Make the answers what they would assume them to be. The reason flying is such a great mechanic is that its flavor explains itself. When I teach flying for the first time, I know the beginner's eyes will light up when I say, "It flies."

One of the greatest things **Magic** has going for itself is that its flavor does such a great job of matching what it does. Spells feel like spells and creatures feel like creatures. A lightning bolt is a lightning bolt and a grizzly bear is a grizzly bear. The more things there are that teach themselves, the less burden on the game to do so. This is why Ramp;D works so hard to push the game away from things that we know don't make sense to new players. Even if they're just little things that "players get eventually," they add up and raise the line. As we start previewing ***Magic** 2010* next week, you'll see this desire to make the game more intuitive ran throughout the design process.

This brings us to Ramp;D's only other option, removing things. This is not something we do lightly, but it is something that has to be done. If we allow the game to add things, we also must allow it to remove things as well. Multicolor cards, legendary permanents, cantrips, numerous creature keywords, equipment, race/class, hybrid mana, planeswalkers—these are all things available to a designer for any set he or she designs, none of which existed in Alpha. The game has notched up considerably in complexity over the last sixteen years. What has been removed to keep the balance? 

![](https://media.wizards.com/legacy//mtg/images/daily/mm/mm44_balance.jpg)  
I find it interesting that whenever we remove something the common cliché for it is "Ramp;D's dumbing down the game," yet adding new things to **Magic** is "business as usual." These forces are inexorably linked. If you want the latter, you have to accept the former. This is why Ramp;D doesn't worry about lessening the complexity of the game. Inertia is pushing hard in the opposite direction. Until we start removing more things than we add, the complexity level isn't going down.

![](https://media.wizards.com/legacy//mtg/images/daily/mm/mm44_puzzle.jpg)  
...
Here's a different way to think of it. What if I assigned you the reader the following task (think of it as fodder for this article's thread): you have to remove a rule from the game for ***Magic** 2010*. Your goal is to have the least impact you can on the game, but you have to remove a rule that has some effect on game play. What do you choose? You, like Ramp;D, do not have the luxury to say nothing.
...
![](https://media.wizards.com/legacy//mtg/images/daily/mm/mm44_garfield.jpg)  
...
I'm not just talking about mechanics. Complexity will shift. Strategy will shift. Tactics will shift. When one thing leaves, another fills its space. Trust me, Ramp;D has been playing with these new rules for close to a year. The game still feels like **Magic**. In fact, the most interesting thing to me is how little change there's been. I remember the change from pre-*Sixth**Edition* rules to *Sixth Edition* rules, and the M10 shift is not even in the same ballpark.
