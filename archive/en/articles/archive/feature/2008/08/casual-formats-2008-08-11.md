...
---
[Link to Wayback Machine](https://web.archive.org/web/20201112002316/https://magic.wizards.com/en/articles/archive/feature/casual-formats-2008-08-11)
...
There are many more ways to play **Magic** games than the sanctioned formats detailed [here](http://magic.wizards.com/en/game-info/gameplay/rules-and-formats/formats). From single-pack showdowns to massive multiplayer battles, **Magic** is a game ready to be enjoyed in many ways by as many of your friends as possible.
...
[**Limited**](#limited) | [**Constructed**](#constructed) | [**Multiplayer**](#multiplayer) | [**Cube**](#cube) | [**Alternative**](#alternative)
...
A unique take on the [Booster Draft](http://magic.wizards.com/en/game-info/gameplay/formats/booster-draft) format, Solomon Draft allows **Magic** players to draft with just two people. Each player needs three booster packs, which they open without looking at the contents. You shuffle all six packs together, creating a combined pool of ninety cards. Then you're ready to draft.
...
In the Pick-a-Pack draft format, players draft just as they would during a normal [Booster Draft](http://magic.wizards.com/en/game-info/gameplay/formats/booster-draft) with one change: instead of using three booster packs from the most recent **Magic** block, players are allowed to use packs from *any* **Magic** sets. That means the player to your left could be using a pack each of *Darksteel*, *Ravnica*, and *Ice Age* while the player to your right is cracking two packs of *Shadowmoor* and one pack of *Tenth Edition*!
...
Tired of trying to figure out what the most powerful cards are in your local Booster Draft each week? Or are you looking for the opportunity to play cards in draft that are normally passed over? Back Draft is a **Magic** variant that functions like a [Booster Draft](http://magic.wizards.com/en/game-info/gameplay/formats/booster-draft) in reverse!
...
Once the cube has been built, you can use it for any draft format. The most popular option is to build makeshift "booster packs" out of 15 randomly selected cards from the cube and then run a regular [Booster Draft](http://magic.wizards.com/en/game-info/gameplay/formats/booster-draft). But you can also use your cube for Winston Draft, Solomon Draft, or any other kind of draft format.
...
* [Tom LaPille's Cube page](http://playmagicwith.tomlapille.com/index.php/the-cube-faq/)
* [Evan Erwin's Cube page](http://www.cubedrafting.com/Welcome.html)
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/tcg/resources/star_seating.jpg)
...
For more information and discussions about the **Magic Online** Prismatic format, please visit the [**Magic Online** Prismatic discussion forum (English only).](http://forums.gleemax.com/forumdisplay.php?f=775)
...
A number of Vanguard cards were printed around the time the *Tempest* set was released. For a list of the Vanguard cards that were released in physical form, [click here (English only)](http://magic.wizards.com/en/vanguard). In **Magic Online**, each avatar can double as a Vanguard card. You can find more information about them [here](http://magic.wizards.com/en/vanguard).
...
Examples of cards that could be used for a Chaos decks include [Armageddon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Armageddon) (which destroys all lands when it's flipped over), [Kumano, Master Yamabushi](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kumano%2C+Master+Yamabushi) (which allows each player to repeatedly spend ![](https://web.archive.org/web/20211201201921im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless1.gif)![](https://web.archive.org/web/20161227130159im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/red.gif) to deal 1 damage to a creature or player), and [Howling Mine](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Howling+Mine) (which has each player to draw an additional card during his or her draw step). What cards will be in *your* Chaos Deck? That's up to you!
...
It somehow makes sense that such a larger-than-life format was invented up in the wilds of Alaska. Its originators used commanders only from the Legends set, including (and especially!) the Elder Dragons such as [Chromium](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Chromium) and [Nicol Bolas](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Nicol+Bolas). Over time, the format spread. It became popular among judges, who would play it into the wee hours of the night following a hard day's officiating at a Pro Tour or Grand Prix event. (You can read more about their rules [here](http://magic.wizards.com/en/game-info/gameplay/formats/commander).) It soon reached the mainstream and has become a favorite format in casual playgroups everywhere, from the kitchen table down the street to **Magic Online** to the Wizards of the Coast headquarters!


For more information and discussions about the **Magic Online** 100 Card Singleton–Commander format, please visit the [**Magic Online** 100 Card Singleton–Commander discussion forum](http://forums.gleemax.com/forumdisplay.php?f=773) (English only).
...
If you're looking for a format you can play with friends who don't have **Magic** cards of their own, Fat Stack is ideal. To prepare, create two stacks of cards that are used as communal libraries. The first stack features cards that can't produce mana, and the second stack features only lands and other cards that can produce mana (such as [Dark Ritual](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dark+Ritual), [Birds of Paradise](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Birds+of+Paradise), or [Fellwar Stone](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fellwar+Stone)).
...
2. A card may be played as any card in **Magic** with the same mana cost as that card—except for the card it actually is! For example, [Fugitive Wizard](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fugitive+Wizard) (which has a mana cost of ![](https://web.archive.org/web/20161115194122im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/blue.gif)) could be played as [Cursecatcher](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cursecatcher), [Unsummon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Unsummon), or [Ancestral Recall](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ancestral+Recall), but couldn't be played as [Fugitive Wizard](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fugitive+Wizard). In order to "mentally" play a card, a player must be able to accurately describe its card text with no outside help.
...
There are some additional Mental Magic rules that you can play with or not as your group sees fit. Cards in your hand, graveyard, or anywhere else other than in play have no names—but they do have types and subtypes. If you play [Raise Dead](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Raise+Dead) or [Duress](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Duress), for example, read what's actually printed on the card. Also, library-searching effects don't work. If you play a spell or ability that tells you to search your library, that part of the effect doesn't do anything. For a more in-depth discussion, see [Mike Flores's Mental Magic](/en/articles/archive/mental-magic-beginning-2003-02-11) feature article.


Mental Magic challenges players' knowledge of **Magic** and allows for a quick, fun way to pass the time between matches. It also challenges players to figure out whether the ![](https://web.archive.org/web/20161227130050im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless3.gif)![](https://web.archive.org/web/20161115194122im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/blue.gif) card in their hand is better played as [Ray of Command](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ray+of+Command), [Phantasmal Forces](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phantasmal+Forces), or simply as a rainbow land!
...
The difference is that you don't know what spell you're playing when you play it. For example, if you've got a ![](https://web.archive.org/web/20161225105850im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless2.gif)![](https://web.archive.org/web/20161227195556im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/black.gif) card in your hand, you'll tap three lands, show the card to your opponent, and then your opponent tries to think of the least scary card with that mana cost and name it. Players can't help but enjoy themselves as they watch their opponents struggle to name weak cards, only to eventually run out of options and provide their enemy with *something* to do them in. Reverse Mental Magic is a great alternative for those players already well versed in regular Mental Magic play.
...
For additional variations to the game, some players choose to pre-design the stack of cards they'll play with (similar to building a cube for Cube Draft) or restrict participants to being able to perform actions only a certain number of times each turn (meaning a player casting the card [Fireball](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fireball) might be able to spend only 10 mana, or a player activating a [Masticore](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Masticore)'s ability could do so only 10 times).
