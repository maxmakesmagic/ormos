...
---
[Link to Wayback Machine](https://web.archive.org/web/20170717111129/http://magic.wizards.com/en/articles/archive/feature/legacy-ascension-2012-01-17)
...
Fun-loving deck builder Adam Prosak is at it again! At the StarCityGames.com Open Series in Atlanta two weekends ago, Adam brought a [Pyromancer Ascension](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pyromancer+Ascension) deck to the Legacy tables. Once Pyromancer's Ascension has two counters, a [Manamorphose](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Manamorphose) and two Regrowths means you can draw any number of cards. Even if you don't draw the cards needed for the Regrowth plan, the package of [Lightning Bolt](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Bolt) and [Fire // Ice](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fire+%2F%2F+Ice) can burn out your oppoents quickly once Ascension is active. If you've been searching for a crazy and fun Legacy deck to try out, look no further!
...
#### Adam Prosak's Pyromancer Ascension
