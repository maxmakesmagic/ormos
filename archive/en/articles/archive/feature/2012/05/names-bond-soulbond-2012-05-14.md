...
[Brian Tinsman](http://www.wizards.com/Magic/Magazine/Archive.aspx?author=Brian%20Tinsman), lead designer for *Avacyn Restored*, is a man who loves embracing a challenge. Some people will back away from things that have failed, but it only seems to fuel Brian to try and figure out how to make it work. I talked [a few weeks ago](/en/node/654966) about how Brian's determination to solve draw triggers led to him designing miracles. Soulbond has a similar path.


You see, *New Phyrexia* tried to solve a design problem we've been working on forever. How do you capture the flavor of two creatures working together? In Alpha, [Richard](http://www.wizards.com/Magic/Magazine/Archive.aspx?author=Richard%20Garfield) made banding.



![235](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&multiverseid=235)

 

While banding works very differently mechanically from soulbond, it has its roots in the same flavor. The idea of two creatures working together has popped up again and again. It's just something that has such resonant flavor that every designer wants to see if he or she can crack it. *New Phyrexia* had a pretty radical take on it that [Ken Nagle](http://www.wizards.com/Magic/Magazine/Archive.aspx?author=Kenneth%20Nagle) and his design team ([Dave Guskin](http://www.wizards.com/Magic/Magazine/Archive.aspx?author=Dave%20Guskin), Joe Huber, [Matt Place](http://www.wizards.com/Magic/Magazine/Archive.aspx?author=Matt%20Place), and myself) spent a lot of time trying to make work. In the end, things weren't clicking so we went another direction, ultimately leading to Phyrexian mana.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm195_sto.jpg)[Stonewright](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stonewright) | Art by [Wesley Burt](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+%5B%22Wesley+Burt%22%5D)
...
One of the things you learn early in designing a trading card game is the importance as what R&D calls "as-fan." This term refers to how often one can expect a particular theme to show up percentage-wise ("as" it would happen to be "fanned" when opening a booster pack). The biggest two tools to affect as-fan are number and rarity.
