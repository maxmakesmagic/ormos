...
---
[Link to Wayback Machine](https://web.archive.org/web/20211209103222/https://magic.wizards.com/en/articles/archive/making-magic/outside-view-2009-04-23)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "For almost three years, from Dissension through Shards of Alara, I was on every design team. While it was exhilarating, it was also very tiring, and thus I was happy to take a breather during Conflux and Alara Reborn (and by breather, I mean merely leading the design of Zendikar, the 2009 large fall expansion). While I was involved in a macro sense as Head Designer, I was not"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "187636"
[_metadata_:path_date]:- "2009-04-23"
[_metadata_:publish_date]:- "2009-04-27"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "An Outside View"
[_metadata_:wayback_capture_timestamp]:- "2021-12-09 10:32:22"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20211209103222id_/https://magic.wizards.com/en/articles/archive/making-magic/outside-view-2009-04-23"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/making-magic/outside-view-2009-04-23"
---
...
Dragon Broodmother
[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Dragon+Broodmother)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dragon+Broodmother)  
There's a lot of focus on card combinations in **Magic**. What is equally fun, though, are cards that create synergy with themselves. [Dragon Broodmother](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dragon+Broodmother) has great game play that requires no other cards. Each new Dragon token gets to think about each Dragon token that came before it. Every set needs to have cards like this and it is something that I think about during every set I lead.
...
Finest Hour
[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Finest+Hour)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Finest+Hour)  
Every once in a while, gold sets do this odd thing. They create a multicolor card that makes sense when you look at its pieces yet doesn't have the color that the whole effect is normally associated with. The classic example of this is the card [Lightning Helix](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Helix) from *Ravnica*:

[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=LIGHTNING+HELIX)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=LIGHTNING+HELIX)  
[Lightning Helix](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Helix) deals 3 damage to target creature or player—check, that's red.

You gain 3 life—check, that's white.

Deal 3 damage and gain 3 life—wait, that's [Essence Drain](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Essence+Drain), a black card.

[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=ESSENCE+DRAIN)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=ESSENCE+DRAIN)  
It turns out that combining damage to a creature with life gain can be done in monoblack or in red-white.

[Finest Hour](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Finest+Hour) is a similar card. Exalted falls into all three Bant colors. Untap and then attack again. Well, white and blue can untap creatures (green used to but has since lost that ability). Blue gets "[Time Walk](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Time+Walk)" effects where you get to take extra turns. Green is king of doubling things. Combine them all together and you get an effect that makes sense in green-white-blue. But wait, that's [Relentless Assault](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Relentless+Assault) (and its ilk), a red card.

Quirky, but often times that's just how design rolls.

Intimidation Bolt
[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Intimidation+Bolt)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Intimidation+Bolt)  
...
Mechanically, what does a [Lightning Bolt](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Bolt) to creatures and a one-shot, one-sided [Pacifism](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pacifism) have to do with one another? Nothing really. The two have some synergy as it's nice to be able to [Fog](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fog) for a turn while also getting rid of one of the attackers, but when you try to match them up mechanically, the card falls a little short.
...
[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Karrthus%2C+Tyrant+of+Jund)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Karrthus%2C+Tyrant+of+Jund)  
...
Knight of New Alara
[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Knight+of+New+Alara)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Knight+of+New+Alara)  
...
[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Lightning+Reaver)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Reaver)  
...
Mind Funeral
[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Mind+Funeral)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mind+Funeral)  
This card is going to create some cool memories. Why? Because the card doesn't dictate exactly what's going to happen.

Let me step back a moment. What is the role of a game designer? What exactly are we being paid to do? In my opinion, we're being paid to provide entertainment. We are creating fun for the players. How do we do this? There are many ways. One way, and [Mind Funeral](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mind+Funeral) embraces this, is to make cards that create moments. Cards that stop the game and say, "Okay we're now going to play this little minigame." It's important that this minigame matters.

At minimum, [Mind Funeral](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mind+Funeral) is going to mill (slang for "put from library into graveyard") four cards. It could mill half the deck. Potentially, it could mill [the deck – N], where N is all the lands remaining minus four. That's a wide spread. And as milling is a win condition, the success of this spell could have a big impact on the outcome of the game.
...
[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=FRENETIC+EFREET)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=FRENETIC+EFREET)  
[Frenetic Efreet](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Frenetic+Efreet) is probably the most famous card that played up this problem. The coin flips were crucial yet there was no outside way to influence them. As such, [Frenetic Efreet](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Frenetic+Efreet) turned key moments of tournament games into watching a coin flip in the air. On the flip side, one only need to look at the [Semifinal match](/Magic/Magazine/Events.aspx?x=mtgevent/worlds07/sf1) between Pat Chapin and Gabriel Nassif from [Worlds 2007](/Magic/Magazine/Events.aspx?x=mtgevent/worlds07/welcome) to see what excitement a random card could create. (Hit the link for the full story—it involves an [Ignite Memories](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ignite+Memories) with a storm count of 4.)

My point is that the right randomness in the right place can create exciting moments of **Magic**.

Offering to Asha
[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Offering+to+Asha)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Offering+to+Asha)  
The thing I'm happiest about when I see this card is that it appreciates aesthetics. The converted mana cost is four, the mana required is ![](https://web.archive.org/web/20160830042801im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless4.gif), the spell gains you 4 life, the flavor text is four lines. (I'm kidding about that last one.) On the surface this might seem silly, but I have studied aesthetics long enough to know that if something feels right that it simply makes people happier and more receptive. Aesthetics, for those of you that haven't seen me talk about this before, is the study/philosophy of the creation and appreciation of beauty. It's a lot more objective than you might assume. (For more about aesthetics, feel free to check out my column [Zen and the Art of Cycle Maintenance](/Magic/Magazine/Article.aspx?x=mtgcom/daily/mr28).)
...
Predatory Advantage
[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Predatory+Advantage)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Predatory+Advantage)  
...
Sen Triplets
[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Sen+Triplets)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sen+Triplets)  
As the man behind [Mindslaver](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mindslaver), I've always had a fondness for messing with your opponent's stuff. This card answers the traditional problem that cards like Word of Command creates by only allowing one player at a time access to your opponent's hand. I also like that this card makes you pay for your opponent's spells with your own mana to give the card a limitation to work around in deck construction (and help keep the power to some extent in check).

Sigil Captain
[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Sigil+Captain)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sigil+Captain)  
...
> ![](https://web.archive.org/web/20211201201921im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless1.gif): Gain 1 life.
...
My 30 Cents
![](https://media.wizards.com/legacy//mtg/images/daily/mm/mm36_change.jpg)  
