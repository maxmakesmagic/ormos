...
---
[Link to Wayback Machine](https://web.archive.org/web/20220120193625/https://magic.wizards.com/en/articles/archive/feature/post-guildpact-pdc-2006-03-23)
...
[_metadata_:node]:- "620166"
[_metadata_:publish_date]:- "2006-03-23"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Post-Guildpact PDC"
[_metadata_:wayback_capture_timestamp]:- "2022-01-20 19:36:25"
...
As a follow-up to my [Swimming with Sharks](/en/articles/archive/cue-%E2%80%9Cjaws%E2%80%9D-theme-music-2006-03-16) foray, I thought I'd touch on playing in Two-Headed Giant Champs this past weekend. I hope that lots of you were able to give the format a try; it really is a lot of fun! It's also quite skill-testing - while we were playing, I could quickly tell whether my opponents had actually tested 2HG rather than just leaning exclusively on experience playing *Ravnica* block Limited. A common mistake was playing Magemarks on your teammate's creatures without realizing they don't function unless they are on a creature you control.


Team Jolly Green consisted of myself and longtime friend Josh Adams. In addition to playtesting the format with me, Josh is also a compulsive Limited player on MTGO, and puts in at least one draft a day. He knows *Ravnica* block Limited very well, so I was counting on him to recognize some synergies that might have otherwise gotten missed. One contribution I made was pointing out to him that [Cloudstone Curio](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cloudstone+Curio) has the word “may” on it, so that you can use it when you want to. Josh did some ridiculous things with the Curio throughout the day.


![Hex](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Hex)After seven rounds of Swiss, we found ourselves blessed by math and good fortune. One team at 5-2 would make Top 4, and that team was Jolly Green. We had an astonishing 67% for our tie-breakers; the very last round, nearly every team we had played in the Swiss after the first round was still in contention for the Top 4. After getting past the round of 4, winning the title was in sight. I got a fantastically aggressive draw: turn 1 [Frenzied Goblin](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Frenzied+Goblin); Josh played a turn 2 [Dimir Infiltrator](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dimir+Infiltrator). On turns 3 and 4 I played [Skyknight Legionnaire](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Skyknight+Legionnaire)s, and on turn 5 [Ghor-Clan Savage](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ghor-Clan+Savage) with a Bloodthirst counter. Our opponents had a slow start, with one Head stalled on mana, and the other Head with no fliers. We got our opponents from 40 to 24 life pretty quickly. Josh had a [Convolute](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Convolute) in hand and an [Orzhova, the Church of Deals](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Orzhova%2C+the+Church+of+Deals) in play, but decided to tap down to play his [Conclave Equenaut](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Conclave+Equenaut). I didn't object because my biggest concern was our opponents drawing a way to deal with my Savage; I really had no other beef in my hand and we wanted to put the game away before the guy drew out of his mana screw. There was only one card that would have made the Equenaut a terrible, terrible play, since it would be our sixth creature.
 Out of 88 possible rares in *Ravnica*, what would we least want to see be one of their 4 *Ravnica* rares? Yep; despite really good odds they would not have it, next turn they cast [Hex](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hex). We did not recover in time to prevent the game from swinging around in their favor, and ended up settling for 2nd place.


Now, one thing I've often read about when it comes to trying to better yourself as a **Magic** player is harnessing the inherent luck that's a factor in **Magic**. You can't do anything about “bad luck” or “good luck”, but you can certainly play the game to try and swing things in your favor. A great player would have realized there was no real reason to play another creature when we had clear board superiority; while the odds were against being so brutally punished for the move, we should have shut that window of opportunity for our opponent. Josh could have sat on the [Convolute](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Convolute) and just activated the Church EOT if he didn't need to stop a spell. I learned a valuable lesson, and hope that next time I can think like a great player.


### Win a Trip to L.A. for the Magic Invitational!


We will all be checking out the [**Magic** Invitational](/en/articles/archive/event-coverage/2006-magic-invitational-voting-2006-02-10) on ***Magic** Online* May 10-12, but wouldn't it be nice to attend the Electronic Entertainment Expo (E3) and see it in person? For the next week, about half of all MTGO Premier Events will be designated “E3 Qualifier Events.” Each E3 Qualifier will invite the Top 8 finishers to play in the “**Magic** Invitational at E3” Tournament on Saturday April 1, 2006. See the [***Magic** Online* Event Schedule](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=magic/magiconline/eventsmain) for a complete schedule of E3 Qualifiers, and check out the [**Magic** Invitational](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=magic/magiconline/article032006) at E3 page for more details!


### Guildpact for PDC


[Two weeks](/en/articles/archive/roving-reporter-2006-03-09) back I checked in with some multiplayer fans to see what Guildpact cards they thought would make a splash in group games. This week I checked in with the some of the Pauper Deck Challenge crew. For those who might be unfamiliar with PDC, I wrote about it here ([Spotlight on PDC](/en/articles/archive/spotlight-pdc-survivor-magic-2005-07-21)) and there are some links to other columns talking about the format. It's basically an all-common format, and there are Player Run Events tournaments that you can join, so if Standard, Extended or Classic gets a little rich for your blood, give PDC a try! 
...
> 
> *GloinOin*: I think the main cards that will develop into staples are the ones which bring entirely new elements to PDC. Obviously the “karoo” lands help two-color decks and [Scab-Clan Mauler](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Scab-Clan+Mauler) will see a lot of play in Red/Green beats. My personal standouts so far have been [Izzet Chronarch](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Izzet+Chronarch) and [Steamcore Weird](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Steamcore+Weird); they helped me to win mini PDC recently with a 12-0 game record. It's a basic Red/Blue counter-burn deck with *Guildpact* added. Evu came up with the idea of running [Cloudpost](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cloudpost)s to provide additional mana boosts to [Kaervek's Torch](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kaervek%27s+Torch) and [Condescend](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Condescend).
> 
> 
> 
...
> 
> *GloinOin*: The sideboard was prepared for an aggro metagame, with [Smash](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Smash) there to help fend off Affinity. Currently the main decks to beat are: Red/Green beats, mono-Blue control Affinity, and Mono-Black Control. Counter-burn decks and a deck based around abusing [Nantuko Husk](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Nantuko+Husk) and token creatures are on the rise. The Husk deck is capable of turn 4 or 5 kills on a good day. There is also a pet project of lathspel and myself, built around [Spiraling Embers](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Spiraling+Embers) and [Oboro Breezecaller](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Oboro+Breezecaller). It can goldfish on turn 5, but is inconsistent against control. It uses [Rush of Knowledge](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rush+of+Knowledge) and the land Affinity golems from *Darksteel*.
> 
> 
> *SpikeBoyM*: Some of the early heavy hitters now are the “karoo” lands (which we love) and [Blind Hunter](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blind+Hunter) because it is in colors that don't get used often, and it's just a nutty card in a creature-based format like PDC. A lot of people are going to try and make [Wee Dragonauts](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wee+Dragonauts) work because they can get ridiculous fast. I feel the best place for them is in the [Ire of Kaminari](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ire+of+Kaminari) decks floating around, with the Dragonauts as an alternate win condition. There's nothing like [Lava Spike](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lava+Spike) spliced with [Glacial Ray](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Glacial+Ray), then cast [Glacial Ray](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Glacial+Ray), then attacking for 5. 
> 
> 
> 
...
#### Ire Dragonauts (PDC) by SpikeBoyM
...
3
[Murmurs from Beyond](https://gatherer.wizards.com/Pages/Search/Default.aspx?name=+%5BMurmurs%5D+%5Bfrom%5D+%5BBeyond%5D)
...
> 
> *SpikeBoyM*: Most of the Bloodthirst creatures will make a huge splash, especially the Mauler and the Ghor Clan commons. They will really make Red/Green aggro even better. My sleeper pick for *Guildpact* would have to be [Mourning Thrull](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mourning+Thrull), it just seems like it could be really powerful. 
> 
> 
> 
...
The first post-*Guildpact*, post-[Pro Tour Honolulu](/en/events/coverage/living-heezy-street) Standard Open 4x event kicked off with a good crowd of 154 players. Unlike Honolulu, this Top 8 was dominated by Orzhov, with full half sporting White and Black spells. Heezy Street (Gruul), Zoo, Izzetron, Owling Mine and Heartbeat were all MIA for this one.
...
1st Place: mikeman29, Greater Gifts  
 ...
 8th Place: rip\_kolm, Wildfire


![Gifts Ungiven](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Gifts+Ungiven)In taking the top prize, mikeman29 went with tried-and-true power, utilizing the [Gifts Ungiven](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gifts+Ungiven) engine to set up [Yosei, the Morning Star](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Yosei%2C+the+Morning+Star) and [Greater Good](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Greater+Good). From the replays, Khaim's Ghost Dad looked like a fairly standard build, while Kirushi took a page from Olivier Ruel's Hand in Hand deck and added the resilient [Paladin en-Vec](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Paladin+en-Vec) to the [Tallowisp](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tallowisp) team. WedUk had many elements of Ghazi-Glare, but appeared to be a bit more aggressive and I never saw [Glare of Subdual](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Glare+of+Subdual). His early game critters picked up Jittes and swung, before accelerating into [Arashi, the Sky Asunder](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Arashi%2C+the+Sky+Asunder)s and [Kodama of the North Tree](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kodama+of+the+North+Tree). Decimator88 and bobthedog's B/W aggro decks appeared to be very similar to Ruel's Honolulu Top 8 Hand in Hand deck. LankanProdigy walked a rogue path with a Boros mana base chock full of efficient damage dealers like [Lava Spike](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lava+Spike), [Char](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Char) and [Lightning Helix](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Helix) backed with Isamaru and [Scorched Rusalka](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Scorched+Rusalka). rip\_kolm utilized the familiar but still potent sorcery-driven [Wildfire](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wildfire) strategy to punish weenie decks and shaky mana bases alike.
 ### Magic Invitational: My Writer's Pick


For the Writer's Pick in the **Magic** Invitational voting, *Scrye* magazine was given a vote. In addition to writing Into The Aether for mtg.com, I have also written for *Scrye* for several years, and as Contributing Editor covering **Magic**, I was given the honor of determining our vote. We did not have room in our next issue to fully explain my picks, so I thought I'd do so here.
...
*Lifetime Pro Points*—all are talented or else they wouldn't be pros and they wouldn't be on the list to begin with, but I had to figure out a way to rate them relative to one another in terms of raw skill. This seemed like the most straightforward approach.


*Wizards.com Search Hits*—Pro Tours and Grand Prix are covered on Wizards' website, and between the interviews, feature matches, and reporter blogs, I figured this would be one way to see who has attracted the most attention.
...
I got an email from WizO\_Kwai\_Chang, who wanted to share with us a new feature now found on the Wizards.Community forum boards.



> 
> *WizO\_Kwai\_Chang*: I am a moderator on the Wizards Message Boards. I wanted to alert you of our new "MTGO Events Calendar."
> 
> 
...
> 
> 
> I then asked my superiors for some means to provide the results to the public. And so, the [MTGO Events Calendar](http://boards1.wizards.com/calendar.php?c=4) was born!
> 
> 
