...
---
[Link to Wayback Machine](https://web.archive.org/web/20151115092632/http://magic.wizards.com/en/articles/archive/feature/legendary-cube-2015-11-09)
...
"I'll use my [Pyromancer's Goggles](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pyromancer%27s+Goggles) to cast [Cruel Ultimatum](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cruel+Ultimatum). Copy it with [Mirari](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mirari)."
...
Simply put, the *Legendary Cube* is a cube where 100% of the creatures are legendary! This is the cube for Avacyn, Dragonlords, and many of your favorite commanders. This means that many creatures that are staples of other cubes, such as [Eternal Witness](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Eternal+Witness), [Noble Hierarch](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Noble+Hierarch), and [Hero of Bladehold](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hero+of+Bladehold), are not present in this cube. As such, the focus of the *Legendary Cube* is less about representing *Magic*'s most powerful cards and more about supporting the "legendary" theme and providing a unique Cube experience.


The most noticeable difference between the *Legendary Cube* and most cubes is the distribution of mana costs among the creatures. On average, the creatures in the *Legendary Cube* are more powerful, but require more mana to cast. While the *Legendary Cube* contains the occasional [Zurgo Bellstriker](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Zurgo+Bellstriker) or [Saffi Eriksdotter](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Saffi+Eriksdotter), most of the creatures feel more at home next to [Reya Dawnbringer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Reya+Dawnbringer) and [Maelstrom Wanderer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Maelstrom+Wanderer).
...
This is also the first time that a *Magic Online* cube contains two copies of the same card in the same cube. Of course, that honor goes to none other than the [Brothers Yamazaki](http://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=85106)! For the record, my favorite [Brothers Yamazaki](http://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=78968) is the left half, but don't tell the right half!
...
When you are drafting the *Legendary Cube*, look for cards that work well together. Many of the cards are open-ended, but require some other cards to unlock their full potential. The two planeswalkers in the cube, [Daretti, Scrap Savant](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Daretti%2C+Scrap+Savant) and Tezzeret, the Seeker, require a heavy artifact commitment. There are also other cards that reward you for having lots of artifacts, such as [Pia and Kiran Nalaar](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pia+and+Kiran+Nalaar) and [Trading Post](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Trading+Post). The [five Honden](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&name=+%5bHonden%5d)s from *Champions of Kamigawa* are here, and they work extremely well if you can put multiples together. [Temur Ascendancy](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Temur+Ascendancy) is a hilarious combo with [Obzedat, Ghost Council](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Obzedat%2C+Ghost+Council) if you can stomach the hefty mana requirements. These are just a few of the examples; there are countless combinations to discover.


However, you also should pay attention to your mana requirements. There is enough mana-fixing to support three-, four-, and even five-color decks. [Progenitus](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Progenitus) is in the *Legendary Cube*, and the primary way to get it onto the battlefield is to cast it. In addition to the increased multicolored nature of the cards, the cards also require more mana on average. Don't be afraid to play more lands and mana-producing cards such as [Rampant Growth](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rampant+Growth) or [Chromatic Lantern](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Chromatic+Lantern).
...
[![](https://web.archive.org/web/20160726232508im_/http://magic.wizards.com/sites/all/modules/features/wiz_bean_content_deck_list/icons/decklist_download.png)](/en/decklist/deck-list-f17d94fa2e6451c6e6e7a16e2ea44805?n=Red-Green%20Legendary%20Cube%20Draft)
...
2
[Brothers Yamazaki](http://gatherer.wizards.com/Pages/Search/Default.aspx?name=+%5BBrothers%5D+%5BYamazaki%5D)


1
[Reki, the History of Kamigawa](http://gatherer.wizards.com/Pages/Search/Default.aspx?name=+%5BReki,%5D+%5Bthe%5D+%5BHistory%5D+%5Bof%5D+%5BKamigawa%5D)
...
1
[Pure // Simple](http://gatherer.wizards.com/Pages/Search/Default.aspx?name=+%5BPure%5D+%5B&%5D+%5BSimple%5D)
...
![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Radha%2C+Heir+to+Keld)
...
This was one of the few two-color decks I drafted, but there was a ton of cool stuff going on in the draft. [Basilisk Collar](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Basilisk+Collar) was an MVP, in combination with [Godo, Bandit Warlord](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Godo%2C+Bandit+Warlord), [Kumano, Master Yamabushi](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kumano%2C+Master+Yamabushi), or even [Shinka, the Bloodsoaked Keep](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shinka%2C+the+Bloodsoaked+Keep). I was also able to use [Time of Need](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Time+of+Need) to assemble both of the [Brothers Yamazaki](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Brothers+Yamazaki) with this deck.
...
[![](https://web.archive.org/web/20160726232508im_/http://magic.wizards.com/sites/all/modules/features/wiz_bean_content_deck_list/icons/decklist_download.png)](/en/decklist/deck-list-ac57669ac1732c5626576468efeb24d0?n=Grixis%20Spells%20Matter%20Legendary%20Cube%20Draft)
...
![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Beacon+of+Destruction)
...
This was the deck that made the triple [Cruel Ultimatum](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cruel+Ultimatum) play at the beginning of the article. As is typical of many decks without much ramp, this deck played nineteen lands and really needed all of them. I won a few games by casting the same [Beacon of Destruction](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Beacon+of+Destruction) multiple times.
...
[These cards](http://magic.wizards.com/en/MTGO/articles/archive/legendary-cube-cardlist-2015-11-09)!


Here's the part where I hand off the *Legendary Cube* to you. I highly encourage you to log in to *Magic Online* and try out the cube, even if it's just once. It's such a unique and fun format, and I want every fan of *Magic* to experience the same joy I have while playing this cube. I know that I'll be hanging out in the queues. If you see Wotc\_AdamP in your draft pod, feel free to say hello and let me know what you think!
