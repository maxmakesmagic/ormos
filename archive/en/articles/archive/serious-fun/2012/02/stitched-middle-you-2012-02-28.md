...
---
[Link to Wayback Machine](https://web.archive.org/web/20170515014116/http://magic.wizards.com/en/articles/archive/serious-fun/stitched-middle-you-2012-02-28)

[_metadata_:author]:- "Adam Styborski"
[_metadata_:description]:- "Last week's return to Horde Magic was awesome. The email inbox, Twitter mentions, and forum responses were loaded with ideas, critiques, and feedback. Everyone has a slightly different view of having fun with the Horde, and it's in mixing and matching these perspectives that you can craft your local pile of Zombies into exactly what you need."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "691141"
[_metadata_:publish_date]:- "2012-02-28"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Stitched in the Middle with You"
[_metadata_:wayback_capture_timestamp]:- "2017-05-15 01:41:16"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20170515014116id_/http://magic.wizards.com/en/articles/archive/serious-fun/stitched-middle-you-2012-02-28"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/serious-fun/stitched-middle-you-2012-02-28"
---


Stitched in the Middle with You
===============================
...
Last week's [return to Horde **Magic**](/en/articles/archive/serious-fun/then-we-will-fight-shade-2012-02-21) was awesome. The email inbox, Twitter mentions, and forum responses were loaded with ideas, critiques, and feedback. Everyone has a slightly different view of having fun with the Horde, and it's in mixing and matching these perspectives that you can craft your local pile of Zombies into exactly what you need.


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/sf/sf184_horde.jpg)We'll be hitting three topics in no particular order:
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/sf/sf184_call.jpg)How and what to change in your Horde is a very detailed discussion. There are two reasons why fighting the Horde often feels this way.


**1. Your Decks Are Too Powerful**


I love wacky decks with tenuous conditions of victory that rely on hard-to-assemble contraptions of cards. I also love decks teeming with [Demonic Tutor](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Demonic+Tutor) derivatives and an entire kitchen sink of things that will "answer" anything opponents throw out there. In truth, most of my decks are a mix of each extreme, often leaning further to the "wacky good fun" than many of you prefer.
...
> 
> Specifically building a deck to go against the Horde deck seems like a really awful idea and should be avoided at all costs. I stopped reading the article after I read that you played [An-Zerrin Ruins](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=An-Zerrin+Ruins) and chose Zombies. Seriously, how is the format supposed to be anything like *Left 4 Dead* when you have easy anti-Zombie tech?
> 
> 
> 
...
It's a delicate balance only you and your fellow players can discuss and agree too. I compare preparing for the Horde to how I approach parties in roleplaying games: I don't always form parties to go dragon hunting, but when I do I come *fully* prepared. The idea that certain cards are too powerful is entirely subjective. I feel that since the Horde is breaking several fundamental rules of **Magic**, getting to break out some anti-Zombie gear is entirely reasonable. I chose to self-limit it's availability in my red deck since I only had two such spells and only one way to go grab it at will (which was a [Gamble](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gamble) in itself).


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/sf/sf184_pox.jpg)Of course, what constitutes "too powerful" is also dependent upon another aspect of Horde **Magic**.
...
> 
> Aww, no [Noxious Ghoul](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Noxious+Ghoul)? Could be a pretty good [Wrath](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wrath) effect for the Zombies. Bring your spot removal...
> 
> 
> 
...
![Noxious Ghoul](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Noxious+Ghoul)

 

Yeah. I can get behind this. The Horde never has mana issues, so spells like [Plague Wind](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Plague+Wind) and [Decree of Pain](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Decree+of+Pain) are never an issue. Those spells are also boring. Zombies eat brains (and players), and [Noxious Ghoul](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Noxious+Ghoul) is a step in the right direction: it will do some serious damage to non-Zombie creatures (namely, the Survivors) while still getting to attack.


I might or might not have tried to trade for a foil [Noxious Ghoul](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Noxious+Ghoul) last weekend at Grand Prix Baltimore.



> 
> The Horde should include [Bone Harvest](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bone+Harvest), [Footbottom Feast](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Footbottom+Feast), and [the functional reprint in *Dark Ascension*](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=the+functional+reprint+in+Dark+Ascension). That would be pretty nuts.
> 
> 
> 


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/sf/sf184_3card.jpg)Zindaras shared this idea in the forum, and I have to say I was thrown for a loop. Since the Horde casts one "nontoken" spell each turn, what benefit would these have for the shamblers?
...
* [Nested Ghoul](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Nested+Ghoul)
* [Noxious Ghoul](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Noxious+Ghoul)
* [Unbreathing Horde](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Unbreathing+Horde)
* [Geralf's Mindcrusher](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Geralf%27s+Mindcrusher)

And if you're able to reload the Horde *and* have it cast multiple spells, something like [Graveborn Muse](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Graveborn+Muse) can become a very devious and powerful addition. After all, the Horde doesn't lose if it can't draw a card!
...
Josh W. emailed to note that [Archdemon of Unx](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Archdemon+of+Unx) seemed to stand out in a bad way.



> 
> A good replacement for the Archdemon is [Vulturous Zombie](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vulturous+Zombie). It might not have the initial sting that the Archdemon has, but it can get big over time (and it flies).
> 
> 
> 
...
Sacrificing the Archdemon on the Horde's next turn feels awkward, though. While you can just fudge the rules to skip that part, changing things to something that just works is often better. I like [Vulturous Zombie](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vulturous+Zombie), and since I've already stretched the color base to include some blue, the spice of green shouldn't hurt either.
...
> 
> A pairing of [Endless Ranks of the Dead](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Endless+Ranks+of+the+Dead) with [Paradox Haze](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Paradox+Haze).
> 
> 
> 
...
* [Endless Ranks of the Dead](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Endless+Ranks+of+the+Dead) adds X/2 Zombie tokens to the battlefield, where X is the current number of Zombies in play.
* With [Paradox Haze](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Paradox+Haze), [Endless Ranks of the Dead](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Endless+Ranks+of+the+Dead) will trigger and resolve again, adding another X/2 Zombies to the battlefield, where X is still the current number of Zombies in play.
* How many Zombie tokens will you add each turn?

With a little numerical and algebraic judo, [Endless Ranks of the Dead](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Endless+Ranks+of+the+Dead) and [Paradox Haze](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Paradox+Haze) will add (5/4)X Zombies to the battlefield through both triggers. For bonus points (and my greatest admiration), how many will be added if there is a second [Paradox Haze](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Paradox+Haze) in play?
...
If you're a fan of the [Footbottom Feast](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Footbottom+Feast) (and friends) suggestion above, this is one way to make those spells work well. Giving the Horde a chance to keep up with the Joneses not only makes sense, but lets the same Horde play dynamically different if more or less of your friends show up!
...
![Footbottom Feast](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Footbottom+Feast)
...
Join us next week when we see the final fate of [Ghave, Guru of Spores](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ghave%2C+Guru+of+Spores). See you then!
