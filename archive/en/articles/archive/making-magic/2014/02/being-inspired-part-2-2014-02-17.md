...
---
[Link to Wayback Machine](https://web.archive.org/web/20220706002530/https://magic.wizards.com/en/articles/archive/making-magic/being-inspired-part-2-2014-02-17)

[_metadata_:description]:- "Last week was Inspiration Week, but instead of talking about the inspired mechanic (which I already had) I chose instead to talk about the inspiration for each and every block in Magic's history, starting with Theros block and moving backwards. I got as far as Ravnica block (the original one), so today we're going to start with Champions of Kamigawa block. Champions of"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "154791"
[_metadata_:publish_date]:- "2014-02-17"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Being Inspired, Part 2"
[_metadata_:wayback_capture_timestamp]:- "2022-07-06 00:25:30"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20220706002530id_/https://magic.wizards.com/en/articles/archive/making-magic/being-inspired-part-2-2014-02-17"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/making-magic/being-inspired-part-2-2014-02-17"
---
...
Last week was [Inspiration Week](/node/154656), but instead of talking about the inspired mechanic ([which I already had](/node/152776)) I chose instead to talk about the inspiration for each and every block in Magic's history, starting with *Theros* block and moving backwards. I got as far as Ravnica block (the original one), so today we're going to start with *Champions of Kamigawa* block.


### *Champions of Kamigawa* Block


When Richard Garfield designed *Arabian Nights*, his goal was to make a set that captured an existing world. *Homelands*, a year or so later, would try to make a set built around the flavor not of an existing world but of one that the designers had made up, heavily influenced by popular elements of early Magic like Serra Angel and Sengir Vampire. *Champions of Kamigawa* block was the first attempt to try this approach, what we refer to as "top-down" design, as the inspiration for an entire block. ([Here, by the way](http://archive.wizards.com/magic/magazine/article.aspx?x=mtgcom/daily/mr75), is my article from Top-Down Week, if you'd like more information on what it entails.)


![](https://media.wizards.com/images/magic/daily/mm/2014/mm_wk07_287_cardart_forlornpsrudamma.jpg)
Forlorn Pseudamma | Art by [Winona Nelson](http://gatherer.wizards.com/pages/search/default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22winona%20nelson%22%5D)
...
Note that I wanted to go all in. I didn't just want a block *with*artifacts, I wanted a block *about* artifacts. In fact, I wanted a world about artifacts. The head of the creative team at the time was Tyler Bielman. He and I got the idea of a metal world and started planning.


Tyler and I were planning to completely rework how artifacts worked. We came up with five subtypes for artifacts and were planning to make a stark divide between what artifacts and enchantments could do to mechanically separate them. We had very lofty goals, but in the end, all our work did lead to a world made of metal. (Note that a lot of where *Mirrodin* ended up came from [Brady Dommermuth](http://archive.wizards.com/Magic/Magazine/Archive.aspx?author=Brady%20Dommermuth) and then-art director Jeremy Cranford.)
...
![](https://media.wizards.com/images/magic/daily/mm/2014/mm_wk07_287_cardart_felhidespiritbinder.jpg)
Felhide Spiritbinder | Art by [Mathias Kollros](http://gatherer.wizards.com/pages/search/default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22mathias%20kollros%22%5D)
...
Like *Mirrodin* block, this was another block where I was tapping into one of my personal favorites of the game. I have always enjoyed graveyard interactions, going all the way back to Animate Dead in Alpha,which I put in far too many of my decks. In fact, if you chart out all of Magic you will see that I am responsible for a significant amount of graveyard-matters cards, including creating the mechanics [flashback](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=standard&action=advanced&text=+%5Bflashback%5D+%5Byou%5D+%5Bmay%5D), [unearth](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=standard&action=advanced&text=+%5Bunearth%5D), [delve](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=standard&action=advanced&text=+%5Bdelve%5D+%5Beach%5D+%5Bexile%5D), [Gravestorm](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=standard&action=advanced&text=+%5Bgravestorm%5D), [retrace](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=standard&action=advanced&text=+%5Bretrace%5D), [the "kindle" mechanic](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=standard&action=advanced&text=+%5Bplus%5D+%5Bnumber%5D+%5Bcards%5D+%5Bnamed%5D+%5Ball%5D), and [dredge](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=standard&action=advanced&text=+%5Bdredge%5D).
...
![](https://media.wizards.com/images/magic/daily/mm/2014/mm_wk07_287_cardart_arbiteroftheideal.jpg)
Arbiter of the Ideal | Art by [Svetlin Velinov](http://gatherer.wizards.com/pages/search/default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22svetlin%20velinov%22%5D)
...
*Mercadian Masques* was originally built around [Rebels](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&format=+%5B%22Masques+Block%22%5D&subtype=+%5B%22Rebel%22%5D)/[Mercenaries](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&format=+%5B%22Masques+Block%22%5D&subtype=+%5B%22Mercenary%22%5D) and [Spellshapers](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&format=+%5B%22Masques+Block%22%5D&subtype=+%5B%22Spellshaper%22%5D). It's interesting to note that neither was named, making many players feel as if the set had no new mechanics. It was this overwhelming response that made R&D rethink how we treated keywords and made us much more willing to put a name on a mechanic so the audience could easily identify it.


As this was part of the *Weatherlight* Saga, some may ask if the world of Mercadia or the adventures of the *Weatherlight* crew played any role in inspiring the design. The answer was no. At the time, there was a bit of disconnect between R&D and the people in charge of the creative, so while we did things like make Squee, Goblin Naboba Squee card, the mechanical identity had very little to do with the plot of the story.


### *Urza's Saga* Block


This was another block that started off by figuring out its two main mechanics, which in this case were [echo](http://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&output=spoiler,visualspoiler&format=+%5B%22Urza%20Block%22%5D&text=+%5Becho%5D) and [cycling](http://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&output=spoiler,visualspoiler&format=+%5B%22Urza%20Block%22%5D&text=+%5Bcycling%5D). Interestingly, both mechanics, the first made by Mike Elliott (who was also lead designer of this set) and the second by Richard Garfield, were both originally in *Tempest* design. Mike's echo mechanic hadn't started there, though. Mike had made it in a personal set called Astral Ways he had designed before being hired at Wizards. That same set also had [the Sliver mechanic](http://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&output=standard,standard&subtype=+%5B%22Sliver%22%5D&set=+%21%5B%22Magic%202014%20Core%20Set%22%5D).


![](https://media.wizards.com/images/magic/daily/mm/2014/mm_wk07_287_cardart_servantoftymaret.jpg)
Servant of Tymaret | Art by [Karl Kopinski](http://gatherer.wizards.com/pages/search/default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22karl%20kopinski%22%5D)
...
![](https://media.wizards.com/images/magic/daily/mm/2014/mm_wk07_287_cardart_sphinxsdisciple.jpg)
Sphinx's Disciple | Art by [Ryan Alexander Lee](http://gatherer.wizards.com/pages/search/default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22ryan%20alexander%20lee%22%5D)


Bill said the goal of his design team was to focus on creatures and make them central to the game play. For instance, the two main mechanics of the set were [flanking](http://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&text=+%5Bflanking%5D&format=+%5B%22Mirage%20Block%22%5D) and [phasing](http://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&text=+%5Bphasing%5D&format=+%5B%22Mirage%20Block%22%5D), both creature abilities. The *Mirage* design team was also focused on making sure there was a full mana curve of creatures and that things like evasion were plentiful. This, by the way, was a huge contrast to *Ice Age*, the other set that was being designed at the same time. For those who have never had the chance to play *Ice Age* Limited, the set had a lower percentage of creatures that were, on average, smaller and had few evasion abilities.
...
I'm not sure when the *Ice Age* Nordic flavor got added, but my best guess is, like *Mirage* and its African-inspired flavor, it probably came later in design and was not part of the original inspiration of the set. I do know that the design team was very conscious of thinking about basic things that could be added to the game that were not there originally. I'm pretty confident, for instance, that they had multicolor cards in their set before Steve Conard and his team started designing *Legends*. With things like [cantrips](http://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&text=+%5Bdraw%5D+%5Bcard%5D&format=+%5B%22Ice%20Age%20Block%22%5D) and [cumulative upkeep](http://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&text=+%5Bcumulative%5D+%5Bupkeep%5D&format=+%5B%22Ice%20Age%20Block%22%5D), the East Coast Playtesters were looking for new staples that could be added to the game.
...
As always, I am eager to hear what you think about some of the stories I shared this and last week. You can email me, post comments in this article's thread, or contact me through any of my social media ([Twitter](https://twitter.com/maro254), [Tumblr](http://markrosewater.tumblr.com/), [Google+](https://plus.google.com/107824009487778543249/posts), and [Instagram](http://instagram.com/mtgmaro#)).
