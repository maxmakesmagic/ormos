...
Great Designer Search 3 – Meet the Top 8
========================================
...
Trial 1 was ten questions each requiring a 250- to 350-word answer. You can see the design test along with what criteria we were looking for [here](https://magic.wizards.com/en/articles/archive/making-magic/essay-what-you-will-2018-02-05).


3,056 people turned in the first trial and advanced to Trial 2, a multiple-choice test. Trial 2 had 75 questions covering a variety of design and R&D issues. (You can see the test [here](https://magic.wizards.com/en/articles/archive/making-magic/make-choice-part-1-2018-02-12) and [here](https://magic.wizards.com/en/articles/archive/making-magic/make-choice-part-2-2018-02-19), along with the answers.) 94 candidates scored 73 or higher to advance to Trial 3, a design test.


The design test asked the contestants to design ten two-color cards to a specific set of constraints. (You can see Trial 3 along with my take on the challenges of the test [here](https://magic.wizards.com/en/articles/archive/making-magic/reading-designs-2018-03-05).) From this pool of 94 (using all three tests as judging material), I narrowed down the pool to fifteen candidates. My fellow judges and I then narrowed down the field to today's Top 8.
...
![](https://media.wizards.com/2018/images/daily/GDS3_Werner_sm.png)
...
*I've always loved creating puzzles and games, so I immediately started designing my own cards. I remember two from that first day: a magical ring that would double spells that you cast through it (i.e., [Mirari](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mirari)) and a kind of Totem Armor for enchantments to protect my Circles of Protection, because I really loved Circles of Protection. Well, one out of two ain't bad . . .*
...
![](https://media.wizards.com/2018/images/daily/GDS3_Nieh_sm.png)
...
![](https://media.wizards.com/2018/images/daily/GDS3_Mooney_sm.png)
...
* *Favorite draft deck: [Burning Vengeance](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Burning+Vengeance) (with [Laboratory Maniac](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Laboratory+Maniac) backup)*
* *Favorite combo: [Gravecrawler](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gravecrawler), [Rooftop Storm](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rooftop+Storm), and [Grimgrin](http://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=247237)*
...
![](https://media.wizards.com/2018/images/daily/GDS3_Treat_sm.png)
...
![](https://media.wizards.com/2018/images/daily/GDS3_Geist_sm.png)
...
Favorite card: [Mycoloth](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mycoloth) to play and [Fatal Push](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fatal+Push) as a design  

Favorite basic lands:* Shards of Alara *(Esper)  

Favorite art: [Rekindling Phoenix](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rekindling+Phoenix)  

Favorite flavor text: [Brine Elemental](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Brine+Elemental)  
...
![](https://media.wizards.com/2018/images/daily/GDS3_Hamilton_sm.png)
...
![](https://media.wizards.com/2018/images/daily/GDS3_Siegel-Stechler_sm.png)
...
![](https://media.wizards.com/2018/images/daily/GDS3_Wilson_sm.png)


*Hey everyone! My name is Scott Wilson, and I'm a Japanese translator, ready to translate some sweet ideas into* Magic *cards. I've been playing* Magic *for eighteen of my 30 years on this planet, ever since* Mercadian Masques *seduced me away from other TCGs because I thought [Wishmonger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wishmonger) was the coolest card ever.*
...
![](https://media.wizards.com/2018/images/daily/FEAT20180309_Lauer.png)
