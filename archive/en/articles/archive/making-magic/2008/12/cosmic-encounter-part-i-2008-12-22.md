...
---
[Link to Wayback Machine](https://web.archive.org/web/20160221020229/http://magic.wizards.com/en/articles/archive/making-magic/cosmic-encounter-part-i-2008-12-22)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "Hey, it's Rerun Week! No wait, that was last week. Oh yes, it's Wizards Employees Have the Nerve to Take a Holiday Break Week, Part I! What we do during this two weeks is let each columnist choose their favorite two articles of the year to reprint. After combing through all my columns from 2008 I whittled it down to two (okay, three actually, but you'll see in a minute what I mean). The first is my personal favorite and the second is the one that I felt was my best design column of the year."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "654586"
[_metadata_:publish_date]:- "2008-12-22"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Cosmic Encounter, Part I"
[_metadata_:wayback_capture_timestamp]:- "2016-02-21 02:02:29"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20160221020229id_/http://magic.wizards.com/en/articles/archive/making-magic/cosmic-encounter-part-i-2008-12-22"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/making-magic/cosmic-encounter-part-i-2008-12-22"
---


Cosmic Encounter, Part I
========================
...
*My runner-up personal favorite was [IM Legend](/en/articles/archive/making-magic/im-legend-2008-06-09), my first article of the year where I talk to the colors. The one where they all IM me (if that wasn't apparent from the title—which by the way was my favorite title of the year).*

![Mark and Lora Rosewater](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm8_dip.jpg)  
Last Friday was my tenth wedding anniversary. It's kind of nice that I get a day each year to commemorate the best decision I've ever made in my life. (Yes, choosing to work for Wizards of the Coast only comes in second—I can see the shocked letters now.) My anniversary got me thinking back to ten years earlier—to the wedding itself. You see, Lora's and my wedding was not what you might call typical. In fact, the wedding was such a departure from a traditional wedding that I always thought it would make an excellent topic for an article.

But wait, this is a **Magic** column. What does my wedding have to do with **Magic** design? A lot more than you might think. How is that? Because I used a technique in planning my wedding that I use for every set I design. That technique is a powerful tool known as the theme. Yes, I've already spent a column [explaining why sets have themes](/en/articles/archive/making-magic/phage-against-machine-2003-01-13) but I've never properly explained how to use a theme to enhance a set's design. As a companion piece to walking through how to use a theme to design a **Magic** card set I thought I'd contrast against a real world application, like say, the planning of a wedding. Perhaps a wedding near and dear to my heart. Perhaps my own wedding to Lora (whose maiden name was Lora Montrose, for you trivia buffs). For each lesson, I'll start with an example from my wedding and then apply the same lesson to a **Magic** set, *Shards of Alara* in particular, as that is the set of the moment.
...
![What's this?](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm8_piecesbag.jpg)  
...
![A puzzle!](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm8_puzzle.jpg)  
Here's what our invitation looked like when you put it all together: (You can click on it to see a larger version.)

![Monogamy: Mark & Lora's Real Treat Wedding Game](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm8_monopoly.jpg)*Click to enlarge*  
...
![Trivial Pursuit](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm8_trivialpursuit.jpg)  
Our cake

![The Game of Life looks delicious!](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm8_cake1.jpg)  
Our "Wedding Program"

![Word Search](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm8_wordsearch.jpg)  
Our "Thank You" notes

![[CAPTION]](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm8_madlibs.jpg)  
Our "Return Address Sticker" on our invitation

![The classic 14/15 sliding puzzle](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm8_1415.jpg)  
...
![Wedding Favors](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm8_favors.jpg)  
...
![Giant Die](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm8_die.jpg)  
...
![Wedding Pool](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm8_weddingpool.jpg)  
...
While we were pretty blunt with the theme in our wedding, **Magic** design does have the opportunity to be more subtle. One of the things I'm very happy with in *Shards of Alara* design is how often we were able to make a card relevant to one or more shards without having to hit the players over the head with it. My favorite designs were the ones where we took a card in a single color and made it relevant to every shard that color could be played in. As an example, let's take [Puppet Conjurer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Puppet+Conjurer):

![Puppet Conjurer](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Puppet+Conjurer)The card is black so it can fit in three shards: Esper, Grixis and Jund. Let's take a look at each.

**Esper** – Esper likes this card for two reasons. First, it's an artifact creature. Second, it makes additional artifact creatures. Esper has plenty of ways to take advantage of that. One of my favorite [Puppet Conjurer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Puppet+Conjurer) combos, which made it all the way through from design, is combining it with [Etherium Astrolabe](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Etherium+Astrolabe). 

![Etherium Astrolabe](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Etherium+Astrolabe)**Grixis**—Grixis is a world filled with sacrifice. [Puppet Conjurer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Puppet+Conjurer) creates creatures that are already marked for death. Combine with cards like [Deathgreeter](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Deathgreeter) for lots of fun.

![Deathgreeter](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Deathgreeter)**Jund**—Jund combines creatures eating creatures with rewards for death. [Puppet Conjurer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Puppet+Conjurer)'s temporary Homonculi provides the perfect fodder. (I know that [Puppet Conjurer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Puppet+Conjurer)'s blue activation makes this card less Jund friendly than it does with the other shards—the blue activation, by the way, was added in late development so I have lots of good memories of [Puppet Conjurer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Puppet+Conjurer) and [Hissing Iguanar](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hissing+Iguanar).)

![Hissing Iguanar](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Hissing+Iguanar)My point here is that making themes matter matters.
...
![Cake Closeup](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm8_cake2.jpg)  
...
On both the *Un*-set designs, for example, I crammed the cards full of as many jokes as I possibly could. (Many of *Unglued*'s jokes are explained [here](/en/articles/archive/get-it-2004-08-16-0).) I knew the key to humor was exploiting each and every opportunity.

![Rocket-Powered Turbo Slug](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Rocket-Powered+Turbo+Slug)One of my favorites was in the layout for [Rocket-Powered Turbo Slug](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rocket-Powered+Turbo+Slug); the Slug is running so fast that it mixes up the words to the flavor text. If you take the time to unscramble the letters to recreate the flavor text you get: "Did you go through all that trouble just to read this?" Did I have to go to that level of detail, a joke designed only if players are willing to descramble it? Yes, I believe I did. I believe the set is that much better a design for me taking the time to weave the theme down to the minutiae. Little things *do* mean a lot.
...
[Read Part II](/en/articles/archive/cosmic-encounter-part-ii-2008-10-27)
