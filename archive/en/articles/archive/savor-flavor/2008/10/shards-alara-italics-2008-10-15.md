...
---
[Link to Wayback Machine](https://web.archive.org/web/20200921133750/https://magic.wizards.com/en/articles/archive/savor-flavor/shards-alara-italics-2008-10-15)

[_metadata_:author]:- "Doug Beyer"
[_metadata_:description]:- "The name, art, and game-play feel of a card's mechanics do plenty of work to communicate the world behind the card. But nothing opens the door to that other world like a well-written piece of flavor text. While I write a lot of the flavor text that ends up on Magic cards these days, my main role when it comes to creative text is a thrilling one: to sit back, let others submit inspired flavor text, and cherry-pick the very best ones to go on the cards."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "692731"
[_metadata_:publish_date]:- "2008-10-15"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Shards of Alara in Italics"
[_metadata_:wayback_capture_timestamp]:- "2020-09-21 13:37:50"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20200921133750id_/https://magic.wizards.com/en/articles/archive/savor-flavor/shards-alara-italics-2008-10-15"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/savor-flavor/shards-alara-italics-2008-10-15"
---


*Shards of Alara* in Italics
============================
...
The name, art, and game-play feel of a card's mechanics do plenty of work to communicate the world behind the card. But nothing opens the door to that other world like a well-written piece of flavor text. While I write a lot of the flavor text that ends up on **Magic** cards these days, my main role when it comes to creative text is a thrilling one: to sit back, let others submit inspired flavor text, and cherry-pick the very best ones to go on the cards. Today I'd like to saunter down the flavor-strewn path of *Shards of Alara* with you at my side, and point out just a few of my favorites. First up is the shard of Bant.

### Bant

[![Bant_Battlemage](https://media.magic.wizards.com/image_legacy_migration/magic/images/cardart/ALA/Bant_Battlemage.jpg)](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Bant%2BBattlemage)**[Bant Battlemage](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bant+Battlemage)**

One of my favorite aspects of Alara's five shards is the way that each sub-plane has grown around a system of only three types of mana each. Bant is flush with the magic of honor, growth, and manipulation, but not of direct control over fire or destruction. Adam Lee penned this little ditty for [Bant Battlemage](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bant+Battlemage) that captured this unusual combination of powerful magic and—to us—backwater magical ignorance.
...
I love the juxtaposition of the ease of casual flight magic—an extremely fanciful, high-magic idea—with the difficulty of conjuring up a simple light for the night raid's torches. What would happen to our own history if they knew a few spells back in medieval times? What if Charlemagne's mages knew [Flight](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Flight)? The differences in military strategy and in historical results would be dramatic, yet those ancient mages still might need a simple tinder box to start a fire.

[Excommunicateolabe](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Excommunicateolabe)**[Excommunicate](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Excommunicate)**
...
I love how this makes a Bant-appropriate story out of something as mechanical as "put a guy on top of your library." An [Excommunicate](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Excommunicate)d creature *is* often going to find its way back to the battlefield; the flavor text doesn't pretend that the spell is some kind of permanent removal spell. Instead it embraces the mechanical feel of the card, and builds it into the story behind its casting.

### Esper

[![Scourglass](https://media.magic.wizards.com/image_legacy_migration/magic/images/cardart/ALA/Scourglass.jpg)](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Scourglass)**[Scourglass](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Scourglass)**

[Scourglass](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Scourglass) is a powerful, destructive artifact, and at first I thought it needed a powerful, destructive piece of flavor text. But I loved how this piece, a Matt Cavotta special, captured a more refined, Esper-oriented view of the process: instead of an artificial cataclysm, it presents [Scourglass](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Scourglass)'s activation as a precise warping of fleshy reality during a period of unconsciousness, a tidy cleansing of that ever-flawed organic material during a sphinx's nap.


> *"Soon I will sleep, eyes closing to a world tarnished with flesh, and then wake to a polished vision." —Sharuum*

[![Etherium_Astrolabe](https://media.magic.wizards.com/image_legacy_migration/magic/images/cardart/ALA/Etherium_Astrolabe.jpg)](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Etherium%2BAstrolabe)**[Etherium Astrolabe](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Etherium+Astrolabe)**
...
[![Metallurgeon](https://media.magic.wizards.com/image_legacy_migration/magic/images/cardart/ALA/Metallurgeon.jpg)](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Metallurgeon)**[Metallurgeon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Metallurgeon)**

Esper is not long on laugh-out-loud, guffaw-inducing humor. But as [Metallurgeon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Metallurgeon)'s flavor text shows, a dry wit is certainly appreciated there, especially when it's at the expense of the Ignoble Flesh. This piece was written by **magicthegathering.com** editor Kelly Digges.
...
[![Dreg_Reaver](https://media.magic.wizards.com/image_legacy_migration/magic/images/cardart/ALA/Dreg_Reaver.jpg)](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Dreg%2BReaver)**[Dreg Reaver](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dreg+Reaver)**

Grixis is a world of death—but at one time, when Alara was young, it was still connected to the other shards, and still flush with life. This piece from [Dreg Reaver](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dreg+Reaver) highlights a bit of the process that a Grixis necromancer undergoes in order to find a corpse suitable for his or her biggest reanimation projects.
...
[![Agony_Warp](https://media.magic.wizards.com/image_legacy_migration/magic/images/cardart/ALA/Agony_Warp.jpg)](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Agony%2BWarp)**[Agony Warp](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Agony+Warp)**
...
[![Blister_Beetle](https://media.magic.wizards.com/image_legacy_migration/magic/images/cardart/ALA/Blister_Beetle.jpg)](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Blister%2BBeetle)**[Blister Beetle](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blister+Beetle)**

I'm a fan of flavor text that fits on the card, but conveys ideas that bulge way past the borders of the cardboard. Check out this piece on [Blister Beetle](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blister+Beetle), written by Christa Knott-Dufresne.
...
[![Jungle_Shrine](https://media.magic.wizards.com/image_legacy_migration/magic/images/cardart/ALA/Jungle_Shrine.jpg)](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Jungle%2BShrine)**[Jungle Shrine](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Jungle+Shrine)**
...
Also, intellects don't wear pants, and can't be kicked in them. Ambition, extinct! [Office, submarine](http://www.youtube.com/watch?v=0al0xeCVCMk)!

[![Where_Ancients_Tread](https://media.magic.wizards.com/image_legacy_migration/magic/images/cardart/ALA/Where_Ancients_Tread.jpg)](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Where%2BAncients%2BTread)**[Where Ancients Tread](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Where+Ancients+Tread)**
...
> *"Never subtle nor cryptic is the reckoning of the mighty." —[Mayael the Anima](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mayael+the+Anima)*

I like how, unbeknownst to Mayael herself, this quote pokes subtle fun at the blue mage. Naya doesn't fuss with your stack or [Twiddle](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Twiddle) with your permanents. Naya puts a footprint the size of a moon crater in your neighborhood. Want to know where you stand with Naya's behemoth gods? Check whether your house is [Where Ancients Tread](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Where+Ancients+Tread).

Time for an important issue in today's Letter(s).

### Letter(s) of the Week

Today's letters concern [*A* *Planeswalker's Guide to Alara*](http://ww2.wizards.com/books/Wizards/Products/?doc=219957400).
...
[![A Planeswalker's Guide to Alara](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/stf/stf8_pgta.jpg)](http://ww2.wizards.com/books/wizards/products/?doc=219957400%20)First of all, Jasper, thank you so much. Writers and artists love hearing that their work is enjoyed, and I'll be sure to spread around the praise to everyone who worked so hard on it. Also, I enjoyed your flavorful retelling of its contents—you get a Vorthos Point.
...
[![Gift_of_the_Gargantuan](https://media.magic.wizards.com/image_legacy_migration/magic/images/cardart/ALA/Gift_of_the_Gargantuan.jpg)](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Gift%2Bof%2Bthe%2BGargantuan)On that note, let's look at letter #2.
