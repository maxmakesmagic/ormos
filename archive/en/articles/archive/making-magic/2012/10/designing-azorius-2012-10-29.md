...
---
[Link to Wayback Machine](https://web.archive.org/web/20160819210018/http://magic.wizards.com/en/articles/archive/making-magic/designing-azorius-2012-10-29)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "&#13;"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "656621"
[_metadata_:publish_date]:- "2012-10-29"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Designing for Azorius"
[_metadata_:wayback_capture_timestamp]:- "2016-08-19 21:00:18"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20160819210018id_/http://magic.wizards.com/en/articles/archive/making-magic/designing-azorius-2012-10-29"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/making-magic/designing-azorius-2012-10-29"
---


Designing for Azorius
=====================
...
Welcome to Azorius Week. This is the second of our guild theme weeks for *Return to Ravnica* block. ([Selesnya Week](/en/node/656456) was about a month back.) As I explained during Selesnya Week, we had a series of ten guild theme weeks during the original Ravnica block (you can see all my guild columns [here](http://www.wizards.com/magic/magazine/features.aspx?tag=color%20pie)) where I talked about the color philosophy of each guild. This time out, I'm talking about what it takes to design for each color pair in general and for the guild specifically.


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm219_azorius_guildgate.jpg)
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm219_forecast.jpg)
 

Let me begin by explaining where the *Dissension* design team ([Aaron Forsythe](http://www.wizards.com/magic/magazine/archive.aspx?author=aaron%20forsythe) as lead, with [Mark Gottlieb](http://www.wizards.com/magic/magazine/archive.aspx?author=mark%20gottlieb), [Brandon Bozzi](http://www.wizards.com/magic/magazine/archive.aspx?author=brandon%20bozzi), and myself) was when we designed forecast. From time to time, the head developer comes to me and explains that some deck is doing well and could design please not push in a certain area? Right before *Dissension* started, [Brian Schneider](http://www.wizards.com/magic/magazine/archive.aspx?author=brian%20schneider), the head developer during the *Ravnica* block, came to me and said that white-blue control had gotten a little stronger than he was comfortable with. Could we avoid pushing in that direction in *Dissension*?
...
How many of your minds went to *Unglued*? Before I explain how [Infernal Spawn of Evil](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infernal+Spawn+of+Evil) inspired forecast, let me start by explaining how the card got designed in the first place. Many years ago, [Ron Spencer](http://gatherer.wizards.com/pages/search/default.aspx?output=spoiler&amp;method=visual&amp;action=advanced&amp;artist=%5b%22ron+spencer%22%5d) was assigned some gruesome black card. Normally, before artists paint their illustrations, they send in sketches so the art director can make sure they're going in the right direction.


Ron Spencer had been assigned some gruesome black card and as a joke sent in a sketch that looked a lot like the art of [Infernal Spawn of Evil](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infernal+Spawn+of+Evil). Everyone had a good laugh and then Ron sent in the real sketch. While working on *Unglued*, I decided I wanted to use the original sketch Ron made. I decided the joke of the card was that this was the most evil creature in the world. The name [Infernal Spawn of Evil](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infernal+Spawn+of+Evil) was chosen to play up this joke.


While designing the card, I wanted to find a mechanic that played up the flavor that this creature was so scary that even the mere hint it would eventually appear was enough to scare opponents—scare them enough that it physically hurt them and made them lose life. After playing around with a few ideas I ended up with the idea that you could show the card from your hand once per turn. The card had to be expensive because it was supposed to be big and scary in play and this ability would allow you to do something with it until you could cast it.


Okay, that's how [Infernal Spawn of Evil](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infernal+Spawn+of+Evil) got made. How exactly did my search for a white-blue mechanic get me to a black *Unglued* card? Looking back, here's my best guess as to what happened: White-blue tends to like having cards in hand. That got me to thinking about cards that had a function while in your hand. That line of thinking got me to [Infernal Spawn of Evil](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infernal+Spawn+of+Evil), the one card in **Magic** 's past that did exactly that.
...
**The Combo**: Some of the cards, such as [Pride of the Clouds](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pride+of+the+Clouds), have a forecast effect that has synergy with the spell effect. For example, if you use the forecast on [Pride of the Clouds](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pride+of+the+Clouds) to make a flying Bird token, when you cast [Pride of the Clouds](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pride+of+the+Clouds) it is +1/+1 larger. On these cards, the two effects are linked only by how they work together.


**The Lesser Effect**: Other forecast cards have a forecast effect that is basically a smaller version of the spell effect. An example of this would be [Skyscribing](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Skyscribing). [Skyscribing](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Skyscribing) can use forecast to allow all players to draw a card. If you play the spell it will allow all players to draw X cards.


**The Ability Sharing**: This last example can be seen on [Spirit *en*-Dal](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Spirit+en-Dal). The forecast effect is to grant target creature the ability the creature naturally has, such as shadow on [Spirit *en*-Dal](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Spirit+en-Dal), to a target creature for the turn.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm219_archon_of_the_triumvirate.jpg)
[Archon of the Triumvirate](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Archon+of+the+Triumvirate) | Art by [David Rapoza](http://gatherer.wizards.com/pages/search/default.aspx?output=spoiler&amp;method=visual&amp;action=advanced&amp;artist=%5B%22david%20rapoza%22%5D)


### Detain


The very first meeting we had for *Return to Ravnica* design (the team was [Ken Nagle](http://www.wizards.com/magic/magazine/archive.aspx?author=kenneth%20nagle) as the lead, Alexis Jansen, [Ken Troop](http://www.wizards.com/magic/magazine/archive.aspx?author=ken%20troop), [Zac Hill](http://www.wizards.com/magic/magazine/archive.aspx?author=zac%20hill), and myself) started by Ken saying the following: "Last time, Azorius wasn't really what you expected white-blue to be. We're going to fix that problem this time."
...
The Azorius sub-team was led by [Mark Globus](http://www.wizards.com/magic/magazine/archive.aspx?author=mark%20globus) and included [Dave Humpherys](http://www.wizards.com/magic/magazine/archive.aspx?author=dave%20humpherys), [Billy Moreno](http://www.wizards.com/magic/magazine/archive.aspx?author=billy%20moreno), and Ken Nagle. Ken was there to represent the needs of *Return to Ravnica*. Humpherys was there to give a developer perspective, while Mark and Billy were there to design lots of cards. (While Billy is a developer, he has a strong design sensibility.)
...
![Azorius Arrester](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Azorius+Arrester)

 

As the sub-team played with it, a few issues came up. First, shouldn't jailing a creature also stop it from doing other things? The spell [Arrest](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Arrest), which had a similar flavor, prevented activated abilities. The team decided to add that in as well. Second, the team had to figure out a duration. Playtesting showed that "until your next turn" was short enough to be remembered but long enough to have an impact on both your turn and your opponent's, making both not blocking and not attacking matter.
...
I hope you enjoyed today's peek at Azorius. As always, I'm curious to hear any feedback in my mail, this article's thread, or on my social media ([Twitter](https://twitter.com/maro254), [Tumblr](http://markrosewater.tumblr.com/), and [Google+](https://plus.google.com/107824009487778543249/posts)).
