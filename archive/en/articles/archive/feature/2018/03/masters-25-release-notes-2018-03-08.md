...
---
[Link to Wayback Machine](https://web.archive.org/web/20180308164045/https://magic.wizards.com/en/articles/archive/feature/masters-25-release-notes-2018-03-08)
...
[_metadata_:node]:- "1258471"
[_metadata_:publish_date]:- "2018-03-08"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Masters 25 Release Notes"
[_metadata_:wayback_capture_timestamp]:- "2018-03-08 16:40:45"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20180308164045id_/https://magic.wizards.com/en/articles/archive/feature/masters-25-release-notes-2018-03-08"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/feature/masters-25-release-notes-2018-03-08"
---


Masters 25 Release Notes
========================
...
Document last modified January 10, 2018.


**DOC Download Links:**  
[English](http://media.wizards.com/2018/downloads/A25_Release_Notes/EN_MTGA25_ReleaseNotes.docx)
...
*Masters 25* takes players on a celebratory tour through some of the most powerful cards in all 25 years of *Magic* history. The set includes fan favorites from each and every black-bordered set, from *Limited Edition (Alpha)* through *Rivals of Ixalan*. *Masters 25* is designed to provide an exciting and unique Limited experience with cards that have never been drafted together.
...
The *Masters 25* set contains 249 cards (101 common, 80 uncommon, 53 rare, and 15 mythic rare).
...
Expansion Symbol Icons
======================


Cards in the *Masters 25* set have an expansion symbol icon in their text boxes to commemorate the first set in which they were printed. These icons have no effect on gameplay. If you encounter an expansion symbol that you're not familiar with, you can find it among the card's printings at [Gatherer.Wizards.com](http://gatherer.wizards.com/).
...
All cards in the *Masters 25* set have previously appeared in other *Magic* sets. Accordingly, several keywords and other mechanics make their return. None of the rules regarding these mechanics have changed since they last appeared.
...
Cycling and Typecycling
=======================


Appearing in several sets, most recently the *Amonkhet* block, cycling is a mechanic that lets you exchange certain cards for something you might want more.


![](https://media.wizards.com/2018/a25/en_0T34RZohBk.png)
...
The typecycling variant on cycling goes one step further, allowing you to search your library for what you need. Five cards in the *Masters 25* set have a typecycling ability for one of the five basic land types—when you cycle one of these cards, you'll get one of those lands instead of drawing a card. A sixth card lets you search for any basic land card.


![](https://media.wizards.com/2018/a25/en_6v8NjTIKxr.png)
...
* Anything that interacts with cycling interacts with typecycling as well. Typecycling is a cycling ability, and its cost is a cycling cost.
...
* Swampcycling lets you find any card with the Swamp subtype, including nonbasic land cards. The same is true for the other four typecycling abilities for a basic land type. Most nonbasic lands don't have basic land types, even if they produce colored mana. For example, Twilight Mire is neither a Swamp nor a Forest, while Overgrown Tomb is both.
...
The morph keyword has turned up a few times throughout the years, most recently in the *Khans of Tarkir* block, to hide the true identity of permanents until you decide the time is right to reveal them.


![](https://media.wizards.com/2018/a25/en_5sqNiHeReE.png)
...
Morph 2R *(You may cast this card face down as a 2/2 creature for 3. Turn it face up any time for its morph cost.)*


The megamorph variant rewards you and your creature for this effort with a +1/+1 counter after it's turned face up.


![](https://media.wizards.com/2018/a25/en_larMxNi5Ep.png)
...
* Anything that interacts with morph interacts with megamorph as well. Megamorph is a morph ability, and its cost is a morph cost.
...
* If a creature with megamorph is turned face up for its megamorph cost, you put a +1/+1 counter on it as it's turned face up. This doesn't use the stack.
* If a face-down creature with megamorph is turned face up some other way, you won't put a +1/+1 counter on it.
* If a face-down creature loses its abilities, it can't be turned face up because it no longer has a morph ability (or a morph cost).
...
![](https://media.wizards.com/2018/a25/en_q8nMeYqAC0.png)
...
* If a permanent has protection from a color, it means four things:
	...
	+ Creatures of that color can't block that permanent; and
...
Some creatures won't just give up so easily. Regenerate is a keyword action that spares a creature from destruction.


![](https://media.wizards.com/2018/a25/en_30pTvAs4DM.png)
...
![](https://media.wizards.com/2018/a25/en_RjFxUqbic3.png)
...
* Because Accumulated Knowledge is still on the stack as you perform its instructions, it isn't in your graveyard and won't add to the number of cards drawn.



---

![](https://media.wizards.com/2018/a25/en_tq9XV9lUqW.png)
...
![](https://media.wizards.com/2018/a25/en_q2sQ9r2jfm.png)
...
* The "legend rule" cares about legendary permanents with the exact same English name. You can control Akroma, Angel of Wrath and Akroma, Angel of Fury at the same time.



---

![](https://media.wizards.com/2018/a25/en_3jmB2fRzVu.png)
...
* The "legend rule" cares about legendary permanents with the exact same English name. You can control Akroma, Angel of Fury and Akroma, Angel of Wrath at the same time.



---

![](https://media.wizards.com/2018/a25/en_tEJ1txR9nf.png)
...
![](https://media.wizards.com/2018/a25/en_5UEmL9ZA8l.png)
...
* Assembly-Worker's ability can target any creature with the Assembly-Worker subtype, not only creatures named Assembly-Worker.



---

![](https://media.wizards.com/2018/a25/en_nMwHFLNJhs.png)
...
* Azusa's ability is cumulative with other effects that allow you to play additional lands, such as that of Wayward Swordtooth (from the *Rivals of Ixalan* set).



---

![](https://media.wizards.com/2018/a25/en_5pzkHxavIS.png)
...
![](https://media.wizards.com/2018/a25/en_NwRMUdEhR4.png)
...
![](https://media.wizards.com/2018/a25/en_XIj0IF2cbn.png)
...
* If Blue Sun's Zenith is countered, none of its effects occur. In particular, it will go to its owner's graveyard rather than to its owner's library.
...
![](https://media.wizards.com/2018/a25/en_4e2o6All7e.png)
...
![](https://media.wizards.com/2018/a25/en_0e1HdnQqWr.png)
...
![](https://media.wizards.com/2018/a25/en_XbuClWDJBL.png)
...
![](https://media.wizards.com/2018/a25/en_HhB4vc1gpa.png)
...
* A mana cost of XX means that you pay twice X. If you want X to be 3, you pay 6 to cast Chalice of the Void.
...
![](https://media.wizards.com/2018/a25/en_G350eqF6LL.png)
...
* If the target creature is an illegal target by the time Chandra's Outrage resolves, the spell is countered. No player is dealt damage.



---

![](https://media.wizards.com/2018/a25/en_qUjwauPd6F.png)
...
![](https://media.wizards.com/2018/a25/en_7D50XpuZhh.png)
...
* Only the first main phase each turn is considered a precombat main phase, even if other main phases or combat phases are created (with Relentless Assault, for example).



---

![](https://media.wizards.com/2018/a25/en_6jpNeAAwsP.png)
...
![](https://media.wizards.com/2018/a25/en_73uTixUAgd.png)
...
![](https://media.wizards.com/2018/a25/en_jdQL9QMxJU.png)
...
* If the top card of your library changes while you're casting a spell or activating an ability, you don't reveal the new top card until you finish casting that spell or activating that ability.
...
![](https://media.wizards.com/2018/a25/en_jfIEA49WyW.png)
...
* If Court Hussar enters the battlefield in a way other than being cast as a spell, then W can't have been spent to cast it, and you'll have to sacrifice it.



---

![](https://media.wizards.com/2018/a25/en_mgQES3yc0D.png)
...
* If Curiosity enchants an opponent's creature, you won't draw a card when that creature damages you. The creature has to deal damage to one of your opponents for Curiosity's ability to trigger.



---

![](https://media.wizards.com/2018/a25/en_HjQcRpeHbz.png)
...
![](https://media.wizards.com/2018/a25/en_3od07Qgm5D.png)
...
* You control the last ability of Deadly Designs, no matter who activated the ability to give it its fifth plot counter.
* You must sacrifice Deadly Designs as its last ability resolves. However, you can choose zero creatures as targets if you want.
* If the player who controlled Deadly Designs as its last ability triggered doesn't control it as that ability resolves, Deadly Designs won't be sacrificed. The same is true if each of the ability's targets are all illegal by the time the ability resolves. However, if it's still on the battlefield and has five or more plot counters on it, its last ability will immediately trigger again.



---

![](https://media.wizards.com/2018/a25/en_KQ1SaFY9GS.png)
...
* The last ability of Death's-Head Buzzard affects only creatures on the battlefield at the time it resolves. Creatures that enter the battlefield later in the turn won't get -1/-1.



---

![](https://media.wizards.com/2018/a25/en_ZF7lIV0LHQ.png)
...
* A mana cost of XX means that you pay twice X. If you want X to be 3, you pay 8WW to cast Decree of Justice.



---

![](https://media.wizards.com/2018/a25/en_IkWMusMqWa.png)
...
* If your graveyard and library combined contain five or more cards, you must choose five cards from among them. You can't choose to find fewer than that.
* If your graveyard and library combined contain fewer than five cards, all of those cards will wind up in your library.



---

![](https://media.wizards.com/2018/a25/en_jPWRDmHncD.png)
...
* Echoing Courage has only one target. Other creatures with that name are not targeted. For example, a creature with protection from green will still get +2/+2 if it has the same name as the target creature.
* If the target creature is an illegal target by the time Echoing Courage tries to resolve, the spell is countered. No creatures get +2/+2.
* The name of a creature token is the same as the creature types it was created with, unless the token is a copy of another creature or the effect that created the token specifically gave it a different name. For example, a 1/1 Cat Soldier creature token is named "Cat Soldier."
...
![](https://media.wizards.com/2018/a25/en_mN1i8Pic8O.png)
...
* Casting Eidolon of the Great Revel doesn't cause its own ability to trigger. It must be on the battlefield when the spell is cast for its ability to trigger.
* The amount of mana spent to cast a spell doesn't change its converted mana cost. For example, a card cast with its morph ability has a converted mana cost of 0 even though 3 was paid.
* The converted mana cost of a spell with X in its mana cost includes the value chosen for X.



---

![](https://media.wizards.com/2018/a25/en_6WuC2p8nsX.png)
...
![](https://media.wizards.com/2018/a25/en_hZenaFWIF8.png)
...
![](https://media.wizards.com/2018/a25/en_wVYIX73c1r.png)
...
![](https://media.wizards.com/2018/a25/en_IhBergkhKb.png)
...
* A creature "comes under your control" if it enters the battlefield under your control or if you gain control of it while it's already on the battlefield.



---

![](https://media.wizards.com/2018/a25/en_pnx8nGti9t.png)
...
![](https://media.wizards.com/2018/a25/en_zqEIvjSpUT.png)
...
![](https://media.wizards.com/2018/a25/en_5WcTKewD17.png)
...
* Only the generic mana in that creature's mana cost is reduced. For example, if that creature's mana cost is 1R, you'll have to pay R to keep it.
...
![](https://media.wizards.com/2018/a25/en_zIXRTuYSt1.png)
...
Morph RR *(You may cast this card face down as a 2/2 creature for 3. Turn it face up any time for its morph cost.)*


* Fortune Thief's effect applies only if your life total is being reduced by damage. Other effects or costs (such as losing or paying life) can reduce your life total below 1 as normal.
...
* Fortune Thief won't prevent you from losing the game if your life total becomes 0 or less or if some other effect causes you to lose the game.
* If your life total is less than 1 but you've somehow avoided losing the game, Fortune Thief's effect won't apply at all if you're dealt damage.



---

![](https://media.wizards.com/2018/a25/en_Cleg1sRh3z.png)
...
![](https://media.wizards.com/2018/a25/en_N5gjWfZLJh.png)
...
![](https://media.wizards.com/2018/a25/en_YJuzMjqL27.png)
...
![](https://media.wizards.com/2018/a25/en_AEYW7NhZqq.png)
...
* If damage dealt by a source you control is being divided or assigned among multiple permanents an opponent controls or among an opponent and one or more permanents he or she controls simultaneously, divide the original amount and double the results. For example, if you attack with a 5/5 creature with trample and your opponent blocks with a 2/2 creature, you can assign 2 damage to the blocker and 3 damage to the defending player. These amounts are then doubled to 4 and 6 damage, respectively. You can't double the damage to 10 first and then assign 2 to the creature and 8 to the player.



---

![](https://media.wizards.com/2018/a25/en_5p6xPkJe5c.png)
...
![](https://media.wizards.com/2018/a25/en_XLT3OIwwf4.png)
...
* Because Haunted Fengraf's ability doesn't target any creature card, any creature card put into the graveyard in response to that ability may be returned to your hand.
* All players get to see which card you return to your hand.



---

![](https://media.wizards.com/2018/a25/en_ZmYaagRQXM.png)
...
* The creature that doesn't untap during its controller's untap step is the one that Heavy Arbalest is equipped to as that untap step begins. If a creature was tapped to activate the ability granted to it by the Arbalest, but the Arbalest is no longer equipping it, it will untap as normal.



---

![](https://media.wizards.com/2018/a25/en_jzD2gGUl9q.png)
...
![](https://media.wizards.com/2018/a25/en_SxqGkUlnH1.png)
...
* An ability that triggers whenever you "cycle or discard" a card triggers only once if you cycle a card. The ability "Whenever you discard a card" is functionally identical to this ability; cycling is included for clarity.



---

![](https://media.wizards.com/2018/a25/en_VCN0uebvOc.png)
...
* If Humble Defector's owner leaves the game, Humble Defector not-so-humbly leaves the game along with that player.



---

![](https://media.wizards.com/2018/a25/en_vY0EFNnOGO.png)
...
* If an effect says that an opponent can't gain life, you can't have that player gain life to pay Invigorate's alternative cost. If an effect instead replaces life gain, such as the effect of Sulfuric Vortex, you may choose to pay the cost even though the cost's action is replaced with nothing.



---

![](https://media.wizards.com/2018/a25/en_4o639pSxrs.png)
...
![](https://media.wizards.com/2018/a25/en_grLvDZrJ2l.png)
...
* When Iwamori's triggered ability resolves, first the player whose turn it is (if that player is an opponent) may choose a legendary creature card in hand without revealing it, then each other opponent in turn order may do the same, then all chosen cards are put onto the battlefield at the same time.



---

![](https://media.wizards.com/2018/a25/en_VqC0oeMOIL.png)
...
* You must cast any of the exiled cards you wish to cast while Izzet Chemister's last ability is resolving. You can't cast them later in the turn. A sorcery cast this way will be cast at a time you normally wouldn't be able to.
...
* Any of the cards you don't cast will remain exiled.



---

![](https://media.wizards.com/2018/a25/en_1zjIFIYW4T.png)
...
![](https://media.wizards.com/2018/a25/en_qlJB07rZUq.png)
...
2U, T, Sacrifice another creature: Reveal cards from the top of your library until you reveal a nonlegendary creature card. Put that card onto the battlefield and the rest on the bottom of your library in a random order.


* If your library has no nonlegendary creature cards in it, you'll reveal all the cards in your library, then put them in a random order. Although this is not technically shuffling your library, no player is allowed to know the order of those cards and you will randomize the cards in your deck.



---

![](https://media.wizards.com/2018/a25/en_CD6TAIxKic.png)
...
Morph 3WW *(You may cast this card face down as a 2/2 creature for 3. Turn it face up any time for its morph cost.)*  
...
* If the target creature leaves the battlefield or stops being a creature before damage would be dealt, that damage is not redirected. For example, if you choose a 1/1 creature, then Karona's Zealot would be dealt 3 damage, all 3 is dealt instead to the 1/1 creature, which then dies. If Karona's Zealot would be dealt 3 damage again later in the turn, the 1/1 creature is no longer on the battlefield, so the damage is not redirected.
* If multiple replacement effects would modify how damage would be dealt, the player being dealt damage (or the controller of the permanent being dealt damage) chooses the order in which to apply those effects.
...
![](https://media.wizards.com/2018/a25/en_io1DenEXEk.png)
...
* Kavu Predator's last ability triggers just once for each life-gaining event, whether it's 1 life from Kor Firewalker or 6 life from Renewed Faith.
* Each creature with lifelink dealing combat damage is a single life-gaining event. For example, if two creatures an opponent controls with lifelink deal combat damage at the same time, Kavu Predator's ability will trigger twice. However, if a single creature an opponent controls with lifelink deals combat damage to multiple creatures, players, and/or planeswalkers at the same time (perhaps because it has trample or was blocked by more than one creature), the ability will trigger only once.
* If an opponent gains an amount of life "for each" of something (such as from Congregate), that life is gained as one event and Kavu Predator's ability triggers only once.



---

![](https://media.wizards.com/2018/a25/en_pzhv7vGlji.png)
...
![](https://media.wizards.com/2018/a25/en_uwMLZyxVBj.png)
...
* Kor Firewalker's triggered ability resolves before the red spell that caused it to trigger.



---

![](https://media.wizards.com/2018/a25/en_ZvXkkSzY3e.png)
...
* As Laquatus's Champion's second ability resolves, the player who gains 6 life is the player who was the target of the first ability (or, if that ability is still on the stack, the player who is its target).



---

![](https://media.wizards.com/2018/a25/en_iJ8r3JMM6Z.png)
...
![](https://media.wizards.com/2018/a25/en_68pbI0CV9P.png)
...
![](https://media.wizards.com/2018/a25/en_L9E5NalgS9.png)
...
![](https://media.wizards.com/2018/a25/en_eLpDaPhfcK.png)
...
* Loyal Sentry and the creature it blocks are destroyed before combat damage is dealt. The blocked creature is destroyed even if Loyal Sentry leaves the battlefield before its triggered ability resolves.



---

![](https://media.wizards.com/2018/a25/en_XNoO6DAkCX.png)
...
1W: Create a 4/4 white Angel creature token with flying. Activate this ability only if Luminarch Ascension has four or more quest counters on it.
...
* In a Two-Headed Giant game, Luminarch Ascension's first ability will trigger twice at the beginning of the opposing team's end step if you didn't lose life that turn. It doesn't matter whether your teammate lost life or not.



---

![](https://media.wizards.com/2018/a25/en_KqqoqTRukG.png)
...
![](https://media.wizards.com/2018/a25/en_oXxJJXHFJy.png)
...
* If each player has fewer than seven cards in his or her library as Magus of the Wheel's ability resolves, the game ends in a draw.



---

![](https://media.wizards.com/2018/a25/en_CkM2QNJ2Yz.png)
...
* If the target creature is an illegal target by the time Master of the Wild Hunt's ability tries to resolve, the ability is countered. You won't tap your Wolves, and nothing will deal or be dealt damage.
...
![](https://media.wizards.com/2018/a25/en_3JblnYoWwo.png)
...
![](https://media.wizards.com/2018/a25/en_Ewx1Yk7Q6B.png)
...
![](https://media.wizards.com/2018/a25/en_Ls6oNKihkp.png)
...
![](https://media.wizards.com/2018/a25/en_6xDahKO3qX.png)
...
![](https://media.wizards.com/2018/a25/en_iAEmo9q81r.png)
...
![](https://media.wizards.com/2018/a25/en_P5ElTh62iH.png)
...
![](https://media.wizards.com/2018/a25/en_I3ULgwHAOt.png)
...
![](https://media.wizards.com/2018/a25/en_aJ4M6g7Z99.png)
...
* Nettle Sentinel's triggered ability resolves before the spell that causes it to trigger. The ability will resolve even if that spell is countered.



---

![](https://media.wizards.com/2018/a25/en_Ete9wFtbHM.png)
...
![](https://media.wizards.com/2018/a25/en_jtqWuz2KQG.png)
...
* If a spell or ability causes you to draw multiple cards, Niv-Mizzet's ability triggers that many times.
* If dealing 1 damage to a creature or player causes you to draw a card, perhaps because Niv-Mizzet is enchanted by Curiosity, you'll continue this loop until the loop is interrupted, perhaps by a player losing the game.



---

![](https://media.wizards.com/2018/a25/en_tr2kOXXFMi.png)
...
* If two or more players each control a Notion Thief and a player would draw a card other than the first one in his or her draw step, that player chooses one of the applicable Notion Thief effects to apply. Then the player whose Notion Thief's effect was chosen repeats this process among the remaining Notion Thief effects, and so on, until there are no more possible such effects to apply. Each effect can be applied to the card draw only once this way.
...
![](https://media.wizards.com/2018/a25/en_llPgCOVmbD.png)
...
* Ordeal of Heliod's first triggered ability resolves before blockers are chosen, well before combat damage is dealt.
* The check of whether the enchanted creature has three or more +1/+1 counters on it happens as part of the resolution of first triggered ability. If the third +1/+1 counter is put on the enchanted creature any other way, you won't sacrifice Ordeal of Heliod until the next time the creature attacks.
* If you sacrifice Ordeal of Heliod in some other way than its own ability, its last ability will trigger.



---

![](https://media.wizards.com/2018/a25/en_g2p791JLiU.png)
...
* You are a creature's owner if the card representing it began the game in your deck, or if it's a token that entered the battlefield under your control. If Path of Peace targets a creature that you own but an opponent controls, you'll gain 4 life.
* If the target creature is an illegal target by the time Path of Peace tries to resolve, the spell is countered. No player gains life.



---

![](https://media.wizards.com/2018/a25/en_QGWIGzm93L.png)
...
![](https://media.wizards.com/2018/a25/en_lh8p2Igauy.png)
...
![](https://media.wizards.com/2018/a25/en_9wW5H2RHD4.png)
...
![](https://media.wizards.com/2018/a25/en_7vnNSWoD03.png)
...
![](https://media.wizards.com/2018/a25/en_ynDp46TTnd.png)
...
![](https://media.wizards.com/2018/a25/en_oI4iOBwfkC.png)
...
* If a creature that's already on the battlefield becomes a copy of Primal Clay, it copies the power, toughness, and abilities that were chosen for Primal Clay as it entered the battlefield.



---

![](https://media.wizards.com/2018/a25/en_g2aLPRDOgZ.png)
...
![](https://media.wizards.com/2018/a25/en_dL0I6obHcW.png)
...
* The amount of mana you spent to cast Prossh is usually equal to its converted mana cost. However, you also include any cost reductions and additional costs you pay, including the cost imposed for casting your commander from the command zone in the Commander variant.
* You can't choose to pay extra mana to cast a creature spell unless something instructs you to.
* Prossh's first ability triggers when Prossh is cast and resolves before Prossh does. That ability will resolve even if Prossh is countered.



---

![](https://media.wizards.com/2018/a25/en_TLKfFGyUgi.png)
...
* You can find any number of creature cards, so long as their total converted mana cost is 6 or less. For example, you could find eight creature cards with converted mana cost 0 and three with converted mana cost 2, but you couldn't find two with converted mana cost 4.



---

![](https://media.wizards.com/2018/a25/en_T5xIIWO1np.png)
...
* Pyre Hound's triggered ability resolves before the spell that causes it to trigger. The ability will resolve even if that spell is countered.



---

![](https://media.wizards.com/2018/a25/en_ktcL35B0h6.png)
...
* The enchanted creature is the source of both the damage ability and the resultant damage, not Quicksilver Dagger. For example, if Quicksilver Dagger and Curiosity enchant the same creature, Curiosity's ability will trigger when the damage is dealt.



---

![](https://media.wizards.com/2018/a25/en_xFUGeaQXbs.png)
...
* If the creature this Aura would enchant is an illegal target by the time Rancor tries to resolve, the Aura spell is countered. It won't enter the battlefield, so it won't be put into a graveyard from the battlefield and its ability won't trigger.



---

![](https://media.wizards.com/2018/a25/en_LgGHPyuWU6.png)
...
![](https://media.wizards.com/2018/a25/en_T17xpZftRt.png)
...
![](https://media.wizards.com/2018/a25/en_BiUoaA7ray.png)
...
* Once you announce that you're casting a spell or activating an ability, no player may take other actions until the spell or ability has been paid for. Notably, players can't try to tap your lands to stop you from paying.



---

![](https://media.wizards.com/2018/a25/en_lMQc2iE5pP.png)
...
* Ruric Thar's triggered ability triggers whenever any player casts a noncreature spell, including you.
* Ruric Thar's triggered ability resolves before the spell that causes it to trigger. The ability will resolve even if that spell is countered.
* If Ruric Thar can't attack for any reason (such as being tapped or having come under that player's control that turn), then it doesn't attack. If there's a cost associated with having a creature attack, the player isn't forced to pay that cost, so Ruric Thar doesn't have to attack in that case either.



---

![](https://media.wizards.com/2018/a25/en_Vp4xvxmF1B.png)
...
* If you choose not to attach Sai of the Shinobi to a creature that enters the battlefield, or if you can't (most likely because the creature has left the battlefield by the time the triggered ability resolves), Sai of the Shinobi doesn't move.



---

![](https://media.wizards.com/2018/a25/en_zmg2G0hjrb.png)
...
* Self-Assembler's ability can find any creature card with the Assembly-Worker subtype, not only creature cards named Assembly-Worker. Notably, it can't find Mishra's Factory.



---

![](https://media.wizards.com/2018/a25/en_XOjzrrpkVv.png)
...
* You get the token created by Skeletonize's delayed triggered ability regardless of who controlled the creature.



---

![](https://media.wizards.com/2018/a25/en_jaAdffwZ4y.png)
...
![](https://media.wizards.com/2018/a25/en_Y6ME1IWUXP.png)
...
![](https://media.wizards.com/2018/a25/en_98ApsCkJGP.png)
...
* Stampede Driver's ability affects only creatures you control at the time it resolves. Creatures you begin to control later in the turn won't get +1/+1 or gain trample.



---

![](https://media.wizards.com/2018/a25/en_2YhkMdVUgC.png)
...
* If Stangg leaves the battlefield before its ability has resolved, that ability will still create a Stangg Twin token, but its delayed triggered ability that exiles the token will never have a chance to trigger. That token will remain on the battlefield.



---

![](https://media.wizards.com/2018/a25/en_XfZSfByVxv.png)
...
![](https://media.wizards.com/2018/a25/en_ZR2xJWGGeq.png)
...
![](https://media.wizards.com/2018/a25/en_AjT0TAAecE.png)
...
![](https://media.wizards.com/2018/a25/en_xP7Hrryrfw.png)
...
![](https://media.wizards.com/2018/a25/en_uZQAS5JmW1.png)
...
![](https://media.wizards.com/2018/a25/en_BzKW4NQdZo.png)
...
![](https://media.wizards.com/2018/a25/en_E96QtohbKh.png)
...
* Because damage remains marked on a creature until it's removed as the turn ends, nonlethal damage dealt to Thresher Lizard while you have one or fewer cards in hand may become lethal if cards are put into your hand during that turn.



---

![](https://media.wizards.com/2018/a25/en_4fsZHVU874.png)
...
* Because damage remains marked on a creature until it's removed as the turn ends, nonlethal damage dealt to Timberpack Wolf may become lethal if other Timberpack Wolves leave the battlefield during that turn.



---

![](https://media.wizards.com/2018/a25/en_gVJ9lHP15k.png)
...
* If you cast a card "without paying its mana cost," you can't pay any alternative costs, such as paying 3 to cast a morph card face down. You can, however, pay additional costs. If the card has any mandatory additional costs, such as that of Cathartic Reunion, those must be paid to cast the card.
* If the card has X in its mana cost, you must choose 0 as the value of X when casting it without paying its mana cost.
* If your library has no nonland cards in it with converted mana cost 3 or less, you'll reveal all the cards in your library, then put them in a random order. Although this is not technically shuffling your library, no player is allowed to know the order of those cards and you will randomize the cards in your deck.



---

![](https://media.wizards.com/2018/a25/en_bFWSdVVuTV.png)
...
![](https://media.wizards.com/2018/a25/en_Rkam3dhmAz.png)
...
![](https://media.wizards.com/2018/a25/en_gTjHnqfGKY.png)
...
* If the target creature is an illegal target by the time Twisted Image tries to resolve, the spell is countered. You won't draw a card.



---

![](https://media.wizards.com/2018/a25/en_MwP7UJ8qF8.png)
...
![](https://media.wizards.com/2018/a25/en_6y1wyYNbhV.png)
...
![](https://media.wizards.com/2018/a25/en_R5mRl7ckE4.png)
...
* Vesuvan Shapeshifter's ability to become a copy is a replacement effect. Because turning a creature face up and applying replacement effects both don't use the stack, players won't be able to take actions between the time you announce that you're turning Vesuvan Shapeshifter face up and the time it has become a copy of the creature of your choice.
* Vesuvan Shapeshifter copies exactly what was printed on the original creature (unless that creature is copying something else or is a token; see below). It doesn't copy whether that creature is tapped or untapped, whether it has any counters on it or Auras attached to it, or any non-copy effects that have changed its power, toughness, types, color, or so on.
* If the chosen creature has X in its mana cost, X is considered to be 0.
* If the chosen creature is copying something else (for example, if the chosen creature is another Vesuvan Shapeshifter), then Vesuvan Shapeshifter copies whatever the chosen creature copied.
* If the chosen creature is a token, Vesuvan Shapeshifter copies the original characteristics of that token as stated by the effect that created the token. Vesuvan Shapeshifter is not a token in this case.
* Any enters-the-battlefield abilities of the copied creature will trigger when Vesuvan Shapeshifter enters the battlefield. Any "as [this creature] enters the battlefield" or "[this creature] enters the battlefield with" abilities of the chosen creature will also work as it enters the battlefield. Similarly, any "[when/as] [this creature] is turned face up" abilities of the chosen creature will work if Vesuvan Shapeshifter is turned face up.
* If Vesuvan Shapeshifter somehow enters the battlefield at the same time as another creature, Vesuvan Shapeshifter can't become a copy of that creature. You may only choose a creature that's already on the battlefield.
* When Vesuvan Shapeshifter is turned face down, its copy effect wears off. While it's face down, it's a 2/2 face-down Vesuvan Shapeshifter that can be turned face up for a morph cost of 1U.
* If another creature copies Vesuvan Shapeshifter while it's face up and copying another creature, the new creature will become a copy of whatever Vesuvan Shapeshifter is copying and gain the "you may turn this creature face down" ability. It won't gain morph 1U. If that creature is then turned face down, its copy effect will continue and it'll be a face-down version of whatever it's copying. If the creature it's copying has morph, it can be turned face up. If the creature it's copying doesn't have morph, it's stuck face down.
...
![](https://media.wizards.com/2018/a25/en_YNq0jN3HAT.png)
...
* Whitemane Lion's triggered ability doesn't target any creature. You don't choose what to return until the ability resolves. Once the ability has started to resolve, players can't take actions between choosing the creature and returning it to its owner's hand.
* You may return Whitemane Lion itself to its owner's hand as its triggered ability resolves. If you don't control another creature, you must return it.



---

![](https://media.wizards.com/2018/a25/en_1ytyNvBg2q.png)
...
![](https://media.wizards.com/2018/a25/en_MKpzuxXLBn.png)
...
![](https://media.wizards.com/2018/a25/en_mxXa7jEmpn.png)
...
* When Zoetic Cavern is turned face up, any Auras on it that can't legally enchant it will be put into their owners' graveyards. Any Equipment will become unattached and remain on the battlefield. Any counters on it will remain on it.
...
![](https://media.wizards.com/2018/a25/en_BdlPuH5F3Z.png)
...
* If Zulaport Cutthroat dies at the same time as another creature you control, its ability triggers for that creature.
* In a Two-Headed Giant game, Zulaport Cutthroat's ability causes the opposing team to lose 2 life and you to gain 1 life.



---

*Magic: The Gathering*, *Magic*, *Amonkhet*, *Khans of Tarkir*, and *Rivals of Ixalan* are trademarks of Wizards of the Coast LLC in the USA and other countries. ©2018 Wizards.
