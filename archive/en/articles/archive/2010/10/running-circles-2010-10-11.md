...
---
[Link to Wayback Machine](https://web.archive.org/web/20170317194214/http://magic.wizards.com/en/articles/archive/running-circles-2010-10-11)

[_metadata_:author]:- "Alexis Janson"
[_metadata_:description]:- "&#13; When the Scars of Mirrodin design team first met, we discussed the goals for the set and block, and laid out the items that were expected to be in the final design. At that time, we already knew it would be Mirrodin against Phyrexia, that poison would return, and that artifacts would matter. When the set hit the printers, it contained Mirrodin throwbacks, Mirran cards, Phyrexian cards, poison, and tons of cards that made artifacts matter."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "604751"
[_metadata_:publish_date]:- "2010-10-11"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Running In Circles"
[_metadata_:wayback_capture_timestamp]:- "2017-03-17 19:42:14"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20170317194214id_/http://magic.wizards.com/en/articles/archive/running-circles-2010-10-11"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/running-circles-2010-10-11"
---
...
![](http://magic.wizards.com/sites/mtg/files/styles/auth_small/public/images/person/authorpic_AlexisJanson.jpg?itok=w9TwlwSb)
By Alexis Janson
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature112_sabre.jpg)Without a "Get Out Of Jail Free" card, we had to get to work. We toyed with artifacts that cared about colored mana; different ways of playing with colored mana in your mana pool; [Crystal Shard](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Crystal+Shard) variations; [Spellbomb](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&name=+%5BSpellbomb%5D&format=%5B%22Mirrodin+Block%22%5D) variations; and many other "color matters" artifact mechanics.


Even though we tried a dozen new mechanics in this space, we ultimately settled on simply using colored activations, with a small tweak on a new cycle of [Spellbombs](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&name=+%5BSpellbomb%5D&set=%5B%22Scars+of+Mirrodin%22%5D). Everything else felt too mechanical or complicated, and nothing was fun enough to make up for it.


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature112_3Cards1.jpg)**Affinity:** Seeing as how this worked out so perfectly in the last *Mirrodin* block, we figured there was nothing left to explore here and moved on. I had a great paragraph explaining why we skipped affinity, but like everything else related to affinity it got banned.


*(Note: MaRo's [article](http://www.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/mm/108) challenges this timeline and says affinity came before imprint, but this is wrong—we didn't seriously put affinity into the file until late.)*
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature112_palladium.jpg)Fairly early in design, we needed more artifacts that would stick around and help enable the various "artifacts matter" cards and mechanics floating around. We also needed a bit more mana-fixing. Naturally, this is where we hit upon reprinting the five [mana-Myr](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&text=+%5Bto%5D+%5Byour%5D+%5Bmana%5D+%5Bpool%5D&format=%5B%22Mirrodin+Block%22%5D&type=+%5B%22Creature%22%5D&subtype=+%5B%22Myr%22%5D&cmc=+%3d%5B2%5D)—except, of course, we didn't. Design needs to justify their existence by creating new cards, not by blindly reprinting entire cycles.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature112_5Myr.jpg)Obviously, they satisfied the same needs as the Mocks—which, of course, happens to be the same useful purpose the Myr served in the previous *Mirrodin* block, making them flavorful, relevant, and exceedingly cute. They're also still good at picking up an axe and hitting your opponent in the face.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature112_affintyNo.jpg)**Presence:** I've only mentioned half a dozen keywords so far, but dozens more populated our emails and design meetings. The cycle repeated itself over and over—review our design goals, brainstorm mechanics, select one or two to try, playtest, find out the mechanic was relatively fun, and then discover some reason to euthanize our latest experiment and try again. We were only a month or so away from handing the set off to development, and we still needed a new Mirran mechanic. Having ditched affinity like last season's fashion, we set out to brainstorm some more.


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature112_rustRelic.jpg)With limited time to work, we immediately slotted in a standby mechanic that Mark Globus just had sitting around called "presence." Originally designed to count permanents, it was tweaked to care about artifacts, and design started creating theme decks.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature112_3Cards2.jpg)### Stars of Mirrodin
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature112_mirrodin2.jpg)Although *Mirrodin*, being an artifact set, was allowed to have some number of quirky and awesome artifacts at uncommon, the majority of the marquee cards would end up at rare—so I'm going to spill some dirty secrets about rare design.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature112_geth.jpg)We knew going in that we would use poison, so our initial designs focused on that. I won't bore you with another twenty paragraphs iterating all the mechanical variations involving poison we tried—partly because many of the unused variations show up later in the block, and partly because Mark waited fourteen years for his thunder and I'm not about to steal it from him.
