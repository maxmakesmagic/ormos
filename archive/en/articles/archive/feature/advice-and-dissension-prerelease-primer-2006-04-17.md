...
Keep an eye on your Selesnya cards out of the *Ravnica* portion as that will give you the broadest swath of *Dissension* guilds to work with, leaving only your Rakdos on the sidelines. Blue/Green/White should be a popular arrangement but always keep in mind how easy it is to splash two colors with the right tools in this block. In past sets it would not be uncommon for a player to splash two [Mountain](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mountain)s and a Red removal spell. How different is that from splashing a [Lightning Helix](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Helix) off of a [Boros Garrison](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Boros+Garrison) and [Boros Signet](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Boros+Signet)? Keep your eye on any unused guild cards and the accompanying mana fixers. There is no reason to leave a perfectly devastating Rakdos card in your sideboard when you can splash it at easily as a card with a single colored mana casting cost.
...
This is a pretty exciting card. While I don’t get too excited about land destruction in general, I do stand up and take notice when it can happen at instant speed – and has an even better primary function. Imagine coming out of the gates fast with some janky Red guys like [Sell-Sword Brute](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sell-Sword+Brute) and a random three-drop and having this ready on turn 4. If your opponent plays a creature – any creature... none of the normal Black removal restrictions apply here – you can kill it. If they miss a creature drop or – even better – a land drop, you can send ‘em back to the stone-age with your new-fangled [Stone Rain](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stone+Rain). I don’t even want to discuss what happens if you hit a freshly played karoo there.
