...
---
[Link to Wayback Machine](https://web.archive.org/web/20220518173626/https://magic.wizards.com/en/articles/archive/putting-rd-theros-2013-09-30-0)

[_metadata_:author]:- "Jon Loucks"
[_metadata_:description]:- "Download Magic Online Theros Event Dates Prerelease Events: October 4 - 7 Release Events: October 7 - 23 Face the Hydra Challenge: Preliminaries: October 24 - 28 Finals: October 30 - November 6 Hello my friends! My name is Jonathon Loucks, and I'm a digital designer here in Wizards R&D. I love telling stories about my job, and that's exactly what I get to do today! I'm going"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "688226"
[_metadata_:publish_date]:- "2013-09-30"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Putting the R&D in Theros"
[_metadata_:wayback_capture_timestamp]:- "2022-05-18 17:36:26"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20220518173626id_/https://magic.wizards.com/en/articles/archive/putting-rd-theros-2013-09-30-0"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/putting-rd-theros-2013-09-30-0"
---
...
[![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/digital/magiconline/theros_booster.jpg)](https://accounts.onlinegaming.wizards.com/)
...
* **[Prerelease Events](/en/articles/archive/magic-online-theros-prerelease-and-release-events-2013-09-16-0):** October 4 - 7
* **[Release Events](/en/articles/archive/magic-online-theros-prerelease-and-release-events-2013-09-16-0):** October 7 - 23
* **[Face the Hydra Challenge:](/en/articles/archive/heros-path-standard-format-and-face-hydra-challenge-2013-09-23-0)**
**Preliminaries:** October 24 - 28  
**Finals:** October 30 - November 6
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/digital/magiconline/img_god_enchantment_battlefield_650.png)
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/digital/magiconline/img_monstrous.png)
You're a Monster
----------------
...
There are a few cases in **Magic Online**  where we show exiled cards on the battlefield instead of in the exile zone. [Oblivion Ring](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Oblivion+Ring) is probably the most famous case of this treatment. It's the most intuitive method of showing the association between [Oblivion Ring](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Oblivion+Ring) and the exiled card, though sometimes the implementation isn't entirely straightforward.


It's one thing to exile a single card. [Angel of Serenity](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Angel+of+Serenity) ups the stakes a little bit with three cards. But [Ashiok, Nightmare Weaver](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ashiok%2C+Nightmare+Weaver)? This Planeswalker exiles like crazy! In some control matchups, especially with the new legend rule, it's not crazy to think that Ashiok would have a double-digit number of exiled cards. Do we really want to show that many exiled cards on the battlefield?
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/digital/magiconline/ashiok_exile.png)
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/tcg/products/dgm/tiwoirwiixix/rtdk3u41zz_EN.jpg)
...
This time around, we picked up [Progenitor Mimic](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Progenitor+Mimic) from *Dragon's Maze*. We realized that the copy wasn't getting any blue text, but it was clearly gaining an ability that should be represented. With the release of *Theros*  on **Magic Online**, you'll now see blue text on a Progenitor Mimic that's a copy of something.


There are other instances of clones gaining abilities, such as [Phantasmal Image](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phantasmal+Image). We'd like to add blue text to those eventually as well, but they're not as high of a priority. Part of this past-cleanup effort accepts that we can't fix everything, but we should put extra effort in to polish our most recent releases. I hope that this effort continues to raise the bar for **Magic Online**  sets, even after their release dates!
...
The set spec also has to cover any branded-play requests. For *Theros* , that means following the Hero's Path. The other week [I wrote about how the Hero's Path works](/en/articles/archive/making-magic/so-you-want-be-hero-2013-09-23) on **Magic Online**  (for information on events in the **Magic Online**  Hero's Path, check out the articles on [*Theros*  Prerelease and Release Events](/en/articles/archive/magic-online-theros-prerelease-and-release-events-2013-09-16-0) and the [Face the Hydra Challenge](/en/articles/archive/heros-path-standard-format-and-face-hydra-challenge-2013-09-23-0)). If you're familiar with the Hero's Path in face-to-face **Magic**, then you'll notice some difference with how it works on **Magic Online**. Figuring out exactly how the Hero's Path would work on **Magic Online**  was a multi-discipline effort between the digital designers, the **Magic online**  programmers, business, and the path's original designer, Dave Guskin.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/digital/magiconline/herospath_white_theprotector.jpg)
...
 
Lastly, there was the challenge of creating a [Hydra experience](/en/articles/archive/heros-path-standard-format-and-face-hydra-challenge-2013-09-23-0). We certainly couldn't replicate the unique in-store experience of the Face the Hydra Challenge Deck, so we had to get a little creative. We still wanted players to battle a Hydra, but we had no way of running an event that paired everybody against a hydra of some kind. So we created a tournament where players earned the right to face the mighty Hydra in a separate event, piloted by none other than Wizards R&D! If enough heroes defeat the Hydra, then we give rewards out to the entire community. I wish you the best of luck in defeating the Hydra--you'll need it.
