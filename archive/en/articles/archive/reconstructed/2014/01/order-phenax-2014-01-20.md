...
---
[Link to Wayback Machine](https://web.archive.org/web/20210429040056/https://magic.wizards.com/en/articles/archive/reconstructed/order-phenax-2014-01-20)

[_metadata_:author]:- "Gavin Verhey"
[_metadata_:description]:- "The Gods you'll find in Born of the Gods are cut from a much different cloth than in Theros. For one—and perhaps you already know if you read Mark Rosewater's first preview article or the mechanics article—these Gods are multicolored. Unlike their Theros brethren, these Gods align themselves with two different colors. If you've been following along so far, that's something you"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "206266"
[_metadata_:path_date]:- "2014-01-20"
[_metadata_:publish_date]:- "2014-01-21"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "The Order of the Phenax"
[_metadata_:wayback_capture_timestamp]:- "2021-04-29 04:00:56"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20210429040056id_/https://magic.wizards.com/en/articles/archive/reconstructed/order-phenax-2014-01-20"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/reconstructed/order-phenax-2014-01-20"
---


The Order of the Phenax
=======================
...
The Gods you'll find in *Born of the Gods* are cut from a much different cloth than in *Theros*. 

  
For one—and perhaps you already know if you read [Mark Rosewater's first preview article](http://archive.wizards.com/magic/magazine/Article.aspx?x=mtg/daily/mm/282) or [the mechanics article](http://archive.wizards.com/Magic/magazine/Article.aspx?x=mtg/daily/feature/bornofthegodsmechanics)—these Gods are multicolored. Unlike their *Theros* brethren, these Gods align themselves with two different colors. 
 ...
 The *Theros* Gods were designed to be pretty all-purpose. For example, any deck with enough white mana sources is going to be able to get use out of [Heliod, God of the Sun](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Heliod%2C+God+of+the+Sun), and as long as you have creatures you're doing pretty well with [Purphoros, God of the Forge](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Purphoros%2C+God+of+the+Forge). After all, the *Theros* Gods are the major gods of the pantheon—they have to represent an entire color. 
...
![](https://media.wizards.com/images/magic/tcg/products/bng/KDJ)D(jk2m2389/q1ep2CNflh_EN.jpg)  
...
![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Temple+of+Deceit)
 ...
 Because of the high defender theme, [Doorkeeper](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Doorkeeper) even joins the fray as a way to start a little bit of milling early. Even if you don't find a Phenax until later on (which you should be able to do thanks to [Omenspeaker](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Omenspeaker) and [Read the Bones](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Read+the+Bones)), [Doorkeeper](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Doorkeeper) can help make the job for Phenax that much easier when you finally do find the god of deception. 
...
|  |  |
 ...
 Looking for some different directions? Well, if you want a way to more reliably turn on Phenax you could look at [Lazav, Dimir Mastermind](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lazav%2C+Dimir+Mastermind). While [Nightveil Specter](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Nightveil+Specter) only counts as three toward Phenax's devotion, Lazav counts for four—and with Phenax's base two mana symbols, that's only one away from switching Phenax into a creature. (Plus, Lazav could even copy something with high toughness to boot!) 

 There are quite a few enticing five-drops that didn't make the cut here—[Prognostic Sphinx](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Prognostic+Sphinx) and [Consuming Aberration](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Consuming+Aberration) among them—but this deck really wants to top out at five, curving defenders along the way, and you can only have so many five-drops before your draws start to suffer. 
...
4
[Beck // Call](http://gatherer.wizards.com/Pages/Search/Default.aspx?name=+%5BBeck%5D+%5B&%5D+%5BCall%5D)
...
[Hold the Gates](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hold+the+Gates) and [Tower Defense](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tower+Defense) are two cards that substantially pump the toughness of all your creatures. Normally, extra toughness isn't that worthwhile. But with Phenax on the table, everything changes. 
...
|  |  |
 ...
 Imagine you make four tokens with [Call](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Beck+%2F%2F+Call), then untap. If you cast [Tower Defense](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tower+Defense) and Phenax in this situation, that's twenty-four cards you can mill away right there... and I'd be surprised if you didn't have another creature at that point as well. 

 The real toughness all-star is [Hold the Gates](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hold+the+Gates): with a nearly all-Gate mana base, that means your creatures pick up an extra point of toughness for each land you have. By adding an exorbitant amount of toughness to all of your creatures, Phenax's ability can finish your opponent off in a turn or two. 

 Because of all the Gates, you get to incorporate a Gate engine as well with [Gatecreeper Vine](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gatecreeper+Vine) to help fix up your mana. Some green creatures let you shave lands to flood the board with even more creatures, making Phenax all the more lethal. [Prophet of Kruphix](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Prophet+of+Kruphix) helps you work double time, deploying all the creatures you need to... and then getting a double use out of Phenax's mill ability from your creatures once you've cast him! 
...
|  |  |
 ...
 Looking for tweaks you could put on this deck? If you wanted to, you could convert this to a full-on [Maze's End](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Maze%27s+End) deck. While it's an unlikely combination, it certainly attacks your opponents from two directions they likely weren't expecting... and they might not be able to deal with both. 
...
![](https://media.wizards.com/images/magic/daily/footers/slice1.jpg)![](https://media.wizards.com/images/magic/daily/footers/slice2.jpg)![Gavin Verhey](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/authorpics/authorpic_gavinverhey.jpg) **Gavin Verhey**[@GavinVerhey](https://twitter.com/gavinverhey)[Email Gavin](/company/emailtoauthor.asp?author=Gavin%20Verheyamp;amp;headline=%5BThe%20Order%20of%20the%20Phenax%5D "Click to send email to the author.") | [Author Archive](http://archive.wizards.com/Magic/Magazine/Archive.aspx?author=Gavin%20Verhey)[ReConstructed Archive](/Magic/Magazine/Archive.aspx?tag=ReConstructedamp;description=ReConstructed) |  
