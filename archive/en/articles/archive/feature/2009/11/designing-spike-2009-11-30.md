...
---
[Link to Wayback Machine](https://web.archive.org/web/20170505064137/http://magic.wizards.com/en/articles/archive/feature/designing-spike-2009-11-30)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:publish_date]:- "2009-11-30"
[_metadata_:title]:- "Designing for Spike"
[_metadata_:wayback_capture_timestamp]:- "2017-05-05 06:41:37+00:00"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20170505064137id_/http://magic.wizards.com/en/articles/archive/feature/designing-spike-2009-11-30"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/feature/designing-spike-2009-11-30"
---
...
Welcome to Spike Week, part three of three of our series of player psychographic theme weeks. (Timmy Week was back in March and Johnny Week was in August – you can see "Designing for Timmy" [here](/en/articles/archive/designing-timmy-2009-03-09) and "Designing for Johnny" [here](/en/articles/archive/designing-johnny-2009-08-03).) If you're unfamiliar with our player psychographics, I suggest reading my most recent article on them, "[Timmy, Johnny and Spike Revisited](/en/articles/archive/making-magic/timmy-johnny-and-spike-revisited-2006-03-20-0)". If you're wondering where Melvin and Vorthos are, they're not player psychographics (which I explain in my column on them, "[Melvin and Vorthos](/en/articles/archive/making-magic/melvin-and-vorthos-2007-05-07-0)"), but I'm sure they're eventually get their own theme weeks as theme weeks are hungry monsters and Kelly (Digges, our editor) is always looking for things to feed them. Now that I have all of the required reading out of the way, let's get to what you all came here for. In this column I am going to explain how we design for the Spike psychographic.
...
**![RATS OF RATH](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=RATS+OF+RATH)**


 


Yes, a two-mana 2/1 that allows you to destroy your own cards. At first blush, this card looks sub-optimal. But as you begin to understand the *Tempest* Limited environment, you learn two things. One, there is a very strong aggro strategy that involves black, so having a two-mana 2-power guy is a little better than normal. More importantly though, the seemingly useless ability is far from useless. Why? Because of a little mechanic called buyback. The aggro strategy of *Tempest* Limited is balanced by a control strategy that takes advantage of cards like [Capsize](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Capsize). Once a player had enough mana, buyback spells became very powerful, and there were very few answers. But if [Capsize](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Capsize) is countered because its target goes away (what we called "fizzle" back in the day), the spell will not return to its owner's hand. This makes the Rats' ability very important because it can fizzle buyback spells.


Another means R&D can use to hide a card's strength is to introduce a new ability. Players tend to gauge the power level of a card by comparing it to known cards. When a card does something that isn't easily comparable, it makes such judgments much harder to make. A classic example of this would be the card [Tarmogoyf](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tarmogoyf) from *Future Sight*.
...
The card, at first blush, looks like a goofy [Lhurgoyf](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lhurgoyf) tweak. (To be fair, it *is* a goofy [Lhurgoyf](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lhurgoyf) tweak.) Sure, it can grow quickly if the right number of different card types are in all graveyards, but how hard is that to accomplish? That uncertainty hid the value of the card for a month or two when the set was released. By the way, I should point out that while R&D knew this card was good it ended up proving to be even better than R&D initially thought.


Note that these cards don't always have to appear bad at first. Some of the best examples are cards where the Spikes get to argue about how good something is. A poster child for this type of card just showed up in *Zendikar*: a little snake known as [Lotus Cobra](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lotus+Cobra).
...
Out of the gate there was a lot of excitement for this card. The big debate wasn't "Is it any good?" but "Just how good is it?" Was it merely good or was it awesome? I watched thread after thread and article after article chime in on [Lotus Cobra](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lotus+Cobra) landing all over the spectrum from one of the best two-drops of all time to merely okay. (On that subject, note that it showed up in prominent deck designer Conley Woods's deck at Worlds, which you can [learn all about here](http://www.youtube.com/watch?v=Z8mOZJeQ-yA).)
...
![FACT OR FICTION](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Fact+or+Fiction)

Splitting five cards correctly is very challenging. It depends not just on the value of the five cards in a vacuum but what they mean to the current game state. In addition, understanding what the opponent values, correctly or not, allows for splits that will push the opponent to make a certain choice most often to the advantage of the splitter. Doing this correctly requires a lot of skill. So much so that [Fact or Fiction](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fact+or+Fiction) has proven to be a favorite among Spikes.


The biggest reason is that it is allows Spike to prove himself not just in the choice to put it into his deck but in the actual play of the game itself. Each time he plays the card he gets to prove his ability to use the card correctly. So much so that [Fact or Fiction](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fact+or+Fiction) splits themselves become fodder for Spike metagame discussions.
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm67_charms.jpg)The charms give the player three different options. Usually these options are not interconnected, meaning the card has a variety of uses. Cards like this are popular with Spike because they allow so much flexibility to respond to the situation at hand.
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm67_mechanics.jpg)This choice is one of being able to opt into a more powerful version of the spell later in the game, usually because the player has access to mana. The choice here is choosing whether to use the lesser version early or wait for the more powerful version later.


Another popular choice is the alternate choice. Examples of this would be cycling, evoke or reinforce.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm67_mechanics2.jpg)These cards allow you a choice to do something other than the base effect, sometimes a lesser, cheaper version of it. These cards give you an out if the main use of the card isn't handy or playable right now.


Next we have cards that allow you choices when playing the card that affect what the card is. Although an old example, my go-to for this is [Primal Clay](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Primal+Clay). I could just as easily use any card with imprint or one that forces you to choose a color when played.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm67_cards.jpg)These cards build the choice of what the card is into the playing of the card. This allows Spike to have options of what exactly the card will do. A very popular subset of this for Spikes (and, interestingly enough, Johnnies) are clone cards that allow the player to copy something already in play.
