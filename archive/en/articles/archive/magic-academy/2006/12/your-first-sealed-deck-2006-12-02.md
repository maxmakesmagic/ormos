...
---
[Link to Wayback Machine](https://web.archive.org/web/20170830102233/http://magic.wizards.com/en/articles/archive/magic-academy/your-first-sealed-deck-2006-12-02)

[_metadata_:author]:- "Jeff Cunningham"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "704946"
[_metadata_:publish_date]:- "2006-12-02"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Your First Sealed Deck"
[_metadata_:wayback_capture_timestamp]:- "2017-08-30 10:22:33"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20170830102233id_/http://magic.wizards.com/en/articles/archive/magic-academy/your-first-sealed-deck-2006-12-02"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/magic-academy/your-first-sealed-deck-2006-12-02"
---
...
In Booster Draft (see [Academy 13](/en/node/704936) for an intro to Booster Draft if that term is new to you) one has much control over what their pool is. In Sealed, the skill is making the best out of what you're given. So what approaches should one use to sculpt a card pool down into a *deck*?
...
![Phantom Warrior](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Phantom+Warrior)

We'll be talking more about building your mana base late, but for now keep in mind that in the first two colors you'll normally want to put in enough land to support all your early plays. (To play [Phantom Warrior](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phantom+Warrior), and assume we will be able to play it turn 3, when it is most valuable, we would want to play at least 7 or 8 Islands, for example). For our splash color, though, we include as little land as possible, and refrain from including cards whose value depends on being played in the early game. If Blue was our splash then, while [Phantom Warrior](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phantom+Warrior) is a solid card in its own right, we would understand that since we would only be playing a few Islands, it would not be worth playing. In your splash color, you will want to aim for cards which are valuable in the mid and late game. For example, [Thundermare](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Thundermare) is a good example of a card that would fit well in a splash color. By the time Turn 7 rolls around, you'll probably have drawn one of your splash's lands, even if you don't play that many.

With all that in mind, splash cards will also normally have only one mana symbol of the color you're splashing. Trying to support a ![](https://web.archive.org/web/20161227195556im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/black.gif)![](https://web.archive.org/web/20161227195556im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/black.gif) splash spell in a primarily blue-white deck, for example, is much more difficult to pull off than splashing a spell with just a single ![](https://web.archive.org/web/20161227195556im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/black.gif) in the casting cost. While building your Sealed Deck, it's important to approach your mana-base as reasonably as possible, acknowledging the value of a good solid foundation. While you can often count with clarity the games a specific card wins you ([Blaze](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blaze)!), the games a good mana base wins you, just as valuable, are more difficult to glean.
...
![Dark Banishing](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Dark+Banishing)

**5. Remove**
Removal plays an important role in Limited, and having even a few removal spells is a large improvement on having none.


Besides the fact that removal is just generally good in Limited environments (unlike in Constructed, in Limited [Dark Banishing](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dark+Banishing) will virtually always have a target, and often one that costs more than the spell does), it provides solutions to specific problem creatures.


For instance, while it is not necessary to remove every creature an opponent plays, there will often be a creature that, if left unattended, will make it very difficult for you to win. Consider a Blue/White deck with many small flying creatures. If this deck does not have a [Pacifism](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pacifism), or another solution, a single [Giant Spider](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Giant+Spider) may pose very serious problems. A [Royal Assassin](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Royal+Assassin) may single-handedly put a wrench in the gears of any Green/White deck.
...
However, several 1 drops are playable. You're going to want an ability that has a relevant effect on more expensive cards. ([Festering Goblin](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Festering+Goblin), [Llanowar Elves](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Llanowar+Elves), and [Infantry Veteran](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infantry+Veteran) are good examples of what you might look for in a 1 mana spell).
...
* 2/2s with an evasion ability. ([Phantom Warrior](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phantom+Warrior))
* Higher P/T (or functionally higher) than 2/2 ([Rootwalla](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rootwalla))
* Relevant ability ([Puppet Master](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Puppet+Master))
...
![Hill Giant](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Hill+Giant)
...
![Aven Cloudchaser](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Aven+Cloudchaser)


If a ground creature is worse than a 3/3, it ought to have a very relevant ability here. ([Anaba Shaman](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Anaba+Shaman))
...
5cc: You're only going to want 2 or 3 creatures that cost 5 mana. Occasionally, you'll have to play a plain 3/3 for 5 mana ([Wanderguard Sentry](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wanderguard+Sentry)), but this is not good.


A 5 mana flyer for 3, on the other hand, is a Limited staple. ([Aven Windreader](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Aven+Windreader))


A 5 mana 4/4 is also something you'll almost always play here. ([Flowstone Crusher](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Flowstone+Crusher))


Other than that, you'll just be on the look out for something exceptional. ([Silklash Spider](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Silklash+Spider))
...
By now you're looking for great stats—5/5, or 6/4s ([Craw Wurm](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Craw+Wurm)) are passable here—or bombs (cards that have the potential to win the game practically by themselves, like [Shivan Dragon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shivan+Dragon)).


7cc: Past 6 mana, and you're looking to play possibly one card, *maybe* two. You will sometimes play a 7 mana spell on the basis of its size—around 7/7 is good here. ([Enormous Baloth](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Enormous+Baloth))


Again, this is bomb territory.


8cc: At 8 mana you're looking for bombs, and bombs only. ([Verdant Force](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Verdant+Force)).
...
Don't get caught up by bombs. A [Shivan Dragon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shivan+Dragon) might win most games in which it's cast, but if you don't have other good red spells, your deck will lose when you don't draw it. Don't force yourself to play a color just because you have one great card… try to decide which colors are strongest overall.
...
Remember, while it is not advisable to choose your colors solely based on a bomb you have, you will want that to weigh heavily in your decision. You might not play red even though you have [Shivan Dragon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shivan+Dragon), but you will sure have to think about it if you don't!
...
Note that this is not strictly the cost in the upper right corner. While you will almost certainly want to play [Glory Seeker](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Glory+Seeker)s as soon as possible (turn 2) [Volcanic Hammer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Volcanic+Hammer) will be effective at any point in the game. We leave it off the curve. This method does not require precision; it just aims to give a general sense of a deck's strengths and weaknesses. Arrange the cards where you think they belong.
...
![Foul Imp](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Foul+Imp)
...
Remember, your goal here is to be able to be able to play your cards on the turns they are best. An [Elvish Warrior](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Elvish+Warrior) is great on turn 2, but on turn 6… not so much.




![Elvish Warrior](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Elvish+Warrior)
...
Another regular consideration is cards like [Frozen Shade](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Frozen+Shade), which get better with extra Swamps. In this case it might be better to lean on the side of extra black mana, since in the late game it will be more useful than red mana.
