...
---
[Link to Wayback Machine](https://web.archive.org/web/20201018133842/https://magic.wizards.com/en/articles/archive/magic-academy/introduction-card-advantage-2006-09-23)
...
[_metadata_:node]:- "704896"
[_metadata_:publish_date]:- "2006-09-23"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Introduction to Card Advantage"
[_metadata_:wayback_capture_timestamp]:- "2020-10-18 13:38:42"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20201018133842id_/https://magic.wizards.com/en/articles/archive/magic-academy/introduction-card-advantage-2006-09-23"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/magic-academy/introduction-card-advantage-2006-09-23"
---
...
![Counsel of the Soratami](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Counsel+of+the+Soratami)For some of you this is intuitive, while others will be out there scratching their heads, still uncertain as to exactly what I mean. Therefore, let's do a couple of minor math problems to give you a more concrete example instead of airy-fairy theory.I cast [Counsel of the Soratami](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Counsel+of+the+Soratami). This spell allows me to use one card to draw two cards, thus putting me up one card net. Voila, you have just created card advantage.
...
>  This is the classic example. You cast [Tidings](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tidings), drawing four cards for the cost of one (the [Tidings](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tidings) itself). That's the type of obvious card advantage that everyone understands.
> 
> 
> ![Tidings](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Tidings)
> *2) Force your opponent to discard cards.*  
>  Often casting a discard spell will cost you one card to get one card (like [Duress](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Duress) or [Coercion](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Coercion)), but spells like [Mind Rot](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mind+Rot) are guaranteed to hit two cards of your opponent's as long as they have two or more cards in hand. You lose one (the [Mind Rot](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mind+Rot)), they lose two, you gain a one card advantage in the process.
> 
> 
...
> 
> 
> Say your opponent is attacking with a [Grizzly Bears](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grizzly+Bears) and decides to [Giant Growth](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Giant+Growth) his Bears before combat damage to hit you for five. You respond with [Shock](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shock) on the [Grizzly Bears](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grizzly+Bears), sending both the Bears and the [Giant Growth](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Giant+Growth) to the graveyard. This play cost you one spell to your opponent's two spells, thus netting you one card. Being aware of and making this sort of play is the very cornerstone of how to play better **Magic**.
> 
> 
> Here's a second example in the same vein. Ben has four creatures on the board. Opie has zero creatures, and casts [Wrath of God](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wrath+of+God). This play cost Opie one card in exchange for Ben's four creatures, a pretty good deal by any accounting standard.
> 
> 
...
When Eric “Dinosaur” Taylor originally pitched this concept, it was defined as “card advantage when no one loses cards.” The classic example for this is playing a [Moat](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Moat) against your opponent's army of ground pounders. 

![Moat](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Moat)You haven't killed all the creatures like you would with [Wrath of God](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wrath+of+God) (thus making it virtual), but you have now locked down her entire opposing force with a single card. 

### Special Case: Why is [Howling Mine](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Howling+Mine) not Card Advantage?

![Howling Mine](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Howling+Mine)Many beginning players see [Howling Mine](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Howling+Mine) and flip their lids over the idea of drawing two cards a turn. This in spite of also noticing that it makes the opponent draw an extra card per turn as well. This is what we call a symmetrical effect, and it doesn't net you any card advantage on its own because, while it draws you extra cards, it does *not* draw you extra cards in relation to your opponent.Let me put this another way – you cast [Howling Mine](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Howling+Mine). Who gets to draw a card from it first? Your opponent does. What happens if your opponent just [Naturalize](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Naturalize)s [Howling Mine](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Howling+Mine) before your turn? You get to draw zero extra cards, even though you invested a card to do it, while you opponent is happily sitting there with one extra card in hand.
...
It's been a while since the old man wrote, but edt was one of the foremost thinkers and innovators of **Magic** theory. “[Tempo and Card Advantage](http://www.starcitygames.com/php/news/expandnews.php?Article=3690)” and “[Virtual Cards in Urza's Block, a Sub-Category of Card Advantage Theory](http://mtg.rpg.by/modules/wfsection/article.php?articleid=16)” are two of his classics on this specific area of **Magic** fundamentals.
