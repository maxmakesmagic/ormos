...
---
[Link to Wayback Machine](https://web.archive.org/web/20160326211935/http://magic.wizards.com/en/articles/archive/feature/double-faced-card-rules-2011-08-29)
...
[![](https://media.magic.wizards.com/image_legacy_migration/images/magic/tcg/products/dka/EN_DoubleFacedCardRulesHeader_bizm4338ea.jpg)](/en/node/702046)
*This page is intended to cover double-faced cards in detail. As such, it repeats the basic information from the [Innistrad Mechanics Article](/en/node/697631). If you're just looking for the basics, the Mechanics Article should have you covered.*
...
|  |
| --- |
| </sites/all/modules/custom/wiz_legacy_migration/flipcard/flipcard_big.html?ca=2t12ck9zsy&cb=vag9ov089v&lang=en> |
...
|  |  |
| --- | --- |
| * [Double-Faced Cards in General](#1)
* [Putting Double-Faced Cards in Your Deck](#2)
 | * [Transforming](#4)
* [Double-Faced Cards and Copy Effects](#5)
 |
...
|  |  |
| --- | --- |
| Innistrad Checklist Card | Dark Ascension Checklist Card |
...
Any time a double-faced card is visible—whether because it's in a public zone, because it's revealed (say, by [Telepathy](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Telepathy)), or because it's being looked at by a player due to an effect (say, [Coercion](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Coercion))—the players who can see it can see both faces. Any player who can look at a checklist card in a hidden zone may look at the double-faced card it represents.
...
Although the physical action is the same, transforming is not the same as being turned face down. This means that a double-faced card that transforms will not, for example, trigger [Unblinking Bleb](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Unblinking+Bleb). Double-faced cards are always face up; they are never face down. If an effect (say, [Ixidron](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ixidron)) tries to turn a double-faced card face down, nothing happens.
...
|  |
| --- |
| </sites/all/modules/custom/wiz_legacy_migration/flipcard/flipcard_big.html?ca=uxtqn0kofq&cb=5yunue53me&lang=en> |

### Double-Faced Cards and Copy Effects


Some of the most complicated interactions involving double-faced cards are with copy effects, such as [Clone](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Clone) and [Mirrorweave](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mirrorweave).
