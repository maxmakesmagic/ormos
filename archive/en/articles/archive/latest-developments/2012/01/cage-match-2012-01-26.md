...
---
[Link to Wayback Machine](https://web.archive.org/web/20220626120458/https://magic.wizards.com/en/articles/archive/latest-developments/cage-match-2012-01-26)

[_metadata_:author]:- "Zac Hill"
[_metadata_:description]:- "Hey, y'all. Welcome to Dark Ascension Release Week.As I'm sure you already know—and if not, congratulations on avoiding an artillery-like barrage of banner-ads—the Dark Ascension Prerelease is tomorrow. I hope you can find some time to attend. I mentioned this last week, but DKA was the first set for which I was a member of both the design and development teams. As such, it"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "193881"
[_metadata_:path_date]:- "2012-01-26"
[_metadata_:publish_date]:- "2012-01-27"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Cage Match"
[_metadata_:wayback_capture_timestamp]:- "2022-06-26 12:04:58"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20220626120458id_/https://magic.wizards.com/en/articles/archive/latest-developments/cage-match-2012-01-26"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/latest-developments/cage-match-2012-01-26"
---
...
Hey, y'all. Welcome to *Dark Ascension* Release Week.
...
Now, if you're going to show up to the Prerelease, you might as well be prepared. So make sure to check out the sortable spoiler located [here](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;set=%7C%5B%22Dark+Ascension%22%5D). This'll prepare you for the cards you're going to see, the tricks you need to play around, and the bombs you'll want to cross your fingers for and hope to bust.
...
That card is [Grafdigger's Cage](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grafdigger%27s+Cage).

![](https://media.wizards.com/images/magic/tcg/products/dka/8lnya30yr2_en.jpg)  
Break It Down
...
Which brings me back to [Into the Core](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Into+the+Core) and [Creeping Corrosion](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Creeping+Corrosion).

![](https://media.wizards.com/images/magic/daily/ld/ld179_corrosion2.jpg)[Creeping Corrosion](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Creeping+Corrosion) | Art by [Ryan Pancoast](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=+%5B%22Ryan+Pancoast%22%5D)
...
Are there downsides to doing things this way? Of course there are. While our internal playtesting is reasonably good at identifying dominant strategies, it isn't perfect. Also, when we're developing (say) *Innistrad* we don't know what (say) *Dark Ascension* is going to look like in its final form, so we have to make some predictions that might not hold up. Because of that, sometimes we wind up designing hate cards (like [Into the Core](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Into+the+Core) and [Creeping Corrosion](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Creeping+Corrosion)) that in retrospect aren't entirely necessary. Other times, we design cards like [Tunnel Ignus](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tunnel+Ignus), [Leonin Arbiter](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Leonin+Arbiter), and [Ghost Quarter](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ghost+Quarter) that aren't quite as effective as they need to be. On balance, however, we believe this plan is for the most part working. It gives players options, and some imperfect options are better than no options at all—especially since, should the seeds we plant prove ineffective, we still have the option of the older, louder, brute-force method if need be.

![](https://media.wizards.com/images/magic/daily/ld/ld179_threejcg.jpg)  
...
Can You Dig It?
All of this leads us right back to [Grafdigger's Cage](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grafdigger%27s+Cage).
...
When we were developing *Dark Ascension*, *New Phyrexia* hadn't even been released yet. Internally, our Pod decks hadn't started dominating the FFL until *Innistrad*, but it's conceivable that we had missed something. Conceivably, Pod could have been oppressive from the moment it was printed. Had that been true, the environment would be terrible. Players would be picking up their library and searching it every turn, tutoring for the optimal answer every time. [Clone](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Clone)s like [Phantasmal Image](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phantasmal+Image) and [Phyrexian Metamorph](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phyrexian+Metamorph) made it relatively easy to blow up lands with [Acidic Slime](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Acidic+Slime) (and [Frost Titan](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Frost+Titan), which is pretty nice with Slime and Pod) every turn of the game, and the presence of numerous Sword-wielding, Pod-saccing, [Garruk-searching](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Garruk%2C+the+Veil-Cursed) one-mana accelerants ensured that you could start doing this very quickly. Finally, the undying mechanic obviously synergizes ***very*** well with the Pod. Taken together, it became clear that should the environment as it existed internally become the environment that existed in the real world, something would have to be done about it.
...
Now, let me be clear about one thing. The card was not *created* to prevent [Blightsteel Colossi](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blightsteel+Colossus) from entering the battlefields out of libraries courtesy of [Jhoira's](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Jhoira+of+the+Ghitu) incessant [Tinker](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tinker)ing. The card was not *created* to prevent you from getting caught up in the storm of [Yawgmoth's nefarious Will](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Yawgmoth%27s+Will). The card was not *created* to keep [Iona](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Iona%2C+Shield+of+Emeria) and [Jin-Gitaxias, Core Augur](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Jin-Gitaxias%2C+Core+Augur) decidedly non-animated or the dreadful [Golgari Grave-Troll](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Golgari+Grave-Troll)s from ever returning or any of that. But it does have those effects. And, for the most part, I am glad it does.
