...
---
[Link to Wayback Machine](https://web.archive.org/web/20181006091056/https://magic.wizards.com/en/articles/archive/making-magic/gatecrashing-party-part-2-2013-01-07)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "*/"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "656671"
[_metadata_:publish_date]:- "2013-01-07"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Gatecrashing the Party, Part 2"
[_metadata_:wayback_capture_timestamp]:- "2018-10-06 09:10:56"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20181006091056id_/https://magic.wizards.com/en/articles/archive/making-magic/gatecrashing-party-part-2-2013-01-07"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/making-magic/gatecrashing-party-part-2-2013-01-07"
---
...
Welcome to the second week of *Gatecrash* previews. [Last week](/en/articles/archive/making-magic/gatecrashing-party-part-1-2012-12-31), I showed off Experiment One, a new evolve card from the Simic guild, and talked about how [Ethan Fleischer](http://www.wizards.com/magic/magazine/archive.aspx?author=ethan%20fleischer) designed the mechanic during [Great Designer Search 2](http://www.wizards.com/magic/magazine/article.aspx?x=mtg/daily/feature/133). Today, I'm going to talk about two more guilds, Boros and Dimir, and show off another cool card—this time one without a guild mechanic on it (well, it almost was a guild mechanic—we'll get to that). Sound good? Then let's get to it. 
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/tcg/products/gtc/mshrpl53qw_en.jpg)  
...
> 
> 
> [Veteran Spearman](http://community.wizards.com/magicthegathering/wiki/Labs:Gds/gds2/NoShoes/Challenge4/C2/)  
>  1W  
...
![Rally the Righteous](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Rally+the+Righteous)
...
![Szadek, Lord of Secrets](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Szadek%2C+Lord+of+Secrets)
...
![Glimpse the Unthinkable](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Glimpse+the+Unthinkable)
...
![1012](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&multiverseid=1012)
  
 This effect plays into the fact that players lose the game if they are ever unable to draw a card. (Note: You don't lose for having an empty library, you lose for being unable to draw a card.) [Richard Garfield](http://www.wizards.com/Magic/Magazine/Archive.aspx?author=Richard%20Garfield) put this rule into the game to make sure the game ended if it ever became stalemated. Millstone showed up in *Antiquities* and all of a sudden a new style of deck was born. Usually called a milling deck, the deck beats you by running you out of cards rather than through damage. 
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm229_cbztszo0sf.jpg)  
 Grind did what we wanted, but much like [propagate in Selesnya](/en/node/656276) in *Return to Ravnica*, it required a second tier of cards. Propagate needed token making and grind needed cards that cared that things had been milled. This was important because it made the grind cards relevant even in decks that weren't necessarily trying to mill out the opponent. The easiest way to do this was with cards that cared about what was in the opponent's graveyard. This theme played easily into black but was a little more of a stretch for blue. 
...
>> Click to Show
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/tcg/products/gtc/iu0xzauwx9_en.jpg)  
Hopefully, Mind Grind demonstrates that Dimir isn't forgetting the milling fans (and remember, the set has more grind cards). Grind's not the guild keyword but there's enough to build a deck around. 
