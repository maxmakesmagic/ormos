...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature144_calendar.jpg)  
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/aiuihcetrfgcvhbnmsviubh1.jpg)  
A creature with hexproof can't be the target of spells or abilities your opponents control, but you can target it with spells and abilities normally. That means that your opponent can't use [Doom Blade](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Doom+Blade) to destroy your Dungrove Elder, but you can still use something like [Lifelink](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lifelink) to make it better—the best of both worlds.

Like most of the evergreen keywords added to the game since its beginnings, hexproof isn't a new concept. It's the keyword version of a familiar ability seen on cards such as [Troll Ascetic](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Troll+Ascetic) and [Sacred Wolf](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sacred+Wolf). Those two cards—along with all the other cards that have text that exactly matches what hexproof does—will receive updated official wordings with the new keyword.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/aftdzxretrxcghbcgsjxngcbkjm2.jpg)  
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/ajhgfrsdxcvuhjkmfcbfgfnfhn3.jpg)  
...
Life loss that isn't caused by damage (for example, the life loss caused by [Vapor Snag](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vapor+Snag)) doesn't cause a creature with bloodthirst to get counters, but damage from a source with infect (such as [Cystbearer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cystbearer)) does, even though it doesn't cause loss of life.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/anbetd4rsesexcvbhjnmkknmbf4.jpg)  
...
Other sources can deal damage to planeswalkers. If a spell or ability you control would deal damage to an opponent, you may have it deal that damage to a planeswalker that opponent controls instead. So while you can't target a planeswalker with a [Shock](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shock), you can have a [Shock](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shock) that targets your opponent deal 2 damage to one of his or her planeswalkers instead of to the player. You can't split the damage from one source between a player and a planeswalker. Damage dealt to a planeswalker results in that many loyalty counters being removed from it.
