...
---
[Link to Wayback Machine](https://web.archive.org/web/20171123215222/https://magic.wizards.com/en/articles/archive/feature/theros-update-bulletin-2013-09-24)

[_metadata_:author]:- "Matt Tabak"
[_metadata_:description]:- "Welcome, dear readers, to a small look behind the curtain, under the hood, and betwixt the metaphors. With every new expansion, the Oracle team and I spend some time working on perfecting the wordings of older cards and tweaking the Comprehensive Rules. After the more substantial update that took place with the  Magic 2014 core set, I knew the Theros update would be a little lighter."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:publish_date]:- "2013-09-24"
[_metadata_:title]:- "Theros Update Bulletin"
[_metadata_:wayback_capture_timestamp]:- "2017-11-23 21:52:22+00:00"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20171123215222id_/https://magic.wizards.com/en/articles/archive/feature/theros-update-bulletin-2013-09-24"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/feature/theros-update-bulletin-2013-09-24"
---
...
But that's tomorrow. For today, please enjoy this small number of updates. Many thanks to my partners on the Oracle team and to the members of the community who brought issues to our attention over the last few months. If you have a card or rule you'd like us to take a look at, please let us know by clicking one of those links at the bottom of the page.
 ...
 Until next time,  [I'm the rules manager](/en/articles/archive/making-magic/walking-planes-hes-not-good-anymore-2013-09-13), and you will do as I say. Please? 



> 
> * Introduction
> * [Oracle Changes](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/feature/266b&page=2)
> * [Comprehensive Rulebook Changes](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/feature/266b&page=3)
> 



**[Animal Boneyard](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Animal+Boneyard) (nonfunctional)** 



 This card deviated slightly from the standard template, seen on cards like [Diamond Valley](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Diamond+Valley). In the effect of an activated ability, we usually refer to a creature sacrificed in the activation cost as "the sacrificed creature." 
...
**[Blood Speaker](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blood+Speaker) (functional, but no one will think so)** 
...
**[Shanodin Dryads](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shanodin+Dryads) (functional)**



 Now that Nymph is (once again) a creature type; the one card that was originally printed as a Nymph, [Shanodin Dryads](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shanodin+Dryads), should also be one. 
...
**[Talara's Bane](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Talara%27s+Bane) (nonfunctional)** 
...
> 
> * [Introduction](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/feature/266b&page=1)
> * Oracle Changes
> * [Comprehensive Rulebook Changes](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/feature/266b&page=3)
> 
...
**301.5e & 303.4j**
 ...
 This rule affects some corner cases with [Bludgeon Brawl](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bludgeon+Brawl) and [Dominating Licid](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dominating+Licid). It's a bit of a deep dive. Still here? Okay then. So, it's possible to have a permanent with an ability that refers to the "equipped creature" that's not an Equipment. Or, you can have one that has an ability that refers to the "enchanted [something]" without being an Aura. In some weird cases, such a permanent can be attached to another permanent. 


 For example, there was a weird combo with [Myr Welder](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Myr+Welder) exiling [Demonspine Whip](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Demonspine+Whip) and [Transmogrifying Licid](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Transmogrifying+Licid). The Welder could now become an Aura and attach to a creature. But if it wasn't an Equipment, what did the [Demonspine Whip](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Demonspine+Whip) ability mean? Was there an "equipped creature?" At the time, we decided no. "Equipped creature" had no meaning if not on an Equipment. "Enchanted creature" had no meaning if not on an Aura. 


 This stance was logical, but it had a few unintended consequences. The most glaring was [Dominating Licid](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dominating+Licid). It becomes an Aura with "You control enchanted creature." This control-changing effect applies in layer 2. But at this point, the Licid isn't an Aura yet. That doesn't happen until layer 4. By rule, the ability didn't do anything, because it said "enchanted creature" and wasn't on an Aura. Clearly, this wasn't what we had in mind. 
...
**303.4h**
 ...
 This rule was created to handle the unusual case of an effect trying to put a permanent that isn't an Aura, Equipment, or Fortification onto the battlefield attached to an object or player. It was written a little too narrowly and didn't handle all the cases it needed to. As an example of how this could happen, say you have an Aura with bestow and [Flickerform](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Flickerform) attached to the same creature. If you activate [Flickerform](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Flickerform)'s ability, the card with bestow will return to the battlefield as an unattached enchantment creature. 
