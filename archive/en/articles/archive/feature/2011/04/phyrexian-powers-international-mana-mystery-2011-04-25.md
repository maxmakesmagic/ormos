...
---
[Link to Wayback Machine](https://web.archive.org/web/20161024074643/http://magic.wizards.com/en/articles/archive/feature/phyrexian-powers-international-mana-mystery-2011-04-25)
...
[_metadata_:title]:- "Phyrexian Powers: International Mana Mystery"
...
Phyrexian Powers: International Mana Mystery
============================================
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm137_nphLogo.jpg)### Team Players
...
![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/authorpics/authorpic_daveguskin.jpg)Dave's full-time job is working on the R&D **Magic** Digital Team. This means he spends the majority of his time making sure all the various ways to play **Magic** that involve 1s and 0s are as fun as they can be. Luckily for both Dave and R&D, we like to make sure that everyone who works on **Magic** in R&D has the opportunity to be on design and development teams. I always enjoy having Dave on a design team because he does not shy away from asking the hard questions.
...
![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/authorpics/authorpic_MattPlace.jpg)Here's what I had to say about Matt in his *Scars of Mirrodin* design team bio:
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm140_mark.jpg)I don't know if there will ever be a *Guinness Book of World Records* for **Magic**, but if there is, I plan to lock up the "Been on the Most Design Teams" category. I was on the *New Phyrexia* design team because it's what I do. As you'll see over the next few weeks, I carried my own weight.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm140_scromite1.jpg)When the card went to the creative team for concepting, Brady (Dommermuth, the head of the team) looked ahead to worlds he thought we would visit and came to the conclusion that the most likely place we'd make artifacts with colored mana in their costs would be when we return to Mirrodin and discover that it's become New Phyrexia. (My Phyrexia Week column, [The Untold Story (Well Until Today)](/en/articles/archive/untold-story-well-until-today-2011-04-04), explains how last year's fall set shifted in design.) Brady chose to tie the creative on the card to New Phyrexia. When I tell you that we knew Mirrodin was going to be corrupted by Phyrexia long ago, here's yet another piece of proof. [Sarcomite Myr](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sarcomite+Myr), from *Future Sight* (released in May 2007), pictures a myr being infected by Phyrexian influence.


So [Sarcomite Myr](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sarcomite+Myr) in *Future Sight* was a preprint from *New Phyrexia*. Is this a card I'm showing off today? No and no. [Sarcomite Myr](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sarcomite+Myr) isn't in *New Phyrexia*. Why? Because of a little world called Esper. When I designed [Sarcomite Myr](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sarcomite+Myr) in *Future Sight* I knew it was a mechanic we were going to do. When Brady tied the card creatively to New Phyrexia, he did so because he knew it was a creative element we were going to do. Fate, though, kept these two things from actually colliding. Let me explain.
...
The trouble we were having was finding a way to capture the essence of Esper in a way we could execute at common. (See [last week's column](/en/articles/archive/common-knowledge-2011-04-18) for more on designing commons.) And then Gottlieb (I'm using last names because otherwise this story would be very hard to follow) said, "What if all the people are artifacts?" Obviously, this meant we'd have to make colored artifacts, as the entire point of the shards was that they represented three and exactly three colors.


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm140_esper.jpg)My response was, "I like it. I'm not sure I can get Bill to go for it, but I'll try." Gottlieb's solution was clean and cut through the Gordian knot that had been Esper. Not only did I like it for being a cool solution to our problem, but also because it was the only good one we'd been able to come up with. I went to Bill and, to my surprise, Bill loved it. He actually liked how it made such a strong statement in a very straight-forward way.


The person who didn't like it was Brady. And the reason was none other than [Sarcomite Myr](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sarcomite+Myr). "Artifacts with colored mana is a great idea... for New Phyrexia." Why were we squandering it here? The Phyrexians, he explained, were all about turning flesh to metal and metal to flesh. The very essence of how they transform things cried out to be something that combined color and artifacts. This was the perfect solution. We had to find something else for Esper.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm140_mana2.jpg)After catching my breath, I explained to Aaron how we could combined Phyrexian mana with a goal I had been working on the entire block. Instead of being colorless mana, we make the colored mana Phyrexian. This had a number of positive effects:
...
> 
> 
> Imagine there was a mana symbol that meant ![](https://web.archive.org/web/20211201201921im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless1.gif) or 2 life. It would be very hard to combine that symbol with other generic mana. This restriction would cause all sorts of constraints on what cards you could do and how you could cost them. Colored Phyrexian mana did force you to make all colored mana on that card into Phyrexian mana, but that restriction was far less restrictive.
> 
> 
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm140_dragon.jpg)Moltensteel Dragon | Illustration by [James Ryman](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+%5B%22James+Ryman%22%5D)


Aaron thought my idea sounded good, so our first pitch to the design team had Phyrexian mana live in the colored mana symbols. The idea went over well and as it's the key mechanic of *New Phyrexia*, obviously things worked out all right. If you haven't had a chance to see Phyrexian mana in action, here are some cards that show it off. My particular favorite is a Dragon that definitely feels Phyrexian in nature. If you're interested in seeing the whole set, you can go straight to the [Card Image Gallery](http://www.wizards.com/Magic/TCG/article.aspx?x=mtg/tcg/newphyrexia/spoiler).


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm140_2Cards1.jpg)  
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm140_3Cards1.jpg)### Phy Phy
...
[![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/features/Banner_NPHArticleFooter_140MM.jpg)](http://www.wizards.com/Magic/TCG/products.aspx?x=mtg/tcg/products/newphyrexia) [![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/features/Banner_NPHArticleFooter_Preview_140MM.jpg)](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/feature/140)
