...
---
[Link to Wayback Machine](https://web.archive.org/web/20160908091443/http://magic.wizards.com/en/articles/archive/feature/mtgo%E2%80%99s-own-aklein-goes-worlds-2005-12-01)
...
[_metadata_:node]:- "619976"
[_metadata_:publish_date]:- "2005-12-01"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "MTGO’s Own AKlein Goes To Worlds!"
[_metadata_:wayback_capture_timestamp]:- "2016-09-08 09:14:43"
...
[![](https://media.magic.wizards.com/image_legacy_migration/global/images/events_magic_worlds_picMain_en.jpg)](/en/events/coverage/worlds-2005-japans-crowning-achievement)Today, December 1st marks Day 2 of the penultimate **Magic** tournament—[the **Magic** World Championship](/en/events/coverage/worlds-2005-japans-crowning-achievement)! For 12 years pros from around the world have gathered to battle it out and see who will win the coveted prize of World Champion. 2005 marks the third year ***Magic** Online* has sent one of it's own to compete, along with providing airfare and accommodations. In 2003, Andrew Cuneo (US) won and went on to place a very respectable 42nd and pocket a cool $825. Last year, Toshinori Shigehara (Japan) finished in 210th place. This year, Adam Klein (US) emerged victorious to represent the Aether in the world of paper **Magic**. I thought we'd get to know Adam a little bit before we hop over to see his progress in the standings.
...
**Q: What did you play when you won the Worlds Qualifier? Why did you choose that deck?**  
...
**Q: Have you ever played on the Pro Tour?**   
...
**Q: Care to share with us what you're thinking about playing at Worlds?**   
 A: I'm really not sure about Standard, I have a few decklists I like and I have a few days to pick which deck I'll use. Extended I'll be playing either affinity, a form of [Psychatog](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Psychatog) or Boros Deck Wins, I still haven't quite decided yet :).
...
![](https://media.magic.wizards.com/image_legacy_migration/global/images/magic_expansion_mirage_expansionLogo_en.jpg)In case you haven't been paying attention to your splash screen when ***Magic** Online* launches, let me be the first to let you know: *Mirage* hits the Online Store and becomes legal to play this Monday, December 5th! [*Mirage* Release Events](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=magic/magiconline/article112305) start on Wednesday (instead of the typical Thursday after downtime), so mark your calendars! As usual, the events include Release Leagues (one week long), Draft Queues, Premier Event Flights (2x and 4x Prizes), and the Release Championship. Keep in mind that the Thursday downtime will be hitting as normal so make sure you're not in the middle of a League game or something when that occurs!
...
4
[Gift of Estates](http://gatherer.wizards.com/Pages/Search/Default.aspx?name=+%5BGift%5D+%5Bof%5D+%5BEstates%5D)
...
The resistance between phasing and a quick swarm approach makes it tough. This deck *will* drop a 2 power or evasive creature on turn 1... but then it phases out and can't attack on your second turn, along with the land you dropped so having plenty of one mana critters is essential. The good news is that your swarm is going to be divided between phase land and the board so it becomes less vulnerable to mass removal. You can also play out any legends you draw and just put the duplicates in separate phases. Hopefully you'll also be stealing an extra turn here or there for your trouble.

With all your lands also phasing, odds are that both [Gift of Estates](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gift+of+Estates) and [Weathered Wayfarer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Weathered+Wayfarer) will be able to thin plenty of lands from your deck and keep your mana production steady (though stunted by having to split the lands between phases).
...
For Classic Vanguard, there are plenty of phasing creatures in *Mirage* that already have that drawback and could fit right in to a Frenetic Efreet Vanguard deck (I'm thinking [Merfolk Raiders](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Merfolk+Raiders) and [Frenetic Efreet](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Frenetic+Efreet) himself). [Spatial Binding](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Spatial+Binding) and [Reality Ripple](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Reality+Ripple) also help you manage which side of the phasing divide certain permanents end up.
...
![](https://media.magic.wizards.com/image_legacy_migration/magic/images/MTGO_stalking_tiger.jpg)Which brings me to the [Dredge deck I kicked around for States](/en/articles/archive/three-rs%E2%80%94rachelr-ravnica-and-rainbow-stairwell-2005-11-03). In addition to having a fairly high creature count, being able to snag extra draws obviously helps turbo-charge the Dredge mechanic—play a creature, pay a mana and dredge back something from the graveyard. This build is a bit different than what I'd normally build, using Graverobbers to try and hurt the Hell's Caretaker combo decks. Otherwise, I'd be playing Viridian Shaman to fight [Umezawa's Jitte](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Umezawa%27s+Jitte).
...
For Extended Vanguard, I imagine an Elf [Intruder Alarm](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Intruder+Alarm) would just be completely nuts since you'd no longer have to rely on [Bloodline Shaman](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bloodline+Shaman) for your card draw (which always seemed to mill my [Intruder Alarm](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Intruder+Alarm)s into my graveyard).

![](https://media.magic.wizards.com/image_legacy_migration/global/images/magic_expansion_mirage_td1LargePic_en.jpg)Also, don't forget that ***Mirage* Preconstructed Decks** are going to be available for purchase on December 5th! Since the original paper release of *Mirage* predated preconstructed decks, these are all new creations put together in a variety of ways:

[*Burning Sky*](http://archive.wizards.com/magic/displaythemedeck.asp?set=mirage&decknum=1&lang=en)  is a red/blue deck that was created by the public by the “You Make the *Mirage* Deck” feature that ran on **magicthegathering.com** over several weeks. With efreets, djinns, counterspells and burn this deck is chock full of flavor and fun! 

[*Jungle Jam*](http://archive.wizards.com/magic/displaythemedeck.asp?set=mirage&decknum=2&lang=en) is a Green/White (splash red) deck created by Markus Pettersson, who won a ***Magic** Online* tournament and the privilege to work with Wizards' R&D to build his own deck. The deck features a horde of Griffins aided by other mythological beasts.

[*Night Terrors*](http://archive.wizards.com/magic/displaythemedeck.asp?set=mirage&decknum=3&lang=en) is a Monoblack deck featuring an old favorite – [Spirit of the Night](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Spirit+of+the+Night) – created by popular magicthegathering.com columnist Jay Moldenhauer-Salazar with ample help from his readers.

[*Ride Like the Wind*](http://archive.wizards.com/magic/displaythemedeck.asp?set=mirage&decknum=4&lang=en) is a Red/White deck created exclusively by R&D and focuses on the flanking ability and two Legendary commanders.
...
[Rachel Reynolds](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/jm68#rachel) talked to us the [last](/en/articles/archive/three-rs%E2%80%94rachelr-ravnica-and-rainbow-stairwell-2005-11-03) [three](/en/articles/archive/ita-swk-2005-11-10) [columns](/en/articles/archive/brains-thanksgiving-2005-11-24) about the challenges and fun behind programming *Ravnica: City of Guilds*. She's back for the final installment! ![](https://media.magic.wizards.com/image_legacy_migration/global/images/magic_expansion_rav_expansionLogo_en.jpg)**RachelR**: “After the first 2 weeks of *Ravnica* beta, everything was looking good. There were a lot of people on beta finding bugs, so a lot of things were found right away. QA was doing a great job of processing the bugs and getting them to me quickly, and I was fixing them about as fast as they were coming in. It was especially good that the beginning of beta went smoothly in light of the fact that we were moving across the street right before the *Ravnica* release, so I had to stop fixing bugs earlier than usual. Then the Monday before my Wednesday morning deadline to stop work on *Ravnica*, I came in to work to find one of my computers off. A power outage that left only one of my 2 computers off seemed a bit odd. I tried turning my computer back on, which had been working just fine when I left on Friday, and got a message that said something like "Alert! Previous shut down due to thermal event." 
