...
---
[Link to Wayback Machine](https://web.archive.org/web/20211016204344/https://magic.wizards.com/en/articles/archive/serious-fun/dont-get-mad-get-glad-2013-08-12)

[_metadata_:author]:- "Bruce Richard"
[_metadata_:description]:- "Joe had a Fiendslayer Paladin on the battlefield early in the game. It was the only creature, so there was no real downside to attacking with it, particularly since he wouldn't be leaving himself open to anyone else's creatures. Joe decided to attack Frank. `Are you sure you want to do that?` Frank asked.`I attacked Bruce last round, and now it is your turn,` Joe replied,"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "200066"
[_metadata_:path_date]:- "2013-08-12"
[_metadata_:publish_date]:- "2013-08-13"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Don't Get MAD, Get Glad"
[_metadata_:wayback_capture_timestamp]:- "2021-10-16 20:43:44"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20211016204344id_/https://magic.wizards.com/en/articles/archive/serious-fun/dont-get-mad-get-glad-2013-08-12"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/serious-fun/dont-get-mad-get-glad-2013-08-12"
---
...
By Bruce Richard
 ...
 Joe had a [Fiendslayer Paladin](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fiendslayer+Paladin) on the battlefield early in the game. It was the only creature, so there was no real downside to attacking with it, particularly since he wouldn't be leaving himself open to anyone else's creatures. Joe decided to attack Frank. 
...
MAD is a strategy I see many players use. They sit there and never attack anyone. They build up their defenses, piling lands on top of each other and try to make it almost impossible to attack them. They make it clear to their opponents that the first person to attack them will die, even if they themselves have to die to make that happen. This threat of Mutually Assured Destruction (MAD)[1](#1)leaves the other players to fight among themselves until there is only one opponent remaining. The MAD player, who has been stockpiling powerful cards and setting up his or her defenses all game, makes short work of the remaining player and scores the win. 

[![](https://media.wizards.com/images/magic/daily/sf/sf260_maddog.jpg)](http://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=31818)  
The MAD player should not be confused with the player who responds to an alpha strike from an opponent with one of his or her own—that is not using MAD. The player who responds to being attacked by an opportunistic player with a single small creature by attacking him or her for a similar amount of damage is not using MAD. The keys to MAD are:

1. The intent. Everyone must know your plan. As long as I don't attack you, I will be safe from any retaliation from you. If I do attack you...
2. The act. You need to respond with over-the-top destruction. You need to keep attacking until the opponent is dead.

The goal is to discourage others from attacking by making the option more unpalatable than any other option.
...
The real problem with MAD isn't the weaknesses inherent in the strategy. The real problem with MAD is what it can do to your playgroup. If MAD proves to be a successful strategy in your playgroup, how long will it take for others to copy it? When games involve five players, all of whom are waiting for someone to attack them, the game devolves into idiocy. It will not take long for your games to become unfun, and your group starts to splinter.

Stop the MADness!
[![](https://media.wizards.com/images/magic/daily/sf/sf260_descentintomadness.jpg)](http://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=240119)So how do you combat MAD? I have heard three options often recommended. 

The first option is best described as the **Sacrificial Lamb**. At the start of each game, one player is chosen to attack the MAD player early and often. Since most players' decks aren't tuned to take out a single opponent, it is generally suicide to attack the MAD player. The goal is to survive against the MAD player's assault for as long as possible. The Sacrificial Lamb is to force the MAD player to use up as many of his or her resources as possible, leaving the MAD player as easy pickings for everyone else to feast on. In the next game, a different player is chosen as the Sacrificial Lamb. As long as there is always someone who is going after the MAD player, that player won't win and will eventually abandon MAD theory.
...
We Can Work it Out
[![](https://media.wizards.com/images/magic/daily/sf/sf260_whisperingmadness.jpg)](http://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=366263)In spite of all this, there is another, far more effective option, that won't force your playgroup into destructive, unfun gaming for what could take a very long time, and likely result in losing a player from your group?
...
My group has had the problem pop up from time to time. Our first decision was to try the Gang Tackle method on the MAD player. We didn't have much fun during that time, but it did solve the problem in a way that was not intended: the MAD player left the group. This was not a high point for me. I like group harmony and I want everyone to have a good time. Our decision to act this way proved childish and our group shrunk as a result.
 ...
 The second time this happened, I had a "frank" discussion with Frank.[2](#2)It was a tough position for him to step away from; it was how he had always played the game. It was never a decision to follow MAD theory, it was just how he played **Magic**. While it took some time, he learned to find a balance between avoiding early conflict to allow for card advantage, and enacting a crushing vengeance whenever someone chose to attack him. 
...
1: Admittedly, destruction is not mutually assured. The MAD player can stop the attacking at any time, or could kill the offending opponent and still be strong enough to stop anyone else from wiping him or her from the game. However, it is more likely that both players will die, even if it requires a third or fourth player to make the final killing blow.[(return)](#a)  
2: Names were changed to either protect my friends or to set up for this gag. You can determine which. [(return)](#b)
