...
---
[Link to Wayback Machine](https://web.archive.org/web/20150710063715/http://magic.wizards.com/en/articles/archive/making-magic/born-legacy-2014-01-17)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "Welcome to the second week of Born of the Gods previews. Last week, I introduced the design team and the major mechanical components of the set. Today, I am going to be looking at the new things added and talk about why and how they got made. I also have another preview card for you before we're through. Sound good? Then let's get to it."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "205966"
[_metadata_:publish_date]:- "2014-01-17"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Born Legacy"
[_metadata_:wayback_capture_timestamp]:- "2015-07-10 06:37:15"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20150710063715id_/http://magic.wizards.com/en/articles/archive/making-magic/born-legacy-2014-01-17"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/making-magic/born-legacy-2014-01-17"
---
...
Welcome to the second week of *Born of the Gods* previews. [Last week](http://archive.wizards.com/Magic/magazine/Article.aspx?x=mtg/daily/mm/282), I introduced the design team and the major mechanical components of the set. Today, I am going to be looking at the new things added and talk about why and how they got made. I also have another preview card for you before we're through. Sound good? Then let's get to it. 

Tribute
![](https://media.wizards.com/images/magic/tcg/products/bng/KDJ)D(jk2m2389/BXfs2Ih8NH_EN.jpg)  
 Two weeks ago, I introduced you to a new phase of **Magic** design called [advanced design](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/mm/282). The idea of advanced design is that we start work on the design before the design team is assembled. Without the focus of a card file, the team has the freedom to prioritize the big picture and figure out what the whole block is up to. 

 The reason I bring up advanced design is because tribute was created by that team and not by the *Born of the Gods* design team. Let me walk you through how this happened. As I explained in my advanced design article, advanced design began as an experiment to test the holistic skill set of [Ethan Fleischer](http://archive.wizards.com/magic/magazine/archive.aspx?author=ethan%20fleischer) and [Shawn Main](http://archive.wizards.com/magic/magazine/archive.aspx?author=Shawn%20Main) (the top two winners of the second [Great Designer Search](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/feature/133)). To allow them the freedom to play in an area that wouldn't slow anyone down, I had them work on "Huey" block (that's the 2014 large October set). 
 ...
 Ethan and Shawn had quickly figured out that they needed more design resources so they had tapped other designers ([Ken Nagle](http://archive.wizards.com/magic/magazine/archive.aspx?author=Ken%20Nagle) and Dan Emmons) as well as a developer who was eager to do more design ([Billy Moreno](http://archive.wizards.com/magic/magazine/archive.aspx?author=Billy%20Moreno)). I explained what *Theros* was doing and talked about where I saw the block going. 
...
![](https://media.wizards.com/images/magic/daily/mm/2014/12nnbpo00d_mm_wk03_283_cardcart_bng_nbsm.jpg) Nyxborn Shieldmate | Art by [Eric Deschamps](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=%5B%22Eric%20Deschamps%22%5D)

 Billy Moreno had an idea for creatures that doubled as Auras and, with a little tweaking from the team, ended up with bestow (that version had the same cost to cast it either way; the idea that there was a separate cost to cast it as an Aura would happen in development). The plan was to use bestow as a new thing in *Born of the Gods*, but as I explained in my [*Theros* preview article](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/mm/264), *Theros* would later pull bestow back a set to solve a structural design problem. 
...
1. It had to be a monster mechanic, meaning it had to be appropriate on cards that would be the size and shape of monsters and it had to be a creature mechanic.
2. I wanted it to have a different feel from monstrosity. If we were going to change over the mechanic, I wanted it to feel different enough to be worthy of the change.
3. I wanted it to make use of +1/+1 counters. This last one is hard to explain until we get to *Journey into Nyx*, but it had to do with an idea I had for the block plan. (That idea didn't actually come to fruition but I believed it would at the time. More on this story during *Journey into Nyx* preview weeks.)
...
|  |  |
 ...
 This led us to discover that we had basically made abilities with an untap symbol while not using the untap symbol. For those unaware, [the untap symbol](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;set=+%5b%22Shadowmoor%22%5damp;text=+%5buntap%5d+%5bsymbol%5d) was a mechanic used in the *Shadowmoor* block where a creature had to untap as a cost. While the ability seemed simple enough on the surface, we found that it actually proved hard for a lot of players to process. 

![](https://media.wizards.com/images/magic/daily/mm/mm116_untap2.jpg)  
...
![](https://media.wizards.com/images/magic/tcg/products/bng/KDJ)D(jk2m2389/HTddbUnyqb_EN.jpg)  
...
*Born* Free
 That's all the time I have for today. I'm very curious to hear all of your impressions of the new set. send any feedback about the set, positive or negative, to my email, post it in the thread to this column or let me hear it through any of my social media ([Twitter](https://twitter.com/maro254), [Tumblr](http://markrosewater.tumblr.com/), [Google+](https://plus.google.com/107824009487778543249/posts)). 
...
Drive to Work #88—*Theros*, Part 7Drive to Work #89—*Theros*, Part 8
 Today's two podcasts are the last two on my extra long series on the design of *Theros*. Note that due to extensive traffic, the final podcast is my longest podcast to date and it is twice as long as a normal podcast. 
