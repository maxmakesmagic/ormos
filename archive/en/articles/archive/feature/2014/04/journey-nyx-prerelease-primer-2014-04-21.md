...
---
[Link to Wayback Machine](https://web.archive.org/web/20170628162345/http://magic.wizards.com/en/articles/archive/feature/journey-nyx-prerelease-primer-2014-04-21)
...
<//www.youtube.com/embed/gTGm-o3OXcA>
...
![](https://media.wizards.com/images/magic/daily/features/2014/wlnglaanse_art_1d.jpg)
Deicide | Art by [Jason Chan](http://gatherer.wizards.com/pages/search/default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22jason%20chan%22%5D)


A Prerelease is your first chance to play with cards from a new set (in this case, *Journey into Nyx*!). In this section, I'll walk you through the basics of attending one. (If you've been to Prereleases before, feel free to skip down to [The Hero's Path](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/feature/296#path).) At a Prerelease, players of all play levels mingle in a friendly, low-stress environment. So let's go through what to do and expect.
...
The main event at a Prerelease is the Seeded Deck tournament, a version of Sealed Deck. Like the *Theros* and *Born of the Gods* Prereleases before it, the *Journey into Nyx* Prerelease will feature seeded packs. [We'll come back to that](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/feature/296#path), but the important thing to know is that your Prerelease Pack's seeded pack will help you play the color you want to play—it's still not a guarantee, though.
...
![](https://media.wizards.com/images/magic/daily/features/2014/wlnglaanse_art_2g.jpg)
Godsend | Art by [Daniel Ljunggren](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22Daniel+Ljunggren%22%5D)
...
![](https://media.wizards.com/images/magic/daily/features/2014/wlnglaanse_prodshot_3.jpg)
...
![](https://media.wizards.com/images/magic/tcg/products/jou/aasd7y23m34co/63lTQPPWzE_EN.jpg)

If you've seen other Hero Cards, you'll note that this one is a little different. First, it's an Equipment (which Dave Guskin talks about that in his [Hero's Path FAQ](http://archive.wizards.com/Magic/magazine/Article.aspx?x=mtg/daily/feature/HerosPathFAQ)). Second, while it has a pretty neat ability, there's an unusual space between the type line and the first line of text for that neat ability. Here's why:
...
![](https://media.wizards.com/images/magic/daily/features/2014/wlnglaanse_strickers_4.jpg)
...
Solidarity of Heroes | Art by [Eric Deschamps](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22Eric+Deschamps%22%5D)
...
**Bestow:** A creature with *bestow* gives you the option to cast it as an Aura that enchants a creature, granting that creature its power, toughness, and abilities. For more details, see the [bestow section](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/feature/journeyintonyxmechanics#anchor3) of the "Mechanics of *Journey into Nyx*" article.
...
**Heroic:** A creature with a *heroic* ability gives you powerful benefits every time you cast a spell that targets it. For more details, see the [heroic section](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/feature/journeyintonyxmechanics#anchor4) of the "Mechanics of *Journey into Nyx*" article.
...
* "[Prerelease Primer](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/feature/123)" (the original!)
