...
---
[Link to Wayback Machine](https://web.archive.org/web/20210502164002/https://magic.wizards.com/en/articles/archive/latest-developments/looking-back-future-2007-08-24)

[_metadata_:author]:- "Aaron Forsythe"
[_metadata_:description]:- "Onslaught Week puts me into an interesting position. It's a set that, unlike some of the other older sets that we've based theme weeks on, was released while this web site was up and functioning, so there are tons of articles in the archives from the Fall 2002 era that go into great depth about cards, mechanics, and issues of Onslaught. I was not writing this column at the"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "612536"
[_metadata_:publish_date]:- "2007-08-24"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Looking Back to the Future"
[_metadata_:wayback_capture_timestamp]:- "2021-05-02 16:40:02"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20210502164002id_/https://magic.wizards.com/en/articles/archive/latest-developments/looking-back-future-2007-08-24"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/latest-developments/looking-back-future-2007-08-24"
---
...
*Onslaught* Week puts me into an interesting position. It's a set that, unlike some of the other older sets that we've based theme weeks on, was released while this web site was up and functioning, so there are tons of articles in the archives from the Fall 2002 era that go into great depth about cards, mechanics, and issues of *Onslaught*.
...
**"**[**Metamorpho...Whoa**](/en/articles/archive/serious-fun/metamorphowhoa-2002-09-10)**" by Anthony Alongi**
...
And that's how Anthony Alongi, casual mage extraordinaire, ended up previewing one of the most dominating Constructed creatures in recent memory. (Check the article out if you want to know how to combo it with cards like [Warpath](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Warpath) or [Souldrinker](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Souldrinker).) I will admit that I got some amount of perverse pleasure in snookering the Sideboard out of their good preview cards.
...
**"**[**Paradigm Shift**](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/bb37)**" by Ben Bleiweiss**


Wow, did we think [Hystrodon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hystrodon) was going to be an awesome card.


![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/fcpics/features/209_CardBackReal.jpg)**"**[**Gotcha**](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/rb37)**!" by Randy Buehler**


Morph is an awesome mechanic—the moments Randy talks about are exactly why I enjoy it. I hindsight, though, I regret the fact that development didn't push the mechanic enough for Constructed play. The aforementioned [Exalted Angel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Exalted+Angel) was the cream of a very small crop. The only other white morph worth playing was [Whipcorder](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Whipcorder), and because it was cheaper and the same size when played face-up, it was rarely correct to run the morph "bluff" in the mana-stingy world of competitive play just to try and trick your opponent into thinking it might be an [Exalted Angel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Exalted+Angel). [Blistering Firecat](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blistering+Firecat) put in an admirable performance, but red didn't offer up many other morphy friends that fit well into a hyper-aggressive deck. [Hystrodon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hystrodon) never lived up to the hype and [Voidmage Prodigy](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Voidmage+Prodigy), which we'll talk about later, fell flat on its face. On top of the problems morph had in and of itself in a Constructed environment, incredibly powerful anti-creature cards like [Lightning Rift](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Rift) murdered random 2/2s over and over again.


We took these lessons to heart with *Time Spiral*, and we hope it showed. We kept morph almost exclusively in one color—blue—to maximize the potential for multiple morph creatures to be good in the same deck. We aggressively costed a couple key morphs ([Vesuvan Shapeshifter](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vesuvan+Shapeshifter), [Fathom Seer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fathom+Seer)), gave others game-breaking flip effects ([Thelonite Hermit](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Thelonite+Hermit), [Brine Elemental](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Brine+Elemental)), and carefully chose a couple reprints to tie it all together ([Willbender](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Willbender), [Voidmage Prodigy](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Voidmage+Prodigy)). The result was a handful of decks in both Standard and Block Constructed that let the morph mechanic do what it was meant to—create scenarios where the creature's identity was in doubt and leave the controller in a position to bluff. You know, all the stuff that happened all the time in *Onslaught* Limited but hardly ever in Constructed.


**"**[**A Bear of a Combo**](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/rb38)**" by Randy Buehler**


This article is an interesting look at the development of the cycle of "[Words](http://ww2.wizards.com/gatherer/index.aspx?term=words%20of&Field_Name=on&setfilter=All%20sets)" enchantments. The long and short of it is that they initially didn't require a payment of ![](https://web.archive.org/web/20211201201921im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless1.gif) to replace draws; they were free to use, and playtesting in the FFL proved them to be broken in that incarnation.
...
**"**[**The Titania Dilemma**](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/rb39)**" by Randy Buehler**


I love the card [Priest of Titania](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Priest+of+Titania), but I have to agree with Randy that it is too powerful to reprint. We tossed about the idea of bringing it back in *Time Spiral*, but that obviously didn't happen, and I highly doubt we'll be seeing this powerful 1/1 again.


**"**[**Crowd Favorites**](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/rb40)**" by Randy Buehler**


I'm always amused by the tales from the R&D crew that worked on *Onslaught* about how unsure everyone was that the tribal theme was going to be popular. In retrospect it seems so obvious when you think of all the decks cards like [Kobold Overlord](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kobold+Overlord), [Lord of Atlantis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lord+of+Atlantis), and [Muscle Sliver](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Muscle+Sliver) spawned in previous years. Well, with *Lorwyn* we're hoping that the theme is as popular as ever, as we're revisiting it. I'm not going to go as far as Randy and say "tribal was a hit across all audiences," as I know the "linear" nature of these sets is off-putting to those that self-identify as craftsman deckbuilders, but to me it is just about as perfect as a set theme can be—simple, fun, and a perfect match to the fantasy flavor of the game.


[![Goblin_Sharpshooter](https://media.magic.wizards.com/image_legacy_migration/magic/images/cardart/ONS/Goblin_Sharpshooter.jpg)](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Goblin%2BSharpshooter)**"**[**Goblins with Guns**](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/rb41)**" by Randy Buehler**


[Goblin Sharpshooter](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Goblin+Sharpshooter) is an awesomely designed card, no doubt about it, and it is also really fun to play with, at least for a few games. When I see the card now, however, I just lump it in with the mass of overpowered Goblins that came out of *Onslaught* Block and terrorized Block Constructed, Standard, and Extended, and continue to strike fear in the hearts of men in Legacy. At some point during that year, Goblins ceased being funny and cool and instead became annoying and mean in the eyes of many players. When people concede at the sight of a one-mana 1/1 in the Casual Room in **Magic Online**, you know that a deck has struck a nerve.
...
[Voidmage Prodigy](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Voidmage+Prodigy) was brought back to Standard in *Time Spiral* to see how he'd fare in an environment free from his nemeses [Lightning Rift](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Rift) and [Slice and Dice](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Slice+and+Dice) (in much the same way that [Shadowmage Infiltrator](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shadowmage+Infiltrator) was brought back free from [Psychatog](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Psychatog)). The Prodigy has been seeing a tiny amount of competitive play, but that's probably more than he saw the first time around. Granted, there aren't as many reasons to build a Wizard deck these days, but it seems that the card just isn't as powerful in general as the Onslaught team had initially hoped.


![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/fcpics/latest/af185_Willbender.jpg)**"**[**Debating Humanity**](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/rb47)**" by Randy Buehler**


Ah, the subject of the "race-class" model, the "Human" type, and creature type revisions. A real hot-button topic. This article required an immediate follow-up from Randy ("[Human Nature](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/rb48)") in which he stated the following:
...
**"**[**Not As Good As We Thought**](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/af35)**" by Aaron Forsythe**
