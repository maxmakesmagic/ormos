...
---
[Link to Wayback Machine](https://web.archive.org/web/20151122002306/http://magic.wizards.com/en/MTGO/articles/archive/magic-online/magic-online-bug-blog-november-19-2015)
...
[_metadata_:node]:- "838356"
[_metadata_:publish_date]:- "2015-11-19"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Magic Online Bug Blog November 19, 2015"
[_metadata_:wayback_capture_timestamp]:- "2015-11-22 00:23:06"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20151122002306id_/http://magic.wizards.com/en/MTGO/articles/archive/magic-online/magic-online-bug-blog-november-19-2015"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/MTGO/articles/archive/magic-online/magic-online-bug-blog-november-19-2015"
---


Magic Online Bug Blog November 19, 2015
=======================================
...
Expect the next Bug Blog on Thursday, December 3!
...
In this week's bug blog, we have a few new known issues in addition to *Legendary Cube* and *Commander (2015 Edition)* known issues. You can also find a list of fixes that went out in the Wednesday, November 18 deployment.


The Known Issues List has been updated, so refer to that for the most up-to-date statuses on *Magic Online* known issues. If you want to see the history of fixed known issues, refer to the [archive](http://magic.wizards.com/en/content/magic-online-fixed-known-issues-archive).
...
* Cardset | [Caged Sun’s](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Caged+Sun%E2%80%99s) mana ability incorrectly doesn't trigger when a land is tapped for an ability that produces more than one mana.
* Cardset | Abilities that generate replacement effects preventing specific cards from being put into graveyards (such as those found on [Progenitus](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Progenitus) or [Blightsteel Colossus](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blightsteel+Colossus)) do not function properly while resolving [Grenzo, Dungeon Warden](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grenzo%2C+Dungeon+Warden)'s activated ability.
* Cardset | All legendary creature cards in all zones owned by a player who controls a [Heroes' Podium](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Heroes%27+Podium) incorrectly receive the power/toughness bonus from its first ability.
* Cardset | [Kumano, Master Yamabushi](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kumano%2C+Master+Yamabushi)'s ability does not cause creature cards to be exiled instead of being put into the graveyard.
* Cardset | [Myriad Landscape](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Myriad+Landscape)’s activated ability incorrectly allows a player to put two basic lands that do not share a land type onto the battlefield.
...
* Cardset | [Anafenza, the Foremost](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Anafenza%2C+the+Foremost) incorrectly exiles creature tokens.
* Cardset | [Illusory Ambusher](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Illusory+Ambusher) does not display blue text indicating the amount of damage it has been dealt.
* Cardset | [Seal of the Guildpact](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Seal+of+the+Guildpact)'s prompt box incorrectly does not specify how many colors the player can choose.
* Cardset | [Void Winnower](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Void+Winnower) incorrectly allows players to cast face-down spells.
* Cardset | [Void Winnower](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Void+Winnower) incorrectly prohibits players from casting spells that have both an even converted mana cost and a variable in the mana cost. For example, a player whose opponent controls a [Void Winnower](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Void+Winnower) is incorrectly prohibited from casting [Rolling Thunder](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rolling+Thunder) or [Nourishing Shoal](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Nourishing+Shoal), even if the value chosen for X would result in a spell with an odd converted mana cost. Even if a player cannot even, they should be able to odd.
* Cardset | Some cards with an alternative cost that involves a player exiling a number of cards from his or her hand do not allow that alternative cost to be paid as expected. Notably, this does not include [Force of Will](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Force+of+Will).
* Cardset | *Legendary Cube* versions of planeswalkers have minor visual irregularities.
* Cardset | The first mode displayed on the stack text of a [Confluence](http://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&name=+%5BConfluence%5D&set=+%5B%22Commander%202015%22%5D) spell (such as Mystic Confluence) is slightly misaligned.
* Cardset | When a single player or object is chosen multiple times as the target of a [Confluence](http://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&name=+%5BConfluence%5D&set=+%5B%22Commander%202015%22%5D), no visual indicator is present to identify the number of times each object or player is chosen. The game log will still identify the chosen target of each mode.
* Cardset | The game log does not display the third choice of a [Confluence](http://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&name=+%5BConfluence%5D&set=+%5B%22Commander%202015%22%5D).
* Duel Scene | If a player right-clicks on the commander of an opponent, they will be presented with a non-functional context menu with zone change options.
...
* Cardset | A bug was resolved that occasionally caused a crash if a player cast a face-down card, turned a face-down creature face up, or targeted a face-down creature with a spell or ability.
* Collection | Changes made to decks now properly sync if a player logs on *Magic Online* on a different computer, except when moving cards between main deck and sideboard.
* Collection | A bug is resolved that makes it so that, the first time a player tries to sort a deck, the deck will not become sorted.
* Duel Scene | Blocking requirements that can’t be met no longer cause games to be unable to proceed past declaration of blockers.
...
|  |  |
| --- | --- |
| [**Gameplay Known Issues**](#gameplayknownissues) | [**Client Known Issues**](#clientknownissues) |
| Gameplay Known Issues, with Scheduled Fix | Client Known Issues, with Scheduled Fix |
| [Fixed Gameplay Known Issues](#fixedgameplay) | [Fixed Client Known Issues](#fixedclient) |
...
| Cardset | *Legendary Cube* versions of planeswalkers have minor visual irregularities. |
| Cardset | [Oblivion Sower](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Oblivion+Sower)’s triggered ability incorrectly allows a player to select an face down exiled land card. |
...
| Cardset | Cards that are exiled by [Ulamog, the Ceaseless Hunger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ulamog%2C+the+Ceaseless+Hunger) incorrectly show association arrows while in the Exiled Zone. |
...
| Cardset | [Metalworker](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Metalworker)’s mana ability cannot be activated during the mana ability step in paying a cost for a spell or ability.  |
...
| Cardset | Several *Battle for Zendikar* promo cards appear with the incorrect set symbol. |
| Cardset | Spells that target [Thunderbreak Regent](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Thunderbreak+Regent) more than once incorrectly trigger [Thunderbreak Regent](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Thunderbreak+Regent)'s ability twice. |
...
| Cardset | [Void Winnower](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Void+Winnower) incorrectly allows players to cast face-down spells. |
| Cardset | [Void Winnower](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Void+Winnower) incorrectly prohibits players from casting spells that have both an even converted mana cost and a variable in the mana cost. For example, a player whose opponent controls a [Void Winnower](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Void+Winnower) is incorrectly prohibited from casting [Rolling Thunder](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rolling+Thunder) or [Nourishing Shoal](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Nourishing+Shoal), even if the value chosen for X would result in a spell with an odd converted mana cost. Even if a player cannot even, they should be able to odd. |
| Cardset | When [Chasm Guide](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Chasm+Guide)’s triggered ability is triggered by [Gideon, Ally of Zendikar](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gideon%2C+Ally+of+Zendikar), it will appear with incorrect art on the stack. |
| Cardset | When [Entreat the Angels](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Entreat+the+Angels) is on the stack with 0 chosen for X, the blue text that typically indicates the value of X does not appear. |
| Cardset | When a single player or object is chosen multiple times as the target of a [Confluence](http://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&name=+%5BConfluence%5D&set=+%5B%22Commander%202015%22%5D), no visual indicator is present to identify the number of times each object or player is chosen. The game log will still identify the chosen target of each mode.  |
...
| Duel Scene | The prompt box displays the incorrect color during the “scry-like” step in the new mulligan process. |
...
| Duel Scene | Under certain rare scenarios, attacking creatures will display on the opponent’s side of the battlefield. Resizing the *Magic Online* game window resolves this display issue. |
| Duel Scene | When a card with the devoid ability is given a color (perhaps by a [Painter’s Servant](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Painter%E2%80%99s+Servant)), it appears with distorted art. |
...
| Cardset | The second ability of [Ugin, the Spirit Dragon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ugin%2C+the+Spirit+Dragon) does not display the chosen value of X. —fixed 10/28 |
| Cardset | The triggered ability on the promo version of [Relic Seeker](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Relic+Seeker) does not function correctly. The non-promo version of this card, however, works as intended. —fixed 10/28 |
| Cardset | [Kiora, Master of the Depths](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kiora%2C+Master+of+the+Depths)’s second loyalty ability does not properly put all cards into the player’s Revealed Cards area.—fixed 10/28 |
| Cardset | Converge cards do not indicate how many colors of mana were spent to cast the spell.—fixed 10/28 |
| Cardset | Cards put into the graveyard with [Kiora, Master of the Depths](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kiora%2C+Master+of+the+Depths)’s second loyalty ability do not properly trigger the second ability of [Sidisi, Brood Tyrant](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sidisi%2C+Brood+Tyrant).—fixed 10/28 |
| Cardset | The landfall ability of [Emeria Shepherd](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Emeria+Shepherd) is incorrectly not optional.—fixed 10/28 |
| Cardset| Premium lands from *Unhinged* are missing the animation that other premium cards have.—fixed 10/28 |
| Cardset | Mana generated by [Shrine of the Forsaken Gods](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shrine+of+the+Forsaken+Gods)’s second ability can’t be spent on face-down creature spells.—fixed 10/28 |
...
  |
| Collection | In the Collection scene, the filter for the *From the Vault: Angels* set appears out of place (above *Battle for Zendikar* instead of with the other *From the Vault* sets). |
...
| Collection | While players are participating in a Constructed event or a League, cards from the decks in those events become locked and cannot be traded away. There is a red “locked card” indicator on these cards. This indicator incorrectly does not appear again after closing the client while remaining in the event. |
...
| General | Under rare circumstances, the Game Details window will display buttons to replay matches instead of a round timer or standings. This will also prevent a toast message from notifying the player that the next round has begun. As a temporary workaround, the Return to Game button found on that screen should address this issue. |
| General | Under rare circumstances, the Upcoming Tournaments schedule does not appear on the Home screen and Scheduled Events don’t load in the Play Lobby. If this occurs, players will be unable to play in any Scheduled Event for which they are already signed up. Closing *Magic Online* and signing back in will address this issue. |
| General | When objects are added to a player’s collection, the window displaying these objects incorrectly defaults to sorting them alphabetically and not by type of object. This keeps booster packs earned as prizes from being immediately seen.  |
...
| Limited Scene | While building a Limited deck, if a player sorts the deck under construction by converted mana cost, clicking the “Add Lands” button will return each card to the appropriate pile even if the player individually moved them to another pile. |
...
  |
| Trade | After clicking the Submit button in a trade, if a player adds or removes cards from the trade, the trade is still incorrectly submitted from his or her trade partner’s side. Toast messaging—messages that pop up on your screen to alert you—does display in this scenario warning players that the trade proposal has changed, and each player will have an opportunity to confirm the trade before it is performed. |
...
  |
| Trade | New trade windows do not always appear in front of other windows. These windows are still accessible via the *Magic Online* program icon in the taskbar. |
...
[Return to Top](#list)
 ...
 Collection | Changes made to decks now properly sync if a player logs on *Magic Online* on a different computer, except when moving cards between main deck and sideboard.—fixed 11/11


|  |
| --- |
| Fixed Client Known Issues |
| Cardset | A bug is resolved that occasionally causes a crash if a player cast a face-down card, turned a face-down creature face up, or targeted a face-down creature with a spell or ability.—fixed 11/11 |
|
| Collection | A bug is resolved that makes it so that, the first time a player tries to sort a deck, the deck will not become sorted. —fixed 11/11 |
| Duel Scene | Blocking requirements that can’t be met no longer cause games to be unable to proceed past declaration of blockers. —fixed 11/11 |
