...
---
[Link to Wayback Machine](https://web.archive.org/web/20150209054033/http://magic.wizards.com/en/articles/archive/latest-developments/shifting-shapes-2006-09-15)

[_metadata_:author]:- "Aaron Forsythe"
[_metadata_:description]:- "Today's preview card is a fun one. The road to its creation was long and arduous, and I'm thrilled that it made it to print and is waiting in warehouses for all of you to open. Feast your eyes…"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "290031"
[_metadata_:publish_date]:- "2006-09-15"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Shifting Shapes"
[_metadata_:wayback_capture_timestamp]:- "2015-02-09 05:40:33"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20150209054033id_/http://magic.wizards.com/en/articles/archive/latest-developments/shifting-shapes-2006-09-15"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/latest-developments/shifting-shapes-2006-09-15"
---
...
![](https://media.wizards.com/legacy/magic/images/mtgcom/fcpics/latest/af136_clone.jpg)Richard Garfield's “Alpha” edition of *Magic*—the first set of cards ever released for the game—contained three blue cards that could become copies of other permanents: [Clone](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Clone), [Vesuvan Doppelganger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vesuvan+Doppelganger), and [Copy Artifact](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Copy+Artifact). These cards were are very popular and very fun, but had some non-intuitive rules problems associated with them. As tournaments became a big part of *Magic* in the coming years, the rules were cleaned up and clarified to remove as much ambiguity as possible, and the R&D of those early years felt that copy cards couldn't be made to work under the existing rules. The three blue cards were yanked from the Core Set after the Revised (third) Edition, and it was years before any new “copy” cards were introduced.


In the meantime, a card called [Dance of Many](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dance+of+Many) was put into a set called *The Dark*. Dance tried copying in a new way—instead of having one card change into another, it simply put a token copy of a creature into play. The rules for copying using tokens were much simpler and easier to understand.
...
The R&D department of the time must have considered those cards to be failures, as another moratorium on copy effects that caused one card to change into another was put in place, and it lasted for many years. *Urza's Saga*'s powerhouse [Morphling](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Morphling) was born of this ban on cloning—it was an attempt to make a [Clone](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Clone)-like card that didn't involve actual copying.


Copying using tokens sprung up from time to time in the next few years, including [Dual Nature](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dual+Nature) in *Prophecy* and [Parallel Evolution](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Parallel+Evolution) in *Torment*. But it wasn't until Rules Manager Paul Barclay “fixed” the game's copy rules prior to the release of *Onslaught* that another true copy card could exist—and it was fitting that the card was the original Alpha [Clone](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Clone), back again as a reprint.


Revised Edition [Clone](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Clone) wording (1994):
...
*Onslaught* [Clone](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Clone) wording (2002):
...
![Sakashima the Impostor](http://gatherer.wizards.com/Handlers/Image.ashx?size=small&type=card&name=Sakashima%20the%20Impostor&options=)

With the copy rules in a “good place,” R&D started introducing new copy cards in to the game, including *Mirrodin's* [Sculpting Steel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sculpting+Steel), *Kamigawa's* [Sakashima the Impostor](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sakashima+the+Impostor), and *Ravnica's* [Copy Enchantment](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Copy+Enchantment). But none of these newer cards had the ability to change from one thing to another while in play like the original Doppelganger did. That area of the rules was still fraught with problems.



It was fitting, then, that the card that forced that area of the rules to be cleaned up was designed by the man destined to become the current rules manager. The card was Ravnica's [Dimir Doppelganger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dimir+Doppelganger), designed by Mark Gottlieb. It took many hours and many revisions, but in 2005, twelve years after the game's debut, *Magic* finally had a Doppelganger supported by rules that actually worked.


Once Gottlieb opened that particular Pandora's Box, R&D started making more cards that caused one thing to change into another in play, including [Mizzium Transreliquat](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mizzium+Transreliquat) and [Cytoshape](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cytoshape). Each new such card required more and more tweaking to the rules, but each worked, and the game is a more fun experience because of them.
...
| Neither | 5162 | 36.8% |
| Both | 5003 | 35.6% |
| Graphic novels | 2294 | 16.3% |
| Comic books | 1575 | 11.2% |
| **Total** | **14034** | **100.0%** |
