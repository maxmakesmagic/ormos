...
---
[Link to Wayback Machine](https://web.archive.org/web/20211018171312/https://magic.wizards.com/en/articles/archive/feature/earn-some-bragging-rights-2003-10-21)
...
[_metadata_:node]:- "630796"
[_metadata_:publish_date]:- "2003-10-21"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Earn Some Bragging Rights"
[_metadata_:wayback_capture_timestamp]:- "2021-10-18 17:13:12"
...
> 
> 
> 2) What sets are legal now? I know that *Seventh Edition* was no longer allowed, but the why is *Odyssey* just phasing out?…I was devastated when I found out that with the introduction of *Core Set: Eighth Edition*, I could no longer use [Meekstone](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Meekstone) and I thought that if *Seventh Edition* was gone, the *Odyssey* block was gone too. When do these sets no longer become type II eligible?
> 
> 
...
> 
 ...
 Thanks for your questions Liz. You weren't the only one wondering how Champs worked, so I've asked to respond in the form of this feature article. Now... on to the answers! ### 1. How To Qualify
...
|  |
| --- |
| **October 25 \*****Information**[Champs Fact Sheet](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=events/magic/champs)**Locations**[North America](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=events/champs/na)[UK/Ireland](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=events/champs/uk) |
...
If you are settled on the exact nature of your decklist in advance of the tournament I recommend registering it before the event. Wizards of the Coast offers a blank **Decklist Registration Sheet** you can **[download here in pdf format](http://www.wizards.com/DCI/downloads/DecklistConstructed.pdf)**. Having your deck on the registeration sheet before you get there significantly reduces the risk of registration errors and it is one less thing for you to have to worry about. Make sure your name is written clearly on the top of the sheet.
...
The rotations of the base sets and the expansion blocks are not connected although I can see why you might think that with the release of *Mirrodin* so close on the heels of *Core Set*. *Core Set* has barely had a chance to make a dent in any Constructed format thus far so it going to be a coming out party for both sets - [Bonesplitter](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bonesplitter)ed [Savannah Lions](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Savannah+Lions) are just one example of the possible pairings.

### 3) What To Expect

Absolutely Anything.

This is a completely new environment and there are no established decks yet. Sure there are some block decks and Standard decks from the previous season but this is opening day of a new season and all the statistics from season's past have been reset. Green-Red control? Why not? There are a number of exciting cards to work with some of which have combined to form similar decks in the past. [Plow Under](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Plow+Under), [Creeping Mold](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Creeping+Mold), [Stone Rain](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stone+Rain), [Viridian Shaman](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Viridian+Shaman), [Birds of Paradise](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Birds+of+Paradise), maybe a [Ravenous Baloth](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ravenous+Baloth) or four. It's beginning to look like Angry Hermit - a classic green-red control deck. You even have [Solemn Simulacrum](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Solemn+Simulacrum) to fill the [Yavimaya Elder](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Yavimaya+Elder) slot.

How about Burning Bridge with [Mindstorm Crown](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mindstorm+Crown) replacing the departed [Grafted Skullcap](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grafted+Skullcap)? Burning Bridge is a mono-red burn deck that held off creatures with [Ensnaring Bridge](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ensnaring+Bridge) and board sweeping effects like [Earthquake](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Earthquake) or [Pyroclasm](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pyroclasm). The former is no longer available but the instant speed [Starstorm](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Starstorm) is still available as is the latter. 
