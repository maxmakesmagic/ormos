...
---
[Link to Wayback Machine](https://web.archive.org/web/20170523155810/http://magic.wizards.com/en/articles/archive/making-magic/few-more-words-rd-2013-06-10)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "A little more than eight years ago, I wrote an article entitled `A Few Words from R&D,` in which I listed a bunch of R&D lingo that I then went on to define. Well, in the last eight years, we've managed to come up with a lot more lingo, so I thought I would write a follow-up with an entire article of even more R&D vocabulary explained."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "656796"
[_metadata_:publish_date]:- "2013-06-10"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "A Few More Words from R&D"
[_metadata_:wayback_capture_timestamp]:- "2017-05-23 15:58:10"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20170523155810id_/http://magic.wizards.com/en/articles/archive/making-magic/few-more-words-rd-2013-06-10"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/making-magic/few-more-words-rd-2013-06-10"
---
...
A little more than eight years ago, I wrote an article entitled "[A Few Words from R&D](/en/articles/archive/making-magic/few-words-rd-2005-01-24)," in which I listed a bunch of R&D lingo that I then went on to define. Well, in the last eight years, we've managed to come up with a lot more lingo, so I thought I would write a follow-up with an entire article of even more R&D vocabulary explained.


Note that I've chosen not to repeat any lingo that appeared in the first article, so I would check it out if you haven't read it yet. I will warn you that a bunch of the lingo is outdated, so here are the ones that we still use today (some more often than others): "Bah-roken," C, Clever Cards, D, The Danger Room, Discriminator card, The Free Table, FFL, Hat Trick, Incrementals, Johnny, Johnny Card, Looter ability, Multiverse, [Ophidian](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ophidian) ability, The Pit, Promotable, Rangestrike, [Rootwalla](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rootwalla) ability, Sexy, Spike, Spike card, Sticker Stock, Tim ability, Timmy, Timmy card, Tweak, Vanilla creature, WUBRG, and Wyluli ability.


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm251_murmuring_phantasm.jpg)With that out of the way, let's get to the definitions:
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm251_biodome.jpg)### Biodome
...
Once a week, all the core designers and developers (see below) get together with [Aaron Forsythe](http://www.wizards.com/Magic/Magazine/Archive.aspx?author=Aaron%20Forsythe) to talk through tactical issues dealing with **Magic**. This meeting tends to get very hands-on, as we discuss things like whether we want to shift an ability in the color pie or how to solve a large meta-issue either design or development is facing.


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm251_chessy.jpg)### Chessy


"I don't think the creature should have three activated abilities. It makes it too **chessy**."


This is an R&D term that means there's no hidden information. It's named after chess, which is a game without any hidden information. Usually, the term is a complaint meaning that it's going to be unfun, because it will require the tracking of too much open information.
...
A core designer is one of the people hired full time to do **Magic** design. The current core designers are myself, [Mark Gottlieb](http://www.wizards.com/Magic/Magazine/Archive.aspx?author=Mark%20Gottlieb), [Ken Nagle](http://www.wizards.com/Magic/Magazine/Archive.aspx?author=Ken%20nagle), [Ethan Fleischer](http://www.wizards.com/magic/magazine/archive.aspx?author=ethan%20fleischer), [Shawn Main](http://www.wizards.com/magic/magazine/archive.aspx?author=Shawn%20Main), and Dan Emmons.
...
A core developer is one of the people hired full time to do **Magic** development. The current core developers are [Erik Lauer](http://www.wizards.com/magic/magazine/archive.aspx?author=Erik%20Lauer), [Dave Humpherys](http://www.wizards.com/magic/magazine/archive.aspx?author=Dave%20Humpherys), [Tom LaPille](http://www.wizards.com/magic/magazine/archive.aspx?author=Tom%20LaPille), [Billy Moreno](http://www.wizards.com/magic/magazine/archive.aspx?author=Billy%20Moreno), and [Sam Stoddard](http://www.wizards.com/magic/magazine/archive.aspx?author=Sam%20Stoddard). (The current development interns are Ian Duke and Ben Hayes.)
...
This stands for "continued quality improvement." To CQI a card is to basically say, "We think we can do better." Usually, a CQIed card stays in the file as it was with the CQI in the notes telling everyone that it's most likely changing. R&D lingo ebbs and flows and this expression is slowly working its way out of the R&D lexicon.
...
Short for "The Great Designer Search," the reality-show-like event we use to find new designers. Four of the six current core designers come from The Great Designer Search. (Ken Nagle came in 2nd in [the first GDS](/en/articles/archive/great-designer-search-2006-10-31), Ethan Fleischer won [the second GDS](http://www.wizards.com/magic/magazine/article.aspx?x=mtg/daily/feature/133), Shawn Main came in 2nd in the second GDS, and Dan Emmons was involved in the community, helping out the finalists of the second GDS.)
...
This word comes from the book [Stranger in a Strange Land](http://en.wikipedia.org/wiki/Stranger_in_a_Strange_Land) by [Robert Heinlein](http://en.wikipedia.org/wiki/Robert_A._Heinlein). In the book, it means "to intimately and completely share the same reality or line of thinking with another physical or conceptual entity." R&D uses the word to mean "[to intuitively understand](http://www.merriam-webster.com/dictionary/grok)." Usually, it's used in the context of whether or not players will "get" what a card does.



![Welkin Tern](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Welkin+Tern)
...
This is R&D's nickname for a flying creature that can only block other fliers.
...
This one's confusing because the public also uses the word "metagame." It just doesn't mean the same thing as the R&D version of the word. (Although I should point out R&D also uses the word as the public uses it.) The R&D "metagame" refers to all the elements involved in a game outside of the playing of the game. For **Magic**, the metagame includes deck building, trading, discussions in-person and through social media, reading stories, etc. R&D uses the term because it's important to understand that much of the "game" goes beyond the "game."
...
This was a new philosophy adopted by R&D during the *Shards of Alara* block. The core idea of New World Order is that we simplify common cards to make the game easier to learn, as a newer player's card collection skews much more toward common. For more on this concept, read [my article on New World Order](/en/node/654416).
...
![Skulking Ghost](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Skulking+Ghost)
...
This is R&D's nickname for the ability "When this card becomes the target of a spell or ability, sacrifice it." It's named after the card [Skulking Ghost](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Skulking+Ghost) from *Mirage*. The ability has since shifted from black to blue. R&D still tends to call it "skulking" although it's sometimes now called "the illusion ability," as it's used exclusively now to mechanically represent illusions. It's funny to note that the word "skulking" was not what represented that ability in [Skulking Ghost](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Skulking+Ghost)'s name. The mechanic was meant to top-down "ghost."
...
This is R&D's nickname for the ability "can't be blocked by more than one creature." It's named after the card [Stalking Tiger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stalking+Tiger) from *Mirage* that had this ability.
...
![Vindictive Mob](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Vindictive+Mob)
...
![1955](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&multiverseid=1955)
...
This is R&D's nickname for the ability "can't be blocked except by two or more creatures." This card is named after the card [Goblin War Drums](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Goblin+War+Drums) from *Fallen Empires*.


### Word!


That's all the words I have for you today. I hope you enjoyed the look behind the scenes of R&D's everyday lingo. As always, I'm curious to hear your feedback on what I talked about today. You can email me, respond in the thread, or send me a message through my social media ([Twitter](https://twitter.com/maro254), [Tumblr](http://markrosewater.tumblr.com/), and [Google+](https://plus.google.com/107824009487778543249/posts)).
