...
[_metadata_:node]:- "704556"
[_metadata_:publish_date]:- "2008-08-11"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Sanctioned Formats"
[_metadata_:wayback_capture_timestamp]:- "2016-02-28 03:40:20"
...
Sanctioned formats are split into two categories: Constructed and Limited. Constructed formats include Standard, Block Constructed, Modern, Vintage, and Legacy. Limited formats include Sealed Deck and Booster Draft.
...
[**Constructed**](#constructed) | [**Limited**](#limited) | [**Two-Headed Giant**](#2hg)
...
The Block Constructed format uses only the cards from a single block of **Magic** sets. Block Constructed formats generally take their name from the first set in the block. For example, the *Innistrad, Dark Ascension,* and *Avacyn Restored* sets make up the *Innistrad* block. The smaller card pool of Block Constructed poses an interesting challenge for players. It also provides an opportunity to enjoy the setting of one of the Multiverse's planes in a focused environment.

For more information on Block Constructed, [click here](http://archive.wizards.com/Magic/TCG/Resources.aspx?x=judge/resources/sfrblock).


**What is Extended?**


The Extended format includes all of the sets legal in the Standard format plus several years worth of earlier cards. The Extended format includes expansions and core sets from the past four years' worth of blocks, giving the format a feel and flavor all its own.

For more information on Extended, [click here](http://www.wizards.com/Magic/Magazine/Article.aspx?x=judge/resources/sfrextended).
...
For more information on Modern, [click here](http://archive.wizards.com/Magic/TCG/Resources.aspx?x=judge/resources/sfrmodern).
...
For more information on Vintage, [click here](http://archive.wizards.com/Magic/TCG/Resources.aspx?x=judge/resources/sfrvintage).
...
For more information on Legacy, [click here](http://archive.wizards.com/Magic/TCG/Resources.aspx?x=judge/resources/sfrlegacy).
...
### Two-Headed Giant Multiplayer Variant
