...
The [first design challenge](https://magic.wizards.com/en/articles/archive/feature/great-designer-search-3-challenge-1-2018-05-17) was a tribal challenge. Here's how the designers did as ranked by the judges:
...
The [second design challenge](https://magic.wizards.com/en/articles/archive/feature/great-designer-search-3-challenge-2-2018-05-22) was a top-down challenge asking the designers to create eight cards based on circus tropes. Here's how the designers did on the challenge as ranked by the judges:
...
The [third design challenge](https://magic.wizards.com/en/articles/archive/feature/great-designer-search-3-challenge-3-2018-05-24) was the mechanics challenge where the designers were asked to make a new mechanic. Here's how they did based on the ranking by the judges:
...
The [fourth design challenge](https://magic.wizards.com/en/articles/archive/feature/great-designer-search-3-challenge-4-2018-05-29) forced the designers to design to heavy restrictions, including incorporating art. Here's how they did based on the ranking by the judges:
...
The [fifth design challenge](https://magic.wizards.com/en/articles/archive/feature/great-designer-search-3-challenge-5-2018-05-31) required the designers to pick a *Magic* expansion and design a brand-new booster pack's worth of cards for it. Here's how they did based on the ranking by the judges:
...
![alt text](https://media.wizards.com/2018/images/daily/CbTg6L6xgo.jpg)*From left: Mark Rosewater, Ari Nieh, Jeremy Geist, and Chris Mooney*
...
Everything seems good when at the last minute one of the developers approaches. They've found a broken deck built around the card [Séance](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=S%C3%A9ance). The card needs to mechanically change. When Brand hears about this, they bring up that they've always felt uncomfortable about calling a card "Séance," so, since it's changing anyway, they'd like the card to change names.


We don't have a lot of time, so here's what we need. We want a new rare white card using the same art, but with a new name. Due to collector numbering, the new card needs to be alphabetically between [Sanctuary Cat](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sanctuary+Cat) and [Silverclaw Griffin](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Silverclaw+Griffin). The card can be any card type as long as it matches the flavor of the name and mechanics. It still needs to be rare. Plus, as we have no time to playtest it, it shouldn't be pushing into risky developmental space.
...
![](https://media.wizards.com/2018/images/daily/cardart_DKA_Seance.jpg)[Séance](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=S%C3%A9ance) | Art by: [David Rapoza](http://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&output=spoiler&method=visual&artist=+%5BDavid%5D+%5BRapoza%5D)
...
This card was deemed a little too close to [Archangel's Light](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Archangel%27s+Light). Also, Melissa felt this wasn't the kind of card we wanted to add without any testing. This card was eliminated.
...
This was another card Melissa was worried about making without any testing. Also, uncommon had [Curse of Exhaustion](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Curse+of+Exhaustion), which prevented cards from getting cast, and we tend not to do two of them in the same set without a thematic reason. This card was eliminated.
...
Rare already had [Requiem Angel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Requiem+Angel), which was a big flying creature. The team felt that this design would step a little too much on that card. Also, the spirit in the art didn't really convey 6/6. This card was eliminated.
...
![alt text](https://media.wizards.com/2018/images/daily/ZtIVjWBD3o.jpg)*Ari Nieh poses with a foil rare sheet of* Dominaria *cards signed by the GDS3 crew.*
