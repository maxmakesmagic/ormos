...
---
[Link to Wayback Machine](https://web.archive.org/web/20160707074938/http://magic.wizards.com/en/articles/archive/feature/phyrexian-kens-demands-2011-05-16)
...
[_metadata_:node]:- "680676"
[_metadata_:publish_date]:- "2011-05-16"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Phyrexian Ken's Demands"
[_metadata_:wayback_capture_timestamp]:- "2016-07-07 07:49:38"
...
In the time since I last led a development team soup to nuts—*Shadowmoor*—not only have I learned a metric ton more about the craft, but I've also led a couple design teams (***Magic** 2010* and ***Magic** 2011*), so I've become more sympathetic to the "plight" of the lead designer.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature143_nphPreviewImage.jpg)  
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature143_reaperOfSheoldred.jpg)  
...
My boss (VP of R&D Bill Rose) specifically asked me to lead develop this set because he knew it was going to be incredibly challenging. Phyrexia was going to be fully formed in this set for the first time in all five colors, and making that happen was going to involve a bit of rule-breaking that would have been unfair to ask most developers to manage. In Tom LaPille's [article the week before last](/en/articles/archive/latest-developments/vision-compleation-2011-05-06), he described *New Phyrexia* as "violating and transgressive," which is an apt description of what the teams were trying to accomplish... as well as something you don't want your typical **Magic** set to feel like.

![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature143_maulSplicer.jpg)  
...
Now this was a goal I could get behind! My style of casual **Magic** always had me putting the screws to people (and I still do it in Commander). I know that things can get out of hand easily, though, and we certainly didn't want to encourage "you can't do anything" **Magic** with cards like [Stasis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stasis) or [The Abyss](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=The+Abyss). Instead, we were aiming for cards that make opponents "slightly miserable."

The low-end stuff in the set chips away at opponents a life point at a time, whereas the big haymakers like the Praetors really makes them feel like they've been beaten. Cards like [Invader Parasite](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Invader+Parasite), [Isolation Cell](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Isolation+Cell), and [Chancellor of the Annex](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Chancellor+of+the+Annex) all make it a little bit harder for your opponents to cast their spells—annoying without being backbreaking. On top of that, there are a number of cards like [Gitaxian Probe](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gitaxian+Probe), [Despise](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Despise), [Life's Finale](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Life%27s+Finale), and [Surgical Extraction](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Surgical+Extraction) that let you look through opponents' hands and libraries—very "violating" things to do—and often remove cards from them.
...
The "free land drop" ability was a bit more swingy than we were willing to tolerate, but I hope we captured the essence of it with the final "add ![](https://web.archive.org/web/20220123123600im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/green.gif)" [Chancellor of the Tangle](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Chancellor+of+the+Tangle) , even though it is no longer in the running for best card in the set.

![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature143_gChancellor.jpg)  
...
Not only did that card not do anything in multiples or in the games that you were already going first, but it had a next to zero percent chance of working within the rules. It was a classic case of a card that was fun to read but not worth playing. We eventually came to [Mana Tithe](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mana+Tithe) as the white reveal ability (remember, taxing is white), although our initial on-the-battlefield ability—"When CARDNAME enters the battlefield, opponents can't cast spells until the beginning of your next turn"—was way too good with [Venser, the Sojourner](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Venser%2C+the+Sojourner) to be printable. That's why we playtest!

[![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature143_5Chancellors.jpg)](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&name=+%5Bchancellor%5D+!%5Brayne%5D)  
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature143_grasp.jpg)  
For example:
...
That card in practice isn't even necessarily better than [Terminate](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Terminate), as you often couldn't cast their creature if you drew it. BUT IT FELT SO MEAN! Ultimately, problems with card sleeves, potential theft, and general game-play mix-ups doomed this mechanic.

The remaining legacy of pwnage is [Praetor's Grasp](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Praetor%27s+Grasp), which is an attempt to turn an opponent's card into one of your own. It isn't quite as visceral, but it gets the feel across to a reasonable degree.

![Praetor's Grasp](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Praetor%27s+Grasp)  
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature143_elsh.jpg)  
...
With the Exarchs also in the file, the development team felt there was too much mirrored stuff going on, so we looked for ways to minimize the number of Elites in the set. Luckily, the Praetors were the perfect place to use that material, as it made sense for them to be the über-powerful "you get both effects" versions of Exarchs. The green Anthemist's ability went to white, doubled up, and became [Elesh Norn, Grand Cenobite](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Elesh+Norn%2C+Grand+Cenobite). We worked with the designers to come up with the rest of the abilities.

[![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature143_5Praetors.jpg)](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&set=%7C%5B%22New+Phyrexia%22%5D&subtype=+%5B%22Praetor%22%5D)  
...
Okay, that's not actually a demand, but there is a lot of truth in that statement. We knew [Karn Liberated](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Karn+Liberated) was going to be a Big Deal for this set (has there ever been a more anticipated Planeswalker card ever?), so we spent a ton of time on him. Design handed off the following design...
...
...which we promptly scrapped. With [Tezzeret, Agent of Bolas](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tezzeret%2C+Agent+of+Bolas) in the previous set, the last thing we wanted was another artifacts-matter planeswalker design. The development team sat around brainstorming what else Karn was known for besides animating artifacts. We came up with:
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature143_karn.jpg)  
Riffing off the world-creation and time-travel ideas, I put forth the phrase "Restart the game," and the team took it from there. The final card is evocative of just about everything about Karn, and he has awesomely-large numbers—just like [Nicol Bolas, Planeswalker](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Nicol+Bolas%2C+Planeswalker) does—as a nod to his pre-mending Planeswalker status.

You can read Doug Beyer's article about [Karn Liberated](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Karn+Liberated)[here](/en/articles/archive/golems-legacy-2011-04-25) for more on this iconic character and card.

![Karn Liberated](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Karn+Liberated)  
It was a bit of a drawback that we couldn't use Karn effectively on the *New Phyrexia* packaging, as we often like to showcase the planeswalkers there. To make up for it, we use him extensively on the fake *Mirrodin Pure* packaging which you can see [here](/en/articles/archive/action-packaging-2011-03-15).

**9. Protect the "SimCity" cards like Flame Scroll that kids could build a deck around.**

"Flame Scroll" was the playtest name for [Shrine of Burning Rage](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shrine+of+Burning+Rage) and, as you can see, I protected them (not that they faced much opposition). Ken's right that a set as evil and destructive-feeling as *New Phyrexia*, you want to provide players something constructive to strive for, and nothing beats a 20-point blast from a single Shrine.

![Shrine of Burning Rage](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Shrine+of+Burning+Rage)  
The other "SimCity" cards we added to the set were the Golem-creating "Splicers." These six cards have a bit of a "Sliver" feel in that each additional one adds abilities to all the others, but they have two additional upsides: (1) they are backwards compatible with all the other Golems and Golem-making cards in the block and throughout **Magic**, and (2) each one combos well with ways to reuse them, from [Glimmerpoint Stag](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Glimmerpoint+Stag) to [Morbid Plunder](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Morbid+Plunder) to [Disperse](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Disperse).
...
|  |  |
| --- | --- |
| Chained Throatseeker | Razor Swine |
...
**11. The color bleeds will face opposition. I feel design found the correct space in white life gain becomes [Drain Life](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Drain+Life), blue card drawing becomes [Unhinge](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Unhinge), and green pump becomes [Steal Strength](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Steal+Strength). The off-putting, vilifying of such happy mechanics gives the set an "evil" black vibe.**

We kept all of what Ken was describing and, yes, a lot of it breaks the color pie in small ways. That's intentional. We needed the set to feel evil and corrupted, and we didn't want to be subtle about it. We talked for a while about making the set feel evil by just amping up the "normal" bad things that colors do, but that was hard to do in colors like green. Would anyone notice if we had two [Naturalize](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Naturalize)s and a Creeping Mold? Would that make the set feel particularly evil? We didn't think so, so we went the more transgressive route: making cards that make you sit up and take notice. Even a simple vanilla like [Loxodon Convert](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Loxodon+Convert) can feel off in a corrupt way; we typically avoid giving white 4-power common creatures, but here it contributed to the feel without breaking the game in any way.

![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature143_enslave.jpg)  
We corrupted black by letting it "steal" a bit from blue with the card [Enslave](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Enslave), a reprint from *Planar Chaos*. Like most of *Planar Chaos* design, we won't be taking much of what happened in *New Phyrexia* as precedent for what colors are capable of (although I expect several designers—perhaps myself included—to try).

![Enslave](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Enslave)  
...
There were eight cards in the design handoff that said "artifact or creature" and the final set ended up with five ([Apostle's Blessing](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Apostle%27s+Blessing), [Numbing Dose](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Numbing+Dose), [Phyrexian Metamorph](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phyrexian+Metamorph), [Artillerize](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Artillerize), and [Geosurge](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Geosurge)).



|  |  |
| --- | --- |
| Phyrexian Metamorph | Artillerize |
...
*Scars of Mirrodin* and *Mirrodin Besieged* both contained lots of throwbacks to the first Mirrodin block, in the forms of both reprint ([Iron Myr](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Iron+Myr)) and homages ([Inkmoth Nexus](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Inkmoth+Nexus)). With Phyrexia fully realized in this set, Ken wanted some throwbacks to the Phyrexians of old from *Antiquities* and the Urza's and *Invasion* blocks.

He got his [Phyrexian Negator](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phyrexian+Negator) ([Phyrexian Obliterator](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phyrexian+Obliterator)), but we didn't try very hard to replicate [Phyrexian Processor](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phyrexian+Processor), and the creative nixed our attempts to reference Yawgmoth (who died on Dominaria).

![Phyrexian Obliterator](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Phyrexian+Obliterator)  
We did get a few other old-school Phyrexian throwbacks in with the reprint of [Phyrexian Hulk](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phyrexian+Hulk) as well as callbacks to [Hollow Dogs](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hollow+Dogs) ([Mortis Dogs](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mortis+Dogs)), [Phyrexian Walker](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phyrexian+Walker) ([Kiln Walker](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kiln+Walker)), and the various Urza's block Skirges such as [Ravenous Skirge](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ravenous+Skirge) ([Vault Skirge](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vault+Skirge)).



|  |  |
| --- | --- |
| Phyrexian Hulk | Mortis Dogs |
...
Ken's handoff only had three proliferate cards, and they were pretty lame—a blue [Twiddle](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Twiddle), a ![](https://web.archive.org/web/20211201201921im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless1.gif)![](https://web.archive.org/web/20161227130159im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/red.gif) 2-damage red spell, and a slow reusable artifact. I think we upgraded them with [Tezzeret's Gambit](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tezzeret%27s+Gambit), [Grim Affliction](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grim+Affliction), and the one-card combo [Viral Drake](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Viral+Drake), as well as turning the burn spell into [Volt Charge](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Volt+Charge).



|  |  |
| --- | --- |
| Tezzeret's Gambit | Grim Affliction |
...
![Viral Drake](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Viral+Drake)  
...
|  |  |
| --- | --- |
| Exclusion Ritual | Invader Parasite |
...
![Phyrexian Digester](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Phyrexian+Digester)  
...
We failed there, no doubt about it. [Conversion Chamber](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Conversion+Chamber) isn't getting it done.
...
![Dispatch](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Dispatch)
> Swords to POWshares  
>  W  
>  Instant  
>  Tap target creature.  
...
![Parasitic Implant](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Parasitic+Implant)
...
![Glistening Oil](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Glistening+Oil)
> Glistening Oil  
>  B  
>  Creature — Ooze  
>  0/1  
...
![Chancellor of the Dross](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Chancellor+of+the+Dross)
...
![Life's Finale](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Life%27s+Finale)
> Exterminate  
>  4BB  
>  Sorcery  
...
![Slag Fiend](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Slag+Fiend)
> Metalgoyf  
>  1R  
>  Creature — Lhurgoyf  
>  \*/\*  
...
![Myr Superion](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Myr+Superion)
> Dreadnought Myr  
>  2  
