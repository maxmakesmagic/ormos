...
---
[Link to Wayback Machine](https://web.archive.org/web/20220524165943/https://magic.wizards.com/en/articles/archive/making-magic/join-ranks-2014-05-28)
...
[_metadata_:node]:- "683531"
[_metadata_:publish_date]:- "2014-05-28"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Join the Ranks!"
[_metadata_:wayback_capture_timestamp]:- "2022-05-24 16:59:43"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20220524165943id_/https://magic.wizards.com/en/articles/archive/making-magic/join-ranks-2014-05-28"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/making-magic/join-ranks-2014-05-28"
---
...
"[Lightning Bolt](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Bolt) deals *three* damage, not *two* damage."


"By Jove, this instant has a power and toughness!"


"The M15 [Riven Turnbull](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Riven+Turnbull) in the file taps for blue. We'd better double-check [Princess Lucrezia](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Princess+Lucrezia)."
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/2014/feat_wk21_301b_woof.png)Of course, had I given it a little more thought, I might have realized that the workweek is forty hours long, and the aforementioned activities would account for, at *most*, twenty of those.
...
Also, there's no dress code. If someone, hypothetically, wished to eschew haircuts entirely and show up to work every day in a [Silversun Pickups](http://en.wikipedia.org/wiki/Silversun_Pickups) sweatshirt over a pair of footie pajamas, he or she would be permitted to do so. Such a person wouldn't likely be viewed as "upwardly mobile" or "self-respecting," but maybe those attributes weren't among the person's top priorities at this stage in his or her life. Hypothetically.


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/2014/feat_wk21_301b_cardart_gnarledscarhide.jpg)[Gnarled Scarhide](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gnarled+Scarhide) | Art by [Greg Staples](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22Greg%20Staples%22%5D)
...
> **Erik Lauer**: Which do you believe to be the stronger card: [Heat Ray](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Heat+Ray) or [Disintegrate](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Disintegrate)?  
> **Hapless Intern:** Uhh... [Disintegrate](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Disintegrate)?  
> **EL:** I've found that people underestimate the hidden second mode of [Disintegrate](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Disintegrate).  
...
![52](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&multiverseid=52)
...
Really, though, we don't operate at optimal efficiency with only three people. We could use an extra set of eyes on everything and, more importantly, it would be nice if I could free up some time to finish my official card nickname encyclopedia. So if you possess the desire, the expertise, and the sheer audacity to join our motley crew, I encourage you [to apply](http://company.wizards.com/about/careers/associate-editor-magic-temporary-job-renton-wa-us?careers-view=1)[to apply](http://company.wizards.com/about/careers).
...
1. As long as you didn't stop playing before **Magic** 2010, you likely realized that "to play" should be "to the battlefield." But that was just a ruse to distract you from the subtler error. This should say "creature card," not just "creature," as a "creature" can only exist on the battlefield.
2. This is an omission I'm paranoid of making myself. A small yet crucial step absent from the procedure is "reveal it." Naturally, you need to reveal the card you searched for to prove to your opponent that it meets the necessary criteria.
3. I played the same trick here as with the first one. Perhaps the fact that Elemental was incorrectly left lowercase distracted you from the fudged ordering of the effect that creates the token. The correct order has the power and toughness first: "a 7/7 green Elemental creature token with trample."  
*Aside on capitalization: In rules text, creature types (and other subtypes) are capitalized; in creative text, they are not. Conversely, the word "Planeswalker" isn't capitalized in rules text because card types aren't capitalized, but it is considered a proper name when it's not in reference to the card type. The More You Know.*
4. This was a trick question, and something of a cruel one. Because we would never in a million years make a card so convoluted? Nope. This is the Oracle wording of a card that actually exists, the Alpha weirdo [Word of Command](https://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=92).
...
[Archdemon of Greed](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Archdemon+of+Greed), [Fiend of the Shadows](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fiend+of+the+Shadows), [Fractured Powerstone](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fractured+Powerstone), [Harmony of Nature](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Harmony+of+Nature), [Heroic Defiance](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Heroic+Defiance), [Highland Giant](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Highland+Giant), and [Plague Fiend](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Plague+Fiend) are all real. That's right—we must take *Innistrad* block transform cards; the various *Portal* sets; special releases like *Planechase*; and yes, even *Unglued* and *Unhinged* into consideration when approving card names. This quiz highlights the importance of checking the database rather than relying on our memories; we may be pretty sure a card name hasn't been used, but we can't be positive unless we check. My personal blind spots include *Portal* sets; Commander products; finished sets that haven't been released yet, and, for some reason, *Avacyn Restored*.
