...
---
[Link to Wayback Machine](https://web.archive.org/web/20220809140941/https://magic.wizards.com/en/articles/archive/latest-developments/painted-corner-2004-07-09-0)

[_metadata_:author]:- "Aaron Forsythe"
[_metadata_:description]:- "I'm not going to be talking about Demons this week (There are only a handful of Demon cards in existence, and I believe the rest of our writers have said every interesting thing there is to say about them...), but I will be talking development. But first... Magic R&D Intern Position Available We're looking for someone to help us playtest here at Wizards. If you (a) can build"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "612566"
[_metadata_:publish_date]:- "2004-07-09"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Painted into a Corner"
[_metadata_:wayback_capture_timestamp]:- "2022-08-09 14:09:41"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20220809140941id_/https://magic.wizards.com/en/articles/archive/latest-developments/painted-corner-2004-07-09-0"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/latest-developments/painted-corner-2004-07-09-0"
---
...
DEVELOPMENT SAYS: Correct! You now know it as [Qumulox](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Qumulox). They even made the card better with an extra point of power. What happened to the white Angel? It was "stolen" for *Champions of Kamigawa*, and replaced in development by [Auriok Windwalker](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Auriok+Windwalker).


![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/fcpics/latest/af22_Fleshgrafter.jpg)
...
I was personally rooting for either of the last two, as I had designed Metaltooth Mongrel and was hoping that it would remain a Hound to further the homage to [Vampire Hounds](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vampire+Hounds) from the *Exodus* set, a card I absolutely adored. But the creative team, given the option, felt the art went best on that guy, and made him a Human Warrior.


DEVELOPMENT SAYS: Correct! The card stayed as it was and became [Fleshgrafter](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fleshgrafter). Zombie Flanders also made it through unscathed (it's now [Blind Creeper](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blind+Creeper)). Junkyard Dog also became a human, was moved to rare, and tweaked a little. You know it as [Moriok Rigger](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Moriok+Rigger).


![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/fcpics/latest/af22_Ebon_Drake.jpg)
...
It quickly became a ![](https://web.archive.org/web/20161225105850im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless2.gif)![](https://web.archive.org/web/20161227195556im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/black.gif) 3/3 flier, and the ability was changed to hurt you whenever anyone played a spell, to mirror Zombie Flanders. The name was changed to "[Ebony Drake](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ebony+Drake)" and the type to Drake to match the Pete Venters artwork you see above.


DEVELOPMENT SAYS: Correct, but only after many attempted changes. The card went from ![](https://web.archive.org/web/20161225105850im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless2.gif)![](https://web.archive.org/web/20161227195556im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/black.gif) 3/3 flier to ![](https://web.archive.org/web/20211201201921im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless1.gif)![](https://web.archive.org/web/20161227195556im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/black.gif)![](https://web.archive.org/web/20161227195556im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/black.gif) 4/2 flier, then back to ![](https://web.archive.org/web/20211201201921im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless1.gif)![](https://web.archive.org/web/20161227195556im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/black.gif)![](https://web.archive.org/web/20161227195556im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/black.gif) 3/3, and finally went full circle back to ![](https://web.archive.org/web/20161225105850im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless2.gif)![](https://web.archive.org/web/20161227195556im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/black.gif), where it was printed as [Ebon Drake](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ebon+Drake). Note that the card was 4/2 when it was put into the "Special Forces" theme deck, which would have made it a better fit with the rest of the cards in the deck. But it was changed back to 3/3 after the decks were finalized.


![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/fcpics/latest/af22_Arachnoid.jpg)
This art loomed over our heads for a while. It looks very spider-like and very green. But it isn't a spider proper, since it only has six legs. And because *Mirrodin* already contained [Tel-Jilad Archers](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tel-Jilad+Archers)--the quintessential "spider" for the block, which was an Elf--we weren't sure what to do. Eventually we decided to create an artifact spider that would just happen to have very green art.
...
DEVELOPMENT SAYS: Correct! [Arachnoid](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Arachnoid) was printed in just this way. Simple and pure.


![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/fcpics/latest/af22_Mephidross_Vampire.jpg)
...
I wasn't a huge fan of this card (it felt too much like a souped-up [Baron Sengir](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Baron+Sengir) for my liking), but I didn't have any better ideas, so it went to development like this.'


DEVELOPMENT SAYS: Boooooo! Ah well, you can't win them all. Developer Devin Low can take the credit for coming up with the super-cool card that actually saw print as [Mephidross Vampire](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mephidross+Vampire). The development team did keep the phrase "combat damage" off the card (opening the door for the vicious [Triskelion](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Triskelion) combo), and also kept... the name. Good enough!


![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/fcpics/latest/af22_Anodet_Lurker.jpg)
...
DEVELOPMENT SAYS: (Imagine a red "X" in a box and a sound effect "RRRRRRRT!" like on Family Feud.) I thought the idea was cool, but development had a tough time imagining this thing eating Soldiers, Beasts, Angels and whatever other kinds of tokens were running around. It didn't make a lot of sense to them, as there's no real way to differentiate a token creature from a regular creature from a flavor standpoint. I tried to argue using [Dogged Hunter](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dogged+Hunter) and [Aether Snap](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Aether+Snap) as precedent, but I obviously didn't win.


They eventually came up with the "bigger [Onulet](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Onulet)" ability and used this art for [Anodet Lurker](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Anodet+Lurker).


![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/fcpics/latest/af22_Ferropede.jpg)
...
DEVELOPMENT SAYS: Correct! It was moved to uncommon and the phrase "combat damage" was added, but otherwise it stayed the same and went out the door as [Ferropede](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ferropede).


![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/fcpics/latest/af22_Thermal_Navigator.jpg)
...
DEVELOPMENT SAYS: Close, but no cigar. I was playing against Brandon Bozzi in a sealed deck game, and he had out a Hopper. On his next turn, he played a [Bonesplitter](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bonesplitter), equipped Hopper with the [Bonesplitter](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bonesplitter), tapped the [Bonesplitter](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bonesplitter) to give Hopper flying, then attacked for 4. "Oh yeah," I said, "the tapped equipment problem."


Since so many players incorrectly tap equipment on attacking creatures, we tried really had to avoid having "tap an artifact" as an activation cost in the *Mirrodin* block. [Lodestone Myr](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lodestone+Myr) and [Clock of Omens](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Clock+of+Omens) -- neither of which are common -- are the only cards in the block to have that cost. Development changed Hopper's activation to "sacrifice an artifact," and he was printed under the name [Thermal Navigator](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Thermal+Navigator).


![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/fcpics/latest/af22_Tanglewalker.jpg)
...
Luckily, the *Darksteel* team came to the rescue. A hole had opened up in their set in green uncommon late in development, and Henry Stern decided he and his team could come up with a card that would fit the Dryad art. And thus was born [Tanglewalker](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tanglewalker).


![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/fcpics/latest/af22_Cosmic_Larva.jpg)
...
Note that Bill also invented [Eater of Days](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Eater+of+Days)--he loves cheap fatties with drawbacks.


Roto-Tiller was in *Darksteel* for a long time, up until they needed to find a place for the story character [Slobad, Goblin Tinkerer](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Slobad%2C+Goblin+Tinkerer). At that point, Roto-Tiller was moved off to *Fifth Dawn*. We didn't particularly want the card, so it sat in our unused pile for a long time.
...
And to put a capper on the card, Brian Tinsman came up with the off-the-wall name "[Cosmic Larva](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cosmic+Larva)." Fabulously weird!
