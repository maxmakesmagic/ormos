...
---
[Link to Wayback Machine](https://web.archive.org/web/20160919173650/http://magic.wizards.com/en/articles/archive/feature/kaladesh-prerelease-primer-2016-09-19)
...
Welcome to a world of invention.


<https://www.youtube.com/embed/NRHvARONqzk>


Kaladesh is a world like no other we've been to. It's a gorgeous plane where incredible craftsmanship is prized and wondrous artifacts are built and used. Artificers and Pilots in Vehicles casually cruise through the streets. Of all the planes in the Multiverse, it's got to be one of the best to take a vacation to right now.


So why not plan your vacation to Kaladesh today with a nice visit to your local Prerelease? It's the only way to get your hands on the cards before they even come out on shelves, letting you check out the set before anybody else!


So where exactly can you find a Prerelease, and what exactly should you be expecting at one? Read on!


The Wondrous World of Prereleases
=================================
...
Prereleases are great because the set is brand new, the footing is fairly equal as everybody plays with the set for the very first time, and you're all just relaxing and having fun exploring the new cards. It's a lot of fun! Even players who have been playing since the beginning of the game look forward to each Prerelease.


If you're a Sealed Deck veteran, you may want to skip ahead to the next section, where I talk about some of the differences you can expect at your local store for *Kaladesh*. But if you're new to the wide world of Sealed Deck, or are maybe just looking for a few extra pointers, then read on!
...
Now it's time to prepare to visit Kaladesh. While you will be building your deck for the event with cards you're given when you get there, there's plenty to do besides just that.


You should pack some wondrous inventions of your own! For example, you may still want to bring a Standard deck to play for fun between rounds, a trade binder, pen and paper to keep track of life totals, and even a water bottle. A Prerelease event tends to take about 4 to 5 hours, so make sure to set aside enough time for the entire event. You may want to bring something like a granola bar or apple to snack on, too. (You may want to check with the local store as well—they might even sell some food there!)


Okay now, let's see. You have a store targeted to visit, and you've filled your pack with everything you'll need. You've even read through the [most recent *Magic* Story](http://magic.wizards.com/en/articles/columns/magic-story-archive), so you're up to date on *Magic* lore. And, of course, you've taken a look at the [Card Image Gallery](http://magic.wizards.com/en/articles/archive/card-image-gallery/kaladesh).
...
![](https://media.wizards.com/2016/images/daily/TAlDtfIrNa.png)


Our product designers here at Wizards have been working to come up with some really interesting twists on a normal deck box, and I love how the *Kaladesh* one turned out! It gets even better in person too.
...
![](https://media.wizards.com/2016/images/daily/h2vlOQKoVY.png)
...
*Kaladesh* is particularly interesting, in that it has a high number of artifacts compared to a typical *Magic* set. You're going to have more artifact options than normal. Unless these are also creatures, they should be counted among your noncreature spells, so narrow it down to the ones you really want to be playing with.


Additionally, *Kaladesh* introduces Vehicles! More on exactly how those work later (or you can just [click here](http://magic.wizards.com/en/articles/archive/feature/kaladesh-mechanics-2016-09-02)), but they're sort of like creatures. However, you do need (other) creatures to be able to crew them. If you play a couple Vehicles, you can treat them like creatures for your creature count, but be wary of playing too many lest you end up with a board full of Vehicles and nothing to drive them!
...
Some stores also support a version of Sealed Deck called Two-Headed Giant (often abbreviated "2HG"), where two players team up against other pairs of players. Each pair gets two Prerelease boxes from which to build their decks.
...
This deals 1 damage to each opponent, meaning that when this creature becomes tapped—perhaps from crewing a Vehicle or attacking—it deals 1 damage to each of your opponents. That's 2 damage to their combined 30 life! Bam!
...
If the idea of spending a day playing a tournament doesn't fit into how you prefer to play *Magic*, or if you have less time and just want to experience the excitement of *Kaladesh* on your own schedule, you can get involved in Open Dueling!
...
Vehicles and energy and fabricate, oh my! *Kaladesh* has a whole host of new abilities running around! You should definitely [check out the mechanics article](http://magic.wizards.com/en/articles/archive/feature/kaladesh-mechanics-2016-09-02) to get a full sense of what's going on—or, for a shorter bite-size version, check out these videos that cover the mechanics in depth:


<https://www.youtube.com/embed/aVa3g6BX0eI>


<https://www.youtube.com/embed/DtEzdPKcJrA>


<https://www.youtube.com/embed/zrI5LabLt4o>
...
It's a brand-new block, and it's hard to find a better time to come check out a Prerelease! Take another look through the [Card Image Gallery](http://magic.wizards.com/en/articles/archive/card-image-gallery/kaladesh), make sure you're preregistered at [your local store](http://locator.wizards.com/), and get ready to come out to the Prerelease and have fun!


That just about covers our path to the Prerelease. And as the *Kaladesh* Inventors' Fair gets into full swing, that just about brings this article to a close.
...
Enjoy the marvelous world of *Kaladesh*!
