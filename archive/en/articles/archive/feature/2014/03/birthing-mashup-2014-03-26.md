...
Many would say that the advantage of playing Kiki Pod over Melira Pod is the ability to combo quickly. However, Melira Pod is generally considered the version with the best ability to grind people out. The best Pod deck is likely one that can capitalize on having the best of both worlds. Today's deck, or rather a tuned version of it, could be that deck.

![Birthing Pod](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Birthing+Pod) The first thing you should notice is the lack of a blue splash, traditionally for [Deceiver Exarch](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Deceiver+Exarch), [Phantasmal Image](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phantasmal+Image), and [Glen Elendra Archmage](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Glen+Elendra+Archmage). Without [Phantasmal Image](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phantasmal+Image) and [Deceiver Exarch](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Deceiver+Exarch), the combo potential is much less explosive, so I'm not sure that's a wise option. However, making room for [Blade Splicer](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blade+Splicer) and [Wall of Omens](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wall+of+Omens) looks really good alongside [Restoration Angel](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Restoration+Angel) and [Birthing Pod](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Birthing+Pod). Not only do those additions beat up on Jund and Zoo, but they provide a ton of value as well. 
