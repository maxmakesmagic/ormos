...
---
[Link to Wayback Machine](https://web.archive.org/web/20210502051800/https://magic.wizards.com/en/articles/archive/decisions-decisions-part-ii-2009-08-10)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "Two weeks ago, I wrote a column examining the use of decisions in game design. As this week's column is the second part of the two-part article, before beginning today's column I'd heartily recommend you take a look at the first part if you haven't already. Last time I stated that I would examine decision creation in five parts of the game: the card level, the mechanics level,"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "657206"
[_metadata_:publish_date]:- "2009-08-10"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Decisions, Decisions, Part II"
[_metadata_:wayback_capture_timestamp]:- "2021-05-02 05:18:00"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20210502051800id_/https://magic.wizards.com/en/articles/archive/decisions-decisions-part-ii-2009-08-10"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/decisions-decisions-part-ii-2009-08-10"
---
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm51_response.jpg)Two weeks ago, I wrote a column examining the use of decisions in game design. As this week's column is the second part of the two-part article, before beginning today's column I'd heartily recommend you take a look at [the first part](/en/articles/archive/decisions-decisions-part-i-2009-07-27) if you haven't already. Last time I stated that I would examine decision creation in five parts of the game: the card level, the mechanics level, the set level, the block level, and the meta-rules level. I did the first two last time, so odds are I'll discuss the other three today.
...
**[Expunge](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Expunge) is a wonderful card.** We joke in the Pit that the main topic of my thread is seldom the main topic of my column. So was the thread two weeks ago all about the role of options versus choices? No, the vast majority of my thread was spent defending the card [Expunge](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Expunge). (I kind of said it was a bad design.) How dare I claim such an awesome card as a failure?


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm51_iPunge.jpg)Let me clarify what I said, as I think the topic drifted a bit. I didn't say [Expunge](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Expunge) was a bad card. On the contrary, the card saw plenty of play, and as the thread shows, there are many players who liked it. I was claiming that it was a bad cycling design. My critique was a technical one, looking at how well the card took advantage of having cycling. Several posters objected that they would rather play [Expunge](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Expunge) than [Terror](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Terror), and that the cycling did occasionally matter. My response is that of course it matters. It would be hard to put cycling on any card and not have it come up some of the time, if for no other reason than cycling helps grease the deck to avoid mana issues.
...
Yes, [Expunge](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Expunge) is essentially better than [Terror](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Terror). And yes, players will be attracted to the thing that is better most of the time. Does that mean we should stop printing [Terror](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Terror)—that we should only make black kill spells that do stuff in addition to killing things? No, it doesn't. Your job as players is to want as much candy as you can get your hands on. My job as the game designer is to make sure that I don't let you have so much access to candy that you all get stomachaches.
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm51_googolplex.jpg)**Options need to and should exist.** When I said choices make for better game play than options, I was not saying that options should be stripped from the game. As demonstrated by the conversation around [Expunge](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Expunge), players love having options. The goal of this two-parter is to explain that options need to be limited, especially when there are choices that fit in the same space. Choices need to be the default, but in the right places for the right reasons, options can and should be used. (Remember, I'm using "option" to refer to additive decisions and "choice" to refer to modal decisions. I'm well aware that by the technical dictionary definition they are synonyms.)
...
**Interactivity –** When a card has a dual function, occasionally decks find a way to make both aspects matter. Perhaps you're playing Selesnya but you are playing in a format that allows access to other cards. There are green and white cards, for example, that can allow you to use cards much as you might normally use them in a Golgari deck. For example, the card [Natural Order](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Natural+Order) from *Visions*, allows you to turn a green creature into any green creature card from your deck. In a format with [Natural Order](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Natural+Order), token making might be a means to get your biggest green creature out of your library and into play in addition to building your army.
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm51_beetle.jpg)**We must keep surprising.** In one of my more colorful metaphors, I've described our player base as the Borg (from *Star Trek*). Our players adapt to whatever we do, so we can't use the same trick twice. This has forced us to get much more innovative in how we create blocks. Once upon a time we could get away with "here's some" and "here's some more" and "here's even more with some tiny twist," but times have changed, and I feel the players expect more from us. That means we have to deliver. We have to find ways to surprise you, and the change evolution seems more prone to accomplishing this task.
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm51_2010.jpg)My game design corollary is this: no rule is worth a game. If a game can exist without a rule and function smoothly, then the rule is not needed. Rules should exist only because they service the game. Essentially, a game should exist with as few rules as it needs to do the things it does. This is why we pulled mana burn from the game. You remove it and the game functions perfectly fine.


The tricky thing about this strategy is that often rules that seem irrelevant aren't. Two perfect examples from **Magic** are the cards [Yawgmoth's Bargain](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Yawgmoth%27s+Bargain) and [Tinker](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tinker).
...
In [Yawgmoth's Bargain](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Yawgmoth%27s+Bargain), I was trying to make a cleaner (and in theory less powerful) version of [Necropotence](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Necropotence). I took off the pesky "Put that card into your hand at the beginning of your next end step" text as I thought it wasn't necessary. Likewise I removed the whole part about needing to pay the difference in converted mana cost from [Transmute Artifact](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Transmute+Artifact) to create [Tinker](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tinker) because I thought it was unnecessary text. In each case I learned the hard way that what seemed like unneeded excess text was not.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm51_frazzled.jpg)Back to ridding the game of unnecessary rules. One way to rid a game of rules is to look for things that are not essential. Another way is to look for rules that are limiting rather than expanding the game. Essentially, I'm looking for options that eclipse choices. Before I jump into the recent rules changes, let me give an example from another game. Suppose Tic Tac Toe had a rule that said that once per game each player could play twice in a row. It's an extra rule. It grants both players an additional ability. Isn't that good? No, because it leads the game to a locked state. The first player puts his X on the board in either the center or a corner, says go, and then is guaranteed a win on his next turn no matter what action the second player takes. You have more options, but the end result is that you actually have no interesting decisions.


Now let's finally talk about "damage on the stack." As far as I'm concerned it's an option that reduces decision-making. Here's an example. Turn one, your opponent plays an [Elite Vanguard](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Elite+Vanguard). You play a Sakura Tribe-Elder on your first turn. Then on their second turn, they attack with the [Elite Vanguard](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Elite+Vanguard). What do you do?


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm51_gameState.jpg)Pre-M10 rules changes, you blocked, put damage on the stack, and then sacrificed your Sakura Tribe-Elder for a land. Sure, you had other things you could do, but all of them were eclipsed strategically by this play. Under M10 rules, the same thing happens. What do you do? It's not so clear. You could block and kill the [Elite Vanguard](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Elite+Vanguard) or you could block and then before damage sacrifice your Sakura Tribe-Elder. This allows you to get a land but at the cost of not destroying the [Elite Vanguard](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Elite+Vanguard). It's no longer an automatic decision.


I understand why players were unhappy with us removing "damage on the stack," but it comes down to the same reasoning why so many players argued fervently for [Expunge](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Expunge). Options are desirable. Of course, if given the decision between two cards, players will always prefer the one with more options (provided, of course, that the costing doesn't make it unusable). The same goes with rules. Players like being able to do more things, but that doesn't make it produce better game play.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm51_strategy.jpg)But wait, didn't we say that "damage on the stack" was removed because it was unintuitive to new players? We did and it is. That was what made this decision so appealing to us. Not only did we remove an unnecessary option from the game, but in doing so, we also rid **Magic** of something that was confusing newer players. We were able to remove complexity and add to strategy. Win-win.
