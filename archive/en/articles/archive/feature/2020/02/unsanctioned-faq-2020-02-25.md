...
[_metadata_:node]:- "1496404"
[_metadata_:publish_date]:- "2020-02-25"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Unsanctioned FAQ"
[_metadata_:wayback_capture_timestamp]:- "2020-02-25 16:58:06"
...
All silver-bordered cards\* have definitive Oracle text that tells you how the card plays, listing its current rules text, creature types, and so on. However, if a card refers to features of the physical card, such as what watermark it has or how many lines of rules text it has or features of its art, look at the actual card you're playing with to figure out the results. In black-bordered *Magic*, all cards with the same English name are treated the same, no matter what version of a card you're playing with. [Shivan Dragon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shivan+Dragon) is [Shivan Dragon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shivan+Dragon) is [Shivan Dragon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shivan+Dragon). In silver-bordered *Magic*? Not so much.
...
No, you can't augment onto creatures unless they are host creatures. I know Half-Kitten, [Serra Angel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Serra+Angel) might seem like a good idea, but that way lies madness. Sorry.
...
Some cards have abilities that let you reroll one or more dice. After any die is rolled, before applying the result of that die, there's an opportunity for you to use those abilities. The original result is ignored, and the new die roll is now considered the official roll. The same is true about cards like [Snickering Squirrel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Snickering+Squirrel) that affect the outcome of the roll.


**Do cards that care about die rolls count all the die rolls if the die is rerolled?**


No. They count only the reroll, just as if the original roll never happened. For example, if you roll a die and then use something like [Wall of Fortune](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wall+of+Fortune) to reroll the die, the game sees only a single die roll with the result of the reroll. Triggered abilities like the one on [As Luck Would Have It](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=As+Luck+Would+Have+It) will trigger only once. Note that this is a change from previous rulings.


**Can a roll have a result greater than 6?**


Sure. For example, [Snickering Squirrel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Snickering+Squirrel) can change a roll of 6 to a roll of 7.


**But a 7 on a six-sided die doesn't exist?**


There's at least one [Snickering Squirrel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Snickering+Squirrel) that would disagree.
...
![](https://media.wizards.com/2020/und/en_HTEL3V4rKn.png)
...
![](https://media.wizards.com/2020/und/en_APxa8BPet2.png)
...
![](https://media.wizards.com/2020/und/en_dXF3dJodQ8.png)
...
Every line counts, even if there are just a few words. Count each section separately. For example, the *Theros Beyond Death* Saga [Elspeth Conquers Death](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Elspeth+Conquers+Death) has sixteen lines of rules text. The reminder text on top doesn't count, then there's five lines in chapter I, four lines in chapter II, and seven lines in chapter III.
...
![](https://media.wizards.com/2020/und/en_vExR5klx3I.png)
...
![](https://media.wizards.com/2020/und/en_4RHXhBlBIz.png)
...
**Say I have a card that doubles my token production, like [Doubling Season](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Doubling+Season). What happens?**


[Doubling Season](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Doubling+Season) (and a few similar cards) applies "if an effect would create one or more tokens," so it will double the initial shipment of Beebles. You'll create eight of them as B.O.B. enters the battlefield. However, it won't double the one created because you activate the first loyalty ability. That Beeble is created because of a cost, not an effect.


However, some more recent cards like [Primal Vigor](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Primal+Vigor) don't specify "effects" and will double any and all Beeble births.
...
![](https://media.wizards.com/2020/und/en_yXtUPFmbva.png)
...
![](https://media.wizards.com/2020/und/en_BzXFbzuiNA.png)
...
![](https://media.wizards.com/2020/und/en_xKt0K6NqGp.png)
...
![](https://media.wizards.com/2020/und/en_ALcVvfYKet.png)
...
![](https://media.wizards.com/2020/und/en_dtl3jd3PiJ.png)
...
![](https://media.wizards.com/2020/und/en_5poJAvW9GC.png)
...
**What if a creature card in a graveyard has no name? (I'm looking at you [\_\_\_\_\_](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=_____).)**
...
![](https://media.wizards.com/2020/und/en_tHR2jQ57Ey.png)
...
![](https://media.wizards.com/2020/und/en_mQmvadFJgK.png)
...
![](https://media.wizards.com/2020/und/en_99nYfgvTZa.png)
...
A keyword from the future! Unless you're reading this after it's been released, in which case . . . <spooky music>A keyword from the present!</spooky music>. But I suppose you could be reading this in a theoretical future in which the keyword was released, threatened to destroy *Magic* (as I do occasionally), and removed from the game, in which case . . . <spookier music>A keyword from the past!</spookier music>
...
![](https://media.wizards.com/2020/und/en_hnZu8zgd9a.png)
...
![](https://media.wizards.com/2020/und/en_PMnaCVoCVo.png)
...
![](https://media.wizards.com/2020/und/en_EYuR6fxIuL.png)
...
[Avatar of Me](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Avatar+of+Me)'s power is equal to your height in feet and its toughness is equal to your American shoe size. Round to the nearest ½.  
[Avatar of Me](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Avatar+of+Me) is the color of your eyes.


**Is [Avatar of Me](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Avatar+of+Me) just the color of my eyes or the color of my eyes and blue?**
...
![](https://media.wizards.com/2020/und/en_dDmPFAfgAI.png)
...
![](https://media.wizards.com/2020/und/en_73mfseEPKX.png)
...
[B-I-N-G-O](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=B-I-N-G-O) gets +9/+9 for each set of three numbers in a row with chip counters on them.


**Do horizontal, vertical, and diagonal rows all count?**


Yes. With a full card, [B-I-N-G-O](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=B-I-N-G-O) will get +72/+72.
...
![](https://media.wizards.com/2020/und/en_78ZN8lDnoX.png)
...
[Blast from the Past](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blast+from+the+Past) deals 2 damage to any target. If this spell was kicked, create a 1/1 red Goblin creature token.
...
**When I cast [Blast from the Past](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blast+from+the+Past) using madness, can I use kicker or buyback?**


Yes, but you do need to pay for the kicker and/or buyback cost(s). If you pay the kicker cost, you get a 1/1 Goblin. If you pay the buyback cost, the spell returns to your hand instead of going to the graveyard. This means for 7RRRR you can cycle [Blast from the Past](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blast+from+the+Past), then pay madness to cast it, adding on kicker and buyback. This means you will draw a card, deal 2 damage to any target, create the Goblin token, and put [Blast from the Past](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blast+from+the+Past) back in your hand.


**What happens if I cast [Blast from the Past](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blast+from+the+Past) using flashback but also pay for buyback?**


Bad news. Flashback will exile the card rather than put it anywhere else, including into your hand because of buyback.


**What happens if I cast [Blast from the Past](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blast+from+the+Past) using flashback but also pay for kicker?**


Good news! Kicking the spell means you'll get a Goblin creature token, then [Blast from the Past](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blast+from+the+Past) is exiled.
...
![](https://media.wizards.com/2020/und/en_PeM9znhxHV.png)
...
Yes. [Booster Tutor](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Booster+Tutor) allows you to bring cards not normally allowed in a given format into the game.
...
![](https://media.wizards.com/2020/und/en_hEqSZcBvJp.png)
...
When you speak in your normal voice, sacrifice [Bronze Calendar](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bronze+Calendar).


**Do two [Bronze Calendar](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bronze+Calendar)s require two different voices?**
...
![](https://media.wizards.com/2020/und/en_ezayY9P4Z1.png)
...
At the beginning of your upkeep, sacrifice [Carnivorous Death-Parrot](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Carnivorous+Death-Parrot) unless you say its flavor text.
...
You may, but be aware that if you do, you're considered to have spoken. [Goblin Mime](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Goblin+Mime) will notice. Note this is a change from previous rulings.
...
![](https://media.wizards.com/2020/und/en_TuysSGO6gN.png)
...
If [Cheatyface](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cheatyface) is in your hand, you may sneak [Cheatyface](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cheatyface) onto the battlefield. If an opponent catches you right away, that player may exile [Cheatyface](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cheatyface).  
...
![](https://media.wizards.com/2020/und/en_aOz1gYJoSl.png)
...
**Can you tap [Chicken à la King](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Chicken+%C3%A0+la+King) to activate its last ability?**
...
![](https://media.wizards.com/2020/und/en_OpFc3GwUrC.png)
...
When a player asks you permission to cast a spell and you refuse, counter that spell and sacrifice [Common Courtesy](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Common+Courtesy).
...
![](https://media.wizards.com/2020/und/en_23rFLEatsW.png)
...
**Can [Duh](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Duh) destroy a creature if another version of it exists with reminder text?**


No. [Duh](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Duh) only cares if the creature it's targeting has reminder text.


**What if I create a token that's a copy of a creature with reminder text? Can [Duh](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Duh) destroy it?**
...
![](https://media.wizards.com/2020/und/en_iQGoqF1JOK.png)
...
As [Elvish Impersonators](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Elvish+Impersonators) enters the battlefield, roll a six-sided die twice. Its base power becomes the first result and its base toughness becomes the second result.
...
![](https://media.wizards.com/2020/und/en_ihaCX76irv.png)
...
**If I have two [Emcee](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Emcee)s in play, do I announce the creature's entrance twice?**


You can do it twice for two +1/+1 counters, once for one +1/+1 counters, or not at all.


**Can I use [Emcee](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Emcee)'s ability if I'm already standing?**


Sure. Just be standing when you make the announcement.


**Can I use [Emcee](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Emcee)'s ability on creatures I don't control?**


Yes, you may.


**Can I use [Emcee](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Emcee)'s ability on creatures without names (such as [\_\_\_\_\_](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=_____) or a face-down creature)?**


No. In order to get a bonus, they must have a name that can be presented. (Note that [\_\_\_\_\_](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=_____) has the ability to give itself a name before it enters the battlefield.


**Can I use nicknames (such as "Gary" for [Gray Merchant of Asphodel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gray+Merchant+of+Asphodel)) when I present them?**


You can add in the nickname for fun, but you don't get the +1/+1 counter unless you say the card's given name.


**Say I use sign language or a nonverbal method of communication. How should I play with [Emcee](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Emcee)?**
...
![](https://media.wizards.com/2020/und/en_SsK6sf4Pnh.png)
...
**What happens if we're in the middle of a subgame and someone casts [Enter the Dungeon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Enter+the+Dungeon)?**
...
![](https://media.wizards.com/2020/und/en_mamw63iD7a.png)
...
During your turn, if [Entirely Normal Armchair](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Entirely+Normal+Armchair) is in your hand, you may hide it on the battlefield.  

0: Return [Entirely Normal Armchair](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Entirely+Normal+Armchair) to its owner's hand. Only any opponent may activate this ability and only if they see [Entirely Normal Armchair](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Entirely+Normal+Armchair).  

2, Sacrifice [Entirely Normal Armchair](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Entirely+Normal+Armchair): Destroy target attacking creature.


**So, this is like [Cheatyface](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cheatyface)?**


Very similar. [Cheatyface](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cheatyface) can be snuck in at any time, while the Armchair is limited to your turn, but both must be in your hand to work. You can't sneak them onto the battlefield from outside the game or your library or anywhere else. We've updated the Oracle text on [Cheatyface](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cheatyface) to clarify that.


**Must [Entirely Normal Armchair](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Entirely+Normal+Armchair) be hidden behind something on the battlefield?**
...
**Can my opponent attempt to activate [Entirely Normal Armchair](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Entirely+Normal+Armchair) if they don't know where it is or even if there's one on the battlefield?**
...
![](https://media.wizards.com/2020/und/en_QEknpqdXN4.png)
...
If there's anything [Frankie Peanuts](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Frankie+Peanuts) hates more than a snitch, it's unsportsmanlike conduct. Your questions need to give the opponent an actual choice.
...
![](https://media.wizards.com/2020/und/en_NzhFgyU46w.png)
...
When [GO TO JAIL](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=GO+TO+JAIL) enters the battlefield, exile target creature an opponent controls until [GO TO JAIL](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=GO+TO+JAIL) leaves the battlefield.  

At the beginning of the upkeep of the exiled card's owner, that player rolls two six-sided dice. If they roll doubles, sacrifice [GO TO JAIL](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=GO+TO+JAIL).


**If a die result is altered by another card, what counts as "doubles"?**


If the two dice end up having the same result, they're considered "doubles." For example, say I roll a 5 and a 6 and use [Snickering Squirrel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Snickering+Squirrel) to change my 5 to a 6. I now have two 6s. That's doubles and [GO TO JAIL](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=GO+TO+JAIL) is sacrificed.
...
![](https://media.wizards.com/2020/und/en_vFfx6eAYxy.png)
...
![](https://media.wizards.com/2020/und/en_3sTRotLSGd.png)
...
Once each turn, while you're searching your library, you may pay 1B, reveal [Infernal Spawn of Infernal Spawn of Evil](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infernal+Spawn+of+Infernal+Spawn+of+Evil) from your library and say "I'm coming, too!" If you do, [Infernal Spawn of Infernal Spawn of Evil](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infernal+Spawn+of+Infernal+Spawn+of+Evil) deals 2 damage to a player of your choice.


**In order to activate the ability must I have some other means of searching my library?**


Yes, [Infernal Spawn of Infernal Spawn of Evil](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infernal+Spawn+of+Infernal+Spawn+of+Evil)'s ability doesn't let you search your library. It applies only if another spell or ability allows you to search it.


**When exactly do I reveal [Infernal Spawn of Infernal Spawn of Evil](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infernal+Spawn+of+Infernal+Spawn+of+Evil)?**


You can reveal [Infernal Spawn of Infernal Spawn of Evil](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infernal+Spawn+of+Infernal+Spawn+of+Evil) any time while searching your library before you shuffle it.
...
**Let's suppose I use an [Infernal Spawn of Infernal Spawn of Evil](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infernal+Spawn+of+Infernal+Spawn+of+Evil) to deal 2 damage to my opponent as I'm searching my library. Then later in my turn, I search my library again. Can I do 2 damage with a second [Infernal Spawn of Infernal Spawn of Evil](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infernal+Spawn+of+Infernal+Spawn+of+Evil)?**


Yes, but you have to reveal both copies of [Infernal Spawn of Infernal Spawn of Evil](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infernal+Spawn+of+Infernal+Spawn+of+Evil) to show that you actually have two in your library.
...
![](https://media.wizards.com/2020/und/en_wffJgNgkVt.png)
...
[Infinity Elemental](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infinity+Elemental)'s power is incalculable. [Infinity Elemental](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infinity+Elemental) has the largest power on the battlefield (although, it will tie other [Infinity Elemental](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infinity+Elemental)s). Gaining or losing power is meaningless to it, however, effects that set its power to another number will still work.
...
**What happens if I have infinite life and then get hit with my opponent's [Infinity Elemental](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infinity+Elemental)?**


Once you're at infinite life, your life total effectively can't change. At infinite life and gain 2 life? You're at infinite life. At infinite life and lose 29 life? You're at infinite life. You can pay any amount of life. In fact, if you're at infinite life and get hit with an opposing [Infinity Elemental](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infinity+Elemental), you'd still be at infinite life.
...
Yes. ([Mox Lotus](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mox+Lotus) could already accomplish this.)
...
![](https://media.wizards.com/2020/und/en_SdlPglStvT.png)
...
**Which die rolls does [Krark's Other Thumb](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Krark%27s+Other+Thumb) work with?**


It works with any die you're instructed or allowed to roll.


**Do cards like [Chicken à la King](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Chicken+%C3%A0+la+King) count the die roll that gets ignored?**
...
**What if the die roll includes some physical functionality? Like [Ol' Buzzbark](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ol%27+Buzzbark) cares where the dice actually land.**
...
**Does [Krark's Other Thumb](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Krark%27s+Other+Thumb) apply to rerolls?**
...
![](https://media.wizards.com/2020/und/en_jN4PpcNyLO.png)
...
As [Look at Me, I'm R&D](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Look+at+Me%2C+I%27m+R%26D) comes into play, choose a number and a second number one higher or one lower than that number.  
...
![](https://media.wizards.com/2020/und/en_FDfNiMtXkl.png)
...
The DCI, originally short for Duelists' Convocation International and later short for absolutely nothing, was the name given to the governing body overseeing all *Magic* organized play. Although this name has since been retired, the card [Look at Me, I'm the DCI](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Look+at+Me%2C+I%27m+the+DCI) persists in its honor.
...
![](https://media.wizards.com/2020/und/en_N84t8SSKOj.png)
...
Phasing: A permanent that's phased out is treated as though it doesn't exist. [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey) is basically around every other turn.


Cumulative upkeep 1: At the beginning of your upkeep, add an age counter to [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey), then you may pay the cost, in this case 1, for each age counter. If you don't, sacrifice it.


Echo: Okay, this one gets weird. Echo means "At the beginning of your upkeep, if this permanent came under your control since the beginning of your last upkeep, sacrifice it unless you pay [cost]." With [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey), there's no cost listed because in ye olden days it was just the mana cost. But that's not the weird part. [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey) is phased out when its echo ability would trigger, so that ability doesn't trigger at the beginning of the upkeep after [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey) enters the battlefield. And thanks to changes to the phasing rules, phasing in doesn't cause [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey) to enter the battlefield, so echo ends up not really doing much at all. (It'll still trigger the upkeep after another player gains control of [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey).)


Fading 3: [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey) enters with three fade counters on it. At the beginning of your upkeep, remove a fade counter from it. If you can't, sacrifice [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey).


Bands with other Dinosaurs: Okay, look. I'm not sure we have enough space to really cover it, but the short, short version is that [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey) can band with other Dinosaurs to attack or block an attacking creature. If it does, you choose how combat damage is dealt to creatures in the band. It's complex. It probably won't come up. Let's move on.


Protection from Homarids: [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey) can't be blocked by Homarids. It can't be the target of any abilities from Homarid sources (or, Thassa help us, Homarid spells). Prevent all damage that Homarids would deal to it. (Technically, Homarids also can't be attached to [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey), but it's really hard to have an Aura or Equipment that's also a Homarid, so . . .)


Snow-covered plainswalk: [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey) can't be blocked if defending player controls a [Snow-Covered Plains](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Snow-Covered+Plains).


Flanking: Whenever [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey) becomes blocked by a creature without flanking, the blocking creature gets -1/-1 until end of turn.


Rampage 2: For every creature that blocks [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey) beyond the first, [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey) gets +2/+2 until end of turn.
...
Turn 1: You cast [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey).
...
Turn 3: During your untap step before you untap, [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey) phases in. At the beginning of that turn's upkeep, cumulative upkeep adds an age counter and then says, "Hey, pay 1." (This assumes your abilities can speak—mine can.) Echo sits mostly quietly, though it occasionally mumbles about the old days. And fading says, "Take off one of my three fading counters." Let's assume you pay for cumulative upkeep.
...
Turn 5: During your untap step before you untap, [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey) phases in. Upkeep rolls around. Cumulative upkeep adds a second age counter and says, "Hey, pay 2." Echo says, "It's almost 5:00! Let's get dinner." And fading says "Take off another fading counter. I'm down to one."
...
Turn 7: During your untap step before you untap, [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey) phases in. Then upkeep, where cumulative upkeep adds a third age counter and says, "Hey, pay 3." Echo wonders about senior discounts if they get a pizza. And fading says, "Take off my last fading counter."
...
Turn 9: During your untap step before you untap, [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey) phases in. Another upkeep, and cumulative upkeep adds a fourth age counter, then says, "Hey, pay 4." Fading then chimes in and says, "You know, I'm going to make you sacrifice [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey). Do you really want to pay 4?" Then cumulative upkeep says, "Maybe I will. What are you going to do about it?" And then echo says, "Guys, can't we all just get along? Can't we all just get along? Get along? Along?" A fight then ensues which ends with [Old Fogey](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Old+Fogey)'s death.
...
![](https://media.wizards.com/2020/und/en_G8G0enxdlu.png)
...
3, T: Spin [Pointy Finger of Doom](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pointy+Finger+of+Doom) in the middle of the table so that it rotates completely at least once, then destroy the closest permanent the finger points to.
...
![](https://media.wizards.com/2020/und/en_SqX2hBx7x9.png)
...
**Again, I draw [Savannah Lions](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Savannah+Lions) and cast it as [Swords to Plowshares](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Swords+to+Plowshares). Then my opponent gains control of my Richard. Can they now choose [Swords to Plowshares](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Swords+to+Plowshares) if they have a card that costs W?**
...
![](https://media.wizards.com/2020/und/en_ulaRMfc84u.png)
...
When [Skull Saucer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Skull+Saucer) enters the battlefield, destroy target creature and put your head on the table. Sacrifice [Skull Saucer](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Skull+Saucer) when your head stops touching the table.
...
![](https://media.wizards.com/2020/und/en_78G3XJVj92.png)
...
[Slaying Mantis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Slaying+Mantis) enters the battlefield by being thrown from a distance of at least three feet.  

When [Slaying Mantis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Slaying+Mantis) enters the battlefield, it fights each creature an opponent controls that it touched as it entered.


**I declare I'm casting [Slaying Mantis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Slaying+Mantis). Is there any way for my opponent to move their cards before the "just a second" mechanic kicks in?**


No, there's not. The announcement of the spell instantly locks all cards into place on the battlefield. Remember that just a second is a variant of the mechanic split second. Because it's a variant of split second, players also can't cast spells or activate abilities while [Slaying Mantis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Slaying+Mantis) is on the stack.


**Can [Slaying Mantis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Slaying+Mantis) be dropped from a height of three feet?**


No, it must be thrown, not dropped. That three-foot distance is horizontal, not vertical.


**[Slaying Mantis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Slaying+Mantis) lands touching multiple creatures. How does the fight work?**


[Slaying Mantis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Slaying+Mantis) fights each creature one-on-one in a handicap match. For example, [Slaying Mantis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Slaying+Mantis) lands on a 3/3, a 4/4, and a 5/5. [Slaying Mantis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Slaying+Mantis) deals 6 damage to each of them, destroying them all. At the same time, they deal a total of 12 damage to [Slaying Mantis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Slaying+Mantis), destroying it. What a maneuver!


**[Slaying Mantis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Slaying+Mantis) touches a creature mid-flight but doesn't end up touching it when it comes to rest. Does it still fight that creature?**
...
If [Slaying Mantis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Slaying+Mantis) touches the object representing the creature token, it will fight it.
...
![](https://media.wizards.com/2020/und/en_kbUmF8QzCY.png)
...
You may tap [Snickering Squirrel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Snickering+Squirrel) to increase the result of a die any player rolled by 1.


**When do I decide if I'm tapping [Snickering Squirrel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Snickering+Squirrel)?**


Right after you see the result of the die roll.


**Can I use the ability if [Snickering Squirrel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Snickering+Squirrel) has summoning sickness?**
...
**Can multiple [Snickering Squirrel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Snickering+Squirrel)s affect the same die roll?**
...
![](https://media.wizards.com/2020/und/en_nFapb8LLUm.png)
...
Roll a six-sided die. [Strategy, Schmategy](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Strategy%2C+Schmategy) has the indicated effect.  
...
4 — [Strategy, Schmategy](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Strategy%2C+Schmategy) deals 3 damage to each creature and each player.  
...
![](https://media.wizards.com/2020/und/en_479dJzEGAj.png)
...
[Super-Duper Death Ray](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Super-Duper+Death+Ray) deals 4 damage to target creature.


**How does trample work on a spell?**


It's like how trample works on a creature: excess damage is dealt to the creature's controller. For example, I cast [Super-Duper Death Ray](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Super-Duper+Death+Ray) and aim it at a 3/3 creature. [Super-Duper Death Ray](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Super-Duper+Death+Ray) deals 3 damage to that creature and the extra 1 damage can be dealt to its controller.
...
![](https://media.wizards.com/2020/und/en_zfXN44phCx.png)
...
![](https://media.wizards.com/2020/und/en_IFsdAmB2Wa.png)
...
![](https://media.wizards.com/2020/und/en_3wLSnCFonI.png)
...
Yes, you can. The ability doesn't use the tap symbol. You could even tap [Wall of Fortune](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wall+of+Fortune) itself this way on the turn it enters the battlefield.
...
![](https://media.wizards.com/2020/und/en_lWro23VbwO.png)
...
As [Water Gun Balloon Game](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Water+Gun+Balloon+Game) enters the battlefield, each player puts a pop! counter on "0."  
...
![](https://media.wizards.com/2020/und/en_1oUECBcUOW.png)
...
![](https://media.wizards.com/2020/und/en_aJVgwV24fy.png)
