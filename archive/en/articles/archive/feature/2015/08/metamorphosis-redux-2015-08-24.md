...
---
[Link to Wayback Machine](https://web.archive.org/web/20150826180613/http://magic.wizards.com/en/articles/archive/feature/metamorphosis-redux-2015-08-24)
...
*With* Battle for Zendikar *releasing soon and* Theros *and* Magic 2015 *rotating out of Standard, we wanted to revisit Mark Rosewater’s very important article from 2014 about the new Standard rotation and the two-block structure. We’ve updated the article and the graphics to represent set names that are known now that were not known at the time.*
...
[Abbot of Keral Keep](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Abbot+of+Keral+Keep) | Art by [Deruchenko Alexander](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=[%22Deruchenko Alexander%22])
...
[Dromoka's Command](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dromoka%27s+Command) | Art by [James Ryman](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=[%22James Ryman%22])
...
![](https://media.wizards.com/2015/images/daily/en_schedule2.gif)
...
| Spring 2015 | *Dragons of Tarkir* | Nothing rotates | Still two three-set blocks |
| Fall 2015 | *Battle for Zendikar* | *Theros* block | Still two three-set blocks |
| Spring 2016 | "Tears" | *Khans of Tarkir* and *Fate Reforged* | Now three two-set blocks |
| Fall 2016 | "Lock" | *Magic Origins* and *Dragons of Tarkir* | Three two-set blocks |
| Spring 2017 | "Barrel" | *Battle for Zendikar* block | Three two-set blocks |

From now through *Battle for Zendikar* block, Standard will stay as is, at two three-set blocks. Then, with the release of "Tears" block, the first spring block (in the spring of 2016), Standard will change over to be three two-set blocks. For the purposes of rotation, we are splitting the three sets of the *Khans of Tarkir* block, plus the core set to be released in 2015, into two, two-set blocks: *Khans of Tarkir* and *Fate Reforged* is one and *Dragons of Tarkir* and the 2015 core set is the other. *Khans of Tarkir* and *Fate Reforged* will rotate out spring 2016 as a unit, and *Dragons of Tarkir* and the core set will rotate out fall 2016 as a unit.
