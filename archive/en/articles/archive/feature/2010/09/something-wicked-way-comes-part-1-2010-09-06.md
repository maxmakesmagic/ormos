...
---
[Link to Wayback Machine](https://web.archive.org/web/20160902154506/http://magic.wizards.com/en/articles/archive/feature/something-wicked-way-comes-part-1-2010-09-06)
...
Welcome to the first week of *Scars of Mirrodin* previews. Man, that felt good. This set is the culmination of so many things and I've had to bite my tongue about it for years, so the chance to actually talk about it is making me a little giddy. There are many facets to the set and I'll be talking about most of them during the three preview weeks (and beyond). Today, though, is all about the greatest quest I ever undertook as a designer: to get poison into a set as a major element. This quest has taken sixteen years (fourteen from the first time I tried to get it in a set). This column is that story. Well, at least Part I. Also before the column is over, I'll let you meet a mythic creature with infect.
...
![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/authorpics/authorpic_markrosewater.jpg)**Mark Rosewater (lead)**
...
![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/authorpics/authorpic_MarkGlobus.jpg)**Mark Globus** 
...
![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/authorpics/authorpic_MarkGottlieb.jpg)**Mark Gottlieb**
...
![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/authorpics/authorpic_NateHeiss.jpg)**Nate Heiss**
...
![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/authorpics/authorpic_AlexisJanson.jpg)**Alexis Janson**
...
![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/authorpics/authorpic_ErikLauer.jpg)**Erik Lauer**
...
![](https://media.magic.wizards.com/image_legacy_migration/magic/images/mtgcom/authorpics/authorpic_MattPlace.jpg)**Matt Place**
...
Our story begins with the release of the *Legends* expansion. The year is 1994 and I, at the time, was just another **Magic** player. Okay, I was making **Magic** puzzles at the time but I hadn't even started doing my freelance writing for *The Duelist* yet. (That would happen later in the summer at Gen Con. You can read about that story [here](/en/articles/archive/making-magic/life-lessons-part-i-2006-02-20-0), in life lesson #5.) I've been working on **Magic** for a long time, but in the beginning I was, like all of you, just a player.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm107_poison1.jpg)Some people don't believe in the existence of love at first sight. I believe those people just haven't experienced the phenomenon. I've often talked about how I'm a Johnny. I love building decks with a challenge to them and poison was right up my alley.
...
![Serpent Generator](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Serpent+Generator)
...
I then started ripping open my *Legends* boosters even faster. More poison. I needed more poison. Alas, [Pit Scorpion](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pit+Scorpion) and [Serpent Generator](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Serpent+Generator) were all I was going to get. *Legends*' poison theme was on two cards. Okay, I was a Johnny. I could adapt. I made some decks. My win ratio was low but I got the taste of poisoning my opponent to death.
...
![Marsh Viper](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Marsh+Viper)

 

Hmm, a creature with poison could give more than one poison counter. I liked. The power level of [Marsh Viper](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Marsh+Viper) matched [Pit Scorpion](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pit+Scorpion) and [Serpent Generator](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Serpent+Generator)—it was low, but I was Johnny and power level scared me not.
...
Quick aside—is getting into **Magic** R&D to do design your end quest? As I mentioned in my column [last week](/en/articles/archive/thank-you-sir-may-i-have-another-2010-08-30) we are going to be doing The Great Designer Search 2. The winner gets a six-month design internship in **Magic** R&D. You can click the link to see all the details, but the biggest take away is make sure to be back here on September 29th to enter.
...
![Swamp Mosquito](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Swamp+Mosquito)

 

One of the things I loved about each new poison card was that they hinted at potential. [Swamp Mosquito](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Swamp+Mosquito), for example, didn't have any power. Normally, 0-power creatures don't win games, but the [Swamp Mosquito](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Swamp+Mosquito) could.
...
As always the power level was low and [Crypt Cobra](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Crypt+Cobra) killed you with damage before it could kill you with poison (a problem *Scars* would tackle) but I felt I was a least pushing in the right direction. I was also on the development team for *Visions* where this card was released:



![SuqAta Assassin](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=SuqAta+Assassin)

 

This was a long time ago so I'm not sure whether I designed this card or just got the fear added, but I was determined to make a poison card that someone who made poison decks would want. As always it wasn't costed aggressively but at least it managed to finally put evasion on a poison creature. (Yeah, yeah [Swamp Mosquito](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Swamp+Mosquito) had flying.) I liked it. Good thing I liked it because **Magic** wasn't going to see another poison creature for ten years! Not for lack of me trying though.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm107_snake1.jpg)The codename for *Tempest* was Bogavhati (Vhati 'il Dal was an Easter egg in the set which referenced the codename). Bogavhati (grossly misspelled by us—the actual name is Bhogavati) is a mythical Hindu land of poisoned snakes. The codename was chosen to specifically play up the strong poison theme. Fifty-eight of the three hundred and thirty cards turned in from design referenced poison on them.


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm107_snake2.jpg)So what happened? At first development just cut down the number. Fifty-eight became thirty-two, then twenty-two, then sixteen, then eight, then four, then two and finally one. Then we had one of our weekly meetings were the topic came up: should we even be supporting poison. It was a weak theme that required tracking a number. The majority of R&D felt as if it didn't have a place in **Magic**. Poison was no longer something **Magic** was going to do.


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm107_snake3.jpg)I won't lie, this was a bit of a setback. But what is a quest if there aren't some obstacles along the way? I wasn't going to let R&D removing the mechanic from the game stop me from making a poison set. I just needed to figure out how I was going to do that.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm107_unglued.jpg)The initial buzz for *Unglued* was very high. So much so that it was decided we were going to do a second one the following year. Known internally as *Unglued II: The Obligatory Sequel*, the set was handed to me. If I wasn't allowed to do poison in "real" **Magic**, then I thought I'd do it in silver bordered world.
...
What you might not know (or know if you read Aaron Forsythe's [articles](http://www.wizards.com/magic/magazine/archive.aspx?author=aaron%20forsythe)) is that I put a third poison card in the design:
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/yt5s4c35esvdfg7iwbrw.jpg)  
  

 
Now is that a card worthy of "Legendary Creature – Dragon Skeleton" or what?


Join me next week when I explain how things like that made it to print.


Until then, may you be a little stubborn when you need to be.
