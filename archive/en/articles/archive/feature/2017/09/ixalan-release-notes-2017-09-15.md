...
---
[Link to Wayback Machine](https://web.archive.org/web/20170915150007/https://magic.wizards.com/en/articles/archive/feature/ixalan-release-notes-2017-09-15)
...
[_metadata_:title]:- "Ixalan Release Notes"
[_metadata_:wayback_capture_timestamp]:- "2017-09-15 15:00:07+00:00"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20170915150007id_/https://magic.wizards.com/en/articles/archive/feature/ixalan-release-notes-2017-09-15"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/feature/ixalan-release-notes-2017-09-15"
---
...
Document last modified July 20, 2017.


**DOC Download Links:**  
[English](http://media.wizards.com/2017/downloads/XLN_Release_Notes/EN_MTGXLN_ReleaseNotes.docx) | [中国话,汉语;中文](http://media.wizards.com/2017/downloads/XLN_Release_Notes/CS_MTGXLN_ReleaseNotes.docx) | [中國話,漢語;中文](http://media.wizards.com/2017/downloads/XLN_Release_Notes/CT_MTGXLN_ReleaseNotes.docx) | [Français](http://media.wizards.com/2017/downloads/XLN_Release_Notes/FR_MTGXLN_ReleaseNotes.docx) | [Deutsch](http://media.wizards.com/2017/downloads/XLN_Release_Notes/DE_MTGXLN_ReleaseNotes.docx)  
[Italiano](http://media.wizards.com/2017/downloads/XLN_Release_Notes/IT_MTGXLN_ReleaseNotes.docx) | [日本語](http://media.wizards.com/2017/downloads/XLN_Release_Notes/JP_MTGXLN_ReleaseNotes.docx) | [한글](http://media.wizards.com/2017/downloads/XLN_Release_Notes/KR_MTGXLN_ReleaseNotes.docx) | [Português](http://media.wizards.com/2017/downloads/XLN_Release_Notes/PT_MTGXLN_ReleaseNotes.docx) | [русский язык](http://media.wizards.com/2017/downloads/XLN_Release_Notes/RU_MTGXLN_ReleaseNotes.docx) | [Español](http://media.wizards.com/2017/downloads/XLN_Release_Notes/ES_MTGXLN_ReleaseNotes.docx)
...
The *Ixalan* set contains 279 cards (20 basic land, 101 common, 80 uncommon, 63 rare, and 15 mythic rare) that appear in booster packs, plus 10 cards available only in *Ixalan* Planeswalker Decks.


Prerelease events: September 23–24, 2017  

Draft Weekend: September 29–October 1, 2017  

Game Day Weekend: November 11–12, 2017


The *Ixalan* set becomes legal for sanctioned Constructed play on its official release date: Friday, September 29, 2017. At that time, the following card sets will be permitted in the Standard format: *Kaladesh, Aether Revolt*, *Amonkhet*, *Hour of Devastation*, and *Ixalan*. Cards from Welcome Decks (and other ancillary products) with the W17 set identification code are also permitted in the Standard format.
...
*Ixalan* Story Spotlight Cards
------------------------------


There are many important moments in the *Ixalan* story, but the five most crucial—called "story spotlights"—are shown on cards. You can read more about these events in the official *Magic* fiction at [mtgstory.com](http://www.mtgstory.com/).


Story spotlight 1: Ixalan's Binding  

Story spotlight 2: Vraska's Contempt  

Story spotlight 3: River's Rebuke  

Story spotlight 4: Thaumatic Compass  

Story spotlight 5: Perilous Voyage
...
![](https://media.wizards.com/2017/xln/en_kQreNok5VK.png)
...
![](https://media.wizards.com/2017/xln/en_g5JIX0IwbO.png)
...
New Keyword Action: Explore
---------------------------


Explore is a new keyword action that appears on thirteen creature cards in the *Ixalan* set. There are also two cards in the set with abilities that trigger "Whenever a creature you control explores." This mechanic isn't associated with a specific faction, and creatures with explore are found in all five colors.


![](https://media.wizards.com/2017/xln/en_gohG04WiSz.png)
...
The official rules for explore are as follows:
...
The rules for double-faced cards haven't changed since their previous appearance in the *Shadows over Innistrad* block.
...
* While a double-faced card isn't on the battlefield, consider only the characteristics of its front face. For example, the above card has only the characteristics of Treasure Map in the graveyard, even if it was Treasure Cove on the battlefield before it was put into the graveyard. Notably, this means that Treasure Map is a nonland card.
* The converted mana cost of a double-faced card is the converted mana cost of its front face, even while it's on the battlefield with its back face up. For example, Treasure Cove has a converted mana cost of 2, even though it's a land with no mana cost. (This rule was introduced with the release of the *Shadows over Innistrad* set.)
* The back face of each double-faced card in the *Ixalan* set is colorless regardless of the color of its front face.
...
* You must clearly mark exactly one box on the checklist card to indicate which double-faced card it represents.
...
New Ability Word: Enrage
------------------------


The only thing better than a Dinosaur is an angry Dinosaur. *Enrage* is an ability word found on some Dinosaur creatures. It indicates an ability that triggers whenever damage is dealt to that creature. An ability word appears in italics and has no rules meaning.


![](https://media.wizards.com/2017/xln/en_wO9xGNUMhW.png)
...
The *Ixalan* set brings back the artifact subtype Vehicle to let you sail the seas in style.


![](https://media.wizards.com/2017/xln/en_gfDHwBBPHF.png)
...
The rules for Vehicles haven't changed since their previous appearance in the *Kaladesh* block.
...
New Artifact Subtype: Treasure
------------------------------


Treasure is a new artifact subtype that appears exclusively on tokens. It**'**s associated with the Pirate faction. There are four versions of the printed Treasure token, each with art of a chest that contains valuables from one of the four factions.


![](https://media.wizards.com/2017/xln/en_BLKANqUD00.png)
...
* Some spells that create Treasure tokens require targets. You can**'**t cast a spell without choosing legal targets. If all of those targets become illegal, the spell is countered and you won**'**t get its Treasure tokens.



---

Rules Change: Planeswalkers Use the "Legend Rule"
-------------------------------------------------


Previously, planeswalkers and legendary permanents were subject to similar but slightly different rules. The official rules under rule 704, "State-Based Actions," were as follows:
...
With the release of the *Ixalan* set, the "planeswalker uniqueness rule" is being removed from the rules, and all previously printed planeswalker cards are receiving errata to add the legendary supertype. All *Ixalan* planeswalker cards are printed with the legendary supertype.


![](https://media.wizards.com/2017/xln/en_TEfbSu9pam.png)


Jace, Cunning Castaway (in *Ixalan* booster packs)  
...
![](https://media.wizards.com/2017/xln/en_wHqxXPqICj.png)


Jace, Ingenious Mind-Mage (in an *Ixalan* Planeswalker Deck)  
...
* If you control two or more legendary permanents with the same English name, choose one and put each other one into its owner's graveyard. This is called the "legend rule."
* Jace, Ingenious Mind-Mage and Jace, Cunning Castaway have different names, so you can control both at the same time.
...
The *Ixalan* set features a cycle of allied-color dual lands to help you make sure you always have the mana that you need. These cards were first printed in the *Magic 2010* core set.


![](https://media.wizards.com/2017/xln/en_Jt9yurxL7m.png)
...
* The enters-the-battlefield abilities of these dual lands check for lands you control with either of the two listed land types, not either of the two listed names. The lands they check for don't have to be basic lands. For example, if you control Scattered Groves (a nonbasic land with the land types Forest and Plains), Rootbound Crag enters the battlefield untapped.
* These dual lands don't have any land types themselves. For example, Rootbound Crag isn't a Forest. A second Rootbound Crag won't enter untapped if you control only Rootbound Crag.
...
![](https://media.wizards.com/2017/xln/en_dXpvfRNxUN.png)
...
![](https://media.wizards.com/2017/xln/en_2S0d70qzYk.png)
...
![](https://media.wizards.com/2017/xln/en_ZgO00izum6.png)
![](https://media.wizards.com/2017/xln/en_0S9PAxGw5M.png)
...
![](https://media.wizards.com/2017/xln/en_8BuR5T4kqb.png)
...
![](https://media.wizards.com/2017/xln/en_kym9E6V1Vd.png)
...
![](https://media.wizards.com/2017/xln/en_5mZiqEekER.png)
...
![](https://media.wizards.com/2017/xln/en_uDtRbs8m1P.png)
...
![](https://media.wizards.com/2017/xln/en_JWL97OP2Uu.png)
...
![](https://media.wizards.com/2017/xln/en_0PPdNFGGoi.png)
...
![](https://media.wizards.com/2017/xln/en_lvIrNYtCaH.png)
...
![](https://media.wizards.com/2017/xln/en_1hSnD5Ppzr.png)
...
![](https://media.wizards.com/2017/xln/en_1Qg0ZyNjGJ.png)
...
![](https://media.wizards.com/2017/xln/en_tINodtCBVd.png)
...
* If the target creature is an illegal target by the time Bright Reprisal resolves, the entire spell is countered. You won't draw a card. If, on the other hand, the target is a legal target but isn't destroyed (most likely because it has indestructible), you'll draw a card.



---

![](https://media.wizards.com/2017/xln/en_C1oC1OiTqv.png)
...
![](https://media.wizards.com/2017/xln/en_P9FMMTi6df.png)
...
3R: Gain control of target creature an opponent controls until end of turn. Untap that creature. It gains haste until end of turn. Activate this ability only any time you could cast a sorcery.
...
![](https://media.wizards.com/2017/xln/en_9ZVXDqDNTO.png)


Castaway's Despair *(Planeswalker Deck only)*  
...
![](https://media.wizards.com/2017/xln/en_G2Bt8GEcNQ.png)
...
* If the target creature is an illegal target by the time Contract Killing resolves, the entire spell is countered. You won't get Treasures. If, on the other hand, the target is a legal target but isn't destroyed (most likely because it has indestructible), you'll get Treasures.



---

![](https://media.wizards.com/2017/xln/en_jU8FiF81jH.png)
...
![](https://media.wizards.com/2017/xln/en_Z9vnrlQdDI.png)
...
![](https://media.wizards.com/2017/xln/en_jWvyPdmUFP.png)
...
* If the target creature or player is an illegal target by the time Dark Nourishment resolves, the entire spell is countered. You won't gain life.



---

![](https://media.wizards.com/2017/xln/en_5BlOFj41dP.png)
...
![](https://media.wizards.com/2017/xln/en_QK2Sa8vzUh.png)
...
* If each target card is an illegal target by the time Deadeye Tracker's ability resolves, the entire ability is countered. Deadeye Tracker won't explore.



---

![](https://media.wizards.com/2017/xln/en_LZaFbMCTHB.png)
...
![](https://media.wizards.com/2017/xln/en_hJ0SvTEDiP.png)
...
![](https://media.wizards.com/2017/xln/en_Cu9bETMyt6.png)
...
![](https://media.wizards.com/2017/xln/en_qUFwFkjWxt.png)
...
![](https://media.wizards.com/2017/xln/en_mH5Nja9ImK.png)
...
![](https://media.wizards.com/2017/xln/en_ugc7TQMVpj.png)
...
![](https://media.wizards.com/2017/xln/en_Ee7YrmKo5j.png)
...
![](https://media.wizards.com/2017/xln/en_t7RdWftJtL.png)
...
![](https://media.wizards.com/2017/xln/en_m0kMO8TGWS.png)
...
![](https://media.wizards.com/2017/xln/en_E3ZKnSXbJa.png)
![](https://media.wizards.com/2017/xln/en_cINU9LtjbR.png)
...
![](https://media.wizards.com/2017/xln/en_EAsB1HfXSz.png)
...
![](https://media.wizards.com/2017/xln/en_4b8OyOmodU.png)
...
![](https://media.wizards.com/2017/xln/en_sDHqEyVZRu.png)
...
![](https://media.wizards.com/2017/xln/en_VOf4twHy3J.png)
...
![](https://media.wizards.com/2017/xln/en_bIRJ8UVJvW.png)
...
![](https://media.wizards.com/2017/xln/en_8YZqEihIrj.png)
...
![](https://media.wizards.com/2017/xln/en_nNu4AGKopL.png)
...
* If two Fleet Swallowers attack, each trigger determines the top half of that player's library separately. For example, if the target player has fifteen cards in his or her library, that player puts the top eight cards into the graveyard, then puts the top four cards into the graveyard.



---

![](https://media.wizards.com/2017/xln/en_ulChNTz1mz.png)
...
![](https://media.wizards.com/2017/xln/en_UnTUyUcwQz.png)


Grasping Current *(Planeswalker Deck only)*  
...
* You may cast Grasping Current without choosing any target creatures. You'll just search for Jace, Ingenious Mind-Mage. However, if you choose any targets and all of those targets become illegal before Grasping Current resolves, the spell will be countered and you won't search.



---

![](https://media.wizards.com/2017/xln/en_dz4uDxN2j5.png)
...
![](https://media.wizards.com/2017/xln/en_5MpazyK4wb.png)
![](https://media.wizards.com/2017/xln/en_NyYNyTtDLS.png)
...
![](https://media.wizards.com/2017/xln/en_o6LPTjzOik.png)
...
![](https://media.wizards.com/2017/xln/en_J87EyxwFSn.png)
...
![](https://media.wizards.com/2017/xln/en_28vminrxJz.png)
...
![](https://media.wizards.com/2017/xln/en_PxlYqa3ZQJ.png)
...
![](https://media.wizards.com/2017/xln/en_urn2CTQWmj.png)


Huatli, Dinosaur Knight *(Planeswalker Deck only)*  
...
![](https://media.wizards.com/2017/xln/en_5FTmAhfoQp.png)
...
* If some (but not all) of the targets become illegal, the original division of damage still applies, but no damage is dealt to illegal targets. If all targets become illegal, the ability will be countered.



---

![](https://media.wizards.com/2017/xln/en_8sisHLOl48.png)


Huatli's Spurring *(Planeswalker Deck only)*  
...
![](https://media.wizards.com/2017/xln/en_rXoEuzjgbw.png)
...
![](https://media.wizards.com/2017/xln/en_u9Gm7DRdGS.png)
...
* You can control one legendary Jace, Cunning Castaway in addition to any number of nonlegendary copies of Jace, Cunning Castaway. See also "Rules Change: Planeswalkers Use the 'Legend Rule'" in the General Notes section of this document.
...
Jace, Ingenious Mind-Mage *(Planeswalker Deck only)*  
...
![](https://media.wizards.com/2017/xln/en_RuaG3NhYTq.png)
...
* Jade Guardian can be the target of its own ability.



---

![](https://media.wizards.com/2017/xln/en_eWnx2KRQWO.png)
...
![](https://media.wizards.com/2017/xln/en_NPS8WefIOD.png)
...
![](https://media.wizards.com/2017/xln/en_AUl9VbPXTg.png)
...
* If Kitesail Freebooter leaves the battlefield before its enters-the-battlefield ability resolves, the opponent will reveal his or her hand, but no card will be exiled.
...
![](https://media.wizards.com/2017/xln/en_tjpm9lUw0o.png)
...
![](https://media.wizards.com/2017/xln/en_ELsHk8phhf.png)
![](https://media.wizards.com/2017/xln/en_smfibkFjaT.png)
...
![](https://media.wizards.com/2017/xln/en_iJZHsnuzaL.png)
...
![](https://media.wizards.com/2017/xln/en_4wUpGt2QHo.png)
...
![](https://media.wizards.com/2017/xln/en_DWRMnr1iaG.png)
...
![](https://media.wizards.com/2017/xln/en_2NCmehnIjg.png)
...
![](https://media.wizards.com/2017/xln/en_aCs28rmzzU.png)
...
![](https://media.wizards.com/2017/xln/en_yhA7T9YOrv.png)
...
![](https://media.wizards.com/2017/xln/en_59sKsxfRnY.png)
...
* If the land this Aura would enchant is an illegal target by the time New Horizons resolves, the entire spell is countered. It won't enter the battlefield, so its ability won't trigger.
...
![](https://media.wizards.com/2017/xln/en_5rdcvyq3pX.png)
...
* If the target permanent is an illegal target by the time Perilous Voyage resolves, the entire spell is countered. You won't scry.
...
![](https://media.wizards.com/2017/xln/en_fwjvkJ6DeV.png)
...
* If the creature this Aura would enchant is an illegal target by the time Pious Interdiction resolves, the entire spell is countered. It won't enter the battlefield, so its ability won't trigger.



---

![](https://media.wizards.com/2017/xln/en_4RR0xWZ9Qt.png)
...
![](https://media.wizards.com/2017/xln/en_2BqpFFb286.png)
...
![](https://media.wizards.com/2017/xln/en_4zqXWg6oS5.png)
...
![](https://media.wizards.com/2017/xln/en_hz81cQLpKQ.png)
![](https://media.wizards.com/2017/xln/en_nwpo11MmZ6.png)
...
![](https://media.wizards.com/2017/xln/en_CrhqxNfbZ3.png)
...
![](https://media.wizards.com/2017/xln/en_iBuUrYKxrz.png)
...
![](https://media.wizards.com/2017/xln/en_8FRtkHLbi2.png)
...
![](https://media.wizards.com/2017/xln/en_jW7miymqTQ.png)
...
* If the target creature is an illegal target by the time Rile resolves, the entire spell is countered. You won't draw a card.



---

![](https://media.wizards.com/2017/xln/en_DhuQjPqsMp.png)
...
![](https://media.wizards.com/2017/xln/en_N6hDAxf5ku.png)
...
![](https://media.wizards.com/2017/xln/en_Okd58Nyuhd.png)
...
![](https://media.wizards.com/2017/xln/en_LI6kQHOGIC.png)
...
2B, Sacrifice a creature: Create two colorless Treasure artifact tokens with "T, Sacrifice this artifact: Add one mana of any color to your mana pool."  
...
![](https://media.wizards.com/2017/xln/en_wetBr8S7zS.png)
...
![](https://media.wizards.com/2017/xln/en_HGxEL3mMy8.png)
...
![](https://media.wizards.com/2017/xln/en_UK76KUgUYf.png)
...
![](https://media.wizards.com/2017/xln/en_m3r0MYxqSK.png)
![](https://media.wizards.com/2017/xln/en_Ino8szLZ1O.png)
...
![](https://media.wizards.com/2017/xln/en_om3PkZGo5v.png)
...
* That player can find fewer basic land cards than the number of exiled creatures, whether because he or she wants to or because he or she doesn't have that many basic land cards left.
...
![](https://media.wizards.com/2017/xln/en_VKVipr3utp.png)
...
![](https://media.wizards.com/2017/xln/en_bGeHXD0yU0.png)
...
![](https://media.wizards.com/2017/xln/en_D41oqXU9Rw.png)
...
![](https://media.wizards.com/2017/xln/en_jvCAf4qnKI.png)
...
![](https://media.wizards.com/2017/xln/en_qmvbJ2LQkK.png)
...
![](https://media.wizards.com/2017/xln/en_CO1f3VzmMN.png)
...
* If the target artifact or enchantment is an illegal target by the time Slice in Twain resolves, the entire spell is countered. You won't draw a card. If, on the other hand, the target is a legal target but isn't destroyed (most likely because it has indestructible), you'll draw a card.



---

![](https://media.wizards.com/2017/xln/en_SCFDEAyX2B.png)
...
![](https://media.wizards.com/2017/xln/en_BTyfarI7Xt.png)
...
![](https://media.wizards.com/2017/xln/en_dXTxJENSpe.png)
...
![](https://media.wizards.com/2017/xln/en_VdWIGLwN7K.png)
...
![](https://media.wizards.com/2017/xln/en_wZkZ5jvNGp.png)
...
![](https://media.wizards.com/2017/xln/en_2C253byaSh.png)
...
![](https://media.wizards.com/2017/xln/en_qMFe2MsMZS.png)
...
![](https://media.wizards.com/2017/xln/en_5tOynBtb9Y.png)
![](https://media.wizards.com/2017/xln/en_SGiJXW9Dw5.png)
...
![](https://media.wizards.com/2017/xln/en_rkztaqCAq3.png)
...
![](https://media.wizards.com/2017/xln/en_C47hkllAv1.png)
...
![](https://media.wizards.com/2017/xln/en_pNabNC2JRu.png)
...
![](https://media.wizards.com/2017/xln/en_ykMZj6wCcj.png)
...
![](https://media.wizards.com/2017/xln/en_iQvb4J1GOT.png)
...
![](https://media.wizards.com/2017/xln/en_5KrvPa90aV.png)
![](https://media.wizards.com/2017/xln/en_9nQVcgTYrC.png)
...
![](https://media.wizards.com/2017/xln/en_ulU2Wn4lKk.png)
...
* If the target creature is an illegal target by the time Verdant Rebirth resolves, the entire spell is countered. You won't draw a card.



---

![](https://media.wizards.com/2017/xln/en_meUgsDytXJ.png)
...
![](https://media.wizards.com/2017/xln/en_HiifuSCplb.png)
...
* Vineshaper Mystic can be the target of its own ability.



---

![](https://media.wizards.com/2017/xln/en_s5gSLJdQiN.png)
...
![](https://media.wizards.com/2017/xln/en_jTImWTGW8L.png)
...
* If the target artifact, creature, or enchantment is an illegal target by the time Vraska's second ability resolves, the entire ability is countered. You won't get a Treasure. If, on the other hand, the target is a legal target but isn't destroyed (most likely because it has indestructible), you will get a Treasure.
...
![](https://media.wizards.com/2017/xln/en_lrdJDXzb6a.png)
...
* If the target creature or planeswalker is an illegal target by the time Vraska's Contempt resolves, the entire spell is countered. You won't gain life.
...
![](https://media.wizards.com/2017/xln/en_UBMBPNXl7u.png)
...
XGG: Put X +1/+1 counters on target land you control. That land becomes a 0/0 Elemental creature with haste. It's still a land.
...
![](https://media.wizards.com/2017/xln/en_JESJUwm86X.png)
...
![](https://media.wizards.com/2017/xln/en_nQgXIAveib.png)
...
*Magic: The Gathering*, *Magic*, *Ixalan*, *Kaladesh*, *Aether Revolt*, *Amonkhet*, *Hour of Devastation*, *Shadows over Innistrad*, *Khans of Tarkir*, and Planeswalker Deck are trademarks of Wizards of the Coast LLC in the USA and other countries. ©2017 Wizards of the Coast.
