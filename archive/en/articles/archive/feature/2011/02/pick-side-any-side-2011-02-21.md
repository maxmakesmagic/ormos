...
---
[Link to Wayback Machine](https://web.archive.org/web/20210303155544/https://magic.wizards.com/en/articles/archive/feature/pick-side-any-side-2011-02-21)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "Welcome to Pick a Side Week. We've asked all of you to pick a side in the Mirran-Phyrexian conflict, so this week all the columnists are going to do the same (or talk about how they went about making their choices). I'm been the most vocal advocate of the Phyrexians, so it's pretty clear I've already chosen my side. I choose Phyrexia. Okay, 62 words in and I've already"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "653316"
[_metadata_:publish_date]:- "2011-02-21"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Pick a Side, Any Side"
[_metadata_:wayback_capture_timestamp]:- "2021-03-03 15:55:44"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20210303155544id_/https://magic.wizards.com/en/articles/archive/feature/pick-side-any-side-2011-02-21"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/feature/pick-side-any-side-2011-02-21"
---
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm131_phyrexian.jpg)Okay, 62 words in and I've already completed my assigned theme. Only 2700+ words to go. Perhaps, I should go into slightly more detail on why I'm choosing Phyrexia or, more accurately, why I've been Phyrexia's greatest cheerleader since the set first premiered. Note that in everything I'm going to say below, I am talking about myself and my opinion, not the opinion of R&D or Wizards at large. Today is about me explaining why I, Mark Rosewater, have picked the Phyrexian side.
...
**Proliferate –** In case I haven't made this point clear in numerous other columns, I am a Johnny. (If you don't know what I'm talking about, go read [my most recent column](/en/articles/archive/making-magic/timmy-johnny-and-spike-revisited-2006-03-20-2) on the psychographics of **Magic**.) I enjoy expressing myself through **Magic** by using my creativity to do my own thing. Because of that, I'm a big fan of open-ended mechanics. That is, I like mechanics that give me a lot of options how to use them. In R&D we tend to refer to these as Johnny mechanics. By far the Johnniest mechanic in *Scars of Mirrodin* block is proliferate. (Proliferate has some Timmy and Spike appeal as well, but if you have to stick it in one psychographic, it's more Johnny than any other.)
...
**Metalcraft –** This is what we call a threshold mechanic in R&D. (I talk all about this in my column during Metalcraft Week, [I Want to Threshold Your Hand (Or Possibly My Artifacts)](/en/articles/archive/i-want-threshold-your-hand-or-possibly-my-artifacts-2010-10-18).) Threshold mechanics tend to lean a little more towards Spike as they are usually resource-management mechanics (manage your resources to make sure that you can have thing X happen). The linearity of metalcraft helps add some Timminess to it.
...
**Indestructible (Darksteel) –** I'm not going to get into my ongoing quest to turn this into a keyword, but I will say I'm still fighting the good fight. I do like indestructible quite a bit as a mechanic (I had a whole column about it during Darksteel Week, [The Darksteel Returns](/en/articles/archive/darksteel-returns-2010-12-13)), so much so that I helped push it to become an evergreen mechanic (R&D slang for something that we can use whenever we want, often appearing in every block). I like how *Scars* block is using it but the fact that it's become a mainstay keeps it from feeling as special as the other mechanics. If I was grading it for all of **Magic**, I'd give it an 8, but for creating excitement in *Scars of Mirrodin* block, it's closer to a 4. It was necessary and I'm glad we used it, but it doesn't do much to make the Mirrodin side more exciting for me.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm131_monitor.jpg)The Phyrexians also hit an archetype that fascinates me. Here's what I said about the archetype [during Proliferate Week](/en/node/652911):
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/stf/stf127_comic2.jpg)But in order for stories to be told, you have to give your heroes some villains. Sure, a few of the planeswalkers are villains, but as comics demonstrate, you need a lot more villains than you need heroes. The heroes stick around but the villains have to come and go, partly because the heroes need to win most of the time and partly because you want to change up your story.
...
That's all I got for today. I hope my reasoning proved interesting. All those who have some commentary on my choice can email me, tweet me (@[maro254](http://twitter.com/maro254)) or can reply in the article thread. I'm guessing their might be a counterpoint to some issues I raised in today's column.
