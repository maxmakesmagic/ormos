...
---
[Link to Wayback Machine](https://web.archive.org/web/20171123235606/https://magic.wizards.com/en/articles/archive/feature/early-september-2009-update-bulletin-2009-09-03)
...
The second update will coincide with the [*Zendikar*](http://archive.wizards.com/magic/tcg/products.aspx?x=mtg/tcg/products/zendikar) Prerelease. That's when the Comprehensive Rules will be hit with a crowbar delicately tuned to incorporate all necessary Zendikariana, and I'll spend some time reviewing the more esoteric Oracle items clogging up my inbox.


This update, on the other hand, covers [*Planechase*](http://archive.wizards.com/Magic/TCG/ProductArticle.aspx?x=mtg/tcg/planechase/productinfo) and [*Masters Edition III*](http://archive.wizards.com/magic/tcg/productarticle.aspx?x=mtg/tcg/mastersed3/productinfo). The *Planechase* planes (plus four extra cards that don't seem to have come from any previously printed set .... Weird ....) are being entered into Oracle, and will thus show up in [Gatherer](http://gatherer.wizards.com/Pages/Default.aspx). So, as long as we're doing an Oracle update, we might as well do an Oracle update. This is certainly nonstandard—Oracle is generally updated only when a new expansion is released—but the [July Update Bulletin](/en/articles/archive/july-2009-update-bulletin-2009-07-08) noted that it was coming.
...
* [Reaping the Rewards](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Reaping+the+Rewards) got a typo corrected. ("Sacrifice" was misspelled in Oracle.)
* [Æther Rift](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=%C3%86ther+Rift) got an obsolete wording updated. ("Discard a card from your hand" changed to just "Discard a card.")
* [Harm's Way](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Harm%27s+Way) got a minor wording correction to help alleviate some confusion. [Shining Shoal](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shining+Shoal) and [Shadowbane](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shadowbane) got the same fix.
...
**Kicker**  
 As printed, kicker cards had abilities that did their thing "if you paid the kicker cost." This was inaccurate (since it didn't matter if *you* paid the kicker cost), so these long ago changed to say "if the kicker cost was paid." But that's still inaccurate. What matters is whether you *choose* to pay the kicker cost as you cast the spell, not whether you actually pay it. Imagine that there's a card that costs ![](https://web.archive.org/web/20211201201921im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless1.gif)![](https://web.archive.org/web/20161227125855im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/white.gif) and has a kicker cost of ![](https://web.archive.org/web/20161225105850im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless2.gif). (Oh, wait—there is.) Now imagine that there's a card that reduces the cost you pay for creature spells you cast by ![](https://web.archive.org/web/20161225105850im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless2.gif). (Oh, wait—there is.) Now put them together. You cast [Ardent Soldier](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ardent+Soldier), you choose to pay the kicker cost, but you wind up spending just ![](https://web.archive.org/web/20211201201921im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless1.gif)![](https://web.archive.org/web/20161227125855im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/white.gif) because you control [Planar Gate](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Planar+Gate). [Ardent Soldier](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ardent+Soldier)'s ability says that it gets a +1/+1 counter if the kicker cost was paid. Well, it wasn't ... but [Ardent Soldier](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ardent+Soldier) still gets the +1/+1 counter because the ability is lying. After the revision, these abilities check whether the spell "was kicked," not whether the cost was paid. It should be much clearer that that's based on the decision rather than the payment mechanics.


**[Harm's Way](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Harm%27s+Way)**  
 This card has two major confusion issues working against it. One involves how it interacts with your opponent's planeswalkers (short answer: badly), which is not getting addressed at this time. The other involves how it interacts with [Pyroclasm](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pyroclasm). If a single source is dealing damage to you and/or creatures you control and/or planeswalkers you control, you can redirect *any 2* of that source's damage. You choose which bits of damage with pinpoint accuracy. So, for example, if you control two [Runeclaw Bear](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Runeclaw+Bear)s and someone casts [Pyroclasm](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pyroclasm), you can save both Bears by redirecting 1 damage [Pyroclasm](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pyroclasm) would deal to Bear A and 1 damage [Pyroclasm](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pyroclasm) would deal to Bear B. But that's really unclear from the wording, so we're tweaking it to help.
...
**[Arcades Sabboth](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Arcades+Sabboth)**  
...
**[Banshee](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Banshee)**  
...
**[Burning of Xinye](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Burning+of+Xinye), [Imperial Edict](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Imperial+Edict), & [Wei Assassins](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wei+Assassins)**  
[Burning of Xinye](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Burning+of+Xinye) is the "*Portal Three Kingdoms* [Wildfire](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wildfire)." Except it's totally not. The printed wording is "You destroy four of your lands and your opponent destroys four of his or her lands. Then [Burning of Xinye](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Burning+of+Xinye) deals 4 damage to each creature. *(This includes your creatures.)*" This is quite different from [Wildfire](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wildfire). The lands are destroyed, not sacrificed. And on other *Portal* cards, "your opponent" has been interpreted quite consistently as meaning "target opponent," so it'd be wildly arbitrary for this one to hit "each player" instead ... especially if your teammate gets caught in the crossfire. 
...
[Imperial Edict](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Imperial+Edict) and [Wei Assassins](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wei+Assassins) were also printed with "destroy" wordings that had migrated over to "sacrifice" in Oracle because of the similarity they bore to other cards (specifically [Cruel Edict](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cruel+Edict)). But they're changing back too.


*New [Imperial Edict](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Imperial+Edict) wording*  
 Target opponent chooses a creature he or she controls. Destroy it.


*New [Wei Assassins](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wei+Assassins) wording*  
 When Wei Assassins enters the battlefield, target opponent chooses a creature he or she controls. Destroy it.


**[Call to Arms](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Call+to+Arms) & [Jihad](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Jihad)**  
 A few issues here. As printed, [Call to Arms](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Call+to+Arms) referenced "cards," so it shouldn't look at tokens. More importantly, [Call to Arms](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Call+to+Arms) would be buried in the event of a tie for most common color; that's not true with the wording it's had in Oracle. And less importantly (but more pedantically), the printed card stopped granting the bonus as soon as the condition wasn't true. [Jihad](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Jihad)'s getting the same fix on the third point.


*New [Call to Arms](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Call+to+Arms) wording*  
...
*New [Jihad](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Jihad) wording*  
...
**[Cosmic Horror](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cosmic+Horror)**  
 As printed, [Cosmic Horror](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cosmic+Horror) was destroyed, not sacrificed, if you didn't pay. The new wording also flows better (IMO) than what was there.
...
**[Dance of Many](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dance+of+Many)**  
...
**[Divine Intervention](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Divine+Intervention)**  
 This card was a victim of "Oracle drift"; it had functionally changed in Oracle for no discernable reason. It behaved differently if the last counter is removed by [Æther Snap](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=%C3%86ther+Snap), for example. So it's being undriftified.
...
**[Gauntlets of Chaos](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gauntlets+of+Chaos)**  
...
**[Halfdane](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Halfdane)**  
...
**[Hazezon Tamar](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hazezon+Tamar)**  
...
Although the printed wording isn't very clear, I came to believe that the ability is supposed to create a delayed triggered ability when Hazezon enters the battlefield, not be a "beginning of upkeep" trigger that looks into the past (as it is in Oracle). The Oracle wording has the bizarre ramification that if I cast [Hazezon Tamar](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hazezon+Tamar), then on your next turn you [Mind Control](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mind+Control) it, no one gets any tokens at all! And that just can't be right, so that's getting changed too.
...
**[Illusionary Mask](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Illusionary+Mask)**  
 What a weird, weird card. Under the original rules in place for this card, a face-down creature is what it actually is ... it was just face down. So, for example, if you had a face-down [Lord of the Pit](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lord+of+the+Pit), and your opponent tried to [Terror](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Terror) it (because how would she know it was black?) the [Terror](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Terror) would be an illegal play. "It doesn't work." "Why not?" "It just doesn't." It would live through [Infest](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Infest). It would eat a creature during each of your upkeeps. This had some implementation problems, as you might imagine. Around the time the morph-filled *Onslaught* came out, the rules for face-down cards changed, and this card changed accordingly. But what it changed to was quite arbitrary, and didn't match what the card said at all.
...
**[Kjeldoran Frostbeast](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kjeldoran+Frostbeast)**  
...
**[Kobold Overlord](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kobold+Overlord)**  
 The Oracle wording is functionally different than the printed wording with regard to subtype changing effects. As printed, [Kobold Overlord](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kobold+Overlord) would have first strike even if something caused it to stop being a Kobold; that's not true of the Oracle wording.
...
**[Rohgahh of Kher Keep](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rohgahh+of+Kher+Keep)**  
 More Oracle drift ....
...
1. As printed, the control change affected all [Kobolds of Kher Keep](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kobolds+of+Kher+Keep), not just the ones you control.
2. As printed, the creatures became tapped before changing control.
3. The intervening-unless clause is weird (as also seen on [Cosmic Horror](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cosmic+Horror)'s Oracle wording that we're getting rid of).
...
**[Spoils of Victory](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Spoils+of+Victory)**  
 And this is the Oracle driftiest card I've ever seen! The printed card had you search your library for a [Plains](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Plains), [Island](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Island), [Swamp](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Swamp), [Mountain](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mountain), or [Forest](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Forest) card. The Oracle wording had you search for a basic land card, as if those were the same thing! [Tundra](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tundra) has something to say about that ... .
...
**[The Tabernacle at Pendrell Vale](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=The+Tabernacle+at+Pendrell+Vale)**  
...
**[Voodoo Doll](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Voodoo+Doll)**  
 Another sacrifice/destroy discrepancy. Also, the printed card implies that you don't destroy [Voodoo Doll](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Voodoo+Doll) if the damage it would deal to you is prevented.
...
**113.2**  
 This left out [Circu, Dimir Lobotomist](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Circu%2C+Dimir+Lobotomist), whose abilities target a zone.
...
**120.3, 704.5s**  
 A new state-based action added just for [Rasputin Dreamweaver](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rasputin+Dreamweaver). If it has too many counters, the excess ones are removed.
...
**509.1g-h**  
 The former rule had an erroneous clause ("an effect says that it becomes unblocked") deleted; that doesn't affect block*ing* creatures. The latter rule had a similar phrase moved from a parenthetical into the body of the rule.
...
**601.2a, 603.3**  
 These rules didn't account for the possibility that some external effect might cause a spell or ability to leave the stack (like [Time Stop](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Time+Stop) or [Venser, Shaper Savant](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Venser%2C+Shaper+Savant)).
...
**614.9**  
 This rule was covering [Sphere of Law](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sphere+of+Law) (for example) just fine, but wasn't covering [Daunting Defender](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Daunting+Defender) correctly at all. It's been revised, and an example was added.
...
**Various examples**  
 I changed "[Grizzly Bears](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grizzly+Bears)" to "[Runeclaw Bear](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Runeclaw+Bear)" because it's singular.
...
* [Introduction](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/feature/54b&page=1)
* [Oracle Changes](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/feature/54b&page=2)
* [Comprehensive Rules Changes](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/feature/54b&page=3)
