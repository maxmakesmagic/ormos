...
---
[Link to Wayback Machine](https://web.archive.org/web/20170502220004/http://magic.wizards.com/en/articles/archive/dynamics-turn-2006-11-24)

[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "117933"
[_metadata_:path_date]:- "2006-11-24"
[_metadata_:publish_date]:- "2013-12-03"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "The Dynamics of a Turn"
[_metadata_:wayback_capture_timestamp]:- "2017-05-02 22:00:04"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20170502220004id_/http://magic.wizards.com/en/articles/archive/dynamics-turn-2006-11-24"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/dynamics-turn-2006-11-24"
---
...
![The letter G!](https://web.archive.org/web/20160213022424im_/http://archive.wizards.com/magic/images/dropcap_G.jpg)reetings and welcome back to the little column we like to call Magic Academy. Once again, I am your host Ted Knutson. In the past two articles, we have covered [the anatomy of a **Magic** card](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/academy/2) and discussed [building your first deck](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/academy/3). Now that you've got a feel for your cards and have enough of a deck to get up and running, it's time to talk about actually playing. Today we are going to build on your knowledge by explaining the phases and steps of a turn, and then walking you through a turn or two against an imaginary opponent to show how a game typically progresses. Remember that, like the previous installments in this series, this one article isn't intended to do everything on it's own. You won't be a contender for the World Championships after this one article. But, what you *will* have is enough of a feel for how the turn works to start working your own way through games and getting the experience you need to learn more.


### Just the FAQs, ma'am


![](https://media.wizards.com/legacy/magic/images/academy/4_rulebook.jpg)All right, to start this adventure, allow me to point to two handy resources that you may not have accessed before, but that you will want to be aware of now and in the future. The first handy resource is the [basic rulebook](http://archive.wizards.com/magic/rules/mtg9edrulebook_en.pdf) (1 MB pdf). This is what I expect you to have some knowledge of as we stride forward into the great unknown. While I am going to repeat some of the information contained therein, it's possible that what we discuss today will be moderately confusing if you haven't walked through the basic rulebook at least once. The rulebook is written in an easy-to-understand fashion, and the info there is still good for an occasional refresher course even for the more advanced player. If questions should arise during your early playing days, go to the section of the basic rulebook that talks about whatever subject you are having a problem with and see if the answer presents itself.


The next, slightly-more-daunting resource is the Comprehensive Rules, which [can be found here](http://archive.wizards.com/Magic/TCG/Article.aspx?x=magic/rules/tourneyplayer). This is where the in-depth rules for tournament players can be found, and it's designed to answer pretty much any question that would arise in the course of *any* **Magic** game. Of course, when you are new to the game, it can also be like slapping you upside the head with a baseball bat of information overload, so for now just expect me to touch on the basics.
...
![Glorious Anthem](http://gatherer.wizards.com/Handlers/Image.ashx?size=small&type=card&name=Glorious%20Anthem&options=)
...
![Icy Manipulator](http://gatherer.wizards.com/Handlers/Image.ashx?size=small&type=card&name=Icy%20Manipulator&options=)
...
![](https://media.wizards.com/legacy/magic/images/academy/4_eot.jpg)
...
Say you have an Elvish Piper in play and tap it during the end of turn step (players will often just call this the "end step" for short) to put a Viashino Sandstalker into play.




![Elvish Piper](http://gatherer.wizards.com/Handlers/Image.ashx?size=small&type=card&name=Elvish%20Piper&options=)
...
Ben is squaring off against Opie in the battle of the kitchen table. Ben is playing [our Green/Red deck from last week](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/academy/3), while Opie has his own black/white concoction. The board currently looks like this:


**Ben** (cards in hand): Giant Growth, Llanowar Elves, Trained Armodon, Verdant Force, Forest  
![](https://media.wizards.com/legacy/magic/images/academy/4_board1.jpg)  
...
*Second Main Phase*: Ben casts another Trained Armodon, and a Llanowar Elves.
...
![](https://media.wizards.com/legacy/magic/images/academy/4_board2.jpg)
...
![](https://media.wizards.com/legacy/magic/images/academy/4_counterspell.jpg)Nothing yields an enormous stack quite like a counterspell war. For those of you interested in a sample mammoth stack, check out this monster from a match during German Nationals in 2003, pictured to the right.


One of the classic "end of turn" decks of all time was Astral Slide, piloted to a Pro Tour victory by Osyp "Joe Black" Lebedowicz. Here's a nasty [Astral Slide mirror match from round 13 of Pro Tour--Venice](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=sideboard/ptven03/fm13) where both players are doing tons of stacking and using end of turn triggers in a battle for a Top 8 slot, showing the kinds of things you'll be capable of as you get more comfortable with how turns work.


For those of you interested in more information about "priority," might I suggest reading [this classic judge article by Lee Sharpe](http://ww2.wizards.com/Site/LeavingWizards.aspx?url=http://www.starcitygames.com/php/news/article/9252.html) that even includes a handy dandy flowchart and introduces the advanced concept of "Last Known Information" as well.
