...
---
[Link to Wayback Machine](https://web.archive.org/web/20200921125904/https://magic.wizards.com/en/articles/archive/feature/multikick-seat-pants-2010-01-25)
...
Welcome to *Worldwake* Previews, Week II. [Last week](/en/articles/archive/and-land-played-2010-01-18) I talked about how we tweaked the land theme. This week I'm going to talk about how we tweaked everything else. But before we get to all of that, how about starting off with the preview card. Let's start this article with a bang.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/tcg/products/worldwake/f6iruav68e_EN.jpg)


I guess I should begin by making sure you understand what multikicker does. Here it is in a nutshell. You know how kicker works? It's like that, except there's no limit on how many times you can kick it. (The famous [" **[CENSORED]**  without  **[CENSORED]** "](/en/articles/archive/cycling-round-track-2009-02-23) turns out to be "kicker without limits.") Also remember that multikicker enhances the spell it's on, meaning that all the improvements are still on the one spell. (Probably the biggest difference, by the way, between multikicker and replicate, but more on this in a bit.) This will matter for things like counterspells.
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm75_wolfTokenTops.jpg)Our internal phrase was "Multikicker takes kicker to 11." (If you don't get that reference, go rent *This Is Spinal Tap*. No, really.) Any given kicker cost always has one of two states: kicked and not kicked. A multikicker cost has an infinite number of possibilities.
...
I have no problem doing kicker-like mechanics, because [as I've explained](/en/articles/archive/making-magic/here%E2%80%99s-kicker-2007-06-11), many mechanics are essentially kicker. But even I have to draw the line when kicker is in the set. Besides, augment was much more exciting as multikicker.
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm75_evolutionVatWithmultikicker.jpg)So multikicker was invented during *Zendikar* design. How did it end up being introduced in *Worldwake*? The mechanic was handed off from design to development in the *Zendikar* file. As development played with the set, they realized that it had a little more going on than it needed. The development team came to the conclusion that bringing back kicker was exciting in and of itself. What if multikicker was held off until *Worldwake*? This would give *Worldwake* something new, while helping give *Zendikar* a little room to grow. It also allowed *Zendikar* to focus on kicker's return rather than its evolution.
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm75_mimeofractureSlice.jpg)For those of you that might not have played four years ago, in *Guildpact* there was a mechanic called replicate (it was the keyword mechanic of the blue-red Izzet guild). Here are a few examples:


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm75_4Cards1.jpg)The idea behind Replicate was that you could pay the replicate cost as any times as you wanted to make copies of the spell. In *Guildpact* (the only set to ever have replicate), the replicate costs always matched the mana cost of the spell.
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/tcg/products/worldwake/j3joamnzq3_EN.jpg)
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/tcg/products/worldwake/n3u62f8rdp_EN.jpg)
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/tcg/products/worldwake/tujfcoz12y_EN.jpg)
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/tcg/products/worldwake/xb0vuv8lxb_EN.jpg)
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/tcg/products/worldwake/h7x6iulis5_EN.jpg)
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/tcg/products/worldwake/vaow3eks1f_EN.jpg)
...
As I'm at the mercy of the Visual Spoiler on the [*Worldwake* product page](http://archive.wizards.com/Magic/TCG/Products.aspx?x=mtg/tcg/products/worldwake), there are a few other innovations that we did that I can't show you quite yet.
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm75_someArt.jpg)The recent revelation for us is that what players really want for the second set is further explorations of the things introduced in the first set. When we introduce a brand-new, unrelated thing we are doing so at the cost of further block development. Remember that the new thing can always be used next year, but further advancements have to wait many years until we re-explore the mechanic.
