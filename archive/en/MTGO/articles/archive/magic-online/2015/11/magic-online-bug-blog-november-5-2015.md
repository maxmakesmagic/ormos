...
---
[Link to Wayback Machine](https://web.archive.org/web/20151107212132/http://magic.wizards.com/en/MTGO/articles/archive/magic-online/magic-online-bug-blog-november-5-2015)
...
[_metadata_:node]:- "822896"
[_metadata_:publish_date]:- "2015-11-05"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Magic Online Bug Blog November 5, 2015"
[_metadata_:wayback_capture_timestamp]:- "2015-11-07 21:21:32"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20151107212132id_/http://magic.wizards.com/en/MTGO/articles/archive/magic-online/magic-online-bug-blog-november-5-2015"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/MTGO/articles/archive/magic-online/magic-online-bug-blog-november-5-2015"
---
...
Expect the next Bug Blog on Thursday, November 19!
...
There's a little bit of everything in this week's edition of the Bug Blog: a list of fixes that went out in last week's deployment, a list of upcoming fixes, and a few new known issues.


In addition to updates, we've made some layout changes to the Bug Blog in the hopes of making it easier to navigate. Just click on the buttons below to view each section!
...
* Cardset | Cards put into the graveyard with [Kiora, Master of the Depths](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kiora%2C+Master+of+the+Depths)’s second loyalty ability do not properly trigger the second ability of [Sidisi, Brood Tyrant](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sidisi%2C+Brood+Tyrant).
* Cardset | Converge cards do not indicate how many colors of mana were spent to cast the spell.
* Cardset | [Kiora, Master of the Depths](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kiora%2C+Master+of+the+Depths)’s second loyalty ability does not properly put all cards into the player’s Revealed Cards area.
* Cardset | Mana generated by [Shrine of the Forsaken Gods](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shrine+of+the+Forsaken+Gods)’s second ability can’t be spent on face-down creature spells.
* Cardset| Premium lands from *Unhinged* are missing the animation that other premium cards have.
* Cardset | The landfall ability of [Emeria Shepherd](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Emeria+Shepherd) is incorrectly not optional.
...
* Cardset | A bug will be resolved that occasionally causes a crash if a player cast a face-down card, turned a face-down creature face up, or targeted a face-down creature with a spell or ability.
* Collection | Changes made to decks will properly sync if a player logs on *Magic Online* on a different computer, except when moving cards between main deck and sideboard.
* Collection | A bug will be resolved that makes it so that, the first time a player tries to sort a deck, the deck will not become sorted. In the meantime, attempting to sort the deck a second time will correctly sort it.
* Duel Scene | Blocking requirements that can’t be met will no longer cause games to be unable to proceed past declaration of blockers.
...
| Sideboard Issues:
 ...
 and
 Sideboard | Extra cards are sometimes added to a player's deck in addition to their choices when Sideboarding. | These issues seem to be tied to the player's computer going to sleep during deckbuilding. Preventing the computer from hibernating may alleviate these issues.
   |
...
| Gameplay Known Issues, with Scheduled Fix | [Client Known Issues, with Scheduled Fix](#scheduledclient) |
...
[Return to Top](#list)
 ...
 Collection | Changes made to decks will properly sync if a player logs on *Magic Online* on a different computer, except when moving cards between main deck and sideboard.—scheduled 11/11


|  |
| --- |
| Client Known Issues, with Scheduled Fix |
| Cardset | A bug will be resolved that occasionally causes a crash if a player cast a face-down card, turned a face-down creature face up, or targeted a face-down creature with a spell or ability.—scheduled 11/11 |
|
| Collection | A bug will be resolved that makes it so that, the first time a player tries to sort a deck, the deck will not become sorted. In the meantime, attempting to sort the deck a second time will correctly sort it.—scheduled 11/11 |
| Duel Scene | Blocking requirements that can’t be met will no longer cause games to be unable to proceed past declaration of blockers. —scheduled 11/11 |
...
| Cardset | The planeswalkers from *Magic Origins* now have the correct card frames.—fixed 10/7 |
| Chat | A toast messaging informing players that an opponent has started a chat no longer appears for each message sent during a match.—fixed 10/7 |
| Collection | New items now automatically appear in player collections as soon as those items are received. Players no longer have to manually refresh to view new items.—fixed 10/7 |
| Collection | Players can no longer create a binder that exceeds the 50,000-card limit by importing a deck.—fixed 10/7 |
| Collection | Text files created with the Export Deck function no longer sometimes display the same card name on multiple lines.—fixed 10/7 |
| Collection | Untradable avatars can no longer be added to a trade binder. —fixed 10/7 |
| Duel Scene | A bug has been resolved that caused creatures to deal incorrect amounts of damage during replays.—fixed 10/7 |
| General | Several bugs not listed elsewhere that caused crashes have been resolved. Additionally, viewing premium cards for which the art has not yet loaded no longer causes a crash.—fixed 10/7 |
| General | The image that appears on the *Magic Online* home screen no longer gets cut off if the window is resized.—fixed 10/7 |
| Leagues | The default sort order for Leagues standings is now number of match wins in descending order.—fixed 10/7 |
