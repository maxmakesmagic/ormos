...
![](https://media.magic.wizards.com/image_legacy_migration/global/images/magic_expansion_coldsnap_expansionLogo_en.jpg)As is our tradition for the Monday after a new set's prerelease events, today we post the full card list for a set right here on the front page of **magicthegathering.com**. Here is the sortable spoiler list for *Coldsnap*. Enjoy! 


**[Launch the *Coldsnap* card list](http://archive.wizards.com/default.asp?x=magic/cardlist/coldsnap)**


 [Or launch *Coldsnap* in Gatherer](http://gatherer.wizards.com/default.asp?setfilter=Coldsnap&output=Spoiler) 
