...
---
[Link to Wayback Machine](https://web.archive.org/web/20210502051824/https://magic.wizards.com/en/articles/archive/cycling-round-track-2009-02-23)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "Welcome to Cycling Week! Wait, you say, didn't we already have a Cycling Week in late March of 2004? Very good, we can't get anything by you. We did. But much as cycling was the first `block` keyword to be repeated so too is Cycling Week the first theme week to be repeated."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "656896"
[_metadata_:publish_date]:- "2009-02-23"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Cycling Round the Track"
[_metadata_:wayback_capture_timestamp]:- "2021-05-02 05:18:24"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20210502051824id_/https://magic.wizards.com/en/articles/archive/cycling-round-track-2009-02-23"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/cycling-round-track-2009-02-23"
---


Cycling Round the Track
=======================
...
Welcome to Cycling Week! Wait, you say, didn't we already have a Cycling Week in late March of 2004? Very good, we can't get anything by you. We did. But much as cycling was the first "block" keyword to be repeated so too is Cycling Week the first theme week to be repeated. (I can already see the letters pointing out all the other repeat theme weeks we've done.) 


Speaking of repeating things, before I dive into today's topic, I want to encourage all of my readers who have any interest in what we're doing with this year's core set (and we're doing a few things unlike any previous core sets) to check out [Aaron Forsythe's feature article](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/feature/27a) today. While my column should be a fun read, Aaron's article is what everyone's going to be talking about. Seriously, check it out.
...
[A Cycling Built For Two](/en/articles/archive/making-magic/cycling-built-two-2004-03-22) – This is the column I wrote during the first Cycling Week and it goes into good detail about how the mechanic got created and what the early versions of it looked like. 


[Cycling Cycling](/en/articles/archive/making-magic/cycling-cycling-2002-09-16) – This was the column I wrote when cycling returned in *Onslaught*. In it I explain why we bring back mechanics. 


[Birth of a Notion](/en/articles/archive/making-magic/birth-notion-2003-05-05) – This column talked about the evolution of landcycling as it was introduced in Scourge. 


[Enchantment Better Things, Part Two](/en/articles/archive/making-magic/enchantment-better-things-part-two-2007-07-02) – This was one of my "talk about the design of individual cards from the new set" columns. Under the section on Lighting Rift I explain how we came up with the idea to have things trigger off of things being cycled. 


[When Worlds Collide, Part II](/en/articles/archive/when-worlds-collide-part-ii-2009-01-26) – This column was just a few weeks ago during Conflux previews when I touch upon how basic land cycling came to be. 


[Zen and the Art of Cycle Maintenance](/en/articles/archive/making-magic/zen-and-art-cycle-maintenance-2002-07-08) – This column actually isn't about cycling but the word "cycle" in the title throws people. It's about designing cycles (most often five-card cycles, but there are other kinds; read the column if you're interested). A good column but not remotely connected to this week's theme.


You'd think my work would be done for today. I'm pointing you to over ten thousand words about cycling. But no, I have vowed to always stay on theme week topic (okay there was [that one time](/en/articles/archive/making-magic/unhinged-or-no-2004-04-05-0) but outside forces could not be avoided) and I always provide new content (provided it's not a holiday that Wizards takes off or the repeat weeks during winter break). As such, I am obligated to produce a cycling-relevant article today. What could I write about?
...
![](https://media.magic.wizards.com/image_legacy_migration/company/images/richard.jpg)  
This guy.


He's famous for playing [the first game ever of **Magic**](/en/articles/archive/whatever-happened-barrys-land-2009-02-09) with Barry Reich. That and, oh you know—HE DESIGNED **MAGIC**! Yes, the creator of cycling also designed a few famous cards such as [Island](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Island) and [Swamp](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Swamp). You might know him as Richard Garfield.


[A Cycling Built For Two](/en/articles/archive/making-magic/cycling-built-two-2004-03-22) goes into greater detail if you want it. The short version is that Richard made the mechanic during *Tempest* design. *Tempest* design had too much going on in it so a bunch of stuff was cut to be used later. For cycling, "later" turned out to be the next year in *Urza's Saga*. (Echo, the other named keyword mechanic in *Urza* block, was also created in *Tempest* design—by Mike Elliott). 
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm27_cyclingText.jpg)  
...
|  |  |
| --- | --- |
| Drifting Djinn | Sandbar Serpent |
...
|  |  |
| --- | --- |
| Polluted Mire | Slippery Karst |

Lands are crucial at a certain stage and can be near useless at another. 


The goal of the initial cycling cards was to get cards into players' decks that might normally not make it in. This is why I feel cards like [Expunge](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Expunge) were a design failure, as you seldom would cycle them, and even when you did out of necessity it made you feel so bad.


![EXPUNGE](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Expunge)  
*Urza's Saga* did have one cycling card that wasn't like the rest though. This card:


![FLUCTUATOR](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Fluctuator)  
[Fluctuator](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fluctuator) was unique in several ways. First, it was the only card to have the word "cycling" appear its rules text that did not itself cycle. Second, it was the only card in the set that encouraged more than one cycling card to be played together. Cycling by its nature is very modular, meaning that each card does not make you want to play any other cards in particular. Third, it was the only card that peeked ahead at where cycling might be headed. Notice, for example, that the card doesn't make cycling free, it cuts the cost by ![](https://web.archive.org/web/20161225105850im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless2.gif). This show we were aware that there was a difference and that someday we'd make use of that difference. But other than [Fluctuator](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fluctuator), cycling was as basic as mechanics come in its first outing. This is not in any way a bad thing. It shows some actual restraint from design.


### *Urza's Legacy*


While *Urza's Legacy* had ten more cards with cycling, it added nothing new to the mix. Every card had cycling ![](https://web.archive.org/web/20161225105850im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless2.gif) and nothing else in the set referred to cycling.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm27_urzasLMoreThanTwo.jpg)  
### *Urza's Destiny*
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm27_urzasDMoreThanTwo.jpg)  
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm27_urzasD2MoreThanTwo.jpg)  
The idea behind these cards was "cycling from play." You pay ![](https://web.archive.org/web/20161225105850im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless2.gif), lose the card from the zone in questionm and then draw a card. These cards followed a similar theme from the original cycling cards. They went onto cards whose importance can change over time. [Heart Warden](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Heart+Warden), for example, is great in the early game when you need the mana but can become useless later when you have tons of lands in play and what you need is an answer to break through a stalemate. Three of the cards ([Marker Beetles](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Marker+Beetles), [Plague Dogs](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Plague+Dogs) and [Yavimaya Elder](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Yavimaya+Elder)) cross with another theme of the set, "leaves play" effects.
...
**Cycling Costs Other Than ![](https://web.archive.org/web/20161225105850im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless2.gif)**


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm27_onslaughtMoreThanTwo.jpg)  
This first advancement was merely us taking the obvious step that everyone assumed we were going to in *Urza's Legacy*: cycling costs other than ![](https://web.archive.org/web/20161225105850im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless2.gif). This included cycling costs with colored mana in them. Note that we still restricted ourselves to cycling cost involving mana. (Non-mana costs as we will see comes later.)


**Cycling that Comes with Effects**


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm27_onslaught2MoreThanTwo.jpg)  
...
Another interesting story is that when we first came up with cycling effects, we had some discussion about how countermagic didn't work against them. Some members of R&D felt that it was wrong, mostly because players might not get that counterspells didn't work. Others of us—I was in this group—felt like counterspells deserved having problem cards just like any other card in **Magic**. (Remember I was the man who designed [Scragnoth](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Scragnoth), the first "can't be countered" spell.) In the end, we went with the cleanest, simplest version that coincidentally hosed control decks. We were okay with that.


**Cards that Trigger off of Cycling**


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm27_onslaught3MoreThanTwo.jpg)  
This last innovation was only on five cards (few people noticed that it was an uncommon cycle) but its presence was felt strongly. These cards did not cycle, they merely had an effect when another card cycled. These "cycling enablers" allowed player to build cards centered around having a lot of cycling cards. In the case of two of them, [Astral Slide](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Astral+Slide) and [Lightning Rift](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Rift), they spawned tournament-level decks.
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm27_legionsMoreThanTwo.jpg)  
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm27_scourgeMoreThanTwo.jpg)  
...
![DRAGON WINGS](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Dragon+Wings)  
...
This set didn't really have any cycling, but as [Twisted Abomination](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Twisted+Abomination) was on the timeshifted sheet, the completist in me felt I should list it. Obviously, when the only cycling card is a reprint, no innovation is going on.
...
|  |  |
| --- | --- |
| Homing Sliver | Vedalken Aethermage |
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm27_shardsMoreThanTwo.jpg)  
...
![VISCERA DRAGGER](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Viscera+Dragger)  
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm27_confluxMoreThanTwo.jpg)  
These cards continue the tutoring line of cycling design as a different form of mana fixing. As I explained in my column when I first [talked about basic landcycling](/en/articles/archive/when-worlds-collide-part-ii-2009-01-26), this is definitely us bleeding the color pie. By default this is green's domain and we have to be careful only to push into it when we have heavily colored sets with significant mana-fixing issues such as *Conflux* with its five-color subtheme. 
