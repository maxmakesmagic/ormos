...
---
[Link to Wayback Machine](https://web.archive.org/web/20160329134833/http://magic.wizards.com/en/articles/archive/making-magic/return-investment-part-2-2012-09-10)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "Hello and welcome to the second week of Return to Ravnica previews. Last week, I talked all about things we did prior to Return to Ravnica's design, but today it's finally time to actually get to the work we did in the design itself. Today, I'm going to walk you through the five guild keywords and how we came up with them. Also, I have a fun preview card to show off, so let's stop wasting time and get to it."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "656246"
[_metadata_:publish_date]:- "2012-09-10"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Return on Investment, Part 2"
[_metadata_:wayback_capture_timestamp]:- "2016-03-29 13:48:33"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20160329134833id_/http://magic.wizards.com/en/articles/archive/making-magic/return-investment-part-2-2012-09-10"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/making-magic/return-investment-part-2-2012-09-10"
---
...
Hello and welcome to the second week of *Return to Ravnica* previews. [Last week](/en/node/656216), I talked all about things we did prior to *Return to Ravnica*'s design, but today it's finally time to actually get to the work we did in the design itself. Today, I'm going to walk you through the five guild keywords and how we came up with them. Also, I have a fun preview card to show off, so let's stop wasting time and get to it.


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm212_1_5e36bibfjc.jpg)Art by [Chippy](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22Chippy%22%5D)
...
This meant that the key factor to making everything work was to latch onto the exact same thing we used last time we were on Ravnica—the guilds. Last we saw, there was a dissension of the Guildpact on Ravnica. I'll let the story folk explain how we got [from there to here](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/feature/210a), but suffice it to say we knew the guilds were going to be the drivers of the design.


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm212_2_vklmvsg7nf.jpg)This meant that the first part of design was figuring out what new things each guild was going to do. For starters, I made the call that every guild was going to have a new keyword. We talked about having a mix of new and returning keywords, but the problem was that, due to the effect of cramming so much into so little space, along with [New World Order](/en/node/654416) complexity issues, each guild could only have one keyword. We felt that if some got new ones while others got old ones, that it would feel unfair to the guilds without new keywords.


Also, as I talked about in [this year's State of Design column](/en/node/656121), one of the biggest challenges was finding a way to combine nostalgia with a sense of novelty. Having new keywords allowed us to do something new while still getting the guild feel we needed. We talked about using returning non-guild keywords (for example, unearth is *so* Golgari) but I felt strongly that each guild needed something brand new. We did look at a few *Future Sight* future-shifted mechanics (like delve) but none seemed a perfect fit, so we never had to answer the "Are cards already previewed from the future new?" question.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm212_3_7rxtwtbx8s.jpg)Art by [Chris Rahn](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22Chris%20Rahn%22%5D)
...
We knew going into *Return to Ravnica* that the Izzet were still going to be the most spell-centric guild. This meant we had to find a spell-based mechanic for them, something that would go on instants and/or sorceries. Luckily, Ken already had one in his back pocket. In fact, he had submitted it five years earlier as one of the finalists from the first *Great Designer Search*. (Ken, by the way, talked a great deal about the design of the Izzet and Golgari mechanic in his feature last week, so I'll only be hitting the high notes here. [Please read his article](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/feature/211a) for even more detail.)


 


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm212_nagle_0bp42hntod.jpg)*Check out out all the drama from [The Great Designer Search](/en/articles/archive/great-designer-search-episode-2-%E2%80%93-%E2%80%9Cgimme-five%E2%80%9D-2006-11-02)*
Ken called the mechanic dispersion, and it was modeled after the *Torment* card [Radiate](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Radiate).
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm212_4_k4adl5lr82.jpg)| Art by [Christopher Moeller](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22Christopher%20Moeller%22%5D)
...
1. It was broken.
2. It was *really* broken.
3. It encouraged weird deck building, where you were trying to get as many different types of tokens into your deck as you could.
...
1. Make more token-making cards than populate cards. Also, up the "as-fan" (R&D speak for how often they show up in boosters with rarity skews accounted for) of token cards by sticking them at lower rarities.
2. In general, make more token-making cards than normal.
3. Whenever possible, try to put both effects on the same card. This way there is a built-in use for the populate effect on the card itself. Skew these types of populate cards at lower rarities since they can stand alone.
4. Skew populate cards that only populate at higher rarities and at higher costs to decrease players being able to cast populate spells without having anything happen.
...
![Trostani, Selesnya's Voice](https://media.magic.wizards.com/image_legacy_migration/images/magic/tcg/products/rtr/s21dmypgg0_en.jpg)
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm212_5_dv4insruix.jpg)Slitherhead | Art by [Greg Staples](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22Greg%20Staples%22%5D)
...
|  |  |
| --- | --- |
| Sluiceway Scorpion | Dreg Mangler |
...
1. +1/+1 counters do a good job of reminding you what you need to know. Three counters? The creature has +3/+3. Having other information tied to those counters—this creature has deathtouch or this creature flies—proved to be mentally taxing.
2. The complexity issue along with rules issues made it hard to make scavenge cards with abilities other than keywords.
3. The increased power level made us have to cost the cards even worse and scavenge already had the problem that the mechanic looked far worse than it was.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm212_6_tpn6zuy99j.jpg)Art by [Kev Walker](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22Kev%20Walker%22%5D)
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm212_7_5npb6ixvuh.jpg)White likes order. Blue likes knowledge. Put them together and you have one super uptight guild whose greatest weapon is bureaucracy. If you control and understand the rules, you can make the world work the way you want it to work.
...
The sub-team was led by [Mark Globus](http://archive.wizards.com/magic/magazine/archive.aspx?author=Mark%20Globus) and included Ken and developers [Dave Humpherys](http://archive.wizards.com/magic/magazine/archive.aspx?author=Dave%20Humpherys) and [Billy Moreno](http://archive.wizards.com/magic/magazine/archive.aspx?author=Billy%20Moreno). After a bunch of meetings, the sub-team came up with the detain mechanic (created by Mark Globus, I believe). The concern at the time was that detain wasn't very splashy. It played well and felt very Azorius, but there was worry.
...
Until then, may you [find the guild that suits your personality](/en/articles/archive/quiz-2012-06-04).
