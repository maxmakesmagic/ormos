...
---
[Link to Wayback Machine](https://web.archive.org/web/20220118202219/https://magic.wizards.com/en/articles/archive/feature/cue-%E2%80%9Cjaws%E2%80%9D-theme-music-2006-03-16)
...
![Oath of Ghouls](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Oath+of+Ghouls)While we may not be as Shark infested as Flores's New York City (*New York City!?*), Virginia has had its share of Pro Tour predators and I've rubbed up against a few. I've recurred [Spike Feeder](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Spike+Feeder) every turn with [Oath of Ghouls](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Oath+of+Ghouls) against Kyle Rose's Sligh deck. I've Plowed Under Pete Lieher's Hoodwink deck into oblivion, and I've Aura Mutated Donnie Gallitz's [Parallax Wave](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Parallax+Wave) during combat to turn his assault into an ambush. Looking back, I've actually had fair success against pro players when I've played them on a local level, but obviously these guys knew how to take it up a notch and play at a higher level when they wanted to.
...
Once I posted something I called the “[School of Card-Disadvantage](http://groups.google.com/group/rec.games.trading-cards.magic.strategy/browse_thread/thread/6ed26e4d892d8989/50c4c6ddf35cde0a?q=School+of+Card+Disadvantage&rnum=1#50c4c6ddf35cde0a),” in June of 1998: 



> 
> *“[Cursed Scroll](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cursed+Scroll) rewards bad play. How can you reward someone from dropping their hand, which goes against the basic rules of good Magic play? They should never had made a card like that."* – some control playing-weenie head
> 
> 
...
> 
> 
> ...Now, with the Rath Cycle, WotC has ingeniously and insidiously taken the School of Card Advantage to task, by making the School of Card Disadvantage competitive. That's where cards like [Cursed Scroll](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cursed+Scroll), [Scalding Tongs](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Scalding+Tongs), and [Ensnaring Bridge](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ensnaring+Bridge) come in, rewarding players for going out on a limb, for taking a chance of being devastated by a Card Advantage spell and gaining a tangible benefit. For a long time speed just wasn't fast enough to beat Card Advantage control; now speed has gained some weapons...
> 
> 
...
A few other old school names chimed in on the thread—Eric “edt” Taylor, the incomparable John Shuler (“*It is now, of course, my personal mission to beat you in a Standard sanctioned match with a [Scalding Tongs](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Scalding+Tongs)*”), and even Jamie Wakefield. It was amusing was how quickly people began referring to [Cursed Scroll](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cursed+Scroll) and [Ensnaring Bridge](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ensnaring+Bridge) strategies as “School of Card Disadvantage”... and how much that term drove Flores nuts.
...
[Two Headed Giant Champs](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=events/magic/champs) is this weekend, and I'm playing in it alongside local Limited specialist Josh Adams, who has spent ridiculous time drafting and playing Sealed online. Together, we are team Jolly Green. We've actually done some play testing, and I suppose I could talk about what we've learned about the format.


1. This is not “classic” 2HG (like what you play on ***Magic** Online*); it's quite a bit different so make sure you read up on the rules!
2. Play all of your landwalkers. Yes, even the little Blue crocodile.
3. Filling out your curve with low-cost dorks isn't as important as it is in a duel. You've got 40 life, which translates to a lot more time than you're used to in Sealed or Draft.
4. Bombs are nice, but synergy is better, and cross-deck synergy rules supreme. I'm talking my deck's [Flickerform](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Flickerform) on your [Izzet Chronarch](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Izzet+Chronarch) peanut butter and chocolate goodness.
5. Main deck enchantment removal is rarely useless.

Hm. That doesn't exactly make for a whole article, does it? 


![Life/Death](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Life%2FDeath)Casting about for ideas, I decided to approach Ted “Crushing Blow” Knutson. As my editor for a while over on Star City, I figured he as much as anyone would know what sort of strategy article I might be in a good position to write about. His response?
...
Jamie Wakefield has a long history of being the Green Mage, but Wakefield's style of Green was always quite different from my own. Jamie liked to summon huge monsters and smash face. His philosophy was “the last fattie you can't deal with wins.” Green's aggressive cards didn't really draw me. I liked Green's utility and flexibility in cards like [Survival of the Fittest](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Survival+of+the+Fittest), [Crop Rotation](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Crop+Rotation), [Spike Feeder](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Spike+Feeder), [Birds of Paradise](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Birds+of+Paradise), [Weatherseed Treefolk](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Weatherseed+Treefolk), and [Eternal Witness](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Eternal+Witness). I even liked non-Green cards like [Sensei's Divining Top](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sensei%27s+Divining+Top) that merely played well with Green!
...
Okay, armed with some self-analysis and feedback from my friends, I decided to delve into the colors Green and Black and see what it was about them that gave me strength. Naturally, that brings me to Mark Rosewater and his analysis of the Color Wheel. In [It's Not Easy Being Green](/en/articles/archive/making-magic/its-not-easy-being-green-2002-10-21-0) (Oct 2002), Mark wrote Green's “*end goal is simply to let the natural way evolve. Green, in its heart, wants nothing more than to sit back and watch life unfurl around it. Thus, Green's ultimate goal is growth. Green would be happiest in a world where nature has been allowed to run rampant.*” When I play **Magic** and am at my happiest, the games have unfurled and the battle is engaged on many fronts. My game plan and that of my opponent have run rampant, and may the best plan win.
...
3
[Scandalmonger](https://gatherer.wizards.com/Pages/Search/Default.aspx?name=+%5BScandalmonger%5D)
...
3
[Saber Ants](https://gatherer.wizards.com/Pages/Search/Default.aspx?name=+%5BSaber%5D+%5BAnts%5D)
...
![Darkest Hour](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Darkest+Hour)In the year or two before this, I had turned from the pure Green path looking for help with some of Green's weaknesses, and Black often held the answers. Roswater had this to say in [In The Black](/en/articles/archive/making-magic/black-2004-02-02) (Feb, 2004): “*To accomplish its goals, Black seeks power... Black uses whatever tools are available.*” When it came to Green's inability to deal with opposing creatures, I would splash Black for [Terror](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Terror) or [Smother](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Smother). When my creatures kept dying to my opponent's creature control, I turned to Black for [Living Death](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Living+Death), [Oath of Ghouls](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Oath+of+Ghouls), and [Oversold Cemetery](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Oversold+Cemetery). When they reprinted [Perish](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Perish) in the base set, that most grossly unfair color hoser of all time, I turned to Black for [Darkest Hour](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Darkest+Hour) as insurance. 
 Green and Black filled in each other's holes quite nicely, allowing me to cover any bases I felt needed to be covered, depending on the environment at the time. I turned to that color combination again and again over the years, most recently in last year's Top 8 performance with my Dredge deck[\*](#footnote). Looking over Rosewater's look at the philosophy of the Golgari ([Life and Death](/en/articles/archive/making-magic/life-and-death-2005-10-24-0), Oct 2005), they and I fit hand in glove: *“Green and Black, for instance, are the two colors most adept at manipulating the graveyard and taking advantage of its resources. They are also the two colors that use their link with the graveyard to make use of recursion, consistently reusing their threats... Green builds. Black destroys. Green is symbiotic. Black is parasitic... Black/Green realizes that nature's secret weapon is its ability to recover from harm. If you recognize death as but a piece of the bigger picture, you realize that nothing can ultimately stop you. Sure, things can slow you down temporarily, but combine growth with death and you start creating an unstoppable army.*”
...
The year after winning States, I made a second run at a repeat and ultimately ended up in 4th place (see [A Fine Day at Virginia State Champs, Pt 1](http://www.starcitygames.com/php/news/article/914.html) and [Pt 2](http://www.starcitygames.com/php/news/article/913.html)). 
...
2
[Tectonic Break](https://gatherer.wizards.com/Pages/Search/Default.aspx?name=+%5BTectonic%5D+%5BBreak%5D)
...
The most feared play in Fires decks was a [Saproling Burst](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Saproling+Burst) coming down with a [Fires of Yavimaya](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fires+of+Yavimaya) in play. [Wax/Wane](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wax%2FWane) gave me a maindeck answer to that while not being useless against decks playing no enchantments. [Power Matrix](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Power+Matrix) gave the deck extra reach, allowing me to win fights and punch damage through. The two tweaks gave me an undefeated record for the mirror match up without diluting the power of the deck too much against other matches.


The game plans for both decks were quite different, but there are some obvious common elements. Birds and Elves are a must in all the builds I do well with; Green's acceleration is something I've always loved, because I like playing the more expensive splashy spells. I also obviously loved [Rishadan Port](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rishadan+Port)s, since they treated me so well in my winning States deck; Ports + mana acceleration is a match made in heaven. 


For 2005 Champs, [choosing a Dredge deck](http://www.starcitygames.com/php/news/article/10708.html) happened to be a potent choice against the many control decks that had arisen to fight the Boros menace. [Wrath of God](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wrath+of+God) just wasn't that scary when I could “draw” a creature from my graveyard each turn afterwards. If all I'm looking for is good times and occasional success on a local level, there's nothing wrong with specializing in a color, colors, or type of deck. Some people prefer control decks, some prefer Red decks. The problem is that strength is also a weakness if you want to reach for something bigger.


![](https://media.magic.wizards.com/image_legacy_migration/sideboard/images/worlds05/poy_kenji.jpg)As an illustration, let's look at 2005 Pro Tour Player of the Year Kenji Tsumura and the Constructed decks he's played over the past year or so. Here's a quick rundown:
...
During [Grand Prix Richmond](/en/articles/archive/event-coverage/day-1-blog-archive-2006-02-05), I spent a lot of time at the gunslinging tables, playing a bunch of different decks. Most of the decks I selected were builds I was comfortable with - “Bennie decks” that I could play fairly well on instinct. One deck was quite different—Adrian Sullivan's original Eminent Domain build. This thing was completely alien to me and my play style... and yet the more I played it, the more those differences came into focus. The rhythm of the deck, its relentless quest to slowly but surely set up a devastating [Wildfire](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wildfire) from which your opponent will never recover, was something fresh and new for me. Deciding whether or not to [Remand](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Remand) a spell, whether or not I should kill a creature right away or cast [Annex](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Annex), using my life total as a measure of how many turns I had so I could plan accordingly, I feel playing that deck allowed me to grow as a player. 
...
\*speaking of Dredge, doesn't the mechanic remind you a lot of [Weatherseed Treefolk](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Weatherseed+Treefolk) and [Rancor](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rancor), two of my all-time favorite Green cards?
