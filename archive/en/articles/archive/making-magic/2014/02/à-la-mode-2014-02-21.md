...
---
[Link to Wayback Machine](https://web.archive.org/web/20150710060647/http://magic.wizards.com/en/articles/archive/making-magic/%C3%A0-la-mode-2014-02-21)
...
[_metadata_:node]:- "208951"
[_metadata_:publish_date]:- "2014-02-21"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "À La Mode"
[_metadata_:wayback_capture_timestamp]:- "2015-07-10 06:06:47"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20150710060647id_/http://magic.wizards.com/en/articles/archive/making-magic/%C3%A0-la-mode-2014-02-21"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/making-magic/%C3%A0-la-mode-2014-02-21"
---
...
It's also very important for these type of choice spells—well, all choice spells—that there is an interesting choice to be made by the caster of the spell. If the player will choose the same mode the vast majority of the time, the choice card is not living up to its potential, play-wise.
 ...
 While [Fortify](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fortify) is the example of a basic modal card, there are a number of variations: 

**Charms**

  
 We'll begin with charms. These are cards that give the caster not two, but three choices. The first [charms showed up in *Mirage*](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;name=+%5BCharm%5Damp;set=+%5B%22Mirage%22%5D) and were monocolored. Since then, we've done various multicolor charms, with the latest showing up in [*Return to Ravnica* block](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;name=+%5BCharm%5Damp;block=+%5B%22Return%20to%20Ravnica%22%5D). Because charms have three effects to choose from, they tend to be a little smaller in nature, which makes them have a bit of a different feel. 
...
![](https://media.wizards.com/images/magic/daily/mm/2014/fireandice.jpg)  
 ...
 Because of the layout, split cards are allowed to be a bit more varied in their effects, and it is not as crucial that the two cross over aesthetically. This is because the flavor of the card is that it's actually two cards. If anything, the thing that links the cards together is the name, as split cards are always named as \_\_\_\_\_\_\_ amp; \_\_\_\_\_\_\_. When designing split cards, we always start with the names, as they are the hardest thing to do. We then design to the names. 
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=370802)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=370802)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=3150)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=3150)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=23106)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=23106)  
 The granddaddy of this type of spell is the kicker mechanic. There were a few individual spells like [Taste of Paradise](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Taste+of+Paradise), above, from *Alliances*, that did this before kicker came around, but kicker is what put this section on the map. Kicker first appeared in *Invasion* and allowed the caster to spend more mana to boost the spell in some way, most often making a larger version of the effect. This means that, as with split cards, each effect comes with a different cost. 

 The trick to designing a good kicker spell is to find an effect that will have different value at different times in the game. For example, [Kavu Titan](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kavu+Titan) should often be played at whatever cost you are able to pay for it. There's a very famous story in Ramp;D back when I used to play in the [Future Future League](http://archive.wizards.com/magic/magazine/Article.aspx?x=mtg/daily/ld/260). Randy Buehler gave me a mono-green deck to play and I went 4–0. After that week, Randy informed me that the [Grizzly Bears](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grizzly+Bears) in my deck were actually [Kavu Titan](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kavu+Titan)s. The next week I went 2–2. The big lesson was that I needed to treat my [Kavu Titan](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kavu+Titan)s like [Grizzly Bears](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grizzly+Bears) when I only had two mana but as a 5/5 trampler when I had five. 

 The best kicker designs have that quality, where they hold value at both costs. Like modal spells, it's okay if each of these costs is higher than you would pay if the card only had a single effect. For example, we make strictly better than ![](https://web.archive.org/web/20211201201921im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless1.gif)![](https://web.archive.org/web/20220123123600im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/green.gif) for a 2/2 in most sets yet having a Grizzly Bear with the upside that it's a 5/5 trampler later in the game is quite a bargain. 

**Multikicker**

[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=197769)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=197769)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=96864)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=96864)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=158689)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=158689)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=370535)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=370535)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=4843)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=4843)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=50299)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=50299)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=197)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=197)  
The most basic type of spell in this category is an X spell. This is a spell that allows the caster to choose some amount of colorless mana that is then used to define an aspect of the spell. X spells started back in Alpha and show up in just about every set.
 ...
 The key to designing an X spell is to figure out some variable that can exist at any number chosen. That variable, though, can be used on very different aspects of the spell. Also, as [Fireball](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fireball) above shows, sometimes the mana spent can be used for more than one variable. 

**Amplify**

[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=42278)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=42278)  
 Amplify was a creature mechanic from *Legions* that allowed you to add +1/+1 to the creature for each card in your hand of a certain creature type you revealed. Amplify differs from X spells in that the resource used to set the variable isn't mana. The trick to designing amplify creatures was to try and make creatures where the power was relevant. Sometimes this meant adding a creature keyword like trample or flying. Other times, as with [Daru Stinger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Daru+Stinger) above, it meant giving the creature an ability that cared how many +1/+1 counters were on the creature. Amplify had a limited design space and only makes sense in a set with a strong tribal theme. 

**Devour**

[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=174968)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=174968)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=74201)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=74201)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=5692)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=5692)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=41142)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=41142)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=376323)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=376323)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=130325)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=130325)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=152963)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=152963)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=87341)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=87341)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=87992)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=87992)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=107379)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=107379)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=1017)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=1017)  
 The granddaddy of this type of card is [Primal Clay](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Primal+Clay) from *Antiquities*, where the caster was given three different options of what he or she could get. A lot of cards like this these days are done with an optional cost and they appear up above in the Variable Spell section. 

**Morph**

[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=39492)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=39492)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=35891)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=35891)  
