...
---
[Link to Wayback Machine](https://web.archive.org/web/20170516042022/http://magic.wizards.com/en/articles/archive/latest-developments/second-landfall-2010-01-22)

[_metadata_:author]:- "Tom LaPille"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "647181"
[_metadata_:publish_date]:- "2010-01-22"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "The Second Landfall"
[_metadata_:wayback_capture_timestamp]:- "2017-05-16 04:20:22"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20170516042022id_/http://magic.wizards.com/en/articles/archive/latest-developments/second-landfall-2010-01-22"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/latest-developments/second-landfall-2010-01-22"
---
...
When we print a mechanic for the first time, we like to do simple implementations of it. The biggest reason is that it takes time for players to get comfortable with a new mechanic. Starting out with complicated cards using a mechanic gives a player no time to internalize how the mechanic works, and makes it hard for them to process everything. There is also a secret reason that we like to start simple. **Magic**'s designers and developers are also human, and need time to get comfortable with unfamiliar new cards. Therefore, starting out simple serves the same purpose for us: we get to know the basics of the mechanic well, which lets us design and develop more correctly.


Take, for example, the cycle of landfall creatures in *Zendikar*.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/ld/ld74_5Cards1.jpg)Once one makes the decision to use landfall as a major mechanic in one's set, it makes a lot of sense to have a cycle of common creatures that use it. However, there are lots of ways to implement such a cycle. You could decide that each of the creatures gains some keyword ability on landfall, and end up with a loose cycle whose cards are not obviously related to each other. The simplest version, however, was to have each card in the cycle receive the same bonus. Those versions are simpler for us to work with while we begin to understand the mechanic, and often end up being easier for players to hold in their heads as well.
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/ld/ld74_wwkTransition.jpg)Now, on to Worldwake. It shouldn't surprise you that we still did some simple landfall cards in Worldwake. For now, though, we're doing our best to show you the coolest stuff, so I don't have any simple landfall cards to show you. However, I can show you this simple card that interacts well with landfall, which **Magic** developer Mike Turian spoiled on [his Twitter feed](/en/articles/archive/event-coverage/2008-12-06-0) two days ago.


![Explore](https://media.magic.wizards.com/image_legacy_migration/mtg/images/tcg/products/worldwake/yjnvuovfoe_EN.jpg)(Aside: I'll also be spoiling a card on [my own Twitter feed](http://twitter.com/tomlapille) sometime Friday morning. Perhaps you should be ready!)
...
![Tideforce Elemental](https://media.magic.wizards.com/image_legacy_migration/mtg/images/tcg/products/worldwake/j3joamnzq3_EN.jpg)This card's effect isn't complicated, nor does it have the potential for causing memory issues. However, it creates tricky situations in gameplay, as I learned recently while playing Limited with the first bunch of physical *Worldwake* product that arrived inside R&D. My opponent and I were in a complicated race; he had three creatures of varying sizes out, while I had a Tideforce Elemental and two other creatures of different sizes. After my draw step, I had both a [Harrow](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Harrow) and a [Scalding Tarn](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Scalding+Tarn) in my hand.
...
![Admonition Angel](https://media.magic.wizards.com/image_legacy_migration/mtg/images/tcg/products/worldwake/8bjdgc5ifh_EN.jpg)This card featured very prominently in our testing of *Zendikar* / *Worldwake* Constructed. I will not claim that it is not powerful, because that would be a lie. However, we are confident that it is safe to print. Perhaps you will open one at your *Worldwake* Prerelease and exile a bunch of your opponents' permanents. Hopefully none of your opponents will do that to you.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/ld/ld74_dbufasiuyv5dx.jpg)Now, let's talk about my preview card, which is another over-the-top landfall card. *Worldwake* is about lands coming alive. Because of this, we wanted to make some kind of "land lord"- a creature with a landfall ability that made your lands better. Here's the text box from the first version we made.
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/ld/ld74_beads.jpg)However, we also realized a depressing phenomenon. These comments come from Ken Nagle, Mike Turian, me, Ken, and Alexis Janson respectively.
...
| It's awesome! | 4328 | 48.3% |
| It's good. | 2852 | 31.8% |
| It's okay. | 1323 | 14.8% |
| It's bad. | 216 | 2.4% |
| It's terrible! | 250 | 2.8% |
| **Total** | **8969** | **100.0%** |
