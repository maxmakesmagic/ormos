...
---
[Link to Wayback Machine](https://web.archive.org/web/20221002005840/https://magic.wizards.com/en/articles/archive/latest-developments/nerd-gamer-christmas-2012-05-11)

[_metadata_:author]:- "Zac Hill"
[_metadata_:description]:- "The week or so before a Pro Tour has always been my favorite time of year. It's like nerd gamer Christmas, but with hundreds of thousands of dollars on the line! You never know what you're going to find underneath the tree. Maybe it's an awesome sideboard strategy—like cascading into the same spell every turn, which we brainstormed for our five-color control deck at Pro Tour"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "645011"
[_metadata_:publish_date]:- "2012-05-11"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Nerd Gamer Christmas"
[_metadata_:wayback_capture_timestamp]:- "2022-10-02 00:58:40"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20221002005840id_/https://magic.wizards.com/en/articles/archive/latest-developments/nerd-gamer-christmas-2012-05-11"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/latest-developments/nerd-gamer-christmas-2012-05-11"
---


Nerd Gamer Christmas
====================
...
The week or so before a Pro Tour has always been my favorite time of year. It's like nerd gamer Christmas, but with hundreds of thousands of dollars on the line!


You never know what you're going to find underneath the tree. Maybe it's an awesome sideboard strategy—like cascading into the same spell every turn, which we brainstormed for our five-color control deck at [Pro Tour Honolulu 2009](/en/events/coverage/mitamura-finds-gold-paradise). Maybe it's finding that super-sweet kill card for an engine you already know is *so painfully close* to perfect, like [Mirror Entity](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mirror+Entity) was in the "Elves!" deck that swept [Pro Tour Berlin 2008](/en/node/502416). Maybe it's brewing up a whole new deck altogether, like the out-of-left-field [Tooth and Nail](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tooth+and+Nail) Rock list that Marijn Lybaert, Bill Stark, and I piloted at [Pro Tour Valencia 2007](/en/events/coverage/fortier-reigns-spain). One thing is for sure: despite all the time you've spent practicing and practicing and practicing, tuning and tuning and tuning, perfecting every single card in the deck you *think* you want to play, that last week always changes everything.


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/ld/ld194_logo.jpg)*[Watch the Coverage](http://www.wizards.com/magic/tcg/events.aspx?x=mtg/event/protour/avacynrestored12) This Weekend*
...
**Magic** is really hard to understand. I am really, really glad our Multiverse records aren't public, because the amount of *totally* wrong things I've said about a card before I've played with it is embarrassing. Most of us have had a comparable experience to some extent, I think. I remember time and again at a Prerelease how many cards I thought were going to be bananas that just never took off, or how many [Tarmogoyf](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tarmogoyf)s and [Psychatog](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Psychatog)s and (yep, [take a look at the archives](/en/articles/archive/latest-developments/skullclamp-we-hardly-knew-ye-2004-06-04)) [Skullclamp](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Skullclamp)s went *completely* unnoticed at first.


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/ld/ld194_cal.jpg)[Call of the Herd](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Call+of+the+Herd) | Art by [Carl Critchlow](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+%5B%22Carl+Critchlow%22%5D)


As such, a lot of the tendency in new environments is just to stick with what's already working. Some of this is practical: you only have so much time to playtest, after all, and any time you devote to a flawed idea is time that goes to waste. But some of this is an overemphasis on inertia, or an under-appreciation of how innovative your opponents are likely to be. My first Pro Tour—[Pro Tour New Orleans 2001](http://www.wizards.com/sideboard/event.asp?event=ptnor01)—came right after the release of *Odyssey*, which most players at the tournament (including myself) denounced as incredibly weak—that is, until Tomi Walamies and his [Call of the Herd](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Call+of+the+Herd) made a good show of proving us wrong. Similarly, when it comes to Limited, it's easy to miss how much of a difference one set can make. I remember [Pro Tour Prague](/en/events/coverage/osawa%E2%80%99s-wurms-flog-prague), when *Dissension* came out, and a lot of us were left dumbfounded by why our strategies weren't working. [Selesnya Evangel](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Selesnya+Evangel) and its ilk were some of the most powerful cards in *Ravnica*- *Ravnica*-*Guildpact*, but wound up largely being traps one set later in *Ravnica*-*Guildpact*-*Dissension*.



![Call of the Herd](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Call+of+the+Herd)
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/ld/ld194_see.jpg)[Seedtime](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Seedtime) | Art by [Rebecca Guay](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+%5B%22Rebecca+Guay%22%5D)


Inevitably, certain new cards are heralded as format-defining and Earth-shaking when in reality they merely edge the environment in a certain direction. I can't count how many times some new card was lauded as "the death of (insert deck here)" only to prove little more than a minor annoyance. It sounds hysterical in retrospect, but [Seedtime](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Seedtime) was supposed to just annihilate all of the [Fact or Fiction](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fact+or+Fiction) decks by punishing them for casting spells on your end step. The card wound up being fine, but it's not like drawing a ton of cards at instant speed *stopped* being good, or anything.
...
An even more effective strategy is to occasionally dig up a deck that *used* to be good a while back but dropped off the radar for whatever reason. Maybe a new card came out six months ago that really punished the deck, or maybe it was so fragile that anyone gunning for it could beat it if they tried. You know what, though? Sometimes, people forget about Dre. Conditions change, and a deck becomes good again. The classic example here is when Team ChannelFireball unearthed the [Tempered Steel](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tempered+Steel) deck from *Scars* Block Constructed to just tear a hole in [Worlds 2011](/en/events/coverage/japan-stands-tall-worlds-again). The deck never really did much after that, but it was very well-positioned for that specific weekend.
...
I remember playtesting for [Pro Tour Hollywood](/en/events/coverage/gindy-puts-name-lights), and coming up with all of these [Torrent of Souls](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Torrent+of+Souls) decks that just had the awesomest draws on paper. I remember trying endlessly to make [Giantbaiting](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Giantbaiting)/[Bramblewood Paragon](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bramblewood+Paragon) work, and a hundred million different lists with [Tribal Forcemage](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tribal+Forcemage) and real winners like [Uktabi Drake](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Uktabi+Drake).


All of that was cute, but eventually my team made me come to my senses, and the deck we chose to play at the tournament was a very straightforward Faeries list featuring four copies of [Thoughtseize](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Thoughtseize) in the main deck.
...
Avacynian Priest
 ...
 | </sites/all/modules/custom/wiz_legacy_migration/flipcard/flip.html?ca=Loyal%20Cathar&cb=Unhallowed%20Cathar&lang=en> |

Along those same lines, it's very easy to think about drafting as this complex mini-game of signals, predictions, color-assignments, "pass-cuts" (where you intentionally pass your neighbor a better card in the same color you intend to move into), and all of this other stuff that doesn't matter nearly as much as *drafting a good deck*. To use *Innistrad*-*Dark Ascension* draft as an example: yes, you want to know how to draft [Gnaw to the Bone](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gnaw+to+the+Bone) and [Burning Vengeance](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Burning+Vengeance) and [Curse of the Bloody Tome](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Curse+of+the+Bloody+Tome) and all of that, but you also need to realize when you're getting passed a bunch of [Loyal Cathar](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Loyal+Cathar)s and [Avacynian Priest](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Avacynian+Priest)s and should attack for 2 points of damage over and over again until your opponent dies.
...
I look forward to chatting with all the players this weekend—including a lot of my old teammates—and getting their takes on how the environment has played out. I can't wait to see how things shake out. I hope you get a chance to check us out, either here on DailyMTG.com or over at [TwitchTV](http://www.twitch.tv/magicprotour), to catch a glimpse of this weekend's Pro Tour action firsthand!
