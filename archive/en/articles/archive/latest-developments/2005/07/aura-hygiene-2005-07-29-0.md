...
---
[Link to Wayback Machine](https://web.archive.org/web/20210502142755/https://magic.wizards.com/en/articles/archive/latest-developments/aura-hygiene-2005-07-29-0)

[_metadata_:author]:- "Mark Gottlieb"
[_metadata_:description]:- "Hey folks. Aaron “wasn't available” to write his column this week (contrary to all the rumors, it's nothing to be concerned about—as soon as Brian Schneider brings back the piñata, we'll be ready to start the intervention), so he asked me, as a beloved website alumnus, to fill in for him. What Aaron was going to do, and what I'll be doing instead, is talk to the Magic Rules"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "612931"
[_metadata_:publish_date]:- "2005-07-29"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Aura Hygiene"
[_metadata_:wayback_capture_timestamp]:- "2021-05-02 14:27:55"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20210502142755id_/https://magic.wizards.com/en/articles/archive/latest-developments/aura-hygiene-2005-07-29-0"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/latest-developments/aura-hygiene-2005-07-29-0"
---
...
![Spirit Link](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Spirit+Link)If you haven't looked at the [*Ninth Edition* card file](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=magic/cardlist/9e) yet, you're probably asking “What Auras?” or “What's an Aura?” or some other question that involves the words “what” and “Aura.” Aura is the new enchantment subtype that encompasses all local enchantments: creature enchantments, land enchantments, everything. In fact, the term “local enchantment” no longer exists—it's been replaced by the word “Aura.” And so has “creature enchantments.” And “land enchantments.” They're all grouped together under one subtype. Any enchantment that gets attached to some kind of permanent is an Aura, just like any artifact that gets attached to some kind of creature is an Equipment.Here's the deal: Enchantments that get attached to other stuff now all say “Enchantment — Aura” in their type lines instead of “Enchant [whatever].” That line still exists, but it's been moved to the text box where it belongs. It's now rules text. The word “enchant” is now a keyword like “equip” is (though they work pretty differently).
...
![Confiscate](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Confiscate)**1. *All* enchantments say “enchantment” on the type line.**  
 This is about the point when you should be wondering, “Hey… When's MaGo going to be funny? Where are all the wacky decks? Wait—He's become a corporate tool! MaGo sold out!” No, no. I was never funny. I *told* you my chimpanzee wrote all my [House of Cards](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/columnarchive&column=HouseofCards) columns. That you didn't believe me until now is your own fault.**2. *All* targeted spells say “target” in the text box.**  
