...
[_metadata_:node]:- "657111"
[_metadata_:publish_date]:- "2009-04-20"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Goldfingers"
[_metadata_:wayback_capture_timestamp]:- "2021-04-21 11:54:40"
...
Welcome to the second, and last, *Alara Reborn* Preview Week. Last week I talked about the difficulties of an all-gold design (once again let me stress that by "gold" I am referring to traditional multicolor cards requiring two or more different colored mana to cast). This week I am going to explain how the team solved these problems. And somewhere in the middle of me doing this, I'll show off a preview card. Sound good? Then let's get to it.


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/mm/mm34_swnyvl4xfm.jpg)  
  

 
One quick note before I jump into the thick of things. I am planning on using cards for the *Alara Reborn* [Visual Spoiler](/en/node/641856) to make points. I will hide all cards, forcing you to hit a link to reveal them. If you do not want to see any of the cards, please don't hit the links.
...
This problem in a nutshell is that multicolor cards have problems doing simple effects because the need to make the card feel relevant to both colors forces extra abilities and thus more text. As I explained last week, you can't just make a [Counterspell](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Counterspell). It has to be a [Counterspell](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Counterspell) with some rider that explains why its not mono-blue.
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/tcg/products/alarareborn/8zbnetu32s_EN.jpg)
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/tcg/products/alarareborn/916i62u5u1_EN.jpg)
...
Yes, there is the capability of designing something new through the combination of parts. My personal favorite multicolor design is the card [Recoil](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Recoil).
...
This card has raised a few eyebrows because of its first ability. [Nicol Bolas, Planeswalker](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Nicol%2BBolas%252C%2BPlaneswalker) can destroy any noncreature permanent. This translates to artifacts, enchantments, lands, and planeswalkers. Remember that the card is blue-black-red. Destroying artifacts seems fine. Red can do that. Lands too, as both black and red have land destruction in their slices of the color pie. Planeswalkers are acceptable if you think of direct damage as a means of destroying planeswalkers, and red, and to a lesser extent black, can do that. But that leaves us with enchantments. Blue, black, and red all lack enchantment destruction in the color pie. Only white and green can do that, neither of which shows up in Bolas's mana cost. So how does [Nicol Bolas, Planeswalker](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Nicol%2BBolas%252C%2BPlaneswalker) do that?


The answer is that you're looking at the card in the wrong way. Here's the holistic approach. Does the design feel like [Nicol Bolas, Planeswalker](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Nicol%2BBolas%252C%2BPlaneswalker)? It does. What colors is [Nicol Bolas, Planeswalker](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Nicol%2BBolas%252C%2BPlaneswalker)? If you're familiar with the character, base black with a little blue and red is dead on. The abilities feel like the character and the character matches his cost. By the transitive property—voila. (Ooh, using math to nefarious ends.)
...
This is a beloved top-down design card. In fact, I would call it the poster child for top-down design. One of the mechanics is [Moat](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Moat) (you cannot attack me with nonfliers). [Moat](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Moat) is nowhere near the red part of the color pie. Red does not stop things from attacking—blocking, sure, but not attacking. How is this allowable? Because [Moat](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Moat) is a key part of the overall "you've turned yourself into a dragon" flavor. What color should get "you've turned yourself into a dragon" flavor? Red, obviously, as red is the iconic color of dragons.
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/tcg/products/alarareborn/no44jt29pu_EN.jpg)


Wait a minute, this card isn't part of the Visual Spoiler (yet). Yes, this is my preview card. For armadillo lovers everywhere, I present [Armadillo Cloak](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Armadillo%2BCloak) in equipment form. The relevant issue to my point shows up in the mana cost. See the green mana symbol? That's not part of Esper, but here in *Alara Reborn*, the shards have started colliding, so you get things like Equipment with green and red in their cost. (Okay, this was also a way to get more artifacts into a set that was all-gold, but I feel this work-around was well earned.)
