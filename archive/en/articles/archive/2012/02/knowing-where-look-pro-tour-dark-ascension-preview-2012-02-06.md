...
---
[Link to Wayback Machine](https://web.archive.org/web/20210429111402/https://magic.wizards.com/en/articles/archive/knowing-where-look-pro-tour-dark-ascension-preview-2012-02-06)

[_metadata_:author]:- "Rich Hagon"
[_metadata_:description]:- "A long time ago, when I was a kid, coverage of major sporting events was rubbish. Soccer? You'd get one live match each year—the FA Cup final. The US Masters golf? A half-hour highlights package. Maybe three weeks later. An entire season of American football (or, to the initiated, just plain `football`) was condensed into an hour, at the end of which ninety seconds sufficed to"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "681321"
[_metadata_:publish_date]:- "2012-02-06"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Knowing Where to Look: A Pro Tour Dark Ascension Preview"
[_metadata_:wayback_capture_timestamp]:- "2021-04-29 11:14:02"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20210429111402id_/https://magic.wizards.com/en/articles/archive/knowing-where-look-pro-tour-dark-ascension-preview-2012-02-06"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/knowing-where-look-pro-tour-dark-ascension-preview-2012-02-06"
---
...
A long time ago, when I was a kid, coverage of major sporting events was *rubbish*. Soccer? You'd get one live match each *year*—the FA Cup final. The US Masters golf? A half-hour highlights package. Maybe *three weeks later*. An entire season of American football (or, to the initiated, just plain "football") was condensed into an hour, at the end of which ninety seconds sufficed to cover the Super Bowl. Getting the events I really cared about—the World Series, the NBA Finals—involved hanging out of an attic window with a $10 battery-powered radio, desperately trying to catch the crackling, distorted feed from American Forces Network Radio at the local US Air Base. Did I mention that coverage was *rubbish*?


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature181_rubbish.jpg)Times, as they do, change. Now there's the Golf Channel. Subscription packages to see every single game the New York Mets play each year. NFL Red Zone. Hundreds of live soccer matches every season. Live cricket 16 hours a day. In fact, there's so much awesome competition out there, it's becoming impossible to know where to look. Okay, I'll TiVo the Cardinals, watch Red Zone live, then switch to the Broncos game while recording the... Seriously, the board game *Channel Surfer* can't be far away—a Eurogame of stunning complexity using remote controls to determine the winner.
...
Make no mistake about it. **Magic** has achieved 24/7 status, and that means sometimes you don't know where to look. This article. That podcast. His replay. [My Twitter](http://twitter.com/MTGRich). Your Facebook. Her tournament report. Those standings. Their announcement.
...
When you watch the best players in action, whenever they get to look at the opposing hand of cards (with a [Gitaxian Probe](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gitaxian+Probe) for example) they'll write the cards down. It's not that they have the memory of a goldfish, but **Magic** is a game of complex moving parts, and a little bit of help in the heat of battle goes a long way. That's where [Gatherer](http://gatherer.wizards.com/Pages/Search/Default.aspx?sort=cn+&output=spoiler&method=visual&action=advanced&set=%20%5B%22Dark%20Ascension%22%5D) comes in handy. However much you've pored over the spoiler when it went live, however many articles you've read, and however many Prereleases you went to, chances are you don't know every single last tiny detail about the new set. Chances are, at some stage you'll want exactly that one little bit of information that's escaped you. If you're feeling technological, there are few things handier than Gatherer.


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature181_fatPack.jpg)*Dark Ascension Fat Pack*
...
If you haven't become involved in this already, you really should. Most major sports have fantasy contests running alongside the big event, and now **Magic** has its very own with [the gorgeous new Facebook app](http://apps.facebook.com/magicfantasyprotour/). Like any hardworking baseball manager, you can look through your roster of options to create the most powerful team of cards you can, and score points according to how many copies of each card appear in the top Standard decklists out in Honolulu (likely to be all decks that record at least six wins in the ten Swiss rounds of Constructed play). There's [a lot going on](http://www.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/twtw/180) under the surface of this challenge, since your goal *isn't* to work out who's going to claim the trophy. If someone breaks the format with a mono-blue Control deck featuring four copies of [Counterlash](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Counterlash), and you correctly predict your Polish friend will indeed win the title in that way, you'll get very few points unless dozens of other successful competitors have arrived at [Counterlash](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Counterlash) as a must-have. Your goal, therefore, is to correctly identify the metagame, and that's a puzzle that's been eluding the best pros in the business for more than fifteen years.


[![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature181_fantasy_Static.jpg)](http://www.facebook.com/MagicTheGathering?sk=app_319401148097860)
...
We've got special guests, too, from inside R&D in Renton. Aaron Forsythe will be joining us to provide his ample insights into the state of **Magic**, while Zac Hill—author of the [Latest Developments column](http://www.wizards.com/Magic/Magazine/Archive.aspx?tag=latestdevelopments&description=Latest%20Developments) right here and a member of both the design and development teams for *Dark Ascension*—will lift the lid on lots more behind-the-scenes gossip on the new set. We also know how popular and important deck techs are to you, and when we're not in the booth bringing you live matches, we'll be doing the same great in-depth one-on-ones with the pros, as a new Standard and a new Draft format start to come into focus.
...
![](https://web.archive.org/web/20220216050541im_/https://magic.wizards.com/sites/all/themes/wiz_mtg/img/interface/video-place-holder.png)[.](http://www.youtube.com/v/3t42xq-pnpU&hl=en&fs=1&rel=0)
...
And of course there's Twitter, where you can get coverage updates from [@MagicProTour](http://twitter.com/MagicProTour), plus follow many of the pros, as they keep everyone up-to-date with multiple posts each day. Keep track of the whole experience with the hashtag [#PTDKA](http://twitter.com/#!/search?q=%23PTDKA). It's also a great way to give us feedback on what stories you want to see covered and ask questions about the event—the announcing crew will be keeping tabs on the hashtag to work your thoughts and questions into the live stream.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature174c_path.jpg)Pro Club levels for 2012–2013 get locked in, and it's a simple matter of being Silver, Gold, or Platinum: 15 points gets you Silver status, 25 steps you up to Gold, but 40 is the big one. That's where Platinum status kicks in, together with $250 appearance fee at every Grand Prix, $3,000 appearance fee at each Pro Tour, $1,000 if invited to the World **Magic** Cup, plus hotel and flights at each Pro Tour. It's a sizeable package of benefits, and a lot of players are chasing this *hard*. You can look at the [complete standings here](http://www.wizards.com/Magic/Magazine/Events.aspx?x=protour/standings/ppc201213).
...
If all three are playing [Delver of Secrets](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Delver+of+Secrets) or White-Blue Humans or [Tempered Steel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tempered+Steel), they don't believe that there *is* an answer to the format, and that one of these is—just about—the best deck.


Now it gets interesting. If all three open up with a deck designed to start with turn-one [Swamp](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Swamp) into [Gravecrawler](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gravecrawler), you better believe the Zombie apocalypse (although possibly not the [Zombie Apocalypse](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Zombie+Apocalypse)) is for real.



![Gravecrawler](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Gravecrawler)
...
Now the scenario that's keeping 500+ potential competitors awake at night, worrying: If all three turn up with a deck that revolves around, let's say, [Curse of Misfortunes](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Curse+of+Misfortunes), that's the ballgame right there. If they can make that collection of Curses work, via a Conley Woods special, to the point that all three of these great players are ready to stake their Pro Tour lives on it, everyone else better pray they arrived at exactly the same answer.



![Curse of Misfortunes](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Curse+of+Misfortunes)

 

Of course, the most exciting answer is where Conley updates his winning Titan Ramp deck, Paulo kicks off with [Gravecrawler](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gravecrawler), and Luis takes a leaf out of Shouta Yasooka's book and runs a [Tezzeret, Agent of Bolas](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tezzeret%2C+Agent+of+Bolas) deck. *Then* the door is wide open for a Chapin, an Oberg, or maybe even a Bland to have the hot tech that propels them to triumph. In any case, round one: three decklists.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature181_packs.jpg)[Curse of Misfortunes](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Curse+of+Misfortunes) might not cut it for Standard, but somebody somewhere in Honolulu is going to find it as the rare in the first pack and get passed an uncommon [Curse of Thirst](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Curse+of+Thirst). Two picks in, and there's a strategy ready to rock and roll, with the promise of numerous unloved Curses coming from *Innistrad*. Zombies might turn out to be more shambolic than shambling in Standard, but with [Geralf's Messenger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Geralf%27s+Messenger), [Black Cat](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Black+Cat), [Farbog Boneflinger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Farbog+Boneflinger), [Gravecrawler](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gravecrawler), [Highborn Ghoul](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Highborn+Ghoul), [Reap the Seagraf](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Reap+the+Seagraf), [Sightless Ghoul](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sightless+Ghoul)—and the mythic rare [Mikaeus, the Unhallowed](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mikaeus%2C+the+Unhallowed)—there's plenty of fuel to get your ghoul on in *Dark Ascension*, with the possibility of [Unbreathing Horde](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Unbreathing+Horde) getting a chance to shine out of *Innistrad*.
...
When it comes to the nuts and bolts of a game of **Magic**, different sets focus on different parts of the game. Sometimes you need to see how many cards are in hand to work out who's really winning. *Scars of Mirrodin*? Sure, you're at 20 life, but you're about to die to poison. Sometimes it's all about the red zone, with creatures turning sideways early and often. During the Draft rounds, especially—but during the Constructed rounds too—you're going to need to look at the graveyards. One of the most exciting developments during the *Innistrad* Draft season was the increasing prevalence of the [Spider Spawning](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Spider+Spawning) decks. In assorted blue, black, and green recipes, these decks dumped cards into their own graveyards before using flashback to devastating effect, with an army of Spiders often merely the finishing touch to a deck packed with elegance, synergy, and deep frustration for unprepared opponents.


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/feature181_confusion.jpg)[Increasing Confusion](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Increasing+Confusion) | Art by [Dan Scott](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+%5B%22Dan+Scott%22%5D)


Now, with the arrival of *Dark Ascension*, comes the latest twist to the graveyard tale. Now you'll have to keep an eye on both graveyards at once. While the self-mill deck is still very much an option, even with fewer [Gnaw to the Bone](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gnaw+to+the+Bone), [Forbidden Alchemy](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Forbidden+Alchemy), and [Spider Spawning](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Spider+Spawning) to take from one less *Innistrad* booster, the new storyline involves milling your opponent. Open up an [Increasing Confusion](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Increasing+Confusion) and both mill strategies are open to you. Get to six mana, and over two turns that's fifteen cards you get to send packing. Your opponents start with forty. They start with seven in hand. By turn seven that's another seven gone. That's a dozen or so cards left in their libraries, even if you haven't given them a helping hand in the meantime. With cards like [Chill of Foreboding](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Chill+of+Foreboding) and [Thought Scour](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Thought+Scour), not to mention a significant upgrade to the common [Curse of the Bloody Tome](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Curse+of+the+Bloody+Tome) from *Innistrad*, the competition for mill cards is going to get a lot more interesting.
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/events/ptphi11/f_celebration.jpg)*Samuele Estratti, 2011 Pro Tour Philadelphia champion.*
