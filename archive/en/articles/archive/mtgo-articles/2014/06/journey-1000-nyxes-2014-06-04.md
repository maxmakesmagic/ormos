...
[_metadata_:node]:- "213856"
[_metadata_:path_date]:- "2014-06-04"
[_metadata_:publish_date]:- "2014-05-12"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "The Journey of 1000 Nyxes"
[_metadata_:wayback_capture_timestamp]:- "2022-05-29 08:41:09"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20220529084109id_/https://magic.wizards.com/en/articles/archive/mtgo-articles/journey-1000-nyxes-2014-06-04"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/mtgo-articles/journey-1000-nyxes-2014-06-04"
---
...
I'm back! [Last time](/en/articles/archive/born-digital-gods-2014-06-04-0) I told you all about implementing *Born of the Gods* on **Magic Online**. Today I’m going to take you through the *Journey Into Nyx* process, which made substantial strides for **Magic Online**.
...
![](https://media.wizards.com/legacy/mtg/images/digital/magiconline/bluepowertoughness.png)  
[Pheres-Band Thunderhoof](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pheres-Band+Thunderhoof)
...
![](https://media.wizards.com/legacy/mtg/images/digital/magiconline/graypowertoughness.png)  
...
![](https://media.wizards.com/legacy/mtg/images/digital/magiconline/canbecastwindow.png)
...
![](https://media.wizards.com/legacy/mtg/images/digital/magiconline/coinflip.png)
...
![](https://media.wizards.com/legacy/mtg/images/digital/magiconline/keranosgodofstorms.png)
...
![](http://archive.wizards.com/mtg/images/digital/magiconline/DelayedTrigger.png)  
[Bearer of the Heavens](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bearer+of+the+Heavens)

In addition to the delayed triggers from *Journey Into Nyx*, you’ll also see effects for delayed triggers in the rest of *Theros* block, like [Gift of Immortality](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gift+of+Immortality) and [Rescue from the Underworld](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rescue+from+the+Underworld). As I mentioned with Strive, we try to fix older cards when we can. Unfortunately, in this case each delayed trigger is somewhat hand crafted. Since we can’t easily fix all delayed triggers through **Magic’s** history, we started by focusing on *Theros* block. Over time we’ll continue to implement new delayed triggers in this way, and we’ll try to pick up older delayed triggers when we can. (For example, if a card with a delayed trigger is in the **Magic Online** Cube it’s a good candidate for improvement.)



We’re also working to improve associations between cards, which should help delayed triggers in the future. Right now, [Twinflame](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Twinflame) has the somewhat ambiguous text, “Return them at the beginning of the next end step.” The intent is that at some point in the future this delayed trigger is associated to the tokens it creates through a mouse over highlight. Creating the delayed triggers in the first place was the first big step, and now we can start iterating towards the ideal.


Sins of the Past
Sometimes a card is implemented at a lower quality than we’d like. This is inevitable. Sometimes design misses an interaction, or a card like [Whims of the Fates](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Whims+of+the+Fates) requires [a lot of extra attention](/en/articles/archive/born-digital-gods-2014-06-04-0)  from the programmers, or a new mechanic introduces problems, or a new tool presents a better solution. One of the changes I made in our cardset process was to recognize this inevitability, and focus on improving our newest cards as if they were in the most recent set. For example, check out [Heroes' Podium](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Heroes%27+Podium):




![](https://media.wizards.com/legacy/mtg/images/digital/magiconline/heroespodium.png)

One of the use cases we didn’t have time to address with *Born of the Gods* was activating [Heroes' Podium](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Heroes%27+Podium) for 0, or activating it with no cards in your deck. It would ask the player to look at 0 cards and required an unnecessary confirmation click to continue the game.
...
* You may remember me talking about storm improvements in [a previous article](/en/articles/archive/designing-99-2014-06-04) . Now it’s here! The storm count has been moved out of the game log and onto cards with storm.
* Suspend and Cascade have been greatly improved by the new can be cast from exile window.
* [Arc Trail](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Arc+Trail)’s prompt box text has been made more helpful.
* Fixed a nasty bug with [All Suns' Dawn](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=All+Suns%27+Dawn) where the player was forced to select each card in WUBRG order and couldn’t skip any colors.
* While no coin flip cards were in *Journey Into Nyx*, the presence of [Tavern Swindler](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tavern+Swindler) in *Duel Decks: Jace vs Vraska* helped push the coin flip improvements through.
...
![Jon Loucks](http://archive.wizards.com/Magic/images/mtgcom/authorpics/authorpic_jonloucks.jpg)

|  |  |  |
| --- | --- | --- |
| **Jon Loucks**[@JonLoucks](https://twitter.com/jonloucks) | Email Jon | [Author Archive](/Magic/Magazine/Archive.aspx?author=Jon%20Loucks) |
