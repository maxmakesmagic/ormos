...
---
[Link to Wayback Machine](https://web.archive.org/web/20220813143239/https://magic.wizards.com/en/articles/archive/ten-bits-tenth-2007-08-03)

[_metadata_:author]:- "Aaron Forsythe"
[_metadata_:description]:- "After sets come out, I like to reflect on them. Once we have initial player perceptions and tournament data to go along with the several months of internal post-analysis we do between the time we finish the set and it gets into your hands, I like to go back and read through all the Multiverse comments that I and my coworkers made as the set wound its way through development."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "290551"
[_metadata_:publish_date]:- "2007-08-03"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Ten Bits from Tenth"
[_metadata_:wayback_capture_timestamp]:- "2022-08-13 14:32:39"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20220813143239id_/https://magic.wizards.com/en/articles/archive/ten-bits-tenth-2007-08-03"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/ten-bits-tenth-2007-08-03"
---
...
![Bash_to_Bits](https://media.wizards.com/legacy/magic/images/cardart/od/bash_to_bits.jpg)Sadly, the Multiverse comments for *Tenth Edition* just weren't that interesting. How could they be? After all, we weren't allowed to doctor up any of the individual cards (aside from template refreshes, the discussion of which would be only interesting to the Melvins among you) as we were dealing solely with reprints. Sure, there was some discussion about how good Song of Blood was and that we really shouldn't print it right now (probably something to do with [Mogg War Marshal](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mogg+War+Marshal)), which common tapper we should have in the set, and if [Dross Crocodile](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dross+Crocodile) and [Mass of Ghouls](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mass+of+Ghouls) were too similar, but in general the Core Set commentary can't hold a candle to the heated debates that go on for expert-level expansions.
...
![](https://media.wizards.com/legacy/magic/images/mtgcom/fcpics/latest/af182_originalscardfan.jpg)


In chronological order:


### [Squee, Goblin Nabob](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Squee%2C+Goblin+Nabob) (*Mercadian Masques*, developed in 1998)
...
**[Avatar of Might](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Avatar+of+Might) (*Prophecy*, developed in 1999)**
...
The Invasion dev team called out [Recover](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Recover) as promotable—meaning it is a good candidate to show up in a Core Set—and eight years later it comes true.


The comparison to [Bone Harvest](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bone+Harvest) is an interesting one—I think current R&D believes [Recover](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Recover) to be significantly better than [Bone Harvest](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bone+Harvest), as it gives you an extra card—but neither card has ever made much noise in Constructed.


**[Voice of All](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Voice+of+All) (*Planeshift*, developed in 2000)**
...
We moved [Voice of All](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Voice+of+All) from uncommon to rare in Tenth because protection is such a complicated ability—especially in combination with "choose a color"—that we didn't want new players encountering it very often. It is interesting to see that the card used to be rare in *Planeshift*.


**[Sunken Hope](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sunken+Hope) (*Planeshift*, developed in 2000)**
...
I'm fascinated by how powerful the development team theorized/determined [Sunken Hope](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sunken+Hope) to be at four mana. It does seem like a powerful tool in a creatureless deck full of counterspells, although at five mana it has yet to materialize in high-level decks.


**[Persuasion](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Persuasion) (*Odyssey*, developed in 2000)**
...
For a long time, R&D had a goal of creating the "UBS"—the Universal Base Set that would be the perfect set of core set cards and would never change. We have since revised our thinking and determined that we *like* changing the contents of the Core Set, so the UBS idea has been abandoned. [Persuasion](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Persuasion) was made for that theoretical set, and was initially uncommon before a late switch to rare.


Just as we swapped [Voice of All](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Voice+of+All) back to its design rarity in Tenth, we did so with [Persuasion](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Persuasion), moving it down to uncommon.


**[Ancestor's Chosen](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ancestor%27s+Chosen) (*Judgment*, developed in 2001)**
...
It looks to me like [Ancestor's Chosen](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ancestor%27s+Chosen) began life as an "[Advocate](http://ww2.wizards.com/gatherer/index.aspx?term=advocate&field_name=on&field_rules=on&field_type=on&setfilter=judgment)":
...
**[Arcanis the Omnipotent](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Arcanis+the+Omnipotent) (*Onslaught*, developed in 2001)**
...
**[Phage the Untouchable](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phage+the+Untouchable) (*Legions*, developed in 2002)**
...
**[Commune with Nature](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Commune+with+Nature) (*Champions of Kamigawa*, developed in 2003)**
