...
---
[Link to Wayback Machine](https://web.archive.org/web/20220813224216/https://magic.wizards.com/en/MTGO/articles/archive/magic-online-bug-blog-december-4-2014_2)
...
[_metadata_:node]:- "315596"
[_metadata_:publish_date]:- "2014-12-04"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Magic Online Bug Blog December 4, 2014"
[_metadata_:wayback_capture_timestamp]:- "2022-08-13 22:42:16"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20220813224216id_/https://magic.wizards.com/en/MTGO/articles/archive/magic-online-bug-blog-december-4-2014_2"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/MTGO/articles/archive/magic-online-bug-blog-december-4-2014_2"
---


Magic Online Bug Blog December 4, 2014
======================================
...
This week, many issues that were scheduled previously (as well as a few that weren't scheduled) had fixes deployed in the *Magic Online* update on Wednesday, December 3. Tune into the Bug Blog next week for an update on some of the issues we're targeting for the next *Magic Online* deployment.


**Newly Fixed during the Wednesday, December 3 *Magic Online* Client Update**
...
* C14 | [Nahiri, the Lithomancer](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Nahiri%2C+the+Lithomancer)'s first ability attaches the equipment to previous tokens if they exist
* C14 | Offerings display blue text identifying a chosen opponent before it is chosen. The cards function correctly.
* C14 | [Song of the Dryad](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Song+of+the+Dryad) enchanting another Aura appears incorrectly. The card functions correctly.
...
* General | [Trinisphere](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Trinisphere)'s effect does not apply to spells with X in the mana cost
* General | Various library searching cards hang the game if there is nothing legal to find in the library
...
* Collection | Rarity filter works inconsistently
...
* Events | Occasionally cards can become visually duplicated in your sideboard and prevent deck submission
...
**Newly Added Known Issues as of Thursday, December 4**
...
* General | [Umezawa's Jitte](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Umezawa%27s+Jitte) counters are obscured by the equipped creature—There is a [temporary workaround](#workarounds) for this issue
