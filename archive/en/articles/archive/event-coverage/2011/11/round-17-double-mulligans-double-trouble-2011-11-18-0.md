...
---
[Link to Wayback Machine](https://web.archive.org/web/20220517005429/https://magic.wizards.com/en/articles/archive/event-coverage/round-17-double-mulligans-double-trouble-2011-11-18-0)

[_metadata_:author]:- "Nate Price"
[_metadata_:description]:- "Richard Bland (Punishing Zoo) vs. Ian Wood (Zoo) David Caplan (CounterCat) vs. Janus Kofoed (Bant-Zoo) Nico Bohny (Death Cloud) vs. Josh Utter-Leyton (CounterCat) Well, well, well! What an interesting match we have here. While it may not have been apparent to you at first glance, there was quite the story brewing when the pairings came out for this penultimate round of Worlds."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "520531"
[_metadata_:publish_date]:- "2011-11-18"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Round 17: Double Mulligans, Double Trouble"
[_metadata_:wayback_capture_timestamp]:- "2022-05-17 00:54:29"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20220517005429id_/https://magic.wizards.com/en/articles/archive/event-coverage/round-17-double-mulligans-double-trouble-2011-11-18-0"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/event-coverage/round-17-double-mulligans-double-trouble-2011-11-18-0"
---


Round 17: Double Mulligans, Double Trouble
==========================================
...
David Caplan (CounterCat) vs. Janus Kofoed (Bant-Zoo)
-----------------------------------------------------


[Nico Bohny (Death Cloud) vs. Josh Utter-Leyton (CounterCat)](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/eventcoverage/worlds11/fm18)
...
To my right sat David Caplan. After completing a 6-0 run in the Standard portion of Worlds, Caplan scooted off to the **Magic Online**Championship, where he is a competitor. That's right, he's spearheading the contingent of MOCS players that are crushing the top tables of Worlds. In addition to the six rounds of play for Worlds, each of the MOCS competitors put in four rounds of play in the evening, requiring some severe mental endurance. Despite this incredibly heavy workload, Caplan is still excelling, and playing against competition this tough can only help prepare him more for the Modern portion of the MOCS, starting just after next round.



![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/events/worlds11/r17_caplan_vs_kofoed.jpg)
***Magic Online**  Championship competitor David Caplan squares off against Janus Kofoed, who may have a shot at Rookie of the Year if he Top 8s.* 

### Game 1


Caplan started things first, cracking an [Arid Mesa](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Arid+Mesa) to fetch a [Hallowed Fountain](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hallowed+Fountain). It came into play untapped, effectively [Lightning Bolt](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Bolt)ing himself. He played a [Loam Lion](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Loam+Lion), displaying his Zoo affiliations. Kofoed revealed that he too was an animal lover, with a 2/2 [Wild Nacatl](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wild+Nacatl), thanks in part to a [Temple Garden](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Temple+Garden). Caplan played a [Stomping Ground](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stomping+Ground)s and attacked, his 2/3 waltzing past Kofoed's 2/2. After combat, he made a 3/3 [Wild Nacatl](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wild+Nacatl) of his own. Kofoed made a [Stomping Ground](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stomping+Ground)s of his own, powering up his [Wild Nacatl](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wild+Nacatl) and swinging at Caplan. Kitties traded, and Kofoed replaced his after combat.



![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/events/worlds11/r17_kofoed.jpg)
*Kofoed trades cat for cat, hoping his Zoo deck will come out on top.*

Caplan untapped and played a [Lightning Bolt](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Bolt) on Kofoed's lone Nacatl, clearing the way for his [Loam Lion](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Loam+Lion). To bolster his team, he made a [Tarmogoyf](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tarmogoyf) and passed the turn. Kofoed didn't let the Tarmogyf see a combat step, using a [Path to Exile](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Path+to+Exile) to permanently deal with the best two-drop ever printed, arguably (but not really). Even still, his double mulligan to start the game had left him depleted of options. He could do nothing as he watched his life tick away in the next couple of turns, and Caplan rode his Lion and a hint of burn to a win in the first game.
...
Kofoed was the first to play this game, dropping a [Birds of Paradise](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Birds+of+Paradise) into play on the first turn. After a pair of mulligans himself, Caplan started out with a [Wild Nacatl](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wild+Nacatl). Kofoed put his [Birds of Paradise](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Birds+of+Paradise) to good use with a second-turn [Rhox War Monk](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rhox+War+Monk), which Caplan correctly predicted. When Caplan calmly untapped and played [Deathmark](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Deathmark) on the Monk, it looked as though Kaplan might have baited Kofoed into playing the Monk, though it's unlikely that there was a better play. Kofoed tried to replace his men, but each time, Caplan had an answer. First, [Wild Nacatl](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wild+Nacatl) met a [Lightning Bolt](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Bolt). Then a second War Monk met the same [Deathmark](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Deathmark), thanks to a [Snapcaster Mage](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Snapcaster+Mage).
...
![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/events/worlds11/r17_caplan.jpg)
*Caplan mulligans to five, but that's not slowing him down against Kofoed's [Rhox War Monk](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rhox+War+Monk)s.* 

Kofoed was on the back foot now, slowing the bleeding some with an [Oblivion Ring](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Oblivion+Ring) to stop [Wild Nacatl](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wild+Nacatl), but Caplan still had the Snapcaster to beat down. As Caplan pressed the attack, Kofoed's life dwindled. The final spell was cast soon thereafter, as a [Lightning Helix](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lightning+Helix) finished things off, giving Caplan the win on a mulligan to five, and most likely securing him a berth in the Top 8.
