...
---
[Link to Wayback Machine](https://web.archive.org/web/20211019000358/https://magic.wizards.com/en/articles/archive/limited-information/dependency-issues-2010-01-18)

[_metadata_:author]:- "Steve Sadin"
[_metadata_:description]:- "When you make a pick, you are (usually) taking a card that you believe will make your deck better in some way. It is important to distinguish if that card is going to make the other cards in your deck better, if it is made better because of the other cards in your deck, if it is simply a good card that helps ensure that you will be able to put together a competitive deck (such"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "189376"
[_metadata_:path_date]:- "2010-01-18"
[_metadata_:publish_date]:- "2010-01-19"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Dependency Issues"
[_metadata_:wayback_capture_timestamp]:- "2021-10-19 00:03:58"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20211019000358id_/https://magic.wizards.com/en/articles/archive/limited-information/dependency-issues-2010-01-18"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/limited-information/dependency-issues-2010-01-18"
---
...
When you make a pick, you are (usually) taking a card that you believe will make your deck better in some way. It is important to distinguish if that card is going to make the other cards in your deck better, if it is made better because of the other cards in your deck, if it is simply a good card that helps ensure that you will be able to put together a competitive deck (such as a cheap piece of on color removal), or if it is some combination of the three.

![](https://web.archive.org/web/20130605182503im_/http://wizards.com/mtg/images/daily/li/li74_allyCross.jpg)  
On its lonesome, a [Stonework Puma](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stonework+Puma) really won't do much for you. Sure, it can block creatures with intimidate, like [Bladetusk Boar](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bladetusk+Boar) (which might actually turn out to be quite relevant for you), but in general it won't be very useful unless you have a number of other Allies with relevant abilities. If you do have a bunch of other Allies, then [Stonework Puma](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stonework+Puma) will be a very valuable card for you, as it will make many of your other cards significantly better.
...
You might want to note that Allies function similarly to powerful color intensive cards in this way. If you take a [Gatekeeper of Malakir](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gatekeeper+of+Malakir) early, you are doing so with the intention of drafting a heavy black deck, one where getting to ![](https://web.archive.org/web/20161227195556im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/black.gif)![](https://web.archive.org/web/20161227195556im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/black.gif)![](https://web.archive.org/web/20161227195556im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/black.gif) won't be much of an issue. But if you don't pick up many other black cards, then your [Gatekeeper of Malakir](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gatekeeper+of+Malakir) might end up in your sideboard even if you're playing black! Or, worse yet, that [Gatekeeper of Malakir](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gatekeeper+of+Malakir) might end up in your light black deck as a very marginal card because of your inability to cast it in a timely manner. 

![](https://web.archive.org/web/20130605193901im_/http://wizards.com/mtg/images/daily/li/li74_2Cards1.jpg)  
...
If you take an [Oran-Rief Survivalist](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Oran-Rief+Survivalist) early, you should know pretty much exactly what you're getting yourself into. At the very worst you will have a [Runeclaw Bear](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Runeclaw+Bear), and if you get a decent number of Allies you might end up with something pretty absurd. 

But if you take an [Oran-Rief Survivalist](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Oran-Rief+Survivalist) late in the draft, you will be making a completely different pick. Instead of making the pick based on what could happen in the draft, you will be making your pick based mostly on what has already happened.

Milling them Softly
I know that [last week](/Magic/Magazine/Article.aspx?x=mtg/daily/li/73) was Milling Week, but if you'll bear with me, Halimar Excavator from the [Visual Spoiler](/Magic/TCG/Products.aspx?x=mtg/tcg/products/worldwake) deserves a bit of discussion.

![Halimar Excavator](http://wizards.com//mtg/images/tcg/products/worldwake/6x0u2yd2p4_EN.jpg)  
Unlike [Hedron Crab](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hedron+Crab), which acts almost exclusively as a victory condition for decks that have been crafted perfectly for its inclusion, Halimar Excavator acts both as a potential victory condition on its own and as a way to enable the rest of your Allies.
...
Halimar Excavator will be quite good in most heavy Ally decks, especially if you are able to find multiple copies of the milling Ally. Like [Vedalken Entrancer](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vedalken+Entrancer), Halimar Excavator provides a meaningful defensive body while grinding away at your opponent's library. So even if you find yourself unable to deck your opponent, the board presence that it will offer you is not something to scoff at.
...
![](https://web.archive.org/web/20130605182021im_/http://wizards.com/mtg/images/daily/li/li74_halimarExSplash.jpg)  
Unless you have ten or more Allies, or eight or nine including multiple Halimar Excavators, it is unlikely that you will be winning many games by decking your opponents. If you don't have a ton of other Allies, Halimar Excavators will still function as a [Stonework Puma](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stonework+Puma) to trigger the rest of your Allies.
...
Preview!
It's preview time! Click here.

![Hada Freeblade](https://media.wizards.com/legacy//mtg/images/tcg/products/worldwake/45qsg3yr9m_en.jpg)  
...
If your deck only has two other Allies, or three Allies with negligible abilities, Hada Freeblade probably won't have enough upside to justify including in your deck. This might change if you have a number of [Kor Skyfisher](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kor+Skyfisher)s or pieces of Equipment that really want you to have one drops, but other than that you are going to want to leave your one-mana [Squire](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Squire) in the sideboard.

![](https://media.wizards.com/legacy//mtg/images/daily/li/li74_7vse95bieujt5.jpg)  
...
Hada Freeblade might also have some very real Constructed implications, possibly being just the card to make Allies a viable strategy. Sure, the deck is still going to need a bit more help, but don't be too surprised if you see people following up their Hada Freeblades with [Oran-Rief Survivalist](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Oran-Rief+Survivalist)s and/or [Kazandu Blademaster](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kazandu+Blademaster)s in Block Constructed or even Standard.
...
![](https://web.archive.org/web/20130605192146im_/http://wizards.com/mtg/images/daily/li/li74_allyCardTops.jpg)  
...
If you only have a couple of Allies, you will probably just want to run the ones that are good on their own. Once you have two to four [Oran-Rief Survivalist](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Oran-Rief+Survivalist) / [Kazandu Blademaster](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kazandu+Blademaster) / [Umara Raptor](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Umara+Raptor)–type cards in your deck, you should strongly consider running your [Stonework Puma](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stonework+Puma)s and even your Halimar Excavators, which would otherwise be borderline on their own but become just that little bit better when they have the ability to enhance some of the other cards in your deck.

Putting it All Together: How Many Is Too Many?
In [last week's article](/Magic/Magazine/Article.aspx?x=mtg/daily/li/73) I mentioned that [Tome Scour](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tome+Scour) is a card that you generally don't want to play unless you have eight plus copies of them in your draft deck. After the article went up I received a number of emails from players saying that they had been under the impression that it was against the rules to play more than four copies of a card in a Limited deck.
...
![](https://media.wizards.com/legacy//mtg/images/daily/li/li74_iofhsv5yhiihg.jpg)  
...
In between games, you are allowed to exchange any number of cards from your sideboard and your main deck, so long as you again end up with at least 40 cards. This does not need to be an equal exchange; all that matters is that you have a minimum of 40 cards when you present your deck. If you started with 41 cards, you are allowed to sideboard down to 40. If you started with 40 cards and your opponent's only way to win is by decking you with his or her three [Archive Trap](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Archive+Trap)s, then you are welcome to sideboard so that your deck has fifty-two cards or even a hundred cards if you want to (note, though, that even if your opponent is playing a dedicated mill deck, you will probably want to keep your deck under 60 cards).
