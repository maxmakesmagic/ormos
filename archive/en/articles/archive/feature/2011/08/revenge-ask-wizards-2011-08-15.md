...
---
[Link to Wayback Machine](https://web.archive.org/web/20210116183121/https://magic.wizards.com/en/articles/archive/feature/revenge-ask-wizards-2011-08-15)
...
*As an occasional feature here at **DailyMTG.com**, we collect your questions about **Magic**, the R&D process, and life at Wizards and pose them to members of **Magic** R&D. Ever wanted to know how and why two artists sometimes work on the same card, if R&D considers the storm mechanic inherently broken, or whether [Sphinx of Uthuun](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sphinx+of+Uthuun) and [Rune-Scarred Demon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rune-Scarred+Demon) were originally part of a cycle? Then read on!*
...
It's very rarely something that I ask for; it is simply how said artists choose to work. [Zoltan and Gabor](http://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&artist=+%5Bzoltan%5D+%5Bgabor%5D) have been working together since high school age. When I approached Jana to create **Magic** art, she asked if she could [co-create with Johannes](http://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&artist=+%5Bschirmer%5D+%5Bvoss%5D). When [D. Alexander Gregory](http://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&artist=+%5B%22D.%20Alexander%20Gregory%22%5D) and I illustrated [Teferi](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Teferi%2C+Mage+of+Zhalfir), it's because we had been looking for a project to work together on (and we lived across the street from each other).


![](https://media.magic.wizards.com/image_legacy_migration/mtg/images/daily/features/feature156_mage.jpg)[Teferi, Mage of Zhalfir](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Teferi%2C+Mage+of+Zhalfir) | Art by [D. Alexander Gregory](http://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&artist=+%5B%22D.%20Alexander%20Gregory%22) and [Jeremy Jarvis](http://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&artist=+%5B%22Jeremy%20Jarvis%22)
...
Why is [Vengeful Pharaoh](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vengeful+Pharaoh)'s triggered ability mandatory (not a "may effect")? It seems like exactly the kind of ability that would be optional, and yet it isn't.  
 --Tom D.


![Vengeful Pharaoh](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Vengeful+Pharaoh)  
**A:** From Matt Tabak, **Magic** rules manager:


It's true that [Vengeful Pharaoh](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vengeful+Pharaoh)'s triggered ability could have been optional. There are two key reasons why it isn't:


1) Game play. We didn't want to create scenarios where you could just never attack with your best creature just because your opponent had a [Vengeful Pharaoh](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vengeful+Pharaoh) sitting in the graveyard. Too often, this would just bog games down, particularly in sealed deck games. Now you can send your sacrificial Goblin over to taunt the Pharaoh and buy yourself a little time, or you can just hit hard while you can.


2) Flavor. HOW DARE ANYONE DISTURB MY SLUMBER?!? I WILL EXACT MY VENGEANCE UPON THEE!!!


  
[Rune-Scarred Demon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rune-Scarred+Demon) and [Sphinx of Uthuun](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sphinx+of+Uthuun) are both large rare creatures with ETB abilities that mimic older, powerful spells. Were they originally part of a cycle of five (one in each color)? If so, why wasn't the cycle printed in it's entirety?  
 --Thomas M.
...
|  |  |
| --- | --- |
| Sphinx of Uthuun | Rune-Scarred Demon |

[Rune-Scarred Demon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rune-Scarred+Demon) was a Mark Globus design that was handed off with the design file. It was intended to be a pair with [Diabolic Tutor](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Diabolic+Tutor), as Mark was trying to build several matched pairs of cards into the set. You can see other examples of that design push in the [Empires artifacts](http://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&name=+%5Bempires%5D&set=%7C%5B%22Magic%202012%22%5D) and the pairing of [Arachnus Spinner](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Arachnus+Spinner) and [Arachnus Web](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Arachnus+Web). [Sphinx of Uthuun](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sphinx+of+Uthuun), on the other hand, was created late in development by Dave Humpherys when I needed a riddle for a Sphinx to ask.
