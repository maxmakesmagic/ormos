...
---
[Link to Wayback Machine](https://web.archive.org/web/20160719210424/http://magic.wizards.com/en/articles/archive/making-magic/designing-orzhov-2013-03-25)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "&#13;"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "656736"
[_metadata_:publish_date]:- "2013-03-25"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Designing for Orzhov"
[_metadata_:wayback_capture_timestamp]:- "2016-07-19 21:04:24"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20160719210424id_/http://magic.wizards.com/en/articles/archive/making-magic/designing-orzhov-2013-03-25"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/making-magic/designing-orzhov-2013-03-25"
---
...
Welcome to Orzhov Week, the tenth and final *Return to Ravnica* block guild theme weeks. Today, as in the previous nine columns of this series ([Selesnya](/en/node/656456), [Azorius](/en/articles/archive/making-magic/designing-azorius-2012-10-29), [Izzet](/en/articles/archive/making-magic/designing-izzet-2012-11-12), [Golgari](/en/articles/archive/making-magic/designing-golgari-2012-11-26), [Rakdos](/en/articles/archive/making-magic/designing-rakdos-2012-12-10), [Boros](/en/articles/archive/making-magic/designing-boros-2013-02-04), [Simic](/en/articles/archive/making-magic/designing-simic-2013-02-18), [Gruul](/en/articles/archive/making-magic/designing-gruul-2013-03-04), and [Dimir](/en/articles/archive/making-magic/designing-dimir-2013-03-18)), I am going to be exploring the design of a certain two-color pair—today, obviously, is white and black. If you are interested in the philosophy of Orzhov or any of the other nine two-color pairs, you can go [here to see my ten columns](http://www.wizards.com/magic/magazine/features.aspx?tag=color%20pie) from the *Ravnica* block guild theme weeks where I talked about two-color philosophies.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm240_orzhovguildgate.jpg)[Orzhov Guildgate](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Orzhov+Guildgate) | Art by [John Avon](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22John%20Avon%22%5D)
...
The hardest part comes from something I said above—no enemy color pair in **Magic** more feels like enemies. The fight between the light and the dark is the core conflict of the fantasy genre. [Richard Garfield](http://www.wizards.com/Magic/Magazine/Archive.aspx?author=Richard%20Garfield) is a huge fan of mirrors in design—that is, two cards meant to represent the opposite sides of a conflict. While Richard included many in *Alpha*, one stood heads and heels over the rest:
...
[White Knight](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=White+Knight) and [Black Knight](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Black+Knight). Black, to this day, has tertiary first strike almost solely so it can be mirrored on Knights with white. What speaks more to fantasy than the side of chivalry, honor, and righteousness fighting against its selfish, dark, scheming mirror?
...
I have some strong opinions about the haunt mechanic, but before I get to those, I want to start first by explaining how haunt came to be. The mechanic was created by [Aaron Forsythe](http://www.wizards.com/Magic/Magazine/Archive.aspx?author=Aaron%20Forsythe) during *Guildpact* design. (The *Guildpact* design team was led by Mike Elliott and included Aaron, [Devin Low](http://www.wizards.com/Magic/Magazine/Archive.aspx?author=Devin%20Low), and [Brian Schneider](http://www.wizards.com/Magic/Magazine/Archive.aspx?author=Brian%20Schneider).)


![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm240_keeningapparition.jpg)[Keening Apparition](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Keening+Apparition) | Art by [Terese Nielsen](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22Terese%20Nielsen%22%5D)
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm240_executionersswing.jpg)[Executioner's Swing](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Executioner%27s+Swing) | Art by [Karl Kopinski](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22Karl%20Kopinski%22%5D)
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm240_extort.jpg)As I talked about in one of [my *Gatecrash* preview articles](/en/articles/archive/making-magic/gatecrashing-party-part-3-2013-01-14), extort was not our first attempt at an Orzhov mechanic. In fact, it wasn't our first, second, or third. It wasn't even designed by a member of the design team (although its designer, [Shawn Main](http://www.wizards.com/magic/magazine/archive.aspx?author=Shawn%20Main), was credited as being part of the design team due to his contributions designing extort and battalion). Extort was designed by a design sub-team put together at the start of *Gatecrash* "devign"—the period in between design and development where design still controls the file but development starts to give feedback to be addressed.


The sub-team recommended extort as the Orzhov mechanic but the design team was split. [Mark Gottlieb](http://www.wizards.com/Magic/Magazine/Archive.aspx?author=Mark%20Gottlieb) and I (the two co-leads) were fans. [Dave Humpherys](http://www.wizards.com/magic/magazine/archive.aspx?author=Dave%20Humpherys), who ran the sub-team, stayed neutral as to not bias the decision. [Ethan Fleischer](http://www.wizards.com/magic/magazine/archive.aspx?author=ethan%20fleischer) and Joe Huber weren't so sure about the mechanic. As Mark I and I liked it, it went into the file.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm240_vizkopaguildmage.jpg)[Vizkopa Guildmage](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vizkopa+Guildmage) | Art by [Tyler Jacobson](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22Tyler%20Jacobson%22%5D)


The team eventually came around and it was clear extort was going to be the Orzhov mechanic. The key then was figuring out what kind of cards wanted to have extort on them. For starters, it was clear that [extort worked best on creatures](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&text=+%5Bextort%5D). Extort was the kind of ability that would slowly whittle away at the opponent, but cards with it needed to be able to serve another function so that the game would progress as you were nibbling away. We did make one rare enchantment, [Blind Obedience](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blind+Obedience), which was designed to specifically slow down the opponent, to work with extort.
...
Development did make two important changes. First, in Shawn's version, the extort cost was ![](https://web.archive.org/web/20211201201921im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless1.gif). The development team felt that it needed to have a color commitment. I think development toyed with white cards costing ![](https://web.archive.org/web/20161227125855im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/white.gif) and black cards costing ![](https://web.archive.org/web/20161227195556im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/black.gif), but to make the reminder text consistent (and shorter) it decided to opt for the white-black hybrid symbol. This also indirectly helped with another problem. The ability of draining an opponent felt at home in black but was a little odd in mono-white. By using the hybrid mana, it got a skull—if even a tiny one—to help give the mono-white cards a hint of black for flavor.
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm240_knightofobligation.jpg)[Knight of Obligation](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Knight+of+Obligation) | Art by [Ryan Barger](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22Ryan%20Barger%22%5D)


### It's Black and White


And that wraps up my ten-column series about designing for the two-color pairs. I hope you enjoyed it and, as always, I would love to hear your feedback. You can write me through my email, in the thread of the column, or through any of my social media ([Twitter](https://twitter.com/maro254), [Tumblr](http://markrosewater.tumblr.com/), and [Google+](https://plus.google.com/107824009487778543249/posts)).
...
If you think that sounds like you, see the full job listing [here](http://company.wizards.com/about/careers/magic-web-content-video-producer-temporary-job-renton-wa-us?careers-view=1).
