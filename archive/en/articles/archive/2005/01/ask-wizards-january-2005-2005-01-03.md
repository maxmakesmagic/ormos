...
---
[Link to Wayback Machine](https://web.archive.org/web/20210502144954/https://magic.wizards.com/en/articles/archive/ask-wizards-january-2005-2005-01-03)
...
[_metadata_:node]:- "594911"
[_metadata_:publish_date]:- "2005-01-03"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Ask Wizards - January, 2005"
[_metadata_:wayback_capture_timestamp]:- "2021-05-02 14:49:54"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20210502144954id_/https://magic.wizards.com/en/articles/archive/ask-wizards-january-2005-2005-01-03"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/ask-wizards-january-2005-2005-01-03"
---
...
**Q:** "Is the guy that's missing in [AWOL](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=AWOL)'s picture the same guy with horns that's in [Urza's Hot Tub](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Urza%27s+Hot+Tub)?"


**A:** From **Mark Rosewater**, **Magic** R&D:


"Yes. I mean, if you were going [AWOL](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=AWOL), where better than a hot tob with some attractive babes and Urza's head? (Yes, while its not all that clear in the art, that's Urza's severed head in an inner tube. Gerard cut it off many years ago if you weren't paying attention to the novels.)"
...
"Thank you for your question, Kris. First, I trust what Kris refers to as a 'tournament description' is what the DCI calls a Match History. A Match History is a DCI member's comprehensive record of their participation in DCI-sanctioned tournaments, including the opponents they faced in each round, the result of the each match, and the ratings result from each match. DCI members can obtain access to their detailed Match History by becoming a **Magic** Player Rewards member; the application page is [here](https://www.wizards.com/default.asp?x=magic/rewards/welcome).
...
**Q:** "As the only non-*Mirrodin* Leonin(e), is [Jareth, Leonine Titan](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Jareth%2C+Leonine+Titan) supposed to be a displaced member of Raksha's tribe?"  
...
"In Jareth's case, 'leonine' is used the way you'll find it in the dictionary: 'of, relating to, or characteristic of a lion.' If you look closely, you'll see that [Jareth](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Jareth) is a huge creature of living marble or alabaster, like a great statue come to life. He's at least 10 feet tall, and is not made of flesh and fur. He's definitely not a leonin.
...
"So needless to say, [Jareth](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Jareth) and the leonin aren't related at all."
...
**Q:** "I am aware that the cards [Shadowmage Infiltrator](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Shadowmage+Infiltrator) and [Meddling Mage](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Meddling+Mage) were made by professional players, but how do you get the honour and what other cards have been made this way?"  
...
"Thanks for the question, and check back Jan. 28 for coverage of [Pro Tour - Nagoya](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=protour/nagoya05/facts), brought to you by Brian David-Marshall, Scott Johns, Ted Knutson, Paul Sottosanti, and Jonathan Becker."
...
"After *Masques*, **Magic**  cards went back to using mana symbols wherever possible. The older cards received errata in Oracle so that they couldn't be affected by color-changing effects like [Mind Bend](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mind+Bend).


"P.S. I tackled the 'add ![](https://web.archive.org/web/20211201201921im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless1.gif)' vs. 'add one colorless mana' question in an Ask Wizards on [April 21, 2003](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/askwizards/0403)."


### January 20, 2005


**Q:** "Does the trident-shaped spear in the art of [Pearlspear Courier](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pearlspear+Courier) have anything to do with [Merfolk of the Pearl Trident](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Merfolk+of+the+Pearl+Trident)? (They're both pearl tridents and they look very similar in the pictures, and the Merfolk card references soldiers, which is the theme of the courier.)"  
...
"Chris Otwell of Colorado Springs, CO. He's been playing since December 1, 1995, is a regular participant in [Friday Night **Magic**](/en/articles/archive/event-coverage/feature-super-fnm-2008-07-14), and has a DCI number that is in the eight thousands."
...
**Q:** "I was browsing Ebay for Alpha cards, and came across an Alpha [Black Lotus](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Black+Lotus). The seller posted that Alpha cards were not tournament legal for a long time. Is this true, even for Vintage format?"  
...
"Hello Kevin, and thank you for your question. The answer comes from the DCI Magic: the Gathering Floor Rules, located in the newly-revamped DCI Document Center ([thedci.com/docs](http://www.thedci.com/docs)):
...
"'Timmy, Johnny, Spike' are terms we use here in R&D to describe the different types of **Magic** players. To find out what each name means (and which one you are!), click on this link: '[Timmy, Johnny, and Spike](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/mr11)'"


### January 12, 2005


**Q:** "I saw [Randy Buehler's article](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=magic/magiconline/article121604) on December 16 about Vanguard eventually being ported to ***Magic** Online*. Can we expect a parallel re-release of the paper Vanguard cards for those not fortunate enough to collect them?"  
...
"For all those that can't wait (and we've certainly received a lot of email on this one) we'll be starting up [You Make the Card 3](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/feature/236) shortly after we're done with the *Betrayers of Kamigawa* previews, either the week of January 24 or January 31."
...
[![Gatherer 'Apply filters' drop-down](https://media.wizards.com/legacy/global/images/mtgcom_askwizards_0105_pic1_en.jpg)](http://gatherer.wizards.com/)


**A:** From **Doug Beyer**, **magicthegathering.com** web developer:


"Hi Doug, thanks for your question. The short answer is, you can. If you're trying to search [Gatherer](http://gatherer.wizards.com) for cards in those formats, use the upper drop-down menu under '3. Apply filters.' For Type 2 select 'Standard,' or for Type 1 select 'Vintage.'


"That's how you can ask Gatherer [what enormous creatures are currently in Standard](http://gatherer.wizards.com/default.asp?term=creature&fields=%7Ctype&format=Standard&color=All&output=summary&sort=power&first=1) or [what sort of tutoring is available in Vintage](http://gatherer.wizards.com/default.asp?term=search_your_library&fields=%7Crules&format=Vintage&color=All&output=summary&sort=name&first=1). Hope that helps!"
...
**Q:** "In Mark Rosewater's articles about the new slices of the color pie ('[Seeing Red](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/mr133)', '[The Great White Way](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/mr57)', etc.) he gave examples at the end of each article of people or characters who are stereotypical of their respective color. In his article, '[In the Black](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/mr109)' he made mention that the color black is not inherently evil. However, he did not give an example character for the color black who was not a bad guy, villan, or bad seed. My question is who would you at Ask Wizards classify as a 'good guy' for the color black? Someone who can be classified as a hero. (Note: Bart Simpson does not count as his motives for saving the day at any point are simply to cover his own butt.)"  
