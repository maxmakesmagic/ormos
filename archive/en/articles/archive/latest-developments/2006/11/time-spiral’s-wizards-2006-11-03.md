...
---
[Link to Wayback Machine](https://web.archive.org/web/20220813152620/https://magic.wizards.com/en/articles/archive/latest-developments/time-spiral%E2%80%99s-wizards-2006-11-03)

[_metadata_:author]:- "Aaron Forsythe"
[_metadata_:description]:- "Wizard Week is an awkward theme for me. With the exception of Voidmage Prodigy, there are no cards in Standard that care one way or the other about whether a creature is a Wizard or not. They aren't the theme of a current set, so there aren't any rules about how to develop Wizards. In fact, whether a card is a Wizard or not is a decision made by creative, not development. (The"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "612306"
[_metadata_:publish_date]:- "2006-11-03"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Time Spiral’s Wizards"
[_metadata_:wayback_capture_timestamp]:- "2022-08-13 15:26:20"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20220813152620id_/https://magic.wizards.com/en/articles/archive/latest-developments/time-spiral%E2%80%99s-wizards-2006-11-03"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/latest-developments/time-spiral%E2%80%99s-wizards-2006-11-03"
---


*Time Spiral*’s Wizards
=======================
...
Wizard Week is an awkward theme for me. With the exception of [Voidmage Prodigy](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Voidmage+Prodigy), there are no cards in Standard that care one way or the other about whether a creature is a Wizard or not.
...
![Crookclaw Transmuter](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Crookclaw+Transmuter)
...
![Drifter il-Dal](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Drifter+il-Dal)

Drifter il-Dal

If you haven't figured it out yet, the Drifter is an almost exact reprint of [Spindrift Drake](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Spindrift+Drake) from *Stronghold*. We don't do aggressive blue weenies much these days, but we felt we could do some in *Time Spiral* if they had good nostalgic links to stuff people remembered. I question just how memorable [Spindrift Drake](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Spindrift+Drake) is, but the card he spawned is proving to be a popular one regardless.
...
Endrek was a top-down design based on a character from Dominaria's past; he is the a member of the Ebon Hand and created the sinister race of Thrulls. Check out this line from the flavor text of [Basal Thrull](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Basal+Thrull):
...
Sahr's failures—the most notable being the [Derelor](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Derelor) – led for a call for his execution by other members of the Ebon Hand. From the *Fallen Empires* [Derelor](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Derelor):
...
As the story goes, the Thrulls eventually turned on their masters and overthrew the Ebon Hand, as hinted at in the flavor text of [Thrull Wizard](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Thrull+Wizard):
...
Another attempt at a flavor card. It was obvious from the start that Ith should have the ability of his [Maze of Ith](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Maze%2Bof%2BIth), and once the creative team assured us that he was “one of the good guys,” we slotted him in as the blue-white legend in our rare cycle.
...
The flavor was okay, but the ability had so many words and wasn't popular with the other developers. On top of that, he was a pretty weak card to play with, as you had to pay his mana cost (which I believe was ![](https://web.archive.org/web/20161225105850im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless2.gif)![](https://web.archive.org/web/20161227125855im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/white.gif)![](https://web.archive.org/web/20161115194122im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/blue.gif) at the time) plus twelve more mana before you could use him.


With the possibility of the card being cut from the set, I came to the conclusion that we should just use the “wait before you can use your card” mechanic we were already featuring in *Time Spiral*: suspend. “![](https://web.archive.org/web/20161227125855im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/white.gif)![](https://web.archive.org/web/20161115194122im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/blue.gif)—Suspend 4” is such a cleaner ability for this card, and I got to make my slow-pay-to-remove-counters-for-a-big-effect card with [Dark Depths](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dark+Depths) in *Coldsnap*. Everyone wins!
...
![Lim-Dul the Necromancer](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Lim-Dul+the+Necromancer)
...
Lim-Dul began life as a ![](https://web.archive.org/web/20161227130050im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless3.gif)![](https://web.archive.org/web/20161227195556im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/black.gif)![](https://web.archive.org/web/20161227195556im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/black.gif) 4/4 that had the ability to repeatedly [Zombify](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Zombify) two creatures at a time… provided they had the same name. So, while he couldn't bring a lone [Simic Sky Swallower](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Simic+Sky+Swallower) back to life, he could bring back a pair of them all at once, should two of them end up in the bin somehow.


I liked the idea of the design (Rosewater's, by the way… yes, we pick on his cards just as much as we pick on [Great Designer Search](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/designersearch/home) contestants), but felt the execution was off. My comment from last October: “We need to talk about if this is the right ability. I have the feeling it will come up about as much as [Bloodbond March](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Bloodbond+March), which was (frustratingly) almost never.”
...
![Mangara of Corondor](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Mangara+of+Corondor)
...
I imagine there is supposed to be some kind of flavor to Mangara's ability, but I don't remember what we were thinking at the time. His character is clearly white, and is most famous for being trapped in the [Amber Prison](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Amber+Prison). (**Magic** story fans must enjoy tales of people being trapped.) Perhaps his ability is meant to evoke him blinking out of the [Amber Prison](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Amber+Prison) and into the post-apocalyptic world, grabbing a hold of something, and then taking it with him when he is sucked back through time to the Prison. Sounds good, right?


Some of you have already figured out that Mangara's ability is worded such that he doesn't remove himself from the game as a cost, so if you can untap him or remove him from play via some other means ([Tolarian Sentinel](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tolarian+Sentinel), [Momentary Blink](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Momentary+Blink), etc.), or if the target of his ability becomes illegal (and thus his effect is countered on resolution), you'll get to use him more than once. This odd template was a conscious decision by R&D to enable such trickery. I'll admit to being against that template at the time, but I've grown to love Mangara for all of his combo potential.
...
![Pit Keeper](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Pit+Keeper)

Pit Keeper

[Pit Keeper](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pit+Keeper) was the first card designed by **Magic** Assistant Brand Manager Jake Theis to make it into a **Magic** set. There is a small group of **Magic** players in the company that work in other departments than R&D that we'll often include in the mailing we do when soliciting submissions to fill holes in a set, and occasionally we'll use cards from those people.


Jake showed enough promise that he's going to be starting a six-month gig in R&D next week as part of some of the design and development teams for sets in the “Peanut” block. And to think, it may have all started with [Pit Keeper](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pit+Keeper).


[Pit Keeper](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pit+Keeper) is a great common card for *Time Spiral*. It has a nostalgic ability (from [Oversold Cemetery](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Oversold+Cemetery)) and provides interesting play decisions. How greedy are you? Are you willing to wait turn after turn to get +1 card advantage, or will you play the Keeper ASAP to get some damage in and trade with an opposing creature? A fine design.
...
A simple, simple card; its playtest name was merely “Sage.” [Sage Owl](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sage+Owl) has long been a favorite of many players, and we felt that we owed them a nice, cheap version after heartlessly yanking the original out of the Core Set in *Ninth Edition*.


I was surprised to see that some very good **Magic** players were including this card in their decks at [Pro Tour – Kobe](/en/articles/archive/event-coverage/2006-10-20-0). We didn't give it that much respect in our playtesting.
...
Devin Low made the card during *Coldsnap* design; it was part of the three-color gold rare cycle. Its mana cost was ![](https://web.archive.org/web/20161227130050im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless3.gif)![](https://web.archive.org/web/20220123123600im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/green.gif)![](https://web.archive.org/web/20161227125855im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/white.gif)![](https://web.archive.org/web/20161115194122im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/blue.gif) and its playtest name was “Lord Panthro” (as a nod to [Fleetfoot Panther](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fleetfoot+Panther)), but everything else was the same.
...
I put forth the claim that a lot of the rares that I found exciting in the set let me experience cards that had generally been considered too good to ever print again. *Time Spiral* offered me [Ancestral Recall](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ancestral+Recall), [Balance](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Balance), [Wheel of Fortune](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wheel+of+Fortune), [Juzam Djinn](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Juzam+Djinn), all kinds of “taboo” cards in new and balanced – yet still plenty exciting – forms. There had to be more of that kind of stuff available, and this was the set to do it in. My mind drifted to artifacts. We had a [Black Lotus](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Black+Lotus) and [Gauntlet of Might](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gauntlet+of+Might), but there were many, many more powerful artifacts than that out there. After all, artifacts have historically been some of the most broken cards in the game. Then it hit me.


“We should do new versions of really powerful artifacts, except we can't do them as artifacts or else they'd just have to be too expensive to be cool. Let's just make creature versions of stuff like [Nevinyrral's Disk](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Nevinyrral%27s+Disk), [Black Vise](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Black+Vise), and [Cursed Scroll](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cursed+Scroll) – stuff they'd never expect to see back.”


Brian liked it. We started naming all the decent candidates and proposing colors for them. Disk and Scroll were locks. [Memory Jar](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Memory+Jar), one of the most insane artifacts of all time, would be a great fit, pending testing that it wouldn't be too good even as a creature. We sped back to the office and looked up old artifacts, settling on the cycle in under an hour. The way things fit into colors was almost too good to be true. Brian shopped them around, they went over extremely well, and suddenly they were in the set and being painted – all by some of our best artists, might I add. Even creative took the ball and ran with it on these cards.
...
| Thallids (green) | 2655 | 21.7% |
| One Big Turn (red) | 1505 | 12.3% |
| Madness (black) | 1493 | 12.2% |
| Morph (blue) | 1180 | 9.6% |
| Flanking (white) | 1043 | 8.5% |
