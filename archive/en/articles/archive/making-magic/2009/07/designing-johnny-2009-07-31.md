...
---
[Link to Wayback Machine](https://web.archive.org/web/20170323225719/http://magic.wizards.com/en/articles/archive/making-magic/designing-johnny-2009-07-31)
...
[_metadata_:node]:- "188361"
[_metadata_:path_date]:- "2009-07-31"
[_metadata_:publish_date]:- "2009-08-03"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Designing For Johnny"
[_metadata_:wayback_capture_timestamp]:- "2017-03-23 22:57:19"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20170323225719id_/http://magic.wizards.com/en/articles/archive/making-magic/designing-johnny-2009-07-31"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/making-magic/designing-johnny-2009-07-31"
---
...
Welcome to Johnny Week, part two of our series of player psychographic theme weeks. (The first one, Timmy Week, was back in March—you can see my column on designing for Timmy [here](/magic/Magazine/Article.aspx?x=mtg/daily/mm/29).) If you're not familiar with our player psychographics, I suggest checking my most recent article on them ([Timmy, Johnny, and Spike Revisited](/magic/magazine/article.aspx?x=mtgcom/daily/mr220b)). Once you've caught up on all the required reading (do any other columns you read require homework?), it's time to jump into the meat of this week's column. As I did during Timmy Week, I am going to spend my column explaining how we design for the psychographic in question. This time, of course, it's Johnny's turn.

Here's Johnny
![](https://media.wizards.com/legacy//mtg/images/daily/mm/mm50_brain.jpg)Before I can explain how we design for Johnny I want to start by making sure everyone knows who Johnny is. Johnny is one of the three player psychographics that **Magic** Ramp;D uses to design and develop cards. This, of course, leads to the question what is a player psychographic? A psychographic is a psychological profile that isolates different personality traits and behaviors to help the people using the profile (in this case Ramp;D) better understand what motivates a particular type of player to act a certain way. Learning what different players want out of **Magic** is important for a number of reasons. First, knowledge of which groups exist helps us understand what elements have to be included in each set. Second, knowing what players want helps us design those things into the cards.
...
It's just us now? Good. I just wanted to take a moment to say that as a fellow Johnny I understand the thrill of the hunt. I know the ecstasy of finding something cool that no one else has found yet. I understand the joy of making something work that no one else believed in. I know the buzz you can get from seeing the sparkle in your friends' eyes when you show off what you've done. These moments are pure bliss, and I urge you to embrace them whenever you can. The others may not understand what makes us tick, but that only means they cannot relate to how good it makes us feel. Embrace your Johnniness. It is something special and worthy of being encouraged.
...
![](https://web.archive.org/web/20130603120852im_/http://wizards.com/mtg/images/daily/mm/mm50_timmyJohnnyCross.jpg)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Stone-Tongue+Basilisk)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stone-Tongue+Basilisk)  
[Stone-Tongue Basilisk](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stone-Tongue+Basilisk) was designed for Timmy. Meet a clearly stated condition and you get to combine two very synergistic abilities. This card isn't as well suited for Johnny because the "trick" is printed blatantly on the card. There's no discovery to be had. 
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=entomb)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Entomb)  
...
The Modular Squad
Which brings us to a related point. Many years ago when *Mirrodin* was being released, I wrote a design article about a scale that examined how cards used synergy ([Come Together](/Magic/magazine/Article.aspx?x=mtgcom/daily/mr92)). I named the two ends of the scale linear and modular. Linear cards are cards that beget the use of other cards. Modular cards, on the other hand, are cards that don't push a deck towards needing anything in particular. An example of a linear card would be [Goblin King](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Goblin+King), while a typical modular card would be [Naturalize](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Naturalize). The [Goblin King](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Goblin+King) heavily encourages you to include Goblins, while the [Naturalize](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Naturalize) does very little to defining the rest of your deck.
...
![](https://media.wizards.com/legacy//mtg/images/daily/mm/mm50_peanutbutterchocolate.jpg)  
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Leveler)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Leveler)  
[Leveler](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Leveler) provides a sweet reward up front—a 10/10 for ![](https://web.archive.org/web/20170413132456im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless5.gif)—and then forces the players to deal with a hideous limitation: the loss of your library. This card is a Johnny card because it throws down the gauntlet. It says, "I dare you to figure out how to use me."
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=One+With+Nothing)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=One+with+Nothing)  
[One with Nothing](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=One+with+Nothing) was famous for stirring up a big segment of the audience who was offended that we printed a card that was so obviously worthless. What most of them failed to understand was that it was the majority's rejection of this card that made it so much fun for the Johnnies who used it. Anyone can win with a good card. These Johnnies enjoy winning with bad ones. 
...
[Quirion Ranger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Quirion+Ranger) was an excellent Johnny card because it allowed so many fun tricks. Just as Johnny can show off a combination in his deck so too can he demonstrate a cool trick using an interesting card. The key here is that what Johnny uses to express himself can come from many different levels. It doesn't always have to be from the perspective of deck building. Given the right tools, Johnny can express himself in many ways.
...
[![](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Firemaw+Kavu)](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Firemaw+Kavu)  
The trick was this. If you needed to turn the spell into 4 damage to a creature right away, you could do the following: When the card enters the battlefield, you have the [Firemaw Kavu](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Firemaw+Kavu) deal 2 damage to itself. This will destroy it, causing the Firemaw to go to the graveyard and triggering its 4 damage ability. 
...
In March of 2007, I ran a blurb at the end of [my column](/Magic/magazine/Article.aspx?x=mtgcom/daily/mr270) explaining about the opening of a position on the **Magic** brand team. 

Now let me introduce you to someone.

![](https://media.wizards.com/legacy//mtg/images/daily/mm/mm50_purvis.jpg)This is Mark Purvis. Last week, Mark was promoted to Brand Manager of **Magic**. Mark was a reader of "Making **Magic**" that clicked through to the link and applied for the job above. People always ask me how they can get a job at Wizards. The answer is to pay attention to blurbs like this.

So what is the **Magic** Brand Team looking for? Very simply, they want someone who understands both **Magic** and business. If your Venn Diagram overlaps on these two areas, then this might be a golden job opportunity. Click on [this link](http://hasbro.recruitmax.com/MAIN/careerportal/Job_Profile.cfm?szOrderID=3856amp;szReturnToSearch=1amp;szWordsToHighlight=) to check out what this job entails. You can also click on [this link](http://ww2.wizards.com/Company/Jobs/) if this job doesn't sound like a good fit for you but you want to see what other offerings Wizards currently has.
