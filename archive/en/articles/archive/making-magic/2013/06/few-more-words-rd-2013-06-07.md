...
---
[Link to Wayback Machine](https://web.archive.org/web/20211028000316/https://magic.wizards.com/en/articles/archive/making-magic/few-more-words-r%1Ad-2013-06-07)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "A little more than eight years ago, I wrote an article entitled `A Few Words from Ramp;D,` in which I listed a bunch of Ramp;D lingo that I then went on to define. Well, in the last eight years, we've managed to come up with a lot more lingo, so I thought I would write a follow-up with an entire article of even more Ramp;D vocabulary explained. Note that I've chosen not to"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "198956"
[_metadata_:path_date]:- "2013-06-07"
[_metadata_:publish_date]:- "2013-06-10"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "A Few More Words from RD"
[_metadata_:wayback_capture_timestamp]:- "2021-10-28 00:03:16"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20211028000316id_/https://magic.wizards.com/en/articles/archive/making-magic/few-more-words-r%1Ad-2013-06-07"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/making-magic/few-more-words-r%1Ad-2013-06-07"
---
...
A little more than eight years ago, I wrote an article entitled "[A Few Words from Ramp;D](http://archive.wizards.com/magic/magazine/Article.aspx?x=mtgcom/daily/mr160)," in which I listed a bunch of Ramp;D lingo that I then went on to define. Well, in the last eight years, we've managed to come up with a lot more lingo, so I thought I would write a follow-up with an entire article of even more Ramp;D vocabulary explained. 

 Note that I've chosen not to repeat any lingo that appeared in the first article, so I would check it out if you haven't read it yet. I will warn you that a bunch of the lingo is outdated, so here are the ones that we still use today (some more often than others): "Bah-roken," C, Clever Cards, D, The Danger Room, Discriminator card, The Free Table, FFL, Hat Trick, Incrementals, Johnny, Johnny Card, Looter ability, Multiverse, [Ophidian](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ophidian) ability, The Pit, Promotable, Rangestrike, [Rootwalla](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rootwalla) ability, Sexy, Spike, Spike card, Sticker Stock, Tim ability, Timmy, Timmy card, Tweak, Vanilla creature, WUBRG, and Wyluli ability. 

![](https://media.wizards.com/images/magic/daily/mm/mm251_murmuring_phantasm.jpg)  
With that out of the way, let's get to the definitions:

A/B/C
 "We need to make another **A**." 

 One of the tools development uses to determine power level in Limited is to rank cards on an A/B/C system. (A is the best while C is the worst. I'll let [Latest Developments](http://archive.wizards.com/Magic/magazine/archive.aspx?tag=latest%20developmentsamp;description=latest%20developments) explain the details one of these days.) The result of this is that there is a lot of talk in the Pit of "A cards" and "B cards" and "C cards." 
...
![](https://media.wizards.com/images/magic/daily/mm/mm251_biodome.jpg)Biodome
...
Card Crafting
 ...
 Once a week, all the core designers and developers (see below) get together with [Aaron Forsythe](http://archive.wizards.com/Magic/Magazine/Archive.aspx?author=Aaron%20Forsythe) to talk through tactical issues dealing with **Magic**. This meeting tends to get very hands-on, as we discuss things like whether we want to shift an ability in the color pie or how to solve a large meta-issue either design or development is facing. 

![](https://media.wizards.com/images/magic/daily/mm/mm251_chessy.jpg)Chessy
...
Core Designer
 ...
 A core designer is one of the people hired full time to do **Magic** design. The current core designers are myself, [Mark Gottlieb](http://archive.wizards.com/Magic/Magazine/Archive.aspx?author=Mark%20Gottlieb), [Ken Nagle](http://archive.wizards.com/Magic/Magazine/Archive.aspx?author=Ken%20nagle), [Ethan Fleischer](http://archive.wizards.com/magic/magazine/archive.aspx?author=ethan%20fleischer), [Shawn Main](http://archive.wizards.com/magic/magazine/archive.aspx?author=Shawn%20Main), and Dan Emmons. 

Core Developer
"The costing's legit. I asked one of the core developers."

 A core developer is one of the people hired full time to do **Magic** development. The current core developers are [Erik Lauer](http://archive.wizards.com/magic/magazine/archive.aspx?author=Erik%20Lauer), [Dave Humpherys](http://archive.wizards.com/magic/magazine/archive.aspx?author=Dave%20Humpherys), [Tom LaPille](http://archive.wizards.com/magic/magazine/archive.aspx?author=Tom%20LaPille), [Billy Moreno](http://archive.wizards.com/magic/magazine/archive.aspx?author=Billy%20Moreno), and [Sam Stoddard](http://archive.wizards.com/magic/magazine/archive.aspx?author=Sam%20Stoddard). (The current development interns are Ian Duke and Ben Hayes.) 
...
GDS
 ...
 Short for "The Great Designer Search," the reality-show-like event we use to find new designers. Four of the six current core designers come from The Great Designer Search. (Ken Nagle came in 2nd in [the first GDS](https://archive.wizards.com/magic/magazine/article.aspx?x=mtgcom/designersearch/home), Ethan Fleischer won [the second GDS](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/feature/133), Shawn Main came in 2nd in the second GDS, and Dan Emmons was involved in the community, helping out the finalists of the second GDS.) 

Grok
 "The design is interesting but I don't think the audience will **grok** it." 

 This word comes from the book [Stranger in a Strange Land](http://en.wikipedia.org/wiki/Stranger_in_a_Strange_Land) by [Robert Heinlein](http://en.wikipedia.org/wiki/Robert_A._Heinlein). In the book, it means "to intimately and completely share the same reality or line of thinking with another physical or conceptual entity." Ramp;D uses the word to mean "[to intuitively understand](http://www.merriam-webster.com/dictionary/grok)." Usually, it's used in the context of whether or not players will "get" what a card does. 
...
New World Order
 ...
 This was a new philosophy adopted by Ramp;D during the *Shards of Alara* block. The core idea of New World Order is that we simplify common cards to make the game easier to learn, as a newer player's card collection skews much more toward common. For more on this concept, read [my article on New World Order](http://archive.wizards.com/magic/magazine/Article.aspx?x=mtg/daily/mm/172). 
...
Skulking
 ...
 This is Ramp;D's nickname for the ability "When this card becomes the target of a spell or ability, sacrifice it." It's named after the card [Skulking Ghost](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Skulking+Ghost) from *Mirage*. The ability has since shifted from black to blue. Ramp;D still tends to call it "skulking" although it's sometimes now called "the illusion ability," as it's used exclusively now to mechanically represent illusions. It's funny to note that the word "skulking" was not what represented that ability in [Skulking Ghost](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Skulking+Ghost)'s name. The mechanic was meant to top-down "ghost." 
...
"We've already done trample. How about stalking?"
 ...
 This is Ramp;D's nickname for the ability "can't be blocked by more than one creature." It's named after the card [Stalking Tiger](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stalking+Tiger) from *Mirage* that had this ability. 
...
Trinket Text
 ...
 Trinket text is rules text that adds flavor to a card but usually has very little mechanical impact. A classic example of trinket text would be the "[Vindictive Mob](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vindictive+Mob) cannot be blocked by Saprolings" on *Ravnica*'s [Vindictive Mob](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vindictive+Mob). Trinket text can matter but seldom does. Trinket text is often used because it allows design and development to make a card more flavorful without making it any more powerful. 
...
A virtual vanilla creature is one that, after the first turn it's on the battlefield, basically functions like a vanilla creature. Most often, virtual vanilla creatures have "enters the battlefield" effects or have flash or haste. (And yes, haste can matter in corner cases, but the vast majority of the time haste is meaningless past the first turn.) And yes, this means that there is a term "virtual French vanilla creature" for a creature that is essentially a French vanilla creature after the first turn.

[card]1955[/card]War Drums
"Red needs more evasion and we already have an intimidate creature. How about war drums?"

 This is Ramp;D's nickname for the ability "can't be blocked except by two or more creatures." This card is named after the card [Goblin War Drums](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Goblin+War+Drums) from *Fallen Empires*. 

Word!
 That's all the words I have for you today. I hope you enjoyed the look behind the scenes of Ramp;D's everyday lingo. As always, I'm curious to hear your feedback on what I talked about today. You can email me, respond in the thread, or send me a message through my social media ([Twitter](https://twitter.com/maro254), [Tumblr](http://markrosewater.tumblr.com/), and [Google+](https://plus.google.com/107824009487778543249/posts)). 
