...
---
[Link to Wayback Machine](https://web.archive.org/web/20220705164359/https://magic.wizards.com/en/articles/archive/command-tower/dear-stybsy-2015-12-17)
...
[_metadata_:node]:- "939126"
[_metadata_:publish_date]:- "2015-12-17"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Dear Stybsy"
[_metadata_:wayback_capture_timestamp]:- "2022-07-05 16:43:59"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20220705164359id_/https://magic.wizards.com/en/articles/archive/command-tower/dear-stybsy-2015-12-17"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/command-tower/dear-stybsy-2015-12-17"
---
...
[Teferi's Puzzle Box](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Teferi%27s+Puzzle+Box) | Art by [Donato Giancola](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=+%5B%22Donato+Giancola%22%5D)
...
> 
> [@the\_stybs](https://twitter.com/the_stybs) unconventional ways to build a commander group when all others have failed...
> 
> 
> — EDH.ghost (@EDHGhost) [August 12, 2015](https://twitter.com/EDHGhost/status/631519351170961409)
...
> 
> [@the\_stybs](https://twitter.com/the_stybs) How much spot removal (thinking creatures) do you think belongs in a [#cmdr](https://twitter.com/hashtag/cmdr?src=hash) deck? I run more than most and have been very happy
> 
> 
> — Kyle Carson (@KyleCCarson) [August 12, 2015](https://twitter.com/KyleCCarson/status/631519749818560512)


The amount of spot removal I think needs to be in a deck is precisely the amount it wants—no more and no less.


What I think you're asking me is whether players run *too few* spot removal spells in decks. That's a much tougher one to tackle. I believe efficiency is important for Commander decks. A card like [Crux of Fate](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Crux+of+Fate) or [End Hostilities](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=End+Hostilities) will answer far more creatures at once than [Murderous Cut](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Murderous+Cut) or [Silence the Believers](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Silence+the+Believers). You get more bang for your buck with those sweeping sorceries than with a single stinging instant.


I like to keep a mix and hedge on giving myself choices. More players should consider single-target removal when it can be flexible for your needs: [Suppression Bonds](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Suppression+Bonds), [Hero's Downfall](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hero%27s+Downfall), [Mortify](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mortify), [Putrefy](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Putrefy), and even [Return to the Earth](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Return+to+the+Earth) all cover multiple bases. Those extra choices add up to make up for not scorching the earth with every removal spell.


It's [Tragic Arrogance](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tragic+Arrogance) if sweepers are all anyone considers.
...
> 
> [@the\_stybs](https://twitter.com/the_stybs) Do you build the deck around the commander or pick the commander for the deck?
> 
> 
> — Jim Casale (@Phrost\_) [August 12, 2015](https://twitter.com/Phrost_/status/631519977611235328)
...
> 
> [@the\_stybs](https://twitter.com/the_stybs) How to build a deck that doesn't have a theme.
> 
> 
> — Cole (@Mindmage) [August 12, 2015](https://twitter.com/Mindmage/status/631520281220136962)


Just pile up cards at random, using the first legendary creature you hit as a commander and excluding every card you find that can't be used. [This will help.](http://gatherer.wizards.com/Pages/Card/Details.aspx?action=random)
...
> 
> [@the\_stybs](https://twitter.com/the_stybs) Why won't they ban Dead-Eye Navigator?
> 
> 
> — Mike 'Pope' Cummings (@PopeMike) [August 12, 2015](https://twitter.com/PopeMike/status/631521335919816705)
...
> 
> .[@the\_stybs](https://twitter.com/the_stybs) Hey Adam, what are your thoughts on game ending combos in [#EDH](https://twitter.com/hashtag/EDH?src=hash) and what turn is too early to use them to end a game?
> 
> 
> — Alex Szeto (@Alexckszeto) [August 12, 2015](https://twitter.com/Alexckszeto/status/631522442582716416)



> 
> [@the\_stybs](https://twitter.com/the_stybs) Help me understand why some people apologize after comboing out in a game of commander with cards they selected for their deck.
> 
> 
> — Tom Delia (@mtgradio) [August 12, 2015](https://twitter.com/mtgradio/status/631523251894628352)
...
> 
> [@the\_stybs](https://twitter.com/the_stybs) How do you handle someone who grows frustrated/quits after weeks of running known problem generals and not winning?
> 
> 
> — Erik Tiernan (@Erik\_Tiernan) [August 13, 2015](https://twitter.com/Erik_Tiernan/status/631619316392284160)


You should have stopped killing them on the spot first. Maybe.


There's two way I can read your question. If they're playing dangerous commanders known for winning games quickly and they have the decks that ensure it happens, the failure lies in everyone not agreeing on the Commander experience they're seeking. Building on a common understanding is hard, but [pointing to a common ground on which to start](http://magic.wizards.com/en/articles/archive/serious-fun/commander-laws-public-gatherings-2012-10-29) might help.
...
If you haven't discussed why someone is getting focus-fired upon, and vetted if that was a reasonable course of action or not, then there's more difficult motivations at work than just the random [Rafiq of the Many](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rafiq+of+the+Many) you made sure never went anywhere.
...
> 
> [@the\_stybs](https://twitter.com/the_stybs) How do you define the EDH social contract?
> 
> 
> — Erik Tiernan (@Erik\_Tiernan) [August 13, 2015](https://twitter.com/Erik_Tiernan/status/631619964227690496)


I don't. Some members of the Commander Rules Committee do a great job [sharing the philosophy I defer to](http://www.starcitygames.com/php/news/print.php?Article=18307).
...
> 
> What made the banned cards in Commander, well, banned? I've tried to find a list that explains them, but it doesn't seem to exist. It's important to understand why cards are banned, so we can decide for ourselves when the "others like them" clause is relevant. For example: I expect that [Emrakul, the Aeons Torn](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Emrakul%2C+the+Aeons+Torn) is banned because it enables infinite turns with a two-card combo, but I don't know that for fact. If correct, then I shouldn't use any two-card infinite-turn combos (IE: [Charnelhoard Wurm](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Charnelhoard+Wurm) plus [Temporal Extortion](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Temporal+Extortion)). I don't see how Emrakul is different than other two-card auto-wins.
> 
> 
> - Mike
> 
...
My suggestion is to have [Magic Duels](http://magic.wizards.com/en/content/magic-duels) on your phone handy, for use during that bonus half hour you have if you're the first to go.
...
I hope you had as much fun seeing these answer as I had creating them. Give me a shout-out on Twitter (I'm [@the\_stybs](https://twitter.com/the_stybs)!) if you enjoyed this format for an article. I'm willing to revisit it again when the time's right.
