...
---
[Link to Wayback Machine](https://web.archive.org/web/20161130194503/http://magic.wizards.com/en/articles/archive/making-magic/i-want-threshold-your-hand-or-possibly-my-artifacts-2010-10-18)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "Welcome to Metalcraft Week! This week we'll be discussing one of the Mirran mechanics from Scars of Mirrodin. When a deadly plague-like force seeks to infect your whole plane, you have to pull out a few big guns."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "652936"
[_metadata_:publish_date]:- "2010-10-18"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "I Want to Threshold Your Hand (Or Possibly My Artifacts)"
[_metadata_:wayback_capture_timestamp]:- "2016-11-30 19:45:03"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20161130194503id_/http://magic.wizards.com/en/articles/archive/making-magic/i-want-threshold-your-hand-or-possibly-my-artifacts-2010-10-18"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/making-magic/i-want-threshold-your-hand-or-possibly-my-artifacts-2010-10-18"
---
...
Welcome to Metalcraft Week! This week we'll be discussing one of the Mirran mechanics from *Scars of Mirrodin*. When a deadly plague-like force seeks to infect your whole plane, you have to pull out a few big guns. During the second week of [*Scars* previews](/en/articles/archive/something-wicked-way-comes-part-2-2010-09-13), I talked about the creation of metalcraft so I thought I'd use today's column to step back and look not at metalcraft specifically but at the larger group of mechanics that metalcraft is a part of—something we refer to in R&D as threshold mechanics.
...
![Springing Tiger](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Springing+Tiger)  
[Springing Tiger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Springing+Tiger) is a 3/3 creature (State A). If you ever have seven or more cards in your graveyard, though, [Springing Tiger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Springing+Tiger) turns into a 5/5 creature (State B).

Now let's look at a metalcraft card:

![Carapace Forger](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Carapace+Forger)  
[Carapace Forger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Carapace+Forger) is a 2/2 creature (State A). If though you ever have three or more artifacts on the battlefield, [Carapace Forger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Carapace+Forger) turns into a 4/4 creature (State B). 

As you can see, threshold cards are structurally very similar. (Note that by "threshold cards," I mean the class I'm talking about, not cards with the *Odyssey* mechanic threshold. I'm using this word because it is the slang R&D uses, but I agree it would be less confusing if the category wasn't named after a mechanic in the category. When I use the word "threshold" for the remainder of the article, unless I specify otherwise I'm talking about the class of cards.) The only real difference between them is what causes the swap from A to B. Luckily, this one difference is a pretty important one. For example, [Springing Tiger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Springing+Tiger) and [Carapace Forger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Carapace+Forger) go into very different types of decks. The use of a threshold mechanic in one area does not impede on the use of it in another. As such, threshold mechanics have a considerable amount of design space.
...
![Keldon Warlord](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Keldon+Warlord)  
...
Clearly Keldon Shoeshine Boy is a threshold card, so why wouldn't [Keldon Warlord](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Keldon+Warlord) be? It's just Keldon Shoeshine Boy with more possible states.

Note that in my definition of threshold I included "various" states rather than two. Why? Imagine this card:


> 
> **Super-[Carapace Forger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Carapace+Forger)**  
>  2G  
>  Creature – Elf Artificer  
>  Metalcraft – Super-[Carapace Forger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Carapace+Forger) gets +2/+2 as long as you control three or more artifacts.  
>  Mega Metalcraft - Super-[Carapace Forger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Carapace+Forger) gets +6/+6 as long as you control seven or more artifacts.
> 
> 

Is this card not a threshold card? Adding abilities to it doesn't remove it from the category. It still meets all the criteria. From this we know that threshold cards can have more than two states (well, that and I stated such above). Which brings us back to [Keldon Warlord](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Keldon+Warlord). He is what we'd refer to in R&D as a scaling threshold card. That is, he changes states based on external criteria but there are a large number of iterations. Usually this happens when you are counting the existence of something and each additional thing makes the card stronger.

What this means is that there is a spectrum of threshold cards. (By the way, Devin Low covered this topic in relation to tribal mechanics [back in 2007](/en/articles/archive/latest-developments/count-me-vs-threshold-zero-2007-11-09) if you want to see this discussion from a different vantage point.) On one end we have threshold one. These cards just need one single thing to create their change. [Kird Ape](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kird+Ape) is an example of this end of the spectrum. The other end of the spectrum is count-me threshold where the threshold has various stages each dependent on how many you have of a particular thing. [Keldon Warlord](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Keldon+Warlord) is an example of this end of the spectrum.
...
Now we get to talk about designing threshold mechanics. What are the lessons, R&D has learned over the years?
...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm113_blast.jpg)  
...
There's been a lot of talk on the boards about tension lately. Tom mentioned in an [article](http://www.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/ld/110) a few weeks back how we changed the spellbombs in *Scars of Mirrodin* to lessen a certain tension. (Although I should add that it increases tension on a different axis—do I spend them before I can get the extra card?) This prompted a big discussion about the importance of tension for strategic play. Let me state for the record that R&D isn't against tension. That said, all tensions are not made equal. Tension unto itself is not a positive thing. Forcing a player to make strategic choices can be good game play, but those choices have to empower the player not make him or her feel helpless.

Both complexity and tension are valuable tools when used in the right amount and in the right places. Used incorrectly though, both have the ability to lessen the fun of the game. The role of R&D is to figure out when and where to use tension to maximize enjoyability. This is especially true on threshold mechanics because getting the right combination of factors is all about setting the tension level in the right place.
...
Playtesting proved having three different versions to be brain melting. It was more information than someone could track without dedicating most of your mental resources to it. In design, we call this a "brain freeze." You see, there is a line where you overload the players so much that they are incapable of mentally processing enough to function. (And yes, this line varies from player to player.) Most players never have to think about concepts like brain freeze because R&D never lets brain freeze-inducing sets out the door. (I'm sure there are those that would argue on this point.)

![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/mm/mm113_stoic.jpg)  
