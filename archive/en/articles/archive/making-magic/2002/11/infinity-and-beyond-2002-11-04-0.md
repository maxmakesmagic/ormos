...
---
[Link to Wayback Machine](https://web.archive.org/web/20170104175815/http://magic.wizards.com/en/articles/archive/making-magic/infinity-and-beyond-2002-11-04-0)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "Welcome to Mana Engine Week! This week we’ll be exploring card combinations that allow you to create an endless amount of mana. As many of our other writers will explore this week, there’s quite a number of such combos. As for me, I thought I’d use my column to answer a number of common design questions connected to `infinite` mana engines."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "618126"
[_metadata_:publish_date]:- "2002-11-04"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "To Infinity and Beyond"
[_metadata_:wayback_capture_timestamp]:- "2017-01-04 17:58:15"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20170104175815id_/http://magic.wizards.com/en/articles/archive/making-magic/infinity-and-beyond-2002-11-04-0"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/making-magic/infinity-and-beyond-2002-11-04-0"
---
...
|  |
| --- |
| *[Power Artifact](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Power+Artifact)/[Grim Monolith](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grim+Monolith): One of the easiest mana engines to play.* |
...
A good example is the card [Hand to Hand](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hand+to+Hand) from *Tempest* (click on the words “Hand to Hand” if you don’t know what it does). I designed the card to be a “don’t mess with my guys in combat” card. In tournament play though, it got used as a sideboard card in red decks that was brought in against certain white decks. Since abilities couldn’t be activated during combat it kept players from activating their [Circle of Protection: Red](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Circle%2Bof%2BProtection%253A%2BRed). Did I have this idea in mind when I created the card? No. Did I mind the shift in usage? Absolutely not. I was actually pleased that the public found a way to use the card that I had never thought of.

Design, by nature, is just not deck-oriented. The reason for this is the modular design of trading card games. Trading card games live and die by the ability for the cards to intermix in interesting combinations. In order to maximize this, it’s important that the designers create cards that have maximum interactivity. Thus, when I create a card, I don’t spend a great deal of time figuring out what deck will use the card. I just make generally useful cards and assume that players will find uses for them. This doesn’t mean every card will find a tournament-worthy use. And as I’ve explained in my bad card article (“[When Cards Go Bad](http://archive.wizards.com/default.asp?x=mtgcom/daily/mr5)”), not every card will find a deck. But open-ended design increases the flexibility of the cards.
...
The answer to this question varies a bit in R&D, so I’ll give you my take. I like infinite combos… in moderation. As I’ve explained before, **Magic** is broken up into different types of players (“[Timmy, Johnny, and Spike](/en/articles/archive/making-magic/timmy-johnny-and-spike-2002-03-11)”). I believe infinite combos are good for Johnny and bad for Spike. Johnny has fun seeing what he can do with a **Magic** deck. Spike merely wants to win. Infinite combos provide Johnny with the ability to do bizarre and cool things. Infinite combos in Spike’s hands can cause problems. Let me explain.

There are two types of combo decks: what I’ll call fast combo and slow combo. Fast combo decks win by getting the combo off quicker than the opponent can do anything about it. As such, it turns **Magic** into a game of solitaire. **Magic** is supposed to have player interaction, so when fast combos get played, the game gets less fun. The best example of this was a period in 1998 called “Combo Winter.” Certain degenerate cards in the *Urza’s Saga* block created an environment where games could be won in one or two turns. (One of the most famous stories of that time involved Brian Hacker playing only a [Gustha's Scepter](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gustha%27s+Scepter) on the first turn, and winning the game on the second turn.) The joke at the time was the **Magic** game had shifted. The early game was the flipping of the coin to see who would go first. The mid-game was drawing your opening hand and deciding whether to mulligan. And the end game was the first turn.
...
|  |
| --- |
| *A nice slow combo: [Carnival of Souls](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Carnival+of+Souls), [Contemplation](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Contemplation), [Tortured Existence](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tortured+Existence), [Ashnod's Altar](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ashnod%27s+Altar), [Initiates of the Ebon Hand](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Initiates+of+the+Ebon+Hand), [Ornithopter](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ornithopter), and [Basking Rootwalla](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Basking+Rootwalla). Talk amongst yourselves.* |
...
* [Channel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Channel) – trades life for mana
* [Necroptence](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Necroptence) – trades life for cards
* [Cadaverous Bloom](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cadaverous+Bloom) – trades cards for mana
* [Treasure Trove](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Treasure+Trove) – trades mana for cards
* [Peace of Mind](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Peace+of+Mind) – trades cards (and mana) for life
* [Dream Halls](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dream+Halls) – trades cards for, well, just about anything
* [Earthcraft](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Earthcraft) – trades creature utility for mana
* [Mind over Matter](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mind+over+Matter) – trades cards for mana/utility
* [Squandered Resources](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Squandered+Resources) – trades long term mana for greater short term mana



|  |
| --- |
| *Three powerful "engine" cards: [Cadaverous Bloom](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cadaverous+Bloom), [Earthcraft](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Earthcraft), and [Mind over Matter](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mind+over+Matter).* |
...
**Tutors**
 ...
 Tutors are cards that allow you to search your library for a particular card. They are important to infinite combos (and combos in general) because the allow players to collect all the pieces for their combo. Examples of past tutors: (most of which have Tutor in their name) * [Demonic Tutor](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Demonic+Tutor)
...
* [Jayemdae Tome](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Jayemdae+Tome)

**Mana Generators**

 These are cards that help you speed up your mana. They enable combos as they let you get out expensive engine cards and card drawers earlier than normal. Some past examples of mana accelerators: * [Black Lotus](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Black+Lotus)
...
> 
> 
> *Example: One player controls a creature with the ability “![](https://web.archive.org/web/20210707095534im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless0.gif): [This creature] gains flying.” Another player controls a permanent with the ability “![](https://web.archive.org/web/20210707095534im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless0.gif): Target creature loses flying.” The “infinity rule” ensures that regardless of which player initiated the gain/lose flying ability, the nonactive player will always have the final choice and therefore be able to determine whether the creature has flying. (Note that this assumes that the first player attempted to give the creature flying at least once.)*
> 
> 
...
Normally, my article would have ended, but I couldn’t resist the concept of having an infinite article about infinite combos. If this idea sounds interesting to you, click [here](#begin).
