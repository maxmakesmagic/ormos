...
---
[Link to Wayback Machine](https://web.archive.org/web/20220117023408/https://magic.wizards.com/en/articles/archive/feature/playing-benzo-extended-ptqs-2015-09-03)
...
![verdant force](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=verdant+force)**Sligh:** Reanimating Verdant Force is a good start, but it tends to just pull Incinerate/Fireblast from the opponent. Infestation is the best bet. Get it going early and often, kill off the Pups and Patrols, soak up the Ball Lightnings and eventually win with it. Against a heavy burn version, Contamination can stay in, but you need Null Rod as well. Generally some number of Reanimates are sideboarded out. Easy matchup.
