...
[_metadata_:node]:- "349011"
[_metadata_:publish_date]:- "2015-03-02"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "It's About Time"
[_metadata_:wayback_capture_timestamp]:- "2015-03-02 15:58:34"
...
The first reason is that there is only a limited amount of viable three-color design space, and it was clearly better to put all of it into one set (*Khans of Tarkir*) than to split it up among two sets—especially since *Khans of Tarkir* and *Dragons of Tarkir* would not be drafted together. Putting [Abzan Guide](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Abzan+Guide) into one set, and [Sandsteppe Citadel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sandsteppe+Citadel) into a different set, is just a bad decision.
...
The third reason is that [wedge Dragons](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&set=%5B%22Planar+Chaos%22%5D&subtype=+%5Bdragon%5D) already exist…but until *Fate Reforged*, a full cycle of ally-colored Dragons did not!
...
Dragonlord Silumgar | Art by [Steven Belledin](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22Steven+Belledin%22%5D)
...
* [Renowned Weaponsmith](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Renowned+Weaponsmith) probably left his Vial of Dragonfire around here someplace….
* The *Khans of Tarkir* card [Witness of the Ages](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Witness+of+the+Ages) [*is* the *Fate Reforged* card](http://magic.wizards.com/en/articles/archive/arcana/witness-change-2015-01-12) [Pilgrim of the Fires](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Pilgrim+of+the+Fires). Will the same Golem make an appearance in this altered timeline?
* The first preview card of this article tells this story. That young whippersnapper [Silumgar, the Drifting Death](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Silumgar%2C+the+Drifting+Death) has aged into Dragonlord Silumgar.
...
![](https://media.wizards.com/2015/images/daily/cardart_5adsfjkaREXeZSBsx.jpg)


Sidisi, Undead Vizier | Art by [Min Yum](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoiler&method=visual&action=advanced&artist=%5B%22Min%20Yum%22%5D)
