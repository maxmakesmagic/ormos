...
---
[Link to Wayback Machine](https://web.archive.org/web/20220707043420/https://magic.wizards.com/en/articles/archive/feature/dark-side-green-2012-12-11)
...
But Golgari might have a few other tricks up its sleeve.
 ...
 Just ask Lukas Carlson, who played a Golgari list in one of the TCGPlayer MaxPoint grinders to a favorable result. Lukas's big innovation was actually to move away from the undead half of the spectrum that had already lost its battle the red half and instead focus on the Forests. Sure, [Lotleth Troll](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lotleth+Troll) and some removal stuck around from the Zombies version, but most of the deck is something else entirely. 


 Gone are the days of trying to find a third black mana for your [Geralf's Messenger](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Geralf%27s+Messenger). Instead, we have [Predator Ooze](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Predator+Ooze) taking the wheel. With green as the base color, [Arbor Elf](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Arbor+Elf) allows you to make big plays earlier and [Strangleroot Geist](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Strangleroot+Geist) actually gives you a two-drop worth mentioning. [Rancor](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rancor) is still extremely powerful and is a big incentive to go green. Try loosening up on the black a bit and give Golgari another spin! 
