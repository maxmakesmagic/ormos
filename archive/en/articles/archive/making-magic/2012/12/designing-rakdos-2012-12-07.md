...
---
[Link to Wayback Machine](https://web.archive.org/web/20170729172609/http://magic.wizards.com/en/articles/archive/making-magic/designing-rakdos-2012-12-07)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "Welcome to Rakdos Week. This is the fifth installment of the Return to Ravnica block guild theme weeks."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "196796"
[_metadata_:path_date]:- "2012-12-07"
[_metadata_:publish_date]:- "2012-12-10"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Designing for Rakdos"
[_metadata_:wayback_capture_timestamp]:- "2017-07-29 17:26:09"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20170729172609id_/http://magic.wizards.com/en/articles/archive/making-magic/designing-rakdos-2012-12-07"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/making-magic/designing-rakdos-2012-12-07"
---


Designing for Rakdos
====================
...
Welcome to Rakdos Week. This is the fifth installment of the *Return to Ravnica* block guild theme weeks. (Here are [Selesnya](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/mm/215), [Azorius](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/mm/219), [Izzet](http://archive.wizards.com/magic/magazine/article.aspx?x=mtg/daily/mm/221), and [Golgari](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtg/daily/mm/223).) This is the second batch of guild theme weeks. The original set of ten was done during *Ravnica* block and focused on the color philosophy of each color pair. (You can see those columns [here](http://archive.wizards.com/magic/magazine/features.aspx?tag=color%20pie).) This time around, I'm talking design. How we design for black and red in general and Rakdos in particular. 
...
![](https://media.wizards.com/images/magic/daily/mm/mm225_rakdos_lord_of_riots.jpg)[Rakdos, Lord of Riots](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rakdos%2C+Lord+of+Riots) | Art by [Vincent Proce](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=%5B%22Vincent%20Proce%22%5D)
...
Black-red also has the same problem as that facing Selesnya. The two colors feel so much alike that it's hard to make multicolor spells that feel black and red. A lot of black-red multicolor cards feel like they'd be very comfortable with a hybrid mana cost.
 ...
 The other interesting challenge I discovered during *Innistrad* block, when I made the Vampires black-red, was that it's actually hard to make a weenie strategy in the color pair. At first blush, the two colors seem a natural fit for an aggressive, low-mana strategy, but the high efficiency of black and red's kill spells strongly pushes the colors toward control. Why attack recklessly when you can slow down a little and use your removal to control tempo? [Erik Lauer](http://archive.wizards.com/magic/magazine/archive.aspx?author=Erik%20Lauer) and his development team were able to find ways to play up an aggro strategy for black-red but it took a lot of work on their part (doing things like introducing the [Slith](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;subtype=+%5B%22Slith%22%5D) mechanic to the Vampires to make attacking quickly more viable). 
...
Hellbent
![](https://media.wizards.com/images/magic/daily/mm/mm225_hellbent.jpg)  
...
So let's apply the same strategy to Rakdos. What is the most extreme turn? I cast every spell I have, blowing up everything on the board. Now we take a step back. What did we learn? We learned that Rakdos wants to go full throttle and not stop. Okay, what if we made a mechanic that rewarded that behavior?
 ...
 The design team ([Aaron Forsythe](http://archive.wizards.com/Magic/Magazine/Archive.aspx?author=Aaron%20Forsythe) as lead, [Brandon Bozzi](http://archive.wizards.com/Magic/Magazine/Archive.aspx?author=Brandon%20Bozzi), [Mark Gottlieb](http://archive.wizards.com/Magic/Magazine/Archive.aspx?author=Mark%20Gottlieb), and myself) was happy with hellbent. It was the first guild mechanic we settled on. We loved both the feel and the way it helped define how black-red was going to play. There was just one problem. 

 To explain this, let me first explain a design term. Hellbent is what we call a threshold mechanic. Named after the original threshold mechanic—you guessed it, threshold from *Odyssey* (design by [Richard Garfield](http://archive.wizards.com/Magic/Magazine/Archive.aspx?author=Richard%20Garfield))—a threshold mechanic is a mechanic with the following two traits: 

1. Cards with this mechanic have two states. One normal state and one heightened state.
2. All cards with this mechanic change from the first state to the second state based on the same criteria. (For threshold, as an example, this was having seven cards in your graveyard; for metalcraft, this was having three artifacts on the battlefield.)
...
Unleash
 Through most of design, the Rakdos mechanic was this thing called paincast. The way paincast worked was that any spell with paincast was ![](https://web.archive.org/web/20211201201921im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless1.gif) cheaper for each point of damage you had dealt to an opponent this turn. The mechanic was very flavorful but had a few problems: 

1. The mechanic worried the development team. The quote I remember was this: "Paincast is the scary part of affinity."
2. It was what we call a "win when you're ahead" mechanic, which means that it is often very useless when you most need it and meaningless when you are able to use it.
3. It majorly warped the set. Here's how. When you put in a mechanic, you also start making cards that are synergistic with that mechanic. In paincast's case, it pushed us to make cheap creatures that could make a one-shot burst of an attack. Normally, these creatures are pretty bad, but when they enable paincast, they start getting good. These cards, though, were useless to anyone who wasn't playing the paincast deck, so it cut down on the interconnectivity between the guilds and made decks have less variety as there were fewer cards that could go into every deck.
 Meanwhile, Aaron was concerned that *Return to Ravnica* didn't have a single creature combat mechanic. Most large sets we make have at least one, especially when we're doing a set with five mechanics. Aaron asked the *Return to Ravnica* design team ([Ken Nagle](http://archive.wizards.com/Magic/Magazine/Archive.aspx?author=Kenneth%20nagle) as lead, [Alexis Janson](http://archive.wizards.com/magic/magazine/archive.aspx?author=alexis%20janson), [Zac Hill](http://archive.wizards.com/magic/magazine/archive.aspx?author=Zac%20Hill), [Ken Troop](http://archive.wizards.com/magic/magazine/archive.aspx?author=Ken%20Troop), and myself) to add a creature combat mechanic. 
...
Fun and Fractures
 That's about it for the Rakdos. As always, I'd love to hear your take on my take on the color pair. Feel free to drop me an email, respond to this thread, or contact me on any of my social media ([Twitter](https://twitter.com/maro254), [Tumblr](http://markrosewater.tumblr.com/), and [Google+](https://plus.google.com/107824009487778543249/posts)). 
