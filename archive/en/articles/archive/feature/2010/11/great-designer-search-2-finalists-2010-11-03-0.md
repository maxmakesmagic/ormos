...
![](https://media.magic.wizards.com/image_legacy_migration/images/magic/daily/features/GDS2_jonathonLoucksMedium.jpg)**NAME:** Jonathon Loucks  
...
The idea of the guilds was so easily expressed to the players. [Moroii](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Moroii) doesn't have the word Dimir anywhere on it, yet players know just by looking at [Moroii](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Moroii) which guild it's a part of. Each guild felt very much like it's own unique section of the block. Not only was this expressed in the costs of the cards, but in the mechanics as well. You know [Greater Mossdog](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Greater+Mossdog) is from Golgari with the card having to tell you directly. Even players that never pay attention to flavor couldn't help but know what Ravnica was all about. Each guild has its own goals and methods, both in flavor an mechanics, and that idea comes across so easily. That's what makes Ravnica the best integration.
...
The rule's role is to keep a player's choices manageable. If a player's hand gets too full then the amount of information they need to track can get out of hand. The rule promotes action. Some new players are hesitant to act, so they may sit back and do nothing unless the game is pushing them towards action. The rule also opens up some design space, like [Gnat Miser](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gnat+Miser), and provides a discard outlet to some decks, such as Dredge. So, does the hand size rule pull its weight? Hardly.
...
The rule is often hard to remember. New players might not pay attention to it at all (and they don't really need to in order to play Magic) and even in tournaments players often don't notice (or don't say anything) when they have 8 or more cards. It's not natural or intuitive. There are times when you cast [Sign in Blood](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sign+in+Blood) or play a [Dimir Aqueduct](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dimir+Aqueduct) on turn two, and your opponent points out that you have 8 cards and have to discard. The rule gets you seemingly at random. When a player purposefully uses the rule to discard, it feels strange. It feels too much like they're gaming the system.
...
[Grand Architect](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grand+Architect).
...
The biggest hurdle to new players is the complexity. Magic isn't a simple game, but once you get past that initial hurdle the payoffs are enormous. When thinking about the accessibility of Magic to new players, initial complexity should be the top concern. Step one is to make simple, straightforward cards like [Moriok Reaver](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Moriok+Reaver). Every set needs cards like this, but a set full of them and you'll run into issues of boredom. The real answer to accessibility is to hide complexity.

The simplest way to hide complexity is through rarity, but rarity can't do all the work by itself. There are other ways to hide complexity. Landfall is one of the best examples. [Grazing Gladehart](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grazing+Gladehart) is easy enough for a new player to use while still providing interesting and complex interactions with cards like [Harrow](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Harrow). It's also satisfying for a new player to discover more complicated interactions with cards they've already grown to understand. Like I said, it's crossing that initial hurdle that's difficult.

Complexity can be hidden through flavor. [Fling](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Fling) is a pretty complicated card, but it's easy for a new player to understand because you can tell exactly what's happening: I'm throwing one of my creatures at something. The execution of this idea may be a little complicated (requiring an additional cost, checking a creature's power) but a new player understands what is going on from the start.

You can also hide complexity through repetition. Take metalcraft. A new player will read [Carapace Forger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Carapace+Forger) and wonder what an artifact is. Eventually they'll understand, but if [Carapace Forger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Carapace+Forger) is in M11, the payoff for understanding is very low. They'll just understand one card, [Carapace Forger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Carapace+Forger). A set full of different abilities is going to be very hard to process. In Scars of Mirrodin, however, once a player understands one metalcraft card they'll understand all the other metalcraft cards. While the first metalcraft card looks complicated, once the concept is understood all the metalcraft cards become simple. Each metalcraft card's complexity is hidden in every other metalcraft card.
...
Still, it's important to give players to tools to do what they want to do. Some players like playing the mill deck, so if a set doesn't have a new way for them to mill they'll be disappointed. Cards like [Goblin Guide](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Goblin+Guide) are perfect. It gave spike fans of the red deck a powerful tool they've never had before with a drawback on a completely new axis. You can play "white weenie" with Scars of Mirrodin, but you may need to play artifacts to make [Tempered Steel](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tempered+Steel) work. The same is true for limited as it is for constructed. Some players like being aggressive, but [Blade-Tribe Berserkers](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Blade-Tribe+Berserkers) is going to encourage them to play with artifacts to get what they want. [Horizon Spellbomb](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Horizon+Spellbomb) gives players the tools to draft four or five colors.
...
While there's little friction, that doesn't mean Landfall is boring - it's still changing the way I look at Magic. Landfall makes what is usually the least interesting part of my deck into something special. During gameplay I'm happy no matter what I draw, land or spell. Even before the game I'm given interesting choices when I look at my [Plated Geopede](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Plated+Geopede) and have to decide how many [Terramorphic Expanse](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Terramorphic+Expanse)s I want to play. In limited it encourages me to play more lands in my deck, reducing the number of mana-screwed draws I can get. It also reduces the number of hands that feel mana-flooded.

What's great about landfall is that a player can decide how much they want to care about it. Some players can use [Steppe Lynx](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Steppe+Lynx) with just one land a turn. Somebody else can do a bit more work and add in fetch lands. Somebody else can decide they want a very threatening [Steppe Lynx](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Steppe+Lynx) and play with [Harrow](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Harrow). Then the last guy decides he's going to make the best [Steppe Lynx](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Steppe+Lynx) ever and play with [Scapeshift](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Scapeshift). It's a mechanic that can be bent to meet different desires.
...
Instead of feeling like an upgrade, champion is often used as a way to remove and then return a creature, such as an [Elvish Harbinger](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Elvish+Harbinger), to play. Champion became more of a weird [Momentary Blink](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Momentary+Blink). Once you start getting champion creatures to champion other champion creatures, who knows what's going on anymore. The mechanic works terribly in multiples.
...
2. Making Magic  
 ...
 [[http://community.wizards.com/magicthegathering/wiki/Labs\_talk:Gds/gds2/l...](http://community.wizards.com/magicthegathering/wiki/Labs_talk:Gds/gds2/loucksj%5D)  
 3WWW  
 Creature – Angel  
 5/5  
 Flying  
...
6. Building on a Budget  
 Pit of Shadow (Rare)  
 [Quartz Caverns & Cavern of Shadows - [http://community.wizards.com/magicthegathering/wiki/Labs\_talk:Gds/gds2/l...](http://community.wizards.com/magicthegathering/wiki/Labs_talk:Gds/gds2/loucksj%5D)  
 Land  
...
10. Latest Developments  
 ...
 [Plague Sporecap - [http://community.wizards.com/magicthegathering/wiki/Labs\_talk:Gds/gds2/l...](http://community.wizards.com/magicthegathering/wiki/Labs_talk:Gds/gds2/loucksj%5D)  
 2BBB  
 Creature – Insect  
 Morph 1BB  
...
Commentary  
 ...
 4) Boring Drill is part of a six-card cycle similar to the [Absorb Vis](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Absorb+Vis) cycle from Conflux.  
