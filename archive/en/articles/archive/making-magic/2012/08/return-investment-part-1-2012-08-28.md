...
---
[Link to Wayback Machine](https://web.archive.org/web/20220116093821/https://magic.wizards.com/en/articles/archive/making-magic/return-investment-part-1-2012-08-28)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "Welcome to the first Return to Ravnica Preview Week. Players have been clamoring for news about our fall set, where we return to one of our most popular worlds ever. Finally, I get to start talking about it. If you are unfamiliar with the design of the original Ravnica, I suggest you take a quick peek at my columns about the design of that set from seven years ago (Part I,"
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "195831"
[_metadata_:path_date]:- "2012-08-28"
[_metadata_:publish_date]:- "2012-09-03"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Return on Investment, Part 1"
[_metadata_:wayback_capture_timestamp]:- "2022-01-16 09:38:21"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20220116093821id_/https://magic.wizards.com/en/articles/archive/making-magic/return-investment-part-1-2012-08-28"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/making-magic/return-investment-part-1-2012-08-28"
---


Return on Investment, Part 1
============================
...
Welcome to the first *Return to Ravnica* Preview Week. Players have been clamoring for news about our fall set, where we return to one of our most popular worlds ever. Finally, I get to start talking about it. If you are unfamiliar with the design of the original *Ravnica*, I suggest you take a quick peek at my columns about the design of that set from seven years ago ([Part I](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/mr192), [Part II](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/mr193), and [Part III](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/mr194)) as today's column assumes you are familiar with that block. I have lots to tell (so much so that this is going to be a multi-part column) and a preview to show off, so let's get started.

![](https://media.wizards.com/images/magic/daily/mm/mm211_mountain_2.jpg)[Mountain](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Mountain) | Art by [Richard Wright](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=%5B%22Richard%20Wright%22%5D)
...
![](https://media.wizards.com/images/magic/daily/mm/mm211_nagle.jpg)The first thing I always do is figure out who the lead designer for the set is going to be. For those who have been reading "Making **Magic**" for at least five years, you have been following the story of [Ken Nagle](http://archive.wizards.com/magic/magazine/archive.aspx?author=kenneth%20nagle). Ken first got on my radar as one of the finalists for the first *Great Designer Search*. [Alexis Janson](http://archive.wizards.com/Magic/Magazine/Archive.aspx?author=Alexis%20Janson) (who we will get to in a second) won that first GDS, but Ken so impressed me that I also gave him a six-month design internship in Ramp;D as well as Alexis (the internship was the prize for winning).

Ken managed to parlay the internship into a full-time job and went on to become my design disciple. (Interestingly, the last person to fill this role was [Aaron Forsythe](http://archive.wizards.com/Magic/Magazine/Archive.aspx?author=Aaron%20Forsythe).) Ken was put on many design teams. Eventually, he got to lead his first set, *Worldwake*. He also did a bunch of smaller products like *Archenemy* and *Commander*. Ken's biggest assignment was being put in charge of the design for *New Phyrexia*.
...
![](https://media.wizards.com/images/magic/daily/mm/mm211_xn3gd6o5iw.jpg)Art by [Yeong-hao Han](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=%5B%22Yeong-hao%20Han%22%5D)
...
The large spring set was going to be the world that I wanted to build on Gothic horror. The fall and winter sets were going to be based on a world/mechanics design that [Brian Tinsman](http://archive.wizards.com/Magic/Magazine/Archive.aspx?author=Brian%20Tinsman) had come up with. (Why was Gothic horror just one set? Because there was doubt it could fill up an entire block; they weren't even sure about a two-set block. I seriously couldn't make this stuff up.) Somewhere along the way, the point came up that we were missing an opportunity if we did our horror set in the spring rather than in the fall, near Halloween.

![](https://media.wizards.com/images/magic/daily/mm/mm211_hjduccd50z.jpg)Art by [Clint Cearley](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=%5B%22Clint%20Cearly%22%5D)
...
We knew there was going to be pent-up demand for Ravnica's return, but if we made a set before that set we were only going deflate that excitement. There was no way to hint at Ravnica's return yet not step on the toes of *Return to Ravnica*. At this time, [Doug Beyer](http://archive.wizards.com/Magic/Magazine/Archive.aspx?author=Doug%20Beyer) had an idea about the [Helvault](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Helvault) and an angel named Avacyn and it became clear that the third set could take place on Innistrad.
...
Brian felt that, while Ravnica was very successful, it had one flaw: We never gave the players a chance to pick up any extra cards. Each guild showed up in one set in the block and then that was it (*Dissension* did cheat a tiny bit with the gold split cards.) In fact, back in the day, [Brady Dommermuth](http://archive.wizards.com/Magic/Magazine/Archive.aspx?author=Brady%20Dommermuth) had pushed hard for what ended up being *Coldsnap* to be a fourth set in the *Ravnica* block that revisited all ten guilds.
...
We took this idea to Aaron and [Bill](http://archive.wizards.com/Magic/Magazine/Archive.aspx?author=Bill%20Rose) and they both liked it. My biggest concern was this: would the large sets have enough space? We experimented and, in the end, decided to add ten uncommons to give both of the large sets a little breathing room. Note that the difference in the number of cards between *Return to Ravnica* and *Gatecrash* is twenty-five. Those are all basic lands, because we didn't feel a need to make new ones for *Gatecrash*, since it takes place on the same world. Why five of each land instead of the normal four? Jeremy Jarvis, **Magic**'s Art Director, thought it would be nice to bring back one image for each basic land from the original *Ravnica* to help play up the nostalgia.

![](https://media.wizards.com/images/magic/daily/mm/mm211_aufb3gejbh.jpg)Art by [Howard Lyon](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=%5B%22Howard%20Lyon%22%5D)
...
![](https://media.wizards.com/images/magic/daily/mm/mm211_qpzav1e3s9.jpg)Art by [Zoltan Boros](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=%5B%22Zoltan%20Boros%22%5D)
...
[![](https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=107448)](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=107448)  
...
Without further ado, I introduce Isperia, Supreme Judge.

![Isperia, Supreme Judge](https://media.wizards.com/images/magic/tcg/products/rtr/cxee66db2v_en.jpg)  
...
And in [today's feature](/Magic/Magazine/Article.aspx?x=mtg/daily/feature/211a), Ken Nagle will introduce you to one of the returning guild leaders. Check it out.

![](https://media.wizards.com/images/magic/daily/mm/mm211_2zurc6u5s7.jpg)Isperia, Supreme Judge | Art by [Scott M. Fischer](http://gatherer.wizards.com/Pages/Search/Default.aspx?output=spoileramp;method=visualamp;action=advancedamp;artist=%5B%22Scott%20M.%20Fischer%22%5D)
