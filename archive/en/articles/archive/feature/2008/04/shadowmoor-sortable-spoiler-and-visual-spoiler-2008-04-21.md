...
---
[Link to Wayback Machine](https://web.archive.org/web/20160118133612/http://magic.wizards.com/en/articles/archive/feature/shadowmoor-sortable-spoiler-and-visual-spoiler-2008-04-21)
...
[_metadata_:title]:- "Shadowmoor Sortable Spoiler (and Visual Spoiler!)"
...
*Shadowmoor* Sortable Spoiler (and Visual Spoiler!)
===================================================
...
![](https://media.magic.wizards.com/image_legacy_migration/magic/images/tournamentcenter/2008/shadowmoor_300.jpg)As is our tradition for the Monday after a new set's prerelease events, today we post the full card list for the latest set right here on the front page of **magicthegathering.com**. Here is the sortable spoiler list for *Shadowmoor*. And we've got a new feature: a complete visual spoiler for the entire set, in each of the nine languages it was printed in! Enjoy! 


**[Launch the *Shadowmoor* card list](http://archive.wizards.com/default.asp?x=magic/cardlist/shadowmoor)**



**[Launch the *Shadowmoor* Visual Spoiler](http://archive.wizards.com/default.asp?x=magic/shadowmoor/spoiler)**
