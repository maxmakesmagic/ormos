...
---
[Link to Wayback Machine](https://web.archive.org/web/20170215221801/http://magic.wizards.com/en/articles/archive/making-magic/make-no-mistake-2003-11-10-0)

[_metadata_:author]:- "Mark Rosewater"
[_metadata_:description]:- "The greatest mistake is not admitting when you make one."
[_metadata_:generator]:- "Drupal 7 (http://drupal.org)"
[_metadata_:node]:- "619301"
[_metadata_:publish_date]:- "2003-11-10"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Make No Mistake"
[_metadata_:wayback_capture_timestamp]:- "2017-02-15 22:18:01"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20170215221801id_/http://magic.wizards.com/en/articles/archive/making-magic/make-no-mistake-2003-11-10-0"
[_metadata_:wayback_url]:- "http://magic.wizards.com/en/articles/archive/making-magic/make-no-mistake-2003-11-10-0"
---
...
To me this card wins the prize not because it's the most powerful card ever printed (although that point is up for debate as far as I'm concerned) but that a card as insanely powerful as [Yawgmoth's Will](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Yawgmoth%27s+Will) was created at a time that R&D should have known better. Think about it. [Reclaim](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Reclaim) at ![](https://web.archive.org/web/20211201201921im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless1.gif)![](https://web.archive.org/web/20220123123600im_/https://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/green.gif) lets you return one card to your hand. That card was restricted years before *Urza's Saga* was ever designed.

[Yawgmoth's Will](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Yawgmoth%27s+Will), for one more mana, lets you essentially regrow every card in your graveyard. True, only for that one turn, but then one turn seems plenty potent especially with cards like [Dark Ritual](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Dark+Ritual) and [Lotus Petal](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Lotus+Petal) that were available in the same Standard environment as [Yawgmoth's Will](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Yawgmoth%27s+Will).
...
### #7 - Biggest Mistake - Card Design - Underpowered - [Sorrow's Path](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sorrow%27s+Path)
...
[Tinker](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tinker) came about because I always enjoyed the *Antiquities* card [Transmute Artifact](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Transmute+Artifact). But all the "extra mana payment" text seemed a little clunky. So I took it off. Woops. Maybe combining tutoring and comes into play for free should require some extra mana. 

[Tinker](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tinker) taught me that designers need to understand how a card ticks before they try to update it.

### #9 - Biggest Mistake - Card Design - Rules Problems - Humility

Way, way, way too many rules questions begin with "I have a [Humility](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Humility) in play". Ironically, I was trying to create a very simple elegant card. The design lesson here is that adding things is good. Taking them away? Danger Will Robinson! Danger! (You have to imagine Robby the Robot saying this for the full effect.) 
...
Another common confusion art can create is telling whether a creature has flying. The most blatant example of this happened in *The Dark*. In rare green there was a creature called [Whippoorwill](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Whippoorwill). Be aware that [Whippoorwill](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Whippoorwill) is the name of an actual bird. An actual bird that can fly. And in the art, the creature is shown in mid-flight. All this would be great except for one thing: The card doesn't have flying! 

As a result of a number of illustrations like [Whippoorwill](http://gatherer.wizards.com/Pages/Card/Details.aspx?&name=Whippoorwill), current art descriptions for creatures always include whether the creature can or cannot fly.

### #14 - Biggest Mistake - Art - Misunderstanding the Card's Title - [Hyalopterous Lemure](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Hyalopterous+Lemure)
...
This is far from the only time an artist has mistakenly drawn the wrong item (Mark Tedin's first take on [Urza's Mine](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Urza%27s+Mine) showed a land mine, for example), but the art department is much more thorough about making sure those mistakes don't actually end up on the card.

### #15 - Biggest Mistake - Art - Misreading the Card's Title - Alchor's Tomb

Much of the flavor of *Legends* comes from D&D campaigns of various designers. One such character is Alchor. You see, Alchor was a wizard played by Wizards of the Coast co-founder and former president and CEO, Peter Adkison. The card was supposed to be Alchor's Tome, a mighty tome of magical spells that such a wizard might use in preparing for battle. Unfortunately, the artist mistook "tome" for "tomb" and drew [Alchor's Tomb](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Alchor%27s+Tomb). Thus, at least in the world of **Magic**, Peter's wizard had been killed off.

### #16 - Biggest Mistake - Templating - Dead Ringers

![Dead Ringers](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Dead+Ringers)Templating is the science (or some might say art) of writing out **Magic** rules text in a manner that is both technically precise and clear to comprehend. Occasionally, one of these two functions is not met properly. The most grievous example forgoes the latter.The first reaction most players have is "Huh?"
...
![Book Burning](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Book+Burning)I should just start by showing you the card.You see, the first line doesn't end with a comma, but by breaking there, it sure reads like it wants one. This has led to numerous players writing in saying, "I can deal 6 damage to my opponent if he or she doesn't have [Book Burning](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Book+Burning) in their hand, right?"
...
There have been a number of classic blunders on the Pro Tour. Marco Blume's playing of a [Covetous Dragon](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Covetous+Dragon) when he had no artifacts in play at Worlds '99. Mark Justice's concession to Mike Long in the finals of PT Paris when Long had no way to win left in his deck. But the king of all screw-ups belongs I believe to a young Canadian named Terry Borer.

The moment in question occurred in the quarter-finals of PT Atlanta. The event was the one and only pro tour to use a pre-release limited format. (*Mirage* being the soon to be released set.) Borer was playing against fellow Canadian Darwin Kastle. Terry had the win in his hand. All he had to do was attack with a number of creatures. And then after blocking was assigned, he needed to play [Grave Servitude](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grave+Servitude) from his hand on an unblocked creature (and Borer had more attackers than Kastle had blockers) and he would win. Attack. Play [Grave Servitude](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grave+Servitude) on an unblocked creature. Win the game and the match and advance to the semi-finals. But Borer decided to be tricky. After Kastle declared his blockers, Borer asked "Do you have any fast effects?" 

The question sounds innocent enough but head judge Charlie Catino understood its importance. When Darwin said no and Terry attempted to play [Grave Servitude](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grave+Servitude), Catino stepped in. You see, by asking the question, Borer had passed priority. When Kastle declined to play a spell, the opportunity to play spells had passed. Borer's little tricky question made him miss his window for playing the [Grave Servitude](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Grave+Servitude).
...
As I talked about up above, I have a fine history of making blunders in my columns. Probably my biggest mistake was an aside in my column on the creation of [Phage](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phage) ("[Phage of Enlightenment](/en/articles/archive/making-magic/trigger-happy-2003-01-06)"). In the column, I relayed a combo from R&D developer Elaine Chase that used [Phage](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phage) in combination with [Volrath's Shapeshifter](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Volrath%27s+Shapeshifter) and [Kamahl](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Kamahl). The problem was that neither Elaine or I realized that [Phage](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Phage)'s ability only works with "combat damage" making the little combo not work. (Note that then editor Aaron Forsythe quickly changed the example to [Rorix](http://gatherer.wizards.com/Pages/Card/Details.aspx?name=Rorix) to fix the mistake.) 
