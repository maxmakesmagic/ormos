...
[_metadata_:node]:- "612111"
[_metadata_:publish_date]:- "2006-03-03"
[_metadata_:source]:- "div-main-content"
[_metadata_:title]:- "Yes It Iz"
[_metadata_:wayback_capture_timestamp]:- "2021-10-16 17:15:14"
[_metadata_:wayback_raw_url]:- "https://web.archive.org/web/20211016171514id_/https://magic.wizards.com/en/articles/archive/latest-developments/yes-it-iz-2006-03-03-0"
[_metadata_:wayback_url]:- "https://magic.wizards.com/en/articles/archive/latest-developments/yes-it-iz-2006-03-03-0"
---
...
Just when you didn't think it was possible, [we banned “Affinity” cards](http://archive.wizards.com/Magic/Magazine/Article.aspx?x=dci/announce/dci20060301a) in precisely the format that we thought we didn't have to ban them in: *Mirrodin* Block Constructed.


Why, you may be asking, are we banning the ultra-powerful [Ancient Den](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Ancient+Den)[\*](#footnote) in Block when that was *two blocks ago?* A fine question. I really don't know. I think we just felt bored not having to ban stuff in other formats.
...
![Shattering Spree](http://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Shattering+Spree)
...
As for tuning Izzet for Constructed, we knew we'd have issues putting power into the guild before development even started. Although we didn't predict the exact Blue/Red decks that would emerge pre-*Guildpact* ([Annex](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Annex)-[Wildfire](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wildfire), Urzatron, Red Ninja beatdown, [Magnivore](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Magnivore), [Howling Mine](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Howling+Mine), etc.), we knew that those two colors possessed the best cards in a vacuum. Red had plenty of burn and land destruction, Blue had tournament playable card drawing and countering, and they both had a decent array of creatures. Knowing that, the best we could do for Izzet was give it the cards to fill gaps in their strategies (like [Electrolyze](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Electrolyze)) and possibly enable some crazy new deck with cards like [Gelectrode](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Gelectrode), [Izzet Guildmage](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Izzet+Guildmage), or [Cerebral Vortex](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cerebral+Vortex).


Here are some notes on individual cards:


* **[Electrolyze](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Electrolyze)**. We tried it at "![](https://web.archive.org/web/20161115194122im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/blue.gif)![](https://web.archive.org/web/20161227130159im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/red.gif), deal two damage to a single target and draw a card," we really did. It was far too good, so we added a mana, but the card didn't feel powerful enough. I suggested at one point that [Steamcore Weird](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Steamcore+Weird) be able to split up his damage, but Brian Schneider felt that would be a better upgrade for [Electrolyze](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Electrolyze). That change makes it better at killing things like [Sakura-Tribe Elder](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Sakura-Tribe+Elder), since you can have a second target which prevents the spell from “fizzling” when the sacrifice the Elder.
* **[Cerebral Vortex](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cerebral+Vortex)** began life as a ![](https://web.archive.org/web/20161227130050im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/colorless3.gif)![](https://web.archive.org/web/20161115194122im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/blue.gif)![](https://web.archive.org/web/20161227130159im_/http://magic.wizards.com/sites/all/modules/custom/wiz_autocard/wiz_manacost/manasymbols/red.gif)[Wheel of Fortune](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wheel+of+Fortune). Playtesting showed it to be too strong at that cost. Development was going to print it as a much worse card—perhaps at six mana, perhaps having each player only draw five—unless we could come up with a suitable replacement card that matched the art. [Cerebral Vortex](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Cerebral+Vortex) came to the rescue. One day we'll figure out how to do an interesting and powerful [Wheel of Fortune](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Wheel+of+Fortune) variant that isn't either too ridiculous (like [Windfall](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Windfall)) or too lame (like [Temporal Cascade](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Temporal+Cascade)).
...
* **[Stitch in Time](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Stitch+in+Time)** had replicate at one point. Talk about swingy.
...
\*: And [Seat of the Synod](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Seat+of+the+Synod), and [Vault of Whispers](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Vault+of+Whispers), and [Great Furnace](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Great+Furnace), and [Tree of Tales](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Tree+of+Tales), and [Darksteel Citadel](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Darksteel+Citadel), (/inhales) and [Arcbound Ravager](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Arcbound+Ravager), and [Disciple of the Vault](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Disciple+of+the+Vault), and [Aether Vial](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Aether+Vial). [Omega Myr](https://gatherer.wizards.com/Pages/Card/Details.aspx?name=Omega+Myr) is still legal, so have at it.
